...
Install and activate the following plugins, which are integrated with PoP (_not all of them are mandatory, however **PoP has yet not been tested without them**_):
 ...
 - [Aryo Activity Log](https://wordpress.org/plugins/aryo-activity-log/): for the notifications (**warning: ** this plugin had to be modified to make it work with PoP—otherwise it breaks it—, please ask me to send you the hacked version)

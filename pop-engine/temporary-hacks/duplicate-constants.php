...
add_action('plugins_loaded', 'pop_engine_duplicate_constants', 101);
function pop_engine_duplicate_constants() {
	...
	$compact = \PoP\Engine\Server\Utils::compact_response_json_keys();

    ...
    "repositories": [
        {
            ...
            "package": {
                ...
                "version": "1",
                "dist": {
                    "url": "https://github.com/GatoGraphQL/GatoGraphQL/releases/download/1.0.5/gatographql-1.0.5.zip",
                    "type": "zip"
                },
                "require": {
...
```bash
wp plugin install --activate https://github.com/GatoGraphQL/GatoGraphQL/releases/download/1.0.5/gatographql-1.0.5.zip
```

...
wp import /app/_shared-webserver/assets/gatographql-data.xml --url="$WEBSERVER_DOMAIN" --authors=create --user=admin
wp import /app/_shared-webserver/assets/gatographql-testing-data.xml --url="$WEBSERVER_DOMAIN" --authors=create --user=admin

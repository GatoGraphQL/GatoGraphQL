#!/bin/sh
wp core install --url="gatographql-for-prod.lndo.site" --title="Gato GraphQL for PROD" --admin_user=admin --admin_password=admin --admin_email=admin@example.com --path=/app/wordpress 

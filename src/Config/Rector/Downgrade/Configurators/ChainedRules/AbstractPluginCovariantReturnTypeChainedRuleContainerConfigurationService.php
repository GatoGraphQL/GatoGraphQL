...
abstract class AbstractPluginCovariantReturnTypeChainedRuleContainerConfigurationService extends AbstractCovariantReturnTypeChainedRuleContainerConfigurationService
{

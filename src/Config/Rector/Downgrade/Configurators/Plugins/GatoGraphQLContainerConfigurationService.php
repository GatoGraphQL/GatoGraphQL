...
use PoP\PoP\Config\Rector\Downgrade\Configurators\AbstractMainPluginDowngradeContainerConfigurationService;
    ...
    protected function getSkip(): array
    {
        return array_merge(
            ...
            [
                ...
                $this->pluginDir . '/vendor/symfony/cache/Traits/Redis6Proxy.php',
                $this->pluginDir . '/vendor/symfony/cache/Traits/RedisCluster6Proxy.php',

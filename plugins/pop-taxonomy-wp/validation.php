...
define('POP_TAXONOMYWP_POP_ENGINEWP_MIN_VERSION', 0.1);
...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TAXONOMYWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            __('PoP Taxonomy for WordPress', 'pop-taxonomy-wp'),
            __('PoP Engine for WordPress', 'pop-taxonomy-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            __('PoP Engine for WordPress', 'pop-taxonomy-wp'),
            'https://github.com/leoloso/PoP',
            POP_TAXONOMYWP_POP_ENGINEWP_MIN_VERSION
        );
    }

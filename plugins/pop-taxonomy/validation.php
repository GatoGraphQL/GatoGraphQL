...
define('POP_TAXONOMY_POP_ENGINE_MIN_VERSION', 0.1);
...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TAXONOMY_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            __('PoP Engine', 'pop-taxonomy'),
            'https://github.com/leoloso/PoP',
            POP_TAXONOMY_POP_ENGINE_MIN_VERSION
        );
    }

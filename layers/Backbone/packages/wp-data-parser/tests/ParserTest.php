...
class ParserTest extends TestCase
{
    public function testParser(): void
    {
        ...
        $this->assertEquals(
            $this->getSampleDataExpectedResponse(),
            $parsedData
        );
    }

    private function getSampleDataExpectedResponse(): array
    {
        return array(
            'authors' =>
            array(
            ...
            array(
                ...
                array(
                    ...
                    'post_author' => 3,
                    'post_content' => '<p>There are many different ways to use the web besides a mouse and a pair of eyes.  Users navigate for example with a keyboard only or with their voice. </p>',
                    'post_excerpt' => '',
                    'post_id' => 1724,

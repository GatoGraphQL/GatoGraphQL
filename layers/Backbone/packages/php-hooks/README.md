...
The source code is hosted on the [PoP monorepo](https://github.com/leoloso/PoP), under [`Backbone/packages/php-hooks`](https://github.com/leoloso/PoP/tree/master/layers/Backbone/packages/php-hooks).

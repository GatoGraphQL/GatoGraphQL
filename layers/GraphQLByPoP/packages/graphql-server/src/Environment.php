...
class Environment
{
    public final const EXPOSE_SELF_FIELD_FOR_ROOT_TYPE_IN_GRAPHQL_SCHEMA = 'EXPOSE_SELF_FIELD_FOR_ROOT_TYPE_IN_GRAPHQL_SCHEMA';
    ...
    public final const ENABLE_PROACTIVE_FEEDBACK_WARNINGS = 'ENABLE_PROACTIVE_FEEDBACK_WARNINGS';
    public final const ENABLE_PROACTIVE_FEEDBACK_DEPRECATIONS = 'ENABLE_PROACTIVE_FEEDBACK_DEPRECATIONS';
    public final const ENABLE_PROACTIVE_FEEDBACK_NOTICES = 'ENABLE_PROACTIVE_FEEDBACK_NOTICES';
    public final const ENABLE_PROACTIVE_FEEDBACK_SUGGESTIONS = 'ENABLE_PROACTIVE_FEEDBACK_SUGGESTIONS';
    public final const ENABLE_PROACTIVE_FEEDBACK_LOGS = 'ENABLE_PROACTIVE_FEEDBACK_LOGS';

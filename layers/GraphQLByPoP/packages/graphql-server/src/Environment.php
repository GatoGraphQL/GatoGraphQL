...
class Environment
{
    ...
    public const ENABLE_PROACTIVE_FEEDBACK_WARNINGS = 'ENABLE_PROACTIVE_FEEDBACK_WARNINGS';
    ...
    public const ENABLE_PROACTIVE_FEEDBACK_SUGGESTIONS = 'ENABLE_PROACTIVE_FEEDBACK_SUGGESTIONS';

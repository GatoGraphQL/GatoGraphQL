        ...
        switch ($field->getName()) {
            ...
            case 'fields':
                ...
                if ($type instanceof HasFieldsTypeInterface) {
                    return $type->getFieldIDs($field->getArgument('includeDeprecated')?->getTEMPPPValue());
                }
                return null;
            case 'interfaces':
            ...
            case 'enumValues':
                ...
                if ($type instanceof EnumType) {
                    return $type->getEnumValueIDs($field->getArgument('includeDeprecated')?->getTEMPPPValue());
                }
                return null;
            case 'inputFields':

...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`GraphQLByPoP/packages/graphql-endpoint-for-wp`](https://github.com/GatoGraphQL/PoP/tree/master/layers/GraphQLByPoP/packages/graphql-endpoint-for-wp).

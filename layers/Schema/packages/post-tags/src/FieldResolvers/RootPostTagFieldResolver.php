...
class RootPostTagFieldResolver extends AbstractQueryableFieldResolver
{
    ...
    {
        return match ($fieldName) {
            'postTags' => [TagFilterInputContainerModuleProcessor::class, TagFilterInputContainerModuleProcessor::MODULE_FILTERINNER_TAGS],
            'postTagCount' => [TagFilterInputContainerModuleProcessor::class, TagFilterInputContainerModuleProcessor::MODULE_FILTERINNER_TAGCOUNT],
            'postTagNames' => [TagFilterInputContainerModuleProcessor::class, TagFilterInputContainerModuleProcessor::MODULE_FILTERINNER_TAGS],

...
define('POP_LOCATIONS_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_Locations_Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONS_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-locations')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-locations'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-locations')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-locations'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONS_POP_APPLICATION_MIN_VERSION
        );
    }

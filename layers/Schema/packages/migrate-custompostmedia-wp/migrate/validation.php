<?php
namespace PoPSchema\CustomPostMedia\WP;
use PoP\Translation\Facades\TranslationAPIFacade;
use PoP\Hooks\Facades\HooksAPIFacade;

define('POP_CUSTOMPOSTMEDIAWP_POP_ENGINEWP_MIN_VERSION', 0.1);
...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CUSTOMPOSTMEDIAWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Post Media for WordPress', 'pop-postmedia-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-postmedia-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-postmedia-wp'),
            'https://github.com/leoloso/PoP',
            POP_CUSTOMPOSTMEDIAWP_POP_ENGINEWP_MIN_VERSION
        );
    }

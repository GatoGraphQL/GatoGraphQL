...
define('POP_TAXONOMIES_POP_ENGINE_MIN_VERSION', 0.1);
...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TAXONOMIES_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Taxonomies', 'pop-taxonomies')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Taxonomies', 'pop-taxonomies'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-taxonomies')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-taxonomies'),
            'https://github.com/leoloso/PoP',
            POP_TAXONOMIES_POP_ENGINE_MIN_VERSION
        );
    }

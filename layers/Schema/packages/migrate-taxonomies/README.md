# (Temporary package) Migrate code to package: Taxonomies

Code to be migrated, from legacy PHP 5 code to modern PHP 7 code ([read more here](https://github.com/leoloso/PoP#codebase-migration)). Target package description:  Adds support for taxonomies
...
``` bash
composer require pop-schema/migrate-taxonomies
```

## Development

The source code is hosted on the [PoP monorepo](https://github.com/leoloso/PoP), under [`Schema/packages/migrate-taxonomies`](https://github.com/leoloso/PoP/tree/master/layers/Schema/packages/migrate-taxonomies).

...
class Component extends AbstractComponent
{
    ...
    protected static function defineRuntimeConstants(
        ...
        if (!defined('POP_POSTCATEGORIES_ROUTE_POSTCATEGORIES')) {
            $definitionManager = DefinitionManagerFacade::getInstance();
            define('POP_POSTCATEGORIES_ROUTE_POSTCATEGORIES', $definitionManager->getUniqueDefinition('post-categories', DefinitionGroups::ROUTES));
        }
    }
}

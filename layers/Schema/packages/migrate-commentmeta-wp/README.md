# (Temporary package) Migrate code to package: Comment Meta for WordPress

Code to be migrated, from legacy PHP 5 code to modern PHP 7 code ([read more here](https://github.com/leoloso/PoP#codebase-migration)). Target package description:  Implementation for WordPress of contracts from package "Comment Meta"
...
``` bash
composer require pop-schema/migrate-commentmeta-wp
```

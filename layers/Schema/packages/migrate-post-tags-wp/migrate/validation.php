...
define('POP_POSTTAGSWP_POP_ENGINEWP_MIN_VERSION', 0.1);
...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_POSTTAGSWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Post Tags for WordPress', 'pop-post-tags-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-post-tags-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-post-tags-wp'),
            'https://github.com/leoloso/PoP',
            POP_POSTTAGSWP_POP_ENGINEWP_MIN_VERSION
        );
    }

...
define('POP_METAQUERY_POP_ENGINE_MIN_VERSION', 0.1);
...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_METAQUERY_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Meta Query', 'pop-metaquery')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Meta Query', 'pop-metaquery'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-metaquery')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-metaquery'),
            'https://github.com/leoloso/PoP',
            POP_METAQUERY_POP_ENGINE_MIN_VERSION
        );
    }

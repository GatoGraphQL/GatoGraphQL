...
define('POP_POSTTAGS_POP_ENGINE_MIN_VERSION', 0.1);
...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_POSTTAGS_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP PostTags', 'pop-tags')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP PostTags', 'pop-tags'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-tags')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-tags'),
            'https://github.com/leoloso/PoP',
            POP_POSTTAGS_POP_ENGINE_MIN_VERSION
        );
    }

# (Temporary package) Migrate code to package: Post Tags

Code to be migrated, from legacy to modern PHP code ([read more here](https://github.com/leoloso/PoP#codebase-migration)). Target package description:  Adds support for tags
...
``` bash
composer require pop-schema/migrate-post-tags
```

## Development

The source code is hosted on the [PoP monorepo](https://github.com/leoloso/PoP), under [`Schema/packages/migrate-post-tags`](https://github.com/leoloso/PoP/tree/master/layers/Schema/packages/migrate-post-tags).

...
define('POP_EVENTS_POP_LOCATIONS_MIN_VERSION', 0.1);
...
class PoP_Events_Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_LOCATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTS_POP_LOCATIONS_MIN_VERSION > POP_LOCATIONS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events'),
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-events')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-events'),
            'https://github.com/leoloso/PoP',
            POP_EVENTS_POP_LOCATIONS_MIN_VERSION
        );
    }

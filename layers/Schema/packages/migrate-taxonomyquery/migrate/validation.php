...
define('POP_TAXONOMYQUERY_POP_TAXONOMIES_MIN_VERSION', 0.1);
...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_TAXONOMIES_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TAXONOMYQUERY_POP_TAXONOMIES_MIN_VERSION > POP_TAXONOMIES_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Taxonomy Query', 'pop-taxonomyquery')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Taxonomy Query', 'pop-taxonomyquery'),
            TranslationAPIFacade::getInstance()->__('PoP Taxonomies', 'pop-taxonomyquery')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Taxonomies', 'pop-taxonomyquery'),
            'https://github.com/leoloso/PoP',
            POP_TAXONOMYQUERY_POP_TAXONOMIES_MIN_VERSION
        );
    }

...
define('POP_COMMENTS_POP_POSTS_MIN_VERSION', 0.1);
...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_POSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_COMMENTS_POP_POSTS_MIN_VERSION > POP_POSTS_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Comments', 'pop-comments')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Comments', 'pop-comments'),
            TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-comments')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-comments'),
            'https://github.com/leoloso/PoP',
            POP_COMMENTS_POP_POSTS_MIN_VERSION
        );
    }

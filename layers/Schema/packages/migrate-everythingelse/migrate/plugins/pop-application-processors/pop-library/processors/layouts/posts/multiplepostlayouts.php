...
{
    public const MODULE_LAYOUT_MULTIPLECONTENT_NAVIGATOR = 'layout-multiplepost-navigator';
    public const MODULE_LAYOUT_MULTIPLECONTENT_ADDONS = 'layout-multiplepost-addons';
    public const MODULE_LAYOUT_MULTIPLECONTENT_DETAILS = 'layout-multiplepost-details';
    public const MODULE_LAYOUT_MULTIPLECONTENT_THUMBNAIL = 'layout-multiplepost-thumbnail';
    public const MODULE_LAYOUT_MULTIPLECONTENT_LIST = 'layout-multiplepost-list';
    public const MODULE_LAYOUT_MULTIPLECONTENT_LINE = 'layout-multiplepost-line';
    public const MODULE_LAYOUT_MULTIPLECONTENT_RELATED = 'layout-multiplepost-related';
    public const MODULE_LAYOUT_MULTIPLECONTENT_EDIT = 'layout-multiplepost-edit';
    public const MODULE_LAYOUT_MULTIPLECONTENT_SIMPLEVIEW = 'layout-multiplepost-simpleview';
    public const MODULE_LAYOUT_MULTIPLECONTENT_FULLVIEW = 'layout-multiplepost-fullview';
    public const MODULE_LAYOUT_AUTHORMULTIPLECONTENT_FULLVIEW = 'layout-authormultiplepost-fullview';
    public const MODULE_LAYOUT_SINGLEMULTIPLECONTENT_FULLVIEW = 'layout-singlemultiplepost-fullview';
    public const MODULE_LAYOUT_MULTIPLECONTENT_SIMPLEVIEW_ABOVECONTENT = 'layout-multiplepost-simpleview-abovecontent';

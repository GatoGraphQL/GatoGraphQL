...
{
    public const MODULE_CONTENTINNER_FOLLOWSUSERS = 'contentinner-followsusers';
    public const MODULE_CONTENTINNER_UNFOLLOWSUSERS = 'contentinner-unfollowsusers';
    public const MODULE_CONTENTINNER_RECOMMENDSPOSTS = 'contentinner-recommendsposts';
    public const MODULE_CONTENTINNER_UNRECOMMENDSPOSTS = 'contentinner-unrecommendsposts';
    public const MODULE_CONTENTINNER_SUBSCRIBESTOTAGS = 'contentinner-subscribestotags';
    public const MODULE_CONTENTINNER_UNSUBSCRIBESFROMTAGS = 'contentinner-unsubscribesfromtags';
    public const MODULE_CONTENTINNER_UPVOTESPOSTS = 'contentinner-upvotesposts';
    public const MODULE_CONTENTINNER_UNDOUPVOTESPOSTS = 'contentinner-undoupvotesposts';
    public const MODULE_CONTENTINNER_DOWNVOTESPOSTS = 'contentinner-downvotesposts';
    public const MODULE_CONTENTINNER_UNDODOWNVOTESPOSTS = 'contentinner-undodownvotesposts';

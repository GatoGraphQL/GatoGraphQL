...
{
    public const MODULE_LAYOUT_HIGHLIGHTEDPOST_LINE = 'layout-highlightedpost-line';
    public const MODULE_LAYOUT_HIGHLIGHTEDPOST_ADDONS = 'layout-highlightedpost-addons';

...
{
    public const MODULE_DELEGATORFILTER_MYMEMBERS = 'delegatorfilter-mymembers';
    public const MODULE_DELEGATORFILTER_COMMUNITIES = 'delegatorfilter-communities';
    ...
    {
        $inners = array(
            self::MODULE_DELEGATORFILTER_MYMEMBERS => [GD_URE_Module_Processor_CustomSimpleFilterInners::class, GD_URE_Module_Processor_CustomSimpleFilterInners::MODULE_SIMPLEFILTERINNER_MYMEMBERS],

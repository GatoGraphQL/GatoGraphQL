...
{
    public const MODULE_CHECKPOINTMESSAGEINNER_NOTLOGGEDIN = 'checkpointmessageinner-notloggedin';
    public const MODULE_CHECKPOINTMESSAGEINNER_LOGGEDIN = 'checkpointmessageinner-loggedin';
    public const MODULE_CHECKPOINTMESSAGEINNER_LOGGEDINCANEDIT = 'checkpointmessageinner-loggedincanedit';
    public const MODULE_CHECKPOINTMESSAGEINNER_LOGGEDINISADMIN = 'checkpointmessageinner-loggedinisadmin';

...
{
    public const MODULE_LAYOUT_FEEDBACKMESSAGEALERT_LOGIN = 'layout-feedbackmessagealert-login';
    public const MODULE_LAYOUT_FEEDBACKMESSAGEALERT_LOSTPWD = 'layout-feedbackmessagealert-lostpwd';
    public const MODULE_LAYOUT_FEEDBACKMESSAGEALERT_LOSTPWDRESET = 'layout-feedbackmessagealert-lostpwdreset';
    public const MODULE_LAYOUT_FEEDBACKMESSAGEALERT_LOGOUT = 'layout-feedbackmessagealert-logout';
    public const MODULE_LAYOUT_FEEDBACKMESSAGEALERT_USER_CHANGEPASSWORD = 'layout-feedbackmessagealert-user-changepassword';

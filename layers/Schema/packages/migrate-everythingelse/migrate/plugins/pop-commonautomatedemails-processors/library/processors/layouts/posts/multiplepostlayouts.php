...
{
    public const MODULE_LAYOUT_AUTOMATEDEMAILS_MULTIPLECONTENT_DETAILS = 'layout-automatedemails-multiplepost-details';
    public const MODULE_LAYOUT_AUTOMATEDEMAILS_MULTIPLECONTENT_THUMBNAIL = 'layout-automatedemails-multiplepost-thumbnail';
    public const MODULE_LAYOUT_AUTOMATEDEMAILS_MULTIPLECONTENT_LIST = 'layout-automatedemails-multiplepost-list';
    public const MODULE_LAYOUT_AUTOMATEDEMAILS_MULTIPLECONTENT_SIMPLEVIEW = 'layout-automatedemails-multiplepost-simpleview';
    public const MODULE_LAYOUT_AUTOMATEDEMAILS_MULTIPLECONTENT_FULLVIEW = 'layout-automatedemails-multiplepost-fullview';

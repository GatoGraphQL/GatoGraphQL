...
class PoP_ResourceModuleDecoratorProcessor extends AbstractModuleDecoratorProcessor {
	...
	function getDynamicResourcesMergedmoduletree(array $module, array &$props) {
		...
		foreach ($submodules as $submodule) {
			...
			if ($submodule_ret = $this->getModuleProcessordecorator($submodule)->getDynamicResourcesMergedmoduletree($submodule, $props[$moduleFullName][POP_CONSTANT_RESPONSE_SUBMODULES])) {
	...
	// 		if ($submodule_ret = $this->getModuleProcessordecorator($submodule)->getModulesResources($submodule, $props[$moduleFullName][POP_CONSTANT_RESPONSE_SUBMODULES])) {
	...
	function getDynamicTemplateResourcesMergedmoduletree(array $module, array &$props) {
		...
		foreach ($submodules as $submodule) {
			...
			if ($submodule_ret = $this->getModuleProcessordecorator($submodule)->getDynamicTemplateResourcesMergedmoduletree($submodule, $props[$moduleFullName][POP_CONSTANT_RESPONSE_SUBMODULES])) {

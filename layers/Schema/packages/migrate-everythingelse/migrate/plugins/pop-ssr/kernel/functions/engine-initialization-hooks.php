...
class PoP_SSR_EngineInitialization_Hooks
{
    ...
    protected function removeDatabases(&$data, $engine)
    {
        ...
        foreach ($dynamic_data_properties[$entryModuleOutputName][POP_CONSTANT_RESPONSE_SUBMODULES] as $pagesection_settings_id => $pagesection_data_properties) {
            foreach ($pagesection_data_properties[POP_CONSTANT_RESPONSE_SUBMODULES] as $block_settings_id => $block_settings_id_data_properties) {

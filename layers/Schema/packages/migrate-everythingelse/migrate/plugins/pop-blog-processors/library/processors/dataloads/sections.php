...
class PoP_Blog_Module_Processor_CustomSectionDataloads extends PoP_Module_Processor_SectionDataloadsBase
{
    ...
    public function getRelevantRoute(array $module, array &$props): ?string
    {
        $routes = array(
            ...
            self::MODULE_DATALOAD_AUTHORPOSTS_SCROLL_DETAILS => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_AUTHORPOSTS_SCROLL_FULLVIEW => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_AUTHORPOSTS_SCROLL_LIST => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_AUTHORPOSTS_SCROLL_SIMPLEVIEW => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_AUTHORPOSTS_SCROLL_THUMBNAIL => POP_POSTS_ROUTE_POSTS,
            ...
            self::MODULE_DATALOAD_POSTS_SCROLL_ADDONS => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_POSTS_SCROLL_DETAILS => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_POSTS_SCROLL_FULLVIEW => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_POSTS_SCROLL_LIST => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_POSTS_SCROLL_NAVIGATOR => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_POSTS_SCROLL_SIMPLEVIEW => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_POSTS_SCROLL_THUMBNAIL => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_POSTS_TYPEAHEAD => POP_POSTS_ROUTE_POSTS,
            ...
            self::MODULE_DATALOAD_TAGPOSTS_SCROLL_DETAILS => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_TAGPOSTS_SCROLL_FULLVIEW => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_TAGPOSTS_SCROLL_LIST => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_TAGPOSTS_SCROLL_SIMPLEVIEW => POP_POSTS_ROUTE_POSTS,
            self::MODULE_DATALOAD_TAGPOSTS_SCROLL_THUMBNAIL => POP_POSTS_ROUTE_POSTS,

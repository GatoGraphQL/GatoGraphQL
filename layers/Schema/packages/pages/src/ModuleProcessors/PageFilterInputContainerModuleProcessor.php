...
class PageFilterInputContainerModuleProcessor extends CustomPostFilterInputContainerModuleProcessor
{
    ...
    public const MODULE_FILTERINPUTCONTAINER_PAGELISTLIST = 'filterinner-pagelist';
    public const MODULE_FILTERINPUTCONTAINER_PAGELISTCOUNT = 'filterinner-pagecount';
    public const MODULE_FILTERINPUTCONTAINER_ADMINPAGELISTLIST = 'filterinner-adminpagelist';
    public const MODULE_FILTERINPUTCONTAINER_ADMINPAGELISTCOUNT = 'filterinner-adminpagecount';

...
namespace PoPSchema\EventsWPEM\ConditionalOnContext\AddEventTypeToCustomPostUnionTypes\Overrides\SchemaServices\TypeResolverPickers;

use PoPSchema\CustomPosts\Facades\CustomPostTypeAPIFacade;
use PoPSchema\Events\Facades\EventTypeAPIFacade;
use PoPSchema\CustomPostsWP\TypeResolverPickers\CustomPostTypeResolverPickerInterface;
use PoPSchema\Events\ConditionalOnContext\AddEventTypeToCustomPostUnionTypes\SchemaServices\TypeResolverPickers\EventCustomPostTypeResolverPicker as UpstreamEventCustomPostTypeResolverPicker;

# (Temporary package) Migrate code to package: Tags
...
The source code is hosted on the [PoP monorepo](https://github.com/leoloso/PoP), under [`Schema/packages/migrate-tags`](https://github.com/leoloso/PoP/tree/master/layers/Schema/packages/migrate-tags).

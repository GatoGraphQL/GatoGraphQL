...
define('POP_CUSTOMPOSTSWP_POP_ENGINEWP_MIN_VERSION', 0.1);
...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CUSTOMPOSTSWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-postmedia-wp'),
            'https://github.com/leoloso/PoP',
            POP_CUSTOMPOSTSWP_POP_ENGINEWP_MIN_VERSION
        );
    }

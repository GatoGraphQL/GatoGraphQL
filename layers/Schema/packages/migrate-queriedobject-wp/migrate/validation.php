...
define('POP_QUERIEDOBJECTWP_POP_ENGINEWP_MIN_VERSION', 0.1);
...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_QUERIEDOBJECTWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Queried Object for WordPress', 'pop-queriedobject-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-queriedobject-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-queriedobject-wp'),
            'https://github.com/leoloso/PoP',
            POP_QUERIEDOBJECTWP_POP_ENGINEWP_MIN_VERSION
        );
    }

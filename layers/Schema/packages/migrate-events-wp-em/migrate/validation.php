...
define('EMPOPEVENTS_EMPOPLOCATIONS_MIN_VERSION', 0.1);

class EM_PoPEvents_Validation
{
    public function validate()
    {
        $success = true;

        if (!defined('EMPOPLOCATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('EMPOPLOCATIONS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (EMPOPEVENTS_EMPOPLOCATIONS_MIN_VERSION > EMPOPLOCATIONS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Events Manager for PoP Events', 'events-manager-pop-events'),
            TranslationAPIFacade::getInstance()->__('Events Manager for PoP Locations', 'events-manager-pop-events')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('Events Manager for PoP Locations', 'events-manager-pop-events'),
            'https://github.com/leoloso/PoP',
            EMPOPEVENTS_EMPOPLOCATIONS_MIN_VERSION
        );
    }

...
class CustomPostUserListFieldResolver extends AbstractCustomPostListFieldResolver
{
    ...
    public function getSchemaFieldDescription(TypeResolverInterface $typeResolver, string $fieldName): ?string
    {
        ...
        $descriptions = [
            ...
            'adminCustomPosts' => $translationAPI->__('[Admin] Custom posts by the user', 'users'),
            'adminCustomPostCount' => $translationAPI->__('[Admin] Number of custom posts by the user', 'users'),
        ];

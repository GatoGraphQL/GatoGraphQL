...
define('POP_CATEGORIES_POP_ENGINE_MIN_VERSION', 0.1);
...
class Validation
{
    public function getProviderValidationClass()
    {
        return HooksAPIFacade::getInstance()->applyFilters(
            'PoP_Categories_Validation:provider-validation-class',
            null
        );
    }
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORIES_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Categories', 'pop-categories')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Categories', 'pop-categories'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-categories')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-categories'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORIES_POP_ENGINE_MIN_VERSION
        );
    }

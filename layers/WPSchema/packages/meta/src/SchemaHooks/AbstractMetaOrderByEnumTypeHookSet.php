...
abstract class AbstractMetaOrderByEnumTypeHookSet extends AbstractHookSet
{
    ...
    public function getEnumValueDescription(
        ...
        return match ($enumValue) {
            MetaOrderBy::META_VALUE => $this->__('Order by meta value. See description for ‘meta_value‘ in: https://developer.wordpress.org/reference/classes/wp_query/#order-orderby-parameters', 'gatographql'),

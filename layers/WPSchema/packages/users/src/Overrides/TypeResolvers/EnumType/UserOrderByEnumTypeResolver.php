...
class UserOrderByEnumTypeResolver extends UpstreamUserOrderByEnumTypeResolver
{
    ...
    public function getEnumValueDescription(string $enumValue): ?string
    {
        return match ($enumValue) {
            UserOrderBy::INCLUDE => $this->__('Order by the included list of user IDs (requires the \'ids\' parameter)', 'gatographql'),
            UserOrderBy::WEBSITE_URL => $this->__('Order by user\'s website URL', 'gatographql'),
            UserOrderBy::NICENAME => $this->__('Order by user nicename', 'gatographql'),
            UserOrderBy::EMAIL => $this->__('Order by user email', 'gatographql'),

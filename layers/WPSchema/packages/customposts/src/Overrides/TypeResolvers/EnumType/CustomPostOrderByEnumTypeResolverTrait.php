...
trait CustomPostOrderByEnumTypeResolverTrait
{
    ...
    public function getAdditionalCustomPostEnumValueDescription(string $enumValue): ?string
    {
        return match ($enumValue) {
            CustomPostOrderBy::NONE => $this->getTranslationAPI()->__('No order', 'customposts'),
            ...
            CustomPostOrderBy::PARENT => $this->getTranslationAPI()->__('Order by post/page parent id', 'customposts'),

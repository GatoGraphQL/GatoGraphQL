...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`WPSchema/packages/schema-commons`](https://github.com/GatoGraphQL/PoP/tree/master/layers/WPSchema/packages/schema-commons).

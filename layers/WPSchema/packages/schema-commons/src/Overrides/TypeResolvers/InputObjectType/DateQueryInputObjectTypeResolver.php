...
class DateQueryInputObjectTypeResolver extends UpstreamDateQueryInputObjectTypeResolver
{
    ...
    public function getInputFieldDescription(string $inputFieldName): ?string
    {
        return match ($inputFieldName) {
            'inclusive' => $this->__('For after/before, whether exact value should be matched or not', 'gatographql'),
            'year' => $this->__('4 digit year (e.g. 2011)', 'gatographql'),
            'month' => $this->__('Month number (from 1 to 12)', 'gatographql'),
            'week' => $this->__('Week of the year (from 0 to 53)', 'gatographql'),
            'day' => $this->__('Day of the month (from 1 to 31)', 'gatographql'),
            'hour' => $this->__('Hour (from 0 to 23)', 'gatographql'),
            'minute' => $this->__('Minute (from 0 to 59)', 'gatographql'),
            'second' => $this->__('Second (0 to 59)', 'gatographql'),
            'compare' => $this->__('Determines and validates what comparison operator to use', 'gatographql'),
            'column' => $this->__('Posts column to query against. Default: ‘post_date’)', 'gatographql'),

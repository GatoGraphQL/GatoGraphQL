...
The source code is hosted on the [PoP monorepo](https://github.com/leoloso/PoP), under [`WPSchema/packages/blocks`](https://github.com/leoloso/PoP/tree/master/layers/WPSchema/packages/blocks).

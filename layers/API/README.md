...
<a href="https://newapi.getpop.org/api/graphql/?order=title%7CASC&amp;props=url%7Cauthor.name%7Curl&amp;query=posts(ids:%5B1,1499,1178%5D,order:%24order)@posts.id%7CdateAsString(format:d/m/Y)%7Ctitle<skip(if:false)>%7C--props">View query results</a>

...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`API/packages/api-endpoints-for-wp`](https://github.com/GatoGraphQL/PoP/tree/master/layers/API/packages/api-endpoints-for-wp).

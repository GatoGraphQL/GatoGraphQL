...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/GatoGraphQL), under [`API/packages/api-rest`](https://github.com/GatoGraphQL/GatoGraphQL/tree/master/layers/API/packages/api-rest).

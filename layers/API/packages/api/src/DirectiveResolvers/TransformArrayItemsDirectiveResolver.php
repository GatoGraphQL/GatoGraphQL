...
class TransformArrayItemsDirectiveResolver extends ApplyFunctionDirectiveResolver
{
    ...
    public function resolveDirective(
        ...
        $this->regenerateAndExecuteFunction($objectTypeResolver, $resultIDItems, $arrayItemIdsProperties, $dbItems, $previousDBItems, $variables, $messages, $dbErrors, $dbWarnings, $dbDeprecations, $schemaErrors, $schemaWarnings, $schemaDeprecations);
    ...
    protected function addExpressionsForResultItem(
        ...
        parent::addExpressionsForResultItem($objectTypeResolver, $id, $field, $resultIDItems, $dbItems, $previousDBItems, $variables, $messages, $dbErrors, $dbWarnings, $dbDeprecations, $schemaErrors, $schemaWarnings, $schemaDeprecations);

        $arrayItemPropertyOutputKey = $this->fieldQueryInterpreter->getUniqueFieldOutputKey($objectTypeResolver, $field);

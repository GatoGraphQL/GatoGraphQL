...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TAXONOMYMETA_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Taxonomy Meta', 'pop-taxonomymeta')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Taxonomy Meta', 'pop-taxonomymeta'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-taxonomymeta')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-taxonomymeta'),
            'https://github.com/leoloso/PoP',
            POP_TAXONOMYMETA_POP_ENGINE_MIN_VERSION
        );
    }

...
use PoPCMSSchema\CommentMeta\Facades\CommentMetaTypeAPIFacade;
...
class Utils
{
    ...
    {
        $commentMetaTypeAPI = CommentMetaTypeAPIFacade::getInstance();
        return $commentMetaTypeAPI->getCommentMeta($comment_id, self::getMetaKey($key), $single);
    }

...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_MEDIAWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Media for WordPress', 'pop-media-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-media-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-media-wp'),
            'https://github.com/leoloso/PoP',
            POP_MEDIAWP_POP_ENGINEWP_MIN_VERSION
        );
    }

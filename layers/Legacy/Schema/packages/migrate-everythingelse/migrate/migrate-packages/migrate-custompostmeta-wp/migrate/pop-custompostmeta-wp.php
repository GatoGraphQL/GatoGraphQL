<?php
/*
Plugin Name: PoP Post Meta for WordPress
Version: 0.1
...
//-------------------------------------------------------------------------------------
define('POP_POSTMETAWP_VERSION', 0.106);
define('POP_POSTMETAWP_DIR', dirname(__FILE__));
...
class Plugin
{
    ...
    public function init()
    {
        if ($this->validate()) {
            $this->initialize();
            define('POP_POSTMETAWP_INITIALIZED', true);
        }
    }

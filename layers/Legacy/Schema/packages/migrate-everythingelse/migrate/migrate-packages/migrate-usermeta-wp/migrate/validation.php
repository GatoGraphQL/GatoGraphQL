...
define('POP_USERMETAWP_POP_ENGINEWP_MIN_VERSION', 0.1);
...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERMETAWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Meta for WordPress', 'pop-usermeta-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-usermeta-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-usermeta-wp'),
            'https://github.com/leoloso/PoP',
            POP_USERMETAWP_POP_ENGINEWP_MIN_VERSION
        );
    }

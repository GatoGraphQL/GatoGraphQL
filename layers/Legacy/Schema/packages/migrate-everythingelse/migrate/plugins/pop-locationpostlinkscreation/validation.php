...
define('POP_LOCATIONPOSTLINKSCREATION_POP_LOCATIONPOSTLINKS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTLINKSCREATION_POP_LOCATIONPOSTSCREATION_MIN_VERSION', 0.1);

class PoP_LocationPostLinksCreation_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_LOCATIONPOSTLINKS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_LOCATIONPOSTLINKS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKSCREATION_POP_LOCATIONPOSTLINKS_MIN_VERSION > POP_LOCATIONPOSTLINKS_VERSION) {
        ...
        if (!defined('POP_LOCATIONPOSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKSCREATION_POP_LOCATIONPOSTSCREATION_MIN_VERSION > POP_LOCATIONPOSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation', 'pop-locationpostlinkscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation', 'pop-locationpostlinkscreation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation', 'pop-locationpostlinkscreation'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKSCREATION_POP_LOCATIONPOSTLINKS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation', 'pop-locationpostlinkscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-locationpostlinkscreation')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-locationpostlinkscreation'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKSCREATION_POP_LOCATIONPOSTSCREATION_MIN_VERSION
        );
    }

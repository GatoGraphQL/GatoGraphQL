...
define('POPMAILERAWS_POP_MAILER_AWS_MIN_VERSION', 0.1);
define('POPMAILERAWS_POP_EMAILSENDER_MIN_VERSION', 0.1);

class PoP_EmailSender_AWS_Validation
{
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Email Sender AWS', 'pop-emailsender-aws'),
            TranslationAPIFacade::getInstance()->__('PoP Mailer for AWS', 'pop-emailsender-aws')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Mailer for AWS', 'pop-emailsender-aws'),
            'https://github.com/leoloso/PoP',
            POPMAILERAWS_POP_MAILER_AWS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Email Sender AWS', 'pop-emailsender-aws'),
            TranslationAPIFacade::getInstance()->__('PoP Email Sender', 'pop-emailsender-aws')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Email Sender', 'pop-emailsender-aws'),
            'https://github.com/leoloso/PoP',
            POPMAILERAWS_POP_EMAILSENDER_MIN_VERSION
        );
    }

...
// \PoP\Root\App::addAction('sendemailToUsers:template_folder', '__return_false', PHP_INT_MAX);

// Replace the templates by removing the frame, adding only the Header and Footer
\PoP\Root\App::addAction('sendemailToUsers:template_folders', 'popMailerTemplates', PHP_INT_MAX);

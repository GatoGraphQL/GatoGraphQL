...
define('POP_MASTERCOLLECTIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_MasterCollectionWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_MASTERCOLLECTIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Master Collection Web Platform', 'pop-mastercollection-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-mastercollection-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-mastercollection-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_MASTERCOLLECTIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

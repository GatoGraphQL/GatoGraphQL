...
define('POP_ENGINEWEBPLATFORMOPTIMIZATIONS_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_WebPlatformEngineOptimizations_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ENGINEWEBPLATFORMOPTIMIZATIONS_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Web Platform Engine Optimizations', 'pop-engine-webplatform-optimizations'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-engine-webplatform-optimizations')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-engine-webplatform-optimizations'),
            'https://github.com/leoloso/PoP',
            POP_ENGINEWEBPLATFORMOPTIMIZATIONS_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

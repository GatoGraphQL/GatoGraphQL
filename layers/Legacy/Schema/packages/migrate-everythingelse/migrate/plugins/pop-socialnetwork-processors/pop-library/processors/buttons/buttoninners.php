...
{
    public const MODULE_BUTTONINNER_FOLLOWUSER_PREVIEW = 'buttoninner-followuser-preview';
    public const MODULE_BUTTONINNER_FOLLOWUSER_FULL = 'viewcomponentuttoninner-sidebar-followuser-full';
    public const MODULE_BUTTONINNER_UNFOLLOWUSER_PREVIEW = 'buttoninner-unfollowuser-preview';
    public const MODULE_BUTTONINNER_UNFOLLOWUSER_FULL = 'buttoninner-sidebar-unfollowuser-full';
    public const MODULE_BUTTONINNER_RECOMMENDPOST_PREVIEW = 'buttoninner-recommendpost-preview';
    public const MODULE_BUTTONINNER_RECOMMENDPOST_FULL = 'buttoninner-sidebar-recommendpost-full';
    public const MODULE_BUTTONINNER_UNRECOMMENDPOST_PREVIEW = 'buttoninner-unrecommendpost-preview';
    public const MODULE_BUTTONINNER_UNRECOMMENDPOST_FULL = 'buttoninner-sidebar-unrecommendpost-full';
    public const MODULE_BUTTONINNER_SUBSCRIBETOTAG_PREVIEW = 'buttoninner-subscribetotag-preview';
    public const MODULE_BUTTONINNER_SUBSCRIBETOTAG_FULL = 'buttoninner-sidebar-subscribetotag-full';
    public const MODULE_BUTTONINNER_UNSUBSCRIBEFROMTAG_PREVIEW = 'buttoninner-unsubscribefromtag-preview';
    public const MODULE_BUTTONINNER_UNSUBSCRIBEFROMTAG_FULL = 'buttoninner-sidebar-unsubscribefromtag-full';
    public const MODULE_BUTTONINNER_UPVOTEPOST_PREVIEW = 'buttoninner-upvotepost-preview';
    public const MODULE_BUTTONINNER_UPVOTEPOST_FULL = 'viewcomponentuttoninner-sidebar-upvotepost-full';
    public const MODULE_BUTTONINNER_UNDOUPVOTEPOST_PREVIEW = 'buttoninner-undoupvotepost-preview';
    public const MODULE_BUTTONINNER_UNDOUPVOTEPOST_FULL = 'buttoninner-sidebar-undoupvotepost-full';
    public const MODULE_BUTTONINNER_DOWNVOTEPOST_PREVIEW = 'buttoninner-downvotepost-preview';
    public const MODULE_BUTTONINNER_DOWNVOTEPOST_FULL = 'buttoninner-sidebar-downvotepost-full';
    public const MODULE_BUTTONINNER_UNDODOWNVOTEPOST_PREVIEW = 'buttoninner-undodownvotepost-preview';
    public const MODULE_BUTTONINNER_UNDODOWNVOTEPOST_FULL = 'buttoninner-sidebar-undodownvotepost-full';

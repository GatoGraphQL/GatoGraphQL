...
define('POP_VIEWCOMPONENTHEADERSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_ViewcomponentHeadersWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_VIEWCOMPONENTHEADERSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Viewcomponent Headers Web Platform', 'pop-viewcomponentheaders-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-viewcomponentheaders-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-viewcomponentheaders-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_VIEWCOMPONENTHEADERSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

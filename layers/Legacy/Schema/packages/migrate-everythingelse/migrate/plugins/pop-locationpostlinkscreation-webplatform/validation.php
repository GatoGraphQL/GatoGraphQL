...
define('POP_LOCATIONPOSTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_LocationPostLinksCreationWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_LOCATIONPOSTLINKSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKSCREATIONWEBPLATFORM_POP_LOCATIONPOSTLINKSCREATION_MIN_VERSION > POP_LOCATIONPOSTLINKSCREATION_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation Web Platform', 'pop-locationpostlinkscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation', 'pop-locationpostlinkscreation-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation', 'pop-locationpostlinkscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKSCREATIONWEBPLATFORM_POP_LOCATIONPOSTLINKSCREATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation Web Platform', 'pop-locationpostlinkscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-locationpostlinkscreation-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-locationpostlinkscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

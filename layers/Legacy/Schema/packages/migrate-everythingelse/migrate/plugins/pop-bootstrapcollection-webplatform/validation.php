...
define('POP_BOOTSTRAPCOLLECTIONWEBPLATFORM_POP_BOOTSTRAPWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_BootstrapCollectionWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_BOOTSTRAPWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_BOOTSTRAPWEBPLATFORM_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_BOOTSTRAPCOLLECTIONWEBPLATFORM_POP_BOOTSTRAPWEBPLATFORM_MIN_VERSION > POP_BOOTSTRAPWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Bootstrap Collection Web Platform', 'pop-bootstrapcollection-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Bootstrap Web Platform', 'pop-bootstrapcollection-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Bootstrap Web Platform', 'pop-bootstrapcollection-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_BOOTSTRAPCOLLECTIONWEBPLATFORM_POP_BOOTSTRAPWEBPLATFORM_MIN_VERSION
        );
    }

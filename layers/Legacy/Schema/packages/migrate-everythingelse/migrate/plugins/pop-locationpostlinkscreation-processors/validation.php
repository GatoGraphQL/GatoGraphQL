...
define('POP_LOCATIONPOSTLINKSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTLINKSCREATIONPROCESSORS_POP_LOCATIONPOSTLINKSCREATION_MIN_VERSION', 0.1);

class PoP_LocationPostLinksCreationProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_LOCATIONPOSTLINKSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_LOCATIONPOSTLINKSCREATION_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKSCREATIONPROCESSORS_POP_LOCATIONPOSTLINKSCREATION_MIN_VERSION > POP_LOCATIONPOSTLINKSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation Processors', 'pop-locationpostlinkscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationpostlinkscreation-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationpostlinkscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation Processors', 'pop-locationpostlinkscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation', 'pop-locationpostlinkscreation-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Creation', 'pop-locationpostlinkscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKSCREATIONPROCESSORS_POP_LOCATIONPOSTLINKSCREATION_MIN_VERSION
        );
    }

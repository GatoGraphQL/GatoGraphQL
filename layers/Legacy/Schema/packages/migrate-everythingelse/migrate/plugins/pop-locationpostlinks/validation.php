...
define('POP_LOCATIONPOSTLINKS_POP_LOCATIONS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTLINKS_POP_CONTENTPOSTLINKS_MIN_VERSION', 0.1);

class PoP_LocationPostLinks_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_LOCATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKS_POP_LOCATIONS_MIN_VERSION > POP_LOCATIONS_VERSION) {
        ...
        if (!defined('POP_CONTENTPOSTLINKS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKS_POP_CONTENTPOSTLINKS_MIN_VERSION > POP_CONTENTPOSTLINKS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links', 'pop-locationpostlinks'),
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-locationpostlinks')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-locationpostlinks'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKS_POP_LOCATIONS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links', 'pop-locationpostlinks'),
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-locationpostlinks')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-locationpostlinks'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKS_POP_CONTENTPOSTLINKS_MIN_VERSION
        );
    }

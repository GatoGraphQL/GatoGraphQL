...
define('POP_USERLOGIN_POP_USERSTATE_MIN_VERSION', 0.1);
define('POP_USERLOGIN_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_UserLogin_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERSTATE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERLOGIN_POP_USERSTATE_MIN_VERSION > POP_USERSTATE_VERSION) {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERLOGIN_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Login', 'pop-userlogin'),
            TranslationAPIFacade::getInstance()->__('PoP User State', 'pop-userlogin')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User State', 'pop-userlogin'),
            'https://github.com/leoloso/PoP',
            POP_USERLOGIN_POP_USERSTATE_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Login', 'pop-userlogin'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-userlogin')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-userlogin'),
            'https://github.com/leoloso/PoP',
            POP_USERLOGIN_POP_APPLICATION_MIN_VERSION
        );
    }

...
define('POP_USERPLATFORMWP_POP_USERPLATFORM_MIN_VERSION', 0.1);

class PoP_UserPlatformWP_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERPLATFORMWP_POP_USERPLATFORM_MIN_VERSION > POP_USERPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Platform WordPress', 'pop-userplatformwp'),
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-userplatformwp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-userplatformwp'),
            'https://github.com/leoloso/PoP',
            POP_USERPLATFORMWP_POP_USERPLATFORM_MIN_VERSION
        );
    }

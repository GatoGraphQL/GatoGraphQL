...
define('PSPOP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);
...
class PhotoSwipe_PoP_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (PSPOP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PhotoSwipe for PoP', 'photoswipe-pop'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'photoswipe-pop')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'photoswipe-pop'),
            'https://github.com/leoloso/PoP',
            PSPOP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

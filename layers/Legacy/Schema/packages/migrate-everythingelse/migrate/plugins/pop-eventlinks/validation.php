...
define('POP_EVENTLINKS_POP_EVENTS_MIN_VERSION', 0.1);
define('POP_EVENTLINKS_POP_CONTENTPOSTLINKS_MIN_VERSION', 0.1);

class PoP_EventLinks_Validation
{
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Event Links', 'pop-eventlinks'),
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-eventlinks')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-eventlinks'),
            'https://github.com/leoloso/PoP',
            POP_EVENTLINKS_POP_EVENTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Event Links', 'pop-eventlinks'),
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-eventlinks')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-eventlinks'),
            'https://github.com/leoloso/PoP',
            POP_EVENTLINKS_POP_CONTENTPOSTLINKS_MIN_VERSION
        );
    }

...
define('GFPOPGF_GFPOP_MIN_VERSION', 0.1);
define('GFPOPGF_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);

class GFPoPGenericForms_Validation
{
    public function validate()
    {
        ...
        if (!defined('GFPOP_VERSION')) {
            ...
            $success = false;
        } elseif (GFPOPGF_GFPOP_MIN_VERSION > GFPOP_VERSION) {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (GFPOPGF_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Gravity Forms for PoP Generic Forms', 'gravityforms-pop-genericforms'),
            TranslationAPIFacade::getInstance()->__('Gravity Forms for PoP', 'gravityforms-pop-genericforms')
        );
    }
    ...
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Gravity Forms for PoP Generic Forms', 'gravityforms-pop-genericforms'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'gravityforms-pop-genericforms')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'gravityforms-pop-genericforms'),
            'https://github.com/leoloso/PoP',
            GFPOPGF_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }

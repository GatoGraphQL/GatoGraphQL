...
define('POP_USERPLATFORM_POP_USERLOGIN_MIN_VERSION', 0.1);
define('POP_USERPLATFORM_POP_USERROLES_MIN_VERSION', 0.1);

class PoP_UserPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERLOGIN_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERPLATFORM_POP_USERLOGIN_MIN_VERSION > POP_USERLOGIN_VERSION) {
        ...
        if (!defined('POP_USERROLES_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERPLATFORM_POP_USERROLES_MIN_VERSION > POP_USERROLES_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-userplatform'),
            TranslationAPIFacade::getInstance()->__('PoP User Login', 'pop-userplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Login', 'pop-userplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERPLATFORM_POP_USERLOGIN_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-userplatform'),
            TranslationAPIFacade::getInstance()->__('PoP User Roles', 'pop-userplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Roles', 'pop-userplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERPLATFORM_POP_USERROLES_MIN_VERSION
        );
    }

        ...
        switch ($fieldDataAccessor->getFieldName()) {
         ...
         // Override
            case 'contact':
                ...
                if ($user_url = $objectTypeResolver->resolveValue($user, 'websiteURL', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    $value[] = array(
                ...
                if ($objectTypeResolver->resolveValue($user, 'displayEmail', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    if ($email = $objectTypeResolver->resolveValue($user, 'email', $objectTypeFieldResolutionFeedbackStore, $options)) {
                        $value[] = array(
                ...
                // if ($blog = $objectTypeResolver->resolveValue($user, 'blog', $objectTypeFieldResolutionFeedbackStore, $options)) {
                ...
                //     );
                // }
                if ($facebook = $objectTypeResolver->resolveValue($user, 'facebook', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    $value[] = array(
                ...
                if ($twitter = $objectTypeResolver->resolveValue($user, 'twitter', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    $value[] = array(
                ...
                if ($linkedin = $objectTypeResolver->resolveValue($user, 'linkedin', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    $value[] = array(
                ...
                if ($youtube = $objectTypeResolver->resolveValue($user, 'youtube', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    $value[] = array(
                ...
                if ($instagram = $objectTypeResolver->resolveValue($user, 'instagram', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    $value[] = array(

...
class PoP_CommonAutomatedEmailsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (PTWAE_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Common Automated Emails for PoP', 'pop-commonautomatedemails-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-commonautomatedemails-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-commonautomatedemails-processors'),
            'https://github.com/leoloso/PoP',
            PTWAE_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Common Automated Emails for PoP', 'pop-commonautomatedemails-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Common Automated Emails', 'pop-commonautomatedemails-processors')
        );
    }

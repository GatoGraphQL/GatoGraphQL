...
define('POP_CONTACTUSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_CONTACTUSPROCESSORS_POP_CONTACTUS_MIN_VERSION', 0.1);
define('POP_CONTACTUSPROCESSORS_POP_FORMSPROCESSORS_MIN_VERSION', 0.1);

class PoP_ContactUsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTACTUSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_CONTACTUS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_CONTACTUS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_CONTACTUSPROCESSORS_POP_CONTACTUS_MIN_VERSION > POP_CONTACTUS_VERSION) {
        ...
        if (!defined('POP_FORMSPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTACTUSPROCESSORS_POP_FORMSPROCESSORS_MIN_VERSION > POP_FORMSPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Contact Us Processors', 'pop-contactus-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-contactus-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-contactus-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTACTUSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Contact Us Processors', 'pop-contactus-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Contact Us', 'pop-contactus-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Contact Us', 'pop-contactus-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTACTUSPROCESSORS_POP_CONTACTUS_MIN_VERSION
        );
    }
    public function initialize_warning_3()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Contact Us Processors', 'pop-contactus-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Forms Processors', 'pop-contactus-processors')
        );
    }
    ...
    public function version_warning_3()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Forms Processors', 'pop-contactus-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTACTUSPROCESSORS_POP_FORMSPROCESSORS_MIN_VERSION
        );
    }

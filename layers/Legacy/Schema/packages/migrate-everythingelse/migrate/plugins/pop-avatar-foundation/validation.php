...
define('POP_AVATARFOUNDATION_POP_ENGINE_MIN_VERSION', 0.1);

class PoP_AvatarFoundation_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_AVATARFOUNDATION_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Avatar Foundation', 'pop-avatar-foundation'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-avatar-foundation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-avatar-foundation'),
            'https://github.com/leoloso/PoP',
            POP_AVATARFOUNDATION_POP_ENGINE_MIN_VERSION
        );
    }

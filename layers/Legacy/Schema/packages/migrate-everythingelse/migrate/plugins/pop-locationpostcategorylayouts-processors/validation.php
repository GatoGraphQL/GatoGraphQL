...
define('POP_LOCATIONPOSTCATEGORYLAYOUTSPROCESSORS_POP_LOCATIONPOSTS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTCATEGORYLAYOUTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);

class PoP_LocationPostCategoryLayoutsProcessors_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_LOCATIONPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_LOCATIONPOSTS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTCATEGORYLAYOUTSPROCESSORS_POP_LOCATIONPOSTS_MIN_VERSION > POP_LOCATIONPOSTS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTCATEGORYLAYOUTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Location Post Category Layouts for PoP Processors', 'pop-locationpostcategorylayouts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Location Posts', 'pop-locationpostcategorylayouts-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Posts', 'pop-locationpostcategorylayouts-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTCATEGORYLAYOUTSPROCESSORS_POP_LOCATIONPOSTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Location Post Category Layouts for PoP Processors', 'pop-locationpostcategorylayouts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationpostcategorylayouts-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationpostcategorylayouts-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTCATEGORYLAYOUTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }

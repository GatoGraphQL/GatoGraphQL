...
define('POP_USERCOMMUNITIESWEBPLATFORM_POP_USERCOMMUNITIES_MIN_VERSION', 0.1);
define('POP_USERCOMMUNITIESWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_UserCommunitiesWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_USERCOMMUNITIES_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_USERCOMMUNITIES_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_USERCOMMUNITIESWEBPLATFORM_POP_USERCOMMUNITIES_MIN_VERSION > POP_USERCOMMUNITIES_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERCOMMUNITIESWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Communities Web Platform', 'pop-usercommunities-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP User Communities', 'pop-usercommunities-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Communities', 'pop-usercommunities-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERCOMMUNITIESWEBPLATFORM_POP_USERCOMMUNITIES_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Communities Web Platform', 'pop-usercommunities-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-usercommunities-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-usercommunities-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERCOMMUNITIESWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

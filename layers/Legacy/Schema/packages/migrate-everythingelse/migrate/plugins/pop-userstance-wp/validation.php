...
define('POP_USERSTANCEWP_POP_USERSTANCE_MIN_VERSION', 0.1);

class PoP_UserStanceWP_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERSTANCE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERSTANCEWP_POP_USERSTANCE_MIN_VERSION > POP_USERSTANCE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Stance WordPress', 'pop-userstance-wp'),
            TranslationAPIFacade::getInstance()->__('PoP User Stance', 'pop-userstance-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Stance', 'pop-userstance-wp'),
            'https://github.com/leoloso/PoP',
            POP_USERSTANCEWP_POP_USERSTANCE_MIN_VERSION
        );
    }

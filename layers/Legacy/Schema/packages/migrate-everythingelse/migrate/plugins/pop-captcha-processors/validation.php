...
define('POP_CAPTCHAPROCESSORS_POP_CAPTCHA_MIN_VERSION', 0.1);
define('POP_CAPTCHAPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);

class PoP_CaptchaProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_CAPTCHA_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CAPTCHAPROCESSORS_POP_CAPTCHA_MIN_VERSION > POP_CAPTCHA_VERSION) {
        ...
        if (!defined('POP_CAPTCHA_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CAPTCHAPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Captcha for PoP Processors', 'pop-captcha-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Captcha', 'pop-captcha-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Captcha', 'pop-captcha-processors'),
            'https://github.com/leoloso/PoP',
            POP_CAPTCHAPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Captcha for PoP Processors', 'pop-captcha-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-captcha-processors')
        );
    }

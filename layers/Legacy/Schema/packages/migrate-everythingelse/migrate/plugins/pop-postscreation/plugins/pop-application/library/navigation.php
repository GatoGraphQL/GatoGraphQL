 ...
 * navigation.php
 */
\PoP\Root\App::getHookManager()->addFilter('route:icon', 'popPostscreationRouteIcon', 10, 3);
...
\PoP\Root\App::getHookManager()->addFilter('route:title', 'popPostscreationNavigationTitle', 10, 2);

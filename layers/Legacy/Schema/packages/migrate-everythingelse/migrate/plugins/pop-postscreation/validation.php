...
define('POP_POSTSCREATION_POP_CONTENTCREATION_MIN_VERSION', 0.1);

class PoP_PostsCreation_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_CONTENTCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_POSTSCREATION_POP_CONTENTCREATION_MIN_VERSION > POP_CONTENTCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation', 'pop-postscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-postscreation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-postscreation'),
            'https://github.com/leoloso/PoP',
            POP_POSTSCREATION_POP_CONTENTCREATION_MIN_VERSION
        );
    }

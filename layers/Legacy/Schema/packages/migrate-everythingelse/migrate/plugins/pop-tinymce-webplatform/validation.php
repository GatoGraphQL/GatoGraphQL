...
define('POP_TINYMCEWEBPLATFORM_POP_TINYMCE_MIN_VERSION', 0.1);
define('POP_TINYMCEWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_TinyMCEWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_TINYMCE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TINYMCEWEBPLATFORM_POP_TINYMCE_MIN_VERSION > POP_TINYMCE_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TINYMCEWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP TinyMCE Web Platform', 'pop-tinymce-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP TinyMCE', 'pop-tinymce-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP TinyMCE', 'pop-tinymce-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_TINYMCEWEBPLATFORM_POP_TINYMCE_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP TinyMCE Web Platform', 'pop-tinymce-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-tinymce-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-tinymce-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_TINYMCEWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

...
define('POP_ADDHIGHLIGHTS_POP_ADDRELATEDPOSTS_MIN_VERSION', 0.1);

class PoP_AddHighlights_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ADDRELATEDPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDHIGHLIGHTS_POP_ADDRELATEDPOSTS_MIN_VERSION > POP_ADDRELATEDPOSTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights', 'pop-addhighlights'),
            TranslationAPIFacade::getInstance()->__('PoP Add Related Posts', 'pop-addhighlights')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Related Posts', 'pop-addhighlights'),
            'https://github.com/leoloso/PoP',
            POP_ADDHIGHLIGHTS_POP_ADDRELATEDPOSTS_MIN_VERSION
        );
    }

...
define('POP_LOCATIONPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTSCREATIONPROCESSORS_POP_LOCATIONPOSTSCREATION_MIN_VERSION', 0.1);

class PoP_LocationPostsCreationProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_LOCATIONPOSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSCREATIONPROCESSORS_POP_LOCATIONPOSTSCREATION_MIN_VERSION > POP_LOCATIONPOSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation Processors', 'pop-locationpostscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationpostscreation-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationpostscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation Processors', 'pop-locationpostscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation', 'pop-locationpostscreation-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation', 'pop-locationpostscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSCREATIONPROCESSORS_POP_LOCATIONPOSTSCREATION_MIN_VERSION
        );
    }

...
define('POP_SHAREPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_SHAREPROCESSORS_POP_SHARE_MIN_VERSION', 0.1);
define('POP_SHAREPROCESSORS_POP_FORMSPROCESSORS_MIN_VERSION', 0.1);

class PoP_ShareProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SHAREPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_SHARE_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_SHARE_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_SHAREPROCESSORS_POP_SHARE_MIN_VERSION > POP_SHARE_VERSION) {
        ...
        if (!defined('POP_FORMSPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SHAREPROCESSORS_POP_FORMSPROCESSORS_MIN_VERSION > POP_FORMSPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Share Processors', 'pop-share-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-share-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-share-processors'),
            'https://github.com/leoloso/PoP',
            POP_SHAREPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Share Processors', 'pop-share-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Share', 'pop-share-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Share', 'pop-share-processors'),
            'https://github.com/leoloso/PoP',
            POP_SHAREPROCESSORS_POP_SHARE_MIN_VERSION
        );
    }
    public function initialize_warning_3()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Share Processors', 'pop-share-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Forms Processors', 'pop-share-processors')
        );
    }
    ...
    public function version_warning_3()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Forms Processors', 'pop-share-processors'),
            'https://github.com/leoloso/PoP',
            POP_SHAREPROCESSORS_POP_FORMSPROCESSORS_MIN_VERSION
        );
    }

...
define('POP_CONTENTCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_CONTENTCREATIONPROCESSORS_POP_CONTENTCREATION_MIN_VERSION', 0.1);

class PoP_ContentCreationProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_CONTENTCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTCREATIONPROCESSORS_POP_CONTENTCREATION_MIN_VERSION > POP_CONTENTCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Creation Processors', 'pop-contentcreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-contentcreation-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-contentcreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Creation Processors', 'pop-contentcreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-contentcreation-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-contentcreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTCREATIONPROCESSORS_POP_CONTENTCREATION_MIN_VERSION
        );
    }

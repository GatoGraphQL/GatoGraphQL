...
define('PTWGETPOPDEMO_POPTHEME_WASSUP_MIN_VERSION', 0.1);
define('PTWGETPOPDEMO_GETPOPDEMO_PAGES_MIN_VERSION', 0.1);

class PoPTheme_Wassup_GetPoPDemo_Validation
{
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Theme Wassup GetPoP Demo', 'poptheme-wassup-getpop-demo'),
            TranslationAPIFacade::getInstance()->__('PoP Theme Wassup', 'poptheme-wassup-getpop-demo')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Theme Wassup', 'poptheme-wassup-getpop-demo'),
            'https://github.com/leoloso/PoP',
            PTWGETPOPDEMO_POPTHEME_WASSUP_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Theme Wassup GetPoP Demo', 'poptheme-wassup-getpop-demo'),
            TranslationAPIFacade::getInstance()->__('GetPoP Demo Pages', 'poptheme-wassup-getpop-demo')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('GetPoP Demo Pages', 'poptheme-wassup-getpop-demo'),
            'https://github.com/leoloso/PoP',
            PTWGETPOPDEMO_GETPOPDEMO_PAGES_MIN_VERSION
        );
    }

...
define('POP_CONTENTPOSTLINKSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_CONTENTPOSTLINKSCREATIONPROCESSORS_POP_CONTENTPOSTLINKSCREATION_MIN_VERSION', 0.1);

class PoP_ContentPostLinksCreationProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTPOSTLINKSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_CONTENTPOSTLINKSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTPOSTLINKSCREATIONPROCESSORS_POP_CONTENTPOSTLINKSCREATION_MIN_VERSION > POP_CONTENTPOSTLINKSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Creation Processors', 'pop-contentpostlinkscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-contentpostlinkscreation-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-contentpostlinkscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTPOSTLINKSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Creation Processors', 'pop-contentpostlinkscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Creation', 'pop-contentpostlinkscreation-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Creation', 'pop-contentpostlinkscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTPOSTLINKSCREATIONPROCESSORS_POP_CONTENTPOSTLINKSCREATION_MIN_VERSION
        );
    }

...
define('POP_CONTACTUSWEBPLATFORM_POP_CONTACTUS_MIN_VERSION', 0.1);
define('POP_CONTACTUSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_ContactUsWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_CONTACTUS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTACTUSWEBPLATFORM_POP_CONTACTUS_MIN_VERSION > POP_CONTACTUS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTACTUSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Contact Us Web Platform', 'pop-contactus-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Contact Us', 'pop-contactus-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Contact Us', 'pop-contactus-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CONTACTUSWEBPLATFORM_POP_CONTACTUS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Contact Us Web Platform', 'pop-contactus-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-contactus-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-contactus-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CONTACTUSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

...
define('POP_CATEGORYPOSTSCREATION_POP_CATEGORYPOSTS_MIN_VERSION', 0.1);
define('POP_CATEGORYPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION', 0.1);

class PoP_CategoryPostsCreation_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_CATEGORYPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSCREATION_POP_CATEGORYPOSTS_MIN_VERSION > POP_CATEGORYPOSTS_VERSION) {
        ...
        if (!defined('POP_POSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION > POP_POSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation', 'pop-categorypostscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Category Posts', 'pop-categorypostscreation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Category Posts', 'pop-categorypostscreation'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSCREATION_POP_CATEGORYPOSTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation', 'pop-categorypostscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-categorypostscreation')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-categorypostscreation'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION
        );
    }

...
define('POP_LOCATIONPOSTSWP_POP_LOCATIONPOSTS_MIN_VERSION', 0.1);

class PoP_LocationPostsWP_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_LOCATIONPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSWP_POP_LOCATIONPOSTS_MIN_VERSION > POP_LOCATIONPOSTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts WordPress', 'pop-locationposts-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Location Posts', 'pop-locationposts-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Posts', 'pop-locationposts-wp'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSWP_POP_LOCATIONPOSTS_MIN_VERSION
        );
    }

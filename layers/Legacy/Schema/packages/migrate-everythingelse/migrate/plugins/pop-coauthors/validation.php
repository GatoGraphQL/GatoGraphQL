...
define('POP_COAUTHORS_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_Coauthors_Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_COAUTHORS_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Coauthors', 'pop-coauthors')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Coauthors', 'pop-coauthors'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-coauthors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-coauthors'),
            'https://github.com/leoloso/PoP',
            POP_COAUTHORS_POP_APPLICATION_MIN_VERSION
        );
    }

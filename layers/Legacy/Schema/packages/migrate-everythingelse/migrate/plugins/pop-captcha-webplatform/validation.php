...
define('POP_CAPTCHAWEBPLATFORM_POP_CAPTCHA_MIN_VERSION', 0.1);
define('POP_CAPTCHAWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_CaptchaWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_CAPTCHA_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_CAPTCHA_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_CAPTCHAWEBPLATFORM_POP_CAPTCHA_MIN_VERSION > POP_CAPTCHA_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CAPTCHAWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Captcha Web Platform', 'pop-captcha-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Captcha', 'pop-captcha-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Captcha', 'pop-captcha-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CAPTCHAWEBPLATFORM_POP_CAPTCHA_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Captcha Web Platform', 'pop-captcha-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-captcha-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-captcha-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CAPTCHAWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

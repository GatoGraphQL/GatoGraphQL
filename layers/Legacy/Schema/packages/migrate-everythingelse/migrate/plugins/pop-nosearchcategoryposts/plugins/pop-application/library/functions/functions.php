...
\PoP\Root\App::getHookManager()->addFilter('gd_postname', 'nosearchcategorypostsPostname', 10, 3);
...
\PoP\Root\App::getHookManager()->addFilter('gd_posticon', 'nosearchcategorypostsPosticon', 10, 2);

...
define('POP_NOSEARCHCATEGORYPOSTS_POP_BLOG_MIN_VERSION', 0.1);

class PoP_NoSearchCategoryPosts_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_BLOG_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTS_POP_BLOG_MIN_VERSION > POP_BLOG_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts', 'pop-nosearchcategoryposts'),
            TranslationAPIFacade::getInstance()->__('PoP Blog', 'pop-nosearchcategoryposts')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Blog', 'pop-nosearchcategoryposts'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTS_POP_BLOG_MIN_VERSION
        );
    }

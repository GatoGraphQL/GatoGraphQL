...
define('POP_CATEGORYPOSTSWEBPLATFORM_POP_CATEGORYPOSTS_MIN_VERSION', 0.1);
define('POP_CATEGORYPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_CategoryPostsWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_CATEGORYPOSTS_VERSION')) {
            \PoP\Root\App::addAction('admin_notices', $this->installWarning(...));
            \PoP\Root\App::addAction('network_admin_notices', $this->installWarning(...));
            $success = false;
        } elseif (!defined('POP_CATEGORYPOSTS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSWEBPLATFORM_POP_CATEGORYPOSTS_MIN_VERSION > POP_CATEGORYPOSTS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Web Platform', 'pop-categoryposts-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Category Posts', 'pop-categoryposts-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Category Posts', 'pop-categoryposts-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSWEBPLATFORM_POP_CATEGORYPOSTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Web Platform', 'pop-categoryposts-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-categoryposts-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-categoryposts-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

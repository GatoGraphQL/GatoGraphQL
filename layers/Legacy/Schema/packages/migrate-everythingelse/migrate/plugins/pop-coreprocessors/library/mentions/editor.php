    ...
    $jqueryConstants['MENTIONS'] = array(
        ...
        'TYPES' => array(
            '@' => array(
                ...
                'component' => [PoP_Module_Processor_UserMentionComponentLayouts::class, PoP_Module_Processor_UserMentionComponentLayouts::MODULE_LAYOUTUSER_MENTION_COMPONENT],
            ...
            '#' => array(
                ...
                'component' => [PoP_Module_Processor_TagMentionComponentLayouts::class, PoP_Module_Processor_TagMentionComponentLayouts::MODULE_LAYOUTTAG_MENTION_COMPONENT],
                'key' => 'namedescription',
            ),
        ),
    );

...
define('POP_COREPROCESSORS_POP_BASECOLLECTIONPROCESSORS_MIN_VERSION', 0.1);
...
class PoP_CoreProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_BASECOLLECTIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_COREPROCESSORS_POP_BASECOLLECTIONPROCESSORS_MIN_VERSION > POP_BASECOLLECTIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Core Processors', 'pop-coreprocessors'),
            TranslationAPIFacade::getInstance()->__('PoP Base Collection Processors', 'pop-coreprocessors')
        );
    }

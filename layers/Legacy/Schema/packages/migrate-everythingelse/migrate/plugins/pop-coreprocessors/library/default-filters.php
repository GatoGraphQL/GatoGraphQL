...
\PoP\Root\App::removeAction('wp_head', 'rel_canonical');

// We don't need the shortlink or the generator
\PoP\Root\App::removeAction('wp_head', 'wp_shortlink_wp_head', 10, 0);
\PoP\Root\App::removeAction('wp_head', 'wp_generator');

// This outputs site_url( 'xmlrpc.php' ), and because the xmlrpc.php is blocked, no need to add it
\PoP\Root\App::removeAction('wp_head', 'rsd_link'); // Display the link to the Really Simple Discovery service endpoint, EditURI link
...
\PoP\Root\App::removeFilter( 'get_the_excerpt', 'wp_trim_excerpt'  );

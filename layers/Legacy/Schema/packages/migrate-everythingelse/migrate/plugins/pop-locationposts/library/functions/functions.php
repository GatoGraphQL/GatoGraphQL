...
\PoP\Root\App::getHookManager()->addFilter('gd_format_postname', 'locationpostsFormatPostname', 10, 3);
...
\PoP\Root\App::getHookManager()->addFilter('gd_posticon', 'locationpostsPosticon', 10, 2);

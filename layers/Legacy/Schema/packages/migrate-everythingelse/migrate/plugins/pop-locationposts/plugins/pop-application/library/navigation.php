 ...
 * navigation.php
 */
\PoP\Root\App::getHookManager()->addFilter('route:icon', 'popLocationpostsRouteIcon', 10, 3);
...
\PoP\Root\App::getHookManager()->addFilter('route:title', 'popLocationpostsNavigationRouteTitle', 10, 2);

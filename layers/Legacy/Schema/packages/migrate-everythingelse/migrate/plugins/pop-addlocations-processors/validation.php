...
define('POP_ADDLOCATIONSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_ADDLOCATIONSPROCESSORS_POP_ADDLOCATIONS_MIN_VERSION', 0.1);

class PoP_AddLocationsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDLOCATIONSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_ADDLOCATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDLOCATIONSPROCESSORS_POP_ADDLOCATIONS_MIN_VERSION > POP_ADDLOCATIONS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Locations Processors', 'pop-addlocations-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addlocations-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addlocations-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDLOCATIONSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Locations Processors', 'pop-addlocations-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-addlocations-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-addlocations-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDLOCATIONSPROCESSORS_POP_ADDLOCATIONS_MIN_VERSION
        );
    }

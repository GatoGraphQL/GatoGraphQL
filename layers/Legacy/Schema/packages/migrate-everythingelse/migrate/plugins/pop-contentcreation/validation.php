...
define('POP_CONTENTCREATION_POP_USERPLATFORM_MIN_VERSION', 0.1);

class PoP_ContentCreation_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTCREATION_POP_USERPLATFORM_MIN_VERSION > POP_USERPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-contentcreation'),
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-contentcreation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-contentcreation'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTCREATION_POP_USERPLATFORM_MIN_VERSION
        );
    }

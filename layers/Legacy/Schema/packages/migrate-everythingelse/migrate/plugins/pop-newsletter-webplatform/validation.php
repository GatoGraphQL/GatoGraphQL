...
define('POP_NEWSLETTERWEBPLATFORM_POP_NEWSLETTER_MIN_VERSION', 0.1);
define('POP_NEWSLETTERWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_NewsletterWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_NEWSLETTER_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NEWSLETTERWEBPLATFORM_POP_NEWSLETTER_MIN_VERSION > POP_NEWSLETTER_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NEWSLETTERWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Newsletter Web Platform', 'pop-newsletter-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Newsletter', 'pop-newsletter-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Newsletter', 'pop-newsletter-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_NEWSLETTERWEBPLATFORM_POP_NEWSLETTER_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Newsletter Web Platform', 'pop-newsletter-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-newsletter-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-newsletter-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_NEWSLETTERWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

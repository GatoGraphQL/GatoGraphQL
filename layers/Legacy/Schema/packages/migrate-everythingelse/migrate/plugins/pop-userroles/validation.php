...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_USERS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERROLES_POP_USERS_MIN_VERSION > POP_USERS_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP User Roles', 'pop-userroles')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Roles', 'pop-userroles'),
            TranslationAPIFacade::getInstance()->__('PoP Users', 'pop-userroles')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Users', 'pop-userroles'),
            'https://github.com/leoloso/PoP',
            POP_USERROLES_POP_USERS_MIN_VERSION
        );
    }

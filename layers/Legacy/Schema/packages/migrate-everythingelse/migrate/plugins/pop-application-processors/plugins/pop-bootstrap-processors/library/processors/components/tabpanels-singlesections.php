...
class PoP_Module_Processor_SingleSectionTabPanelComponents extends PoP_Module_Processor_SingleSectionTabPanelComponentsBase
{
    ...
    public function getPanelSubmodules(array $module)
    {
        ...
        $ret = \PoP\Root\App::getHookManager()->applyFilters('PoP_Module_Processor_SingleSectionTabPanelComponents:modules', $ret, $module);
    ...
    public function getPanelHeaders(array $module, array &$props)
    {
        ...
        if ($ret) {
            return \PoP\Root\App::getHookManager()->applyFilters('PoP_Module_Processor_SingleSectionTabPanelComponents:panel_headers', $ret, $module);
        }

...
{
    public const MODULE_BLOCK_TABPANEL_SINGLERELATEDCONTENT = 'block-tabpanel-singlerelatedcontent';
    public const MODULE_BLOCK_TABPANEL_SINGLEAUTHORS = 'block-tabpanel-singleauthors';
    public const MODULE_BLOCK_TABPANEL_SINGLERECOMMENDEDBY = 'block-tabpanel-singlerecommendedby';
    public const MODULE_BLOCK_TABPANEL_SINGLEUPVOTEDBY = 'block-tabpanel-singleupvotedby';
    public const MODULE_BLOCK_TABPANEL_SINGLEDOWNVOTEDBY = 'block-tabpanel-singledownvotedby';

...
class PoP_GenericForms_Bootstrap_Module_Processor_UserViewComponentButtons extends PoP_Module_Processor_UserHeaderViewComponentButtonsBase
{
    ...
    {
        return array(
            [self::class, self::COMPONENT_VIEWCOMPONENT_BUTTON_USER_SHAREBYEMAIL_SOCIALMEDIA],
            [self::class, self::COMPONENT_VIEWCOMPONENT_BUTTON_USER_SHAREBYEMAIL_PREVIEWDROPDOWN],
        );
    }
    ...
    public function getUrl(array $component, array &$props)
    {
        ...
        if (defined('POP_ENGINEWEBPLATFORM_INITIALIZED')) {
            ...
            switch ($component[1]) {
                ...
                case self::COMPONENT_VIEWCOMPONENT_BUTTON_USER_SHAREBYEMAIL_PREVIEWDROPDOWN:
                    $modals = array(
                        self::COMPONENT_VIEWCOMPONENT_BUTTON_USER_SHAREBYEMAIL_SOCIALMEDIA => [PoP_Module_Processor_GFModalComponents::class, PoP_Module_Processor_GFModalComponents::COMPONENT_MODAL_SHAREBYEMAIL],

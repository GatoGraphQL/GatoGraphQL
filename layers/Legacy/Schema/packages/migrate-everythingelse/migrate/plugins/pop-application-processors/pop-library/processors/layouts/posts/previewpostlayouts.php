...
{
    public const MODULE_LAYOUT_PREVIEWPOST_HEADER = 'layout-previewpost-header';
    public const MODULE_LAYOUT_PREVIEWPOST_NAVIGATOR = 'layout-previewpost-navigator';
    public const MODULE_LAYOUT_PREVIEWPOST_ADDONS = 'layout-previewpost-addons';
    public const MODULE_LAYOUT_PREVIEWPOST_DETAILS = 'layout-previewpost-details';
    public const MODULE_LAYOUT_PREVIEWPOST_THUMBNAIL = 'layout-previewpost-thumbnail';
    public const MODULE_LAYOUT_PREVIEWPOST_LIST = 'layout-previewpost-list';
    public const MODULE_LAYOUT_PREVIEWPOST_LINE = 'layout-previewpost-line';
    public const MODULE_LAYOUT_PREVIEWPOST_RELATED = 'layout-previewpost-related';
    public const MODULE_LAYOUT_PREVIEWPOST_EDIT = 'layout-previewpost-edit';
    public const MODULE_LAYOUT_PREVIEWPOST_HIGHLIGHT_CONTENT = 'layout-previewpost-highlight-content';
    public const MODULE_LAYOUT_PREVIEWPOST_HIGHLIGHT_EDIT = 'layout-previewpost-highlight-edit';
    public const MODULE_LAYOUT_PREVIEWPOST_POST_NAVIGATOR = 'layout-previewpost-post-navigator';
    public const MODULE_LAYOUT_PREVIEWPOST_POST_THUMBNAIL = 'layout-previewpost-post-thumbnail';
    public const MODULE_LAYOUT_PREVIEWPOST_POST_ADDONS = 'layout-previewpost-post-addons';
    public const MODULE_LAYOUT_PREVIEWPOST_POST_DETAILS = 'layout-previewpost-post-details';
    public const MODULE_LAYOUT_PREVIEWPOST_POST_LIST = 'layout-previewpost-post-list';
    public const MODULE_LAYOUT_PREVIEWPOST_POST_RELATED = 'layout-previewpost-post-related';
    public const MODULE_LAYOUT_PREVIEWPOST_POST_EDIT = 'layout-previewpost-post-edit';

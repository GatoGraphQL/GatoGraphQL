...
{
    public const MODULE_LAYOUT_USERPOSTINTERACTION = 'layout-userpostinteraction';
    public const MODULE_LAYOUT_USERHIGHLIGHTPOSTINTERACTION = 'layout-userhighlightpostinteraction';

    ...
    public static function getSidebarSubmodules($section)
    {
        ...
        switch ($section) {
            ...
            case GD_COMPACTSIDEBARSECTION_ORGANIZATION:
                ...
                $ret[] = [GD_URE_Custom_Module_Processor_UserMultipleSidebarComponents::class, GD_URE_Custom_Module_Processor_UserMultipleSidebarComponents::COMPONENT_SIDEBARMULTICOMPONENT_ORGANIZATION];
                break;

            case GD_COMPACTSIDEBARSECTION_INDIVIDUAL:
                $ret[] = [GD_Custom_Module_Processor_UserMultipleSidebarComponents::class, GD_Custom_Module_Processor_UserMultipleSidebarComponents::COMPONENT_SIDEBARMULTICOMPONENT_AVATAR];
                $ret[] = [GD_URE_Custom_Module_Processor_UserMultipleSidebarComponents::class, GD_URE_Custom_Module_Processor_UserMultipleSidebarComponents::COMPONENT_SIDEBARMULTICOMPONENT_INDIVIDUAL];
                break;
        }

...
define('POP_COMMONUSERROLESPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_COMMONUSERROLESPROCESSORS_POP_COMMONUSERROLES_MIN_VERSION', 0.1);

class PoP_CommonUserRolesProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_COMMONUSERROLESPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_COMMONUSERROLES_VERSION')) {
            ...
            $success = false;
        } elseif (POP_COMMONUSERROLESPROCESSORS_POP_COMMONUSERROLES_MIN_VERSION > POP_COMMONUSERROLES_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Common User Roles Processors', 'pop-commonuserroles-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-commonuserroles-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-commonuserroles-processors'),
            'https://github.com/leoloso/PoP',
            POP_COMMONUSERROLESPROCESSORS_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Common User Roles Processors', 'pop-commonuserroles-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Common User Roles', 'pop-commonuserroles-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Common User Roles', 'pop-commonuserroles-processors'),
            'https://github.com/leoloso/PoP',
            POP_COMMONUSERROLESPROCESSORS_POP_COMMONUSERROLES_MIN_VERSION
        );
    }

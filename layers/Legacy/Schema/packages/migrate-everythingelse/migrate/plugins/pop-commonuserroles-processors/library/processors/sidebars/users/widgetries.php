...
{
    public const MODULE_WIDGETCOMPACT_ORGANIZATIONINFO = 'widgetcompact-organization-info';
    public const MODULE_WIDGETCOMPACT_INDIVIDUALINFO = 'widgetcompact-individual-info';

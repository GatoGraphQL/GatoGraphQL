...
define('POP_TINYMCE_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_TinyMCE_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TINYMCE_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP TinyMCE', 'pop-tinymce'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-tinymce')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-tinymce'),
            'https://github.com/leoloso/PoP',
            POP_TINYMCE_POP_APPLICATION_MIN_VERSION
        );
    }

...
define('POP_USERSTANCEWEBPLATFORM_POP_USERSTANCE_MIN_VERSION', 0.1);
define('POP_USERSTANCEWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_UserStanceWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERSTANCE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERSTANCEWEBPLATFORM_POP_USERSTANCE_MIN_VERSION > POP_USERSTANCE_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERSTANCEWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Stance Web Platform', 'pop-userstance-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP User Stance', 'pop-userstance-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Stance', 'pop-userstance-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERSTANCEWEBPLATFORM_POP_USERSTANCE_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Stance Web Platform', 'pop-userstance-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-userstance-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-userstance-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERSTANCEWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

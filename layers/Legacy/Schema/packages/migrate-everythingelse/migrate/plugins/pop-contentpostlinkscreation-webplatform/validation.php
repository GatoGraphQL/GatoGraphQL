...
define('POP_CONTENTPOSTLINKSCREATIONWEBPLATFORM_POP_CONTENTPOSTLINKSCREATION_MIN_VERSION', 0.1);
define('POP_CONTENTPOSTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_ContentPostLinksCreationWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_CONTENTPOSTLINKSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_CONTENTPOSTLINKSCREATION_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_CONTENTPOSTLINKSCREATIONWEBPLATFORM_POP_CONTENTPOSTLINKSCREATION_MIN_VERSION > POP_CONTENTPOSTLINKSCREATION_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTPOSTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Creation Web Platform', 'pop-contentpostlinkscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Creation', 'pop-contentpostlinkscreation-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Creation', 'pop-contentpostlinkscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTPOSTLINKSCREATIONWEBPLATFORM_POP_CONTENTPOSTLINKSCREATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Creation Web Platform', 'pop-contentpostlinkscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-contentpostlinkscreation-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-contentpostlinkscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTPOSTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

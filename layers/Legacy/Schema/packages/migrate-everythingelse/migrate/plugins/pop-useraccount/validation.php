...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERACCOUNT_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP User Account', 'pop-useraccount')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Account', 'pop-useraccount'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-useraccount')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-useraccount'),
            'https://github.com/leoloso/PoP',
            POP_USERACCOUNT_POP_ENGINE_MIN_VERSION
        );
    }

...
define('AALPOPCUSTOM_AALPOP_MIN_VERSION', 0.1);

class AAL_PoPCustom_Validation
{
    public function validate()
    {
        ...
        if (!defined('AAL_POP_VERSION')) {
            ...
            $success = false;
        } elseif (AALPOPCUSTOM_AALPOP_MIN_VERSION > AAL_POP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Activity Log for PoP Custom Version', 'aal-pop-custom'),
            TranslationAPIFacade::getInstance()->__('Activity Log for PoP', 'aal-pop-custom')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('Activity Log for PoP', 'aal-pop-custom'),
            'https://github.com/leoloso/PoP',
            AALPOPCUSTOM_AALPOP_MIN_VERSION
        );
    }

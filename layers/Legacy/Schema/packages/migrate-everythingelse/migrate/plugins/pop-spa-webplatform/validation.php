...
define('POP_SPAWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_SPAWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SPAWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Single-Page Application', 'pop-spa-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-spa-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-spa-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_SPAWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

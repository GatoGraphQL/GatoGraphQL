...
define('POP_USERAVATARPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_USERAVATARPROCESSORS_POP_USERAVATAR_MIN_VERSION', 0.1);

class PoP_UserAvatarProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERAVATARPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_USERAVATAR_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERAVATARPROCESSORS_POP_USERAVATAR_MIN_VERSION > POP_USERAVATAR_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('User Avatar for PoP Processors', 'pop-useravatar-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-useravatar-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-useravatar-processors'),
            'https://github.com/leoloso/PoP',
            POP_USERAVATARPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('User Avatar for PoP Processors', 'pop-useravatar-processors'),
            TranslationAPIFacade::getInstance()->__('User Avatar for PoP', 'pop-useravatar-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('User Avatar for PoP', 'pop-useravatar-processors'),
            'https://github.com/leoloso/PoP',
            POP_USERAVATARPROCESSORS_POP_USERAVATAR_MIN_VERSION
        );
    }

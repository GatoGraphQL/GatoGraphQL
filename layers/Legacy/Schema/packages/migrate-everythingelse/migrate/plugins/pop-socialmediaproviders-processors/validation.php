...
class PoP_SocialMediaProvidersProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            HooksAPIFacade::getInstance()->addAction('media_admin_notices', array($this,'installWarning'));
            $success = false;
            ...
            HooksAPIFacade::getInstance()->addAction('media_admin_notices', array($this, 'initializeWarning'));
            $success = false;
            ...
            HooksAPIFacade::getInstance()->addAction('media_admin_notices', array($this,'versionWarning'));
        }

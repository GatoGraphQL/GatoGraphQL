...
define('POP_SOCIALMEDIAPROVIDERSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);

class PoP_SocialMediaProvidersProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            \PoP\Root\App::getHookManager()->addAction('media_admin_notices', array($this,'installWarning'));
            $success = false;
            ...
            \PoP\Root\App::getHookManager()->addAction('media_admin_notices', array($this, 'initializeWarning'));
            $success = false;
        } elseif (POP_SOCIALMEDIAPROVIDERSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
            \PoP\Root\App::getHookManager()->addAction('admin_notices', array($this,'versionWarning'));
            \PoP\Root\App::getHookManager()->addAction('media_admin_notices', array($this,'versionWarning'));
        }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Social Media Providers Processors', 'pop-socialmediaproviders-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-socialmediaproviders-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-socialmediaproviders-processors'),
            'https://github.com/leoloso/PoP',
            POP_SOCIALMEDIAPROVIDERSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }

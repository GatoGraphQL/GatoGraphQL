...
define('POP_CATEGORYPOSTS_POP_BLOG_MIN_VERSION', 0.1);

class PoP_CategoryPosts_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_BLOG_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTS_POP_BLOG_MIN_VERSION > POP_BLOG_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts', 'pop-categoryposts'),
            TranslationAPIFacade::getInstance()->__('PoP Blog', 'pop-categoryposts')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Blog', 'pop-categoryposts'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTS_POP_BLOG_MIN_VERSION
        );
    }

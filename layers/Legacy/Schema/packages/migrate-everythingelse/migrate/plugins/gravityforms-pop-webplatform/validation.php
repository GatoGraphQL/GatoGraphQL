...
define('GFPOPWEBPLATFORM_GFPOP_MIN_VERSION', 0.1);

class GFPoPWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (GFPOPWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
        ...
        if (!defined('GFPOP_VERSION')) {
            ...
            $success = false;
        } elseif (GFPOPWEBPLATFORM_GFPOP_MIN_VERSION > GFPOP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Gravity Forms for PoP Web Platform', 'gravityforms-pop'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'gravityforms-pop')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'gravityforms-pop'),
            'https://github.com/leoloso/PoP',
            GFPOPWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('Gravity Forms for PoP', 'gravityforms-pop'),
            'https://github.com/leoloso/PoP',
            GFPOPWEBPLATFORM_GFPOP_MIN_VERSION
        );
    }

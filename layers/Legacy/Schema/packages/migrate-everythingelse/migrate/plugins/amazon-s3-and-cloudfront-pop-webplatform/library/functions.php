...
HooksAPIFacade::getInstance()->addFilter('pop_modulemanager:allowed_domains', 'popAwss3Allowedurl');
function popAwss3Allowedurl($allowed_domains)
{
    ...
    if ($region = HooksAPIFacade::getInstance()->applyFilters('popAwss3Allowedurl:region', '')) {
        global $as3cf;
        if ($as3cf) {

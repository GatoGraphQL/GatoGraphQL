...
define('POP_USERCOMMUNITIES_POP_USERPLATFORM_MIN_VERSION', 0.1);
define('POP_USERCOMMUNITIES_POP_USERROLES_MIN_VERSION', 0.1);

class PoP_UserCommunities_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERCOMMUNITIES_POP_USERPLATFORM_MIN_VERSION > POP_USERPLATFORM_VERSION) {
        ...
        if (!defined('POP_USERROLES_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERCOMMUNITIES_POP_USERROLES_MIN_VERSION > POP_USERROLES_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Communities', 'pop-usercommunities'),
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-usercommunities')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-usercommunities'),
            'https://github.com/leoloso/PoP',
            POP_USERCOMMUNITIES_POP_USERPLATFORM_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Communities', 'pop-usercommunities'),
            TranslationAPIFacade::getInstance()->__('PoP User Roles', 'pop-usercommunities')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Roles', 'pop-usercommunities'),
            'https://github.com/leoloso/PoP',
            POP_USERCOMMUNITIES_POP_USERROLES_MIN_VERSION
        );
    }

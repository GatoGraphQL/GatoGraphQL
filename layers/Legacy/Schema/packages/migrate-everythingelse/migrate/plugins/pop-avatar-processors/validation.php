...
define('POP_AVATARPROCESSORS_POP_ENGINE_MIN_VERSION', 0.1);
define('POP_AVATARPROCESSORS_POP_AVATAR_MIN_VERSION', 0.1);

class PoP_AvatarProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_AVATARPROCESSORS_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
        ...
        if (!defined('POP_AVATAR_VERSION')) {
            ...
            $success = false;
        } elseif (POP_AVATARPROCESSORS_POP_AVATAR_MIN_VERSION > POP_AVATAR_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Avatar for PoP Processors', 'pop-avatar-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-avatar-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-avatar-processors'),
            'https://github.com/leoloso/PoP',
            POP_AVATARPROCESSORS_POP_ENGINE_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Avatar for PoP Processors', 'pop-avatar-processors'),
            TranslationAPIFacade::getInstance()->__('Avatar for PoP', 'pop-avatar-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('Avatar for PoP', 'pop-avatar-processors'),
            'https://github.com/leoloso/PoP',
            POP_AVATARPROCESSORS_POP_AVATAR_MIN_VERSION
        );
    }

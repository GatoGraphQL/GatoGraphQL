...
define('POP_NEWSLETTER_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_Newsletter_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NEWSLETTER_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Newsletter', 'pop-newsletter'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-newsletter')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-newsletter'),
            'https://github.com/leoloso/PoP',
            POP_NEWSLETTER_POP_APPLICATION_MIN_VERSION
        );
    }

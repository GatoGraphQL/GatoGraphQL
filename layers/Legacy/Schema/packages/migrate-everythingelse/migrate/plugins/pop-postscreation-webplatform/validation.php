...
define('POP_POSTSCREATIONWEBPLATFORM_POP_POSTSCREATION_MIN_VERSION', 0.1);
define('POP_POSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_PostsCreationWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_POSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_POSTSCREATIONWEBPLATFORM_POP_POSTSCREATION_MIN_VERSION > POP_POSTSCREATION_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_POSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation Web Platform', 'pop-postscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation', 'pop-postscreation-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation', 'pop-postscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_POSTSCREATIONWEBPLATFORM_POP_POSTSCREATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation Web Platform', 'pop-postscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-postscreation-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-postscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_POSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

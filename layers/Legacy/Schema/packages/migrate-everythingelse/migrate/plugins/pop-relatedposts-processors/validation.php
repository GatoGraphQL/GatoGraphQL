...
define('POP_RELATEDPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_RELATEDPOSTSPROCESSORS_POP_RELATEDPOSTS_MIN_VERSION', 0.1);

class PoP_RelatedPostsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_RELATEDPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_RELATEDPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_RELATEDPOSTSPROCESSORS_POP_RELATEDPOSTS_MIN_VERSION > POP_RELATEDPOSTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Related Posts Processors', 'pop-relatedposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-relatedposts-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-relatedposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_RELATEDPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Related Posts Processors', 'pop-relatedposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Related Posts', 'pop-relatedposts-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Related Posts', 'pop-relatedposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_RELATEDPOSTSPROCESSORS_POP_RELATEDPOSTS_MIN_VERSION
        );
    }

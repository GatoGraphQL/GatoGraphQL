...
define('POP_LOCATIONPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTLINKSPROCESSORS_POP_LOCATIONPOSTLINKS_MIN_VERSION', 0.1);

class PoP_LocationPostLinksProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_LOCATIONPOSTLINKS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTLINKSPROCESSORS_POP_LOCATIONPOSTLINKS_MIN_VERSION > POP_LOCATIONPOSTLINKS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Processors', 'pop-locationpostlinks-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationpostlinks-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationpostlinks-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links Processors', 'pop-locationpostlinks-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links', 'pop-locationpostlinks-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Post Links', 'pop-locationpostlinks-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTLINKSPROCESSORS_POP_LOCATIONPOSTLINKS_MIN_VERSION
        );
    }

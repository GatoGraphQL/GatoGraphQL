...
define('POP_AVATARAWS_POP_AVATAR_MIN_VERSION', 0.1);
define('POP_AVATARAWS_POP_AWS_MIN_VERSION', 0.1);

class PoP_Avatar_AWS_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_AVATAR_VERSION')) {
            ...
            $success = false;
        } elseif (POP_AVATARAWS_POP_AVATAR_MIN_VERSION > POP_AVATAR_VERSION) {
        ...
        if (!defined('POP_AWS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_AVATARAWS_POP_AWS_MIN_VERSION > POP_AWS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Avatar for PoP and AWS', 'pop-avatar-aws'),
            TranslationAPIFacade::getInstance()->__('Avatar for PoP', 'pop-avatar-aws')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('Avatar for PoP', 'pop-avatar-aws'),
            'https://github.com/leoloso/PoP',
            POP_AVATARAWS_POP_AVATAR_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Avatar for PoP and AWS', 'pop-avatar-aws'),
            TranslationAPIFacade::getInstance()->__('PoP AWS', 'pop-avatar-aws')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP AWS', 'pop-avatar-aws'),
            'https://github.com/leoloso/PoP',
            POP_AVATARAWS_POP_AWS_MIN_VERSION
        );
    }

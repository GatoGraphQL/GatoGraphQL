...
define('POP_POSTCATEGORYLAYOUTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);

class PoP_PostCategoryLayoutsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_POSTCATEGORYLAYOUTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Post Category Layouts for PoP Processors', 'pop-postcategorylayouts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-postcategorylayouts-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-postcategorylayouts-processors'),
            'https://github.com/leoloso/PoP',
            POP_POSTCATEGORYLAYOUTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }

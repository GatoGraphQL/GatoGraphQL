...
define('POP_USERAVATARWEBPLATFORM_POP_USERAVATAR_MIN_VERSION', 0.1);
define('POP_USERAVATARWEBPLATFORM_POP_AVATARWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_UserAvatarWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERAVATAR_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERAVATARWEBPLATFORM_POP_USERAVATAR_MIN_VERSION > POP_USERAVATAR_VERSION) {
        ...
        if (!defined('POP_AVATARWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERAVATARWEBPLATFORM_POP_AVATARWEBPLATFORM_MIN_VERSION > POP_AVATARWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Avatar Web Platform', 'pop-useravatar-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP User Avatar', 'pop-useravatar-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Avatar', 'pop-useravatar-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERAVATARWEBPLATFORM_POP_USERAVATAR_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Avatar Web Platform', 'pop-useravatar-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Avatar Web Platform', 'pop-useravatar-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Avatar Web Platform', 'pop-useravatar-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERAVATARWEBPLATFORM_POP_AVATARWEBPLATFORM_MIN_VERSION
        );
    }

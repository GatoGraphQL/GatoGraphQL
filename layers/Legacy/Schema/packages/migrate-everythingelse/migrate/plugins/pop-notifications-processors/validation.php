...
define('POP_NOTIFICATIONSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_NOTIFICATIONSPROCESSORS_POP_NOTIFICATIONS_MIN_VERSION', 0.1);

class PoP_NotificationsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOTIFICATIONSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_NOTIFICATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOTIFICATIONSPROCESSORS_POP_NOTIFICATIONS_MIN_VERSION > POP_NOTIFICATIONS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Notifications Processors', 'pop-notifications-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-notifications-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-notifications-processors'),
            'https://github.com/leoloso/PoP',
            POP_NOTIFICATIONSPROCESSORS_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Notifications Processors', 'pop-notifications-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Notifications', 'pop-notifications-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Notifications', 'pop-notifications-processors'),
            'https://github.com/leoloso/PoP',
            POP_NOTIFICATIONSPROCESSORS_POP_NOTIFICATIONS_MIN_VERSION
        );
    }

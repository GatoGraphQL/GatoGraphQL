...
define('POP_CAPTCHA_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_Captcha_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CAPTCHA_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Captcha', 'pop-captcha'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-captcha')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-captcha'),
            'https://github.com/leoloso/PoP',
            POP_CAPTCHA_POP_APPLICATION_MIN_VERSION
        );
    }

...
define('POP_USERCOMMUNITIESPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_USERCOMMUNITIESPROCESSORS_POP_USERCOMMUNITIES_MIN_VERSION', 0.1);

class PoP_UserCommunitiesProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERCOMMUNITIESPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_USERCOMMUNITIES_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERCOMMUNITIESPROCESSORS_POP_USERCOMMUNITIES_MIN_VERSION > POP_USERCOMMUNITIES_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Communities Processors', 'pop-usercommunities-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-usercommunities-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-usercommunities-processors'),
            'https://github.com/leoloso/PoP',
            POP_USERCOMMUNITIESPROCESSORS_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Communities Processors', 'pop-usercommunities-processors'),
            TranslationAPIFacade::getInstance()->__('PoP User Communities', 'pop-usercommunities-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Communities', 'pop-usercommunities-processors'),
            'https://github.com/leoloso/PoP',
            POP_USERCOMMUNITIESPROCESSORS_POP_USERCOMMUNITIES_MIN_VERSION
        );
    }

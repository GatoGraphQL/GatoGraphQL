...
define('POP_USERLOGINWP_POP_USERSTATE_MIN_VERSION', 0.1);
define('POP_USERLOGINWP_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_UserLoginWP_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_USERSTATE_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_USERSTATE_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_USERLOGINWP_POP_USERSTATE_MIN_VERSION > POP_USERSTATE_VERSION) {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERLOGINWP_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Login WordPress', 'pop-userloginwp'),
            TranslationAPIFacade::getInstance()->__('PoP User State', 'pop-userloginwp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User State', 'pop-userloginwp'),
            'https://github.com/leoloso/PoP',
            POP_USERLOGINWP_POP_USERSTATE_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Login WordPress', 'pop-userloginwp'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-userloginwp')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-userloginwp'),
            'https://github.com/leoloso/PoP',
            POP_USERLOGINWP_POP_APPLICATION_MIN_VERSION
        );
    }

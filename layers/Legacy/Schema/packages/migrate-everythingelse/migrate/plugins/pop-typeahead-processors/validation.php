...
define('POP_TYPEAHEADPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);

class PoP_TypeaheadProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TYPEAHEADPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Typeahead for PoP Processors', 'pop-typeahead-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-typeahead-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-typeahead-processors'),
            'https://github.com/leoloso/PoP',
            POP_TYPEAHEADPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }

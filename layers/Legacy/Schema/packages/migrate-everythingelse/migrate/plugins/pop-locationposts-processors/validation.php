...
define('POP_LOCATIONPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTSPROCESSORS_POP_LOCATIONS_MIN_VERSION', 0.1);

class PoP_LocationPostsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_LOCATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSPROCESSORS_POP_LOCATIONS_MIN_VERSION > POP_LOCATIONS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Locations Processors', 'pop-locationposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationposts-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-locationposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Locations Processors', 'pop-locationposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-locationposts-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-locationposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSPROCESSORS_POP_LOCATIONS_MIN_VERSION
        );
    }

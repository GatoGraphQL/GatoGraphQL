...
define('POP_VOLUNTEERING_POP_USERPLATFORM_MIN_VERSION', 0.1);

class PoP_Volunteering_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_VOLUNTEERING_POP_USERPLATFORM_MIN_VERSION > POP_USERPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Volunteering', 'pop-volunteering'),
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-volunteering')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-volunteering'),
            'https://github.com/leoloso/PoP',
            POP_VOLUNTEERING_POP_USERPLATFORM_MIN_VERSION
        );
    }

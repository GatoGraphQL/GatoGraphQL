...
define('POP_BASECOLLECTIONPROCESSORS_POP_ENGINEPROCESSORS_MIN_VERSION', 0.1);

class PoP_BaseCollectionProcessors_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_ENGINEPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_ENGINEPROCESSORS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_BASECOLLECTIONPROCESSORS_POP_ENGINEPROCESSORS_MIN_VERSION > POP_ENGINEPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Base Collection Processors', 'pop-basecollection-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Processors', 'pop-basecollection-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Processors', 'pop-basecollection-processors'),
            'https://github.com/leoloso/PoP',
            POP_BASECOLLECTIONPROCESSORS_POP_ENGINEPROCESSORS_MIN_VERSION
        );
    }

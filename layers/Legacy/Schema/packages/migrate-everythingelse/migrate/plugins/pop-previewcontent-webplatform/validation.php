...
define('PPPPOPFE_POP_PREVIEWCONTENT_MIN_VERSION', 0.1);
define('PPPPOPFE_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_PreviewContentWebPlatform_Validation
{
    public function validate()
    {
        $success = true;

        if (!defined('POP_PREVIEWCONTENT_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_PREVIEWCONTENT_INITIALIZED')) {
            ...
            $success = false;
        } elseif (PPPPOPFE_POP_PREVIEWCONTENT_MIN_VERSION > POP_PREVIEWCONTENT_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (PPPPOPFE_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Preview Content Web Platform', 'ppp-pop-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Preview Content', 'ppp-pop-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Preview Content', 'ppp-pop-webplatform'),
            'https://github.com/leoloso/PoP',
            PPPPOPFE_POP_PREVIEWCONTENT_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Preview Content Web Platform', 'ppp-pop-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'ppp-pop-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'ppp-pop-webplatform'),
            'https://github.com/leoloso/PoP',
            PPPPOPFE_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

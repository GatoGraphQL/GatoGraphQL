...
define('POP_SERVICEWORKERS_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);
...
class PoP_ServiceWorkers_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SERVICEWORKERS_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Service Workers', 'pop-serviceworkers'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-serviceworkers')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-serviceworkers'),
            'https://github.com/leoloso/PoP',
            POP_SERVICEWORKERS_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

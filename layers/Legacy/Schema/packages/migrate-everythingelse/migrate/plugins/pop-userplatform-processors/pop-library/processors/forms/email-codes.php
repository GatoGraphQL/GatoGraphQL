...
{
    public const MODULE_CODE_EMAILNOTIFICATIONS_LABEL = 'code-emailnotifications-label';
    public const MODULE_CODE_EMAILNOTIFICATIONS_GENERALLABEL = 'code-emailnotifications-generallabel';
    public const MODULE_CODE_EMAILDIGESTS_LABEL = 'code-dailyemaildigestslabel';

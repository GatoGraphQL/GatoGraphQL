...
{
    public const MODULE_FORMINPUTGROUP_CUP_SHORTDESCRIPTION = 'forminputgroup-cup-shortdescription';
    public const MODULE_FORMINPUTGROUP_CUP_FACEBOOK = 'forminputgroup-cup-facebook';
    public const MODULE_FORMINPUTGROUP_CUP_TWITTER = 'forminputgroup-cup-twitter';

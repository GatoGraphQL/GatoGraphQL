...
{
    public const MODULE_MULTICOMPONENT_EMAILNOTIFICATIONS = 'multicomponent-emailnotifications';
    public const MODULE_MULTICOMPONENT_EMAILNOTIFICATIONS_GENERAL = 'multicomponent-emailnotifications-general';
    public const MODULE_MULTICOMPONENT_EMAILDIGESTS = 'multicomponent-emaildigests';
    ...
    public function getSubmodules(array $module): array
    {
        ...
        switch ($module[1]) {
            case self::MODULE_MULTICOMPONENT_EMAILNOTIFICATIONS:
                ...
                if ($forminputs = HooksAPIFacade::getInstance()->applyFilters(
            ...
            case self::MODULE_MULTICOMPONENT_EMAILDIGESTS:
                ...
                // Allow PoP Social Network to hook in its modules
                $forminputs = HooksAPIFacade::getInstance()->applyFilters(

...
define('POP_USERPLATFORMPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_USERPLATFORMPROCESSORS_POP_USERPLATFORM_MIN_VERSION', 0.1);

class PoP_UserPlatformProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERPLATFORMPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_USERPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERPLATFORMPROCESSORS_POP_USERPLATFORM_MIN_VERSION > POP_USERPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Platform Processors', 'pop-userplatform-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-userplatform-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-userplatform-processors'),
            'https://github.com/leoloso/PoP',
            POP_USERPLATFORMPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Platform Processors', 'pop-userplatform-processors'),
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-userplatform-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-userplatform-processors'),
            'https://github.com/leoloso/PoP',
            POP_USERPLATFORMPROCESSORS_POP_USERPLATFORM_MIN_VERSION
        );
    }

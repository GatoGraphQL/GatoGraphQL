...
{
    public const MODULE_BLOCK_USER_CHANGEPASSWORD = 'block-user-changepwd';
    public const MODULE_BLOCK_MYPREFERENCES = 'block-mypreferences';
    public const MODULE_BLOCK_INVITENEWUSERS = 'block-inviteusers';

...
define('POP_NOTIFICATIONSWEBPLATFORM_POP_NOTIFICATIONS_MIN_VERSION', 0.1);
define('POP_NOTIFICATIONSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_NotificationsWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_NOTIFICATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_NOTIFICATIONS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_NOTIFICATIONSWEBPLATFORM_POP_NOTIFICATIONS_MIN_VERSION > POP_NOTIFICATIONS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOTIFICATIONSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Notifications Web Platform', 'pop-notifications-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Notifications', 'pop-notifications-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Notifications', 'pop-notifications-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_NOTIFICATIONSWEBPLATFORM_POP_NOTIFICATIONS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Notifications Web Platform', 'pop-notifications-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-notifications-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-notifications-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_NOTIFICATIONSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EDITPOSTSWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP EditPosts for WordPress', 'pop-editposts-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-editposts-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-editposts-wp'),
            'https://github.com/leoloso/PoP',
            POP_EDITPOSTSWP_POP_ENGINEWP_MIN_VERSION
        );
    }

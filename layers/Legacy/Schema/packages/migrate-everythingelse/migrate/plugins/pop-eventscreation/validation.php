...
define('POP_EVENTSCREATION_POP_EVENTS_MIN_VERSION', 0.1);
define('POP_EVENTSCREATION_POP_POSTSCREATION_MIN_VERSION', 0.1);

class PoP_EventsCreation_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_EVENTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSCREATION_POP_EVENTS_MIN_VERSION > POP_EVENTS_VERSION) {
        ...
        if (!defined('POP_POSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSCREATION_POP_POSTSCREATION_MIN_VERSION > POP_POSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Creation', 'pop-eventscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-eventscreation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-eventscreation'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSCREATION_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Creation', 'pop-eventscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation', 'pop-eventscreation')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation', 'pop-eventscreation'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSCREATION_POP_POSTSCREATION_MIN_VERSION
        );
    }

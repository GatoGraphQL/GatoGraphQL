...
define('POP_RELATEDPOSTSWEBPLATFORM_POP_RELATEDPOSTS_MIN_VERSION', 0.1);
define('POP_RELATEDPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_RelatedPostsWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_RELATEDPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_RELATEDPOSTSWEBPLATFORM_POP_RELATEDPOSTS_MIN_VERSION > POP_RELATEDPOSTS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_RELATEDPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Related Posts Web Platform', 'pop-relatedposts-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Related Posts', 'pop-relatedposts-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Related Posts', 'pop-relatedposts-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_RELATEDPOSTSWEBPLATFORM_POP_RELATEDPOSTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Related Posts Web Platform', 'pop-relatedposts-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-relatedposts-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-relatedposts-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_RELATEDPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

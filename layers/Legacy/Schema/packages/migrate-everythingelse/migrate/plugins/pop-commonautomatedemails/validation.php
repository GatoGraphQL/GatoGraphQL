...
define('PTWAE_POP_APPLICATION_MIN_VERSION', 0.1);
define('PTWAE_POP_AUTOMATEDEMAILS_MIN_VERSION', 0.1);

class PoP_CommonAutomatedEmails_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (PTWAE_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
        ...
        if (!defined('POP_AUTOMATEDEMAILS_VERSION')) {
            ...
            $success = false;
        } elseif (PTWAE_POP_AUTOMATEDEMAILS_MIN_VERSION > POP_AUTOMATEDEMAILS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Common Automated Emails for PoP', 'pop-commonautomatedemails'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-commonautomatedemails')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-commonautomatedemails'),
            'https://github.com/leoloso/PoP',
            PTWAE_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Common Automated Emails for PoP', 'pop-commonautomatedemails'),
            TranslationAPIFacade::getInstance()->__('PoP Automated Emails', 'pop-commonautomatedemails')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Automated Emails', 'pop-commonautomatedemails'),
            'https://github.com/leoloso/PoP',
            PTWAE_POP_AUTOMATEDEMAILS_MIN_VERSION
        );
    }

...
define('POP_FORMSWEBPLATFORM_POP_FORMS_MIN_VERSION', 0.1);
define('POP_FORMSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_FormsWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_FORMS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_FORMSWEBPLATFORM_POP_FORMS_MIN_VERSION > POP_FORMS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_FORMSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Forms Web Platform', 'pop-forms-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Forms', 'pop-forms-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Forms', 'pop-forms-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_FORMSWEBPLATFORM_POP_FORMS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Forms Web Platform', 'pop-forms-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-forms-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-forms-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_FORMSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

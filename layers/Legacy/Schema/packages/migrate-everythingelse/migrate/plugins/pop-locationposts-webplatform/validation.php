...
define('POP_LOCATIONPOSTSWEBPLATFORM_POP_LOCATIONPOSTS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_LocationPostsWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_LOCATIONPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSWEBPLATFORM_POP_LOCATIONPOSTS_MIN_VERSION > POP_LOCATIONPOSTS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Web Platform', 'pop-locationposts-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Location Posts', 'pop-locationposts-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Posts', 'pop-locationposts-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSWEBPLATFORM_POP_LOCATIONPOSTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Web Platform', 'pop-locationposts-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-locationposts-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-locationposts-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

...
class CPP_Module_Processor_TagSectionTabPanelComponents extends PoP_Module_Processor_TagSectionTabPanelComponentsBase
{
    ...
    {
        return array(
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS00,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS01,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS02,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS03,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS04,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS05,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS06,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS07,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS08,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS09,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS10,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS11,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS12,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS13,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS14,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS15,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS16,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS17,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS18,
            self::COMPONENT_TABPANEL_TAGCATEGORYPOSTS19,
        );
    }

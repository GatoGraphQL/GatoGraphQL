...
define('POP_CATEGORYPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_CATEGORYPOSTSPROCESSORS_POP_CATEGORYPOSTS_MIN_VERSION', 0.1);

class PoP_CategoryPostsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_CATEGORYPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSPROCESSORS_POP_CATEGORYPOSTS_MIN_VERSION > POP_CATEGORYPOSTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Processors', 'pop-categoryposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-categoryposts-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-categoryposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Processors', 'pop-categoryposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Category Posts', 'pop-categoryposts-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Category Posts', 'pop-categoryposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSPROCESSORS_POP_CATEGORYPOSTS_MIN_VERSION
        );
    }

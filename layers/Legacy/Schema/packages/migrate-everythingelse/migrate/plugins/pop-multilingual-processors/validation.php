...
define('POP_MULTILINGUALPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_MULTILINGUALPROCESSORS_POP_MULTILINGUAL_MIN_VERSION', 0.1);

class PoP_MultilingualProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_MULTILINGUALPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_MULTILINGUAL_VERSION')) {
            ...
            $success = false;
        } elseif (POP_MULTILINGUALPROCESSORS_POP_MULTILINGUAL_MIN_VERSION > POP_MULTILINGUAL_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP MultilingualProcessors', 'pop-multilingual-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-multilingual-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-multilingual-processors'),
            'https://github.com/leoloso/PoP',
            POP_MULTILINGUALPROCESSORS_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Multilingual Processors', 'pop-multilingual-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Multilingual', 'pop-multilingual-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Multilingual', 'pop-multilingual-processors'),
            'https://github.com/leoloso/PoP',
            POP_MULTILINGUALPROCESSORS_POP_MULTILINGUAL_MIN_VERSION
        );
    }

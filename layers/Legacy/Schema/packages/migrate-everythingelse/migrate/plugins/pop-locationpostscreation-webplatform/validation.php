...
define('POP_LOCATIONPOSTSCREATIONWEBPLATFORM_POP_LOCATIONPOSTSCREATION_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_LocationPostsCreationWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_LOCATIONPOSTSCREATION_VERSION')) {
            \PoP\Root\App::addAction('admin_notices', $this->installWarning(...));
            \PoP\Root\App::addAction('network_admin_notices', $this->installWarning(...));
            $success = false;
        } elseif (!defined('POP_LOCATIONPOSTSCREATION_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSCREATIONWEBPLATFORM_POP_LOCATIONPOSTSCREATION_MIN_VERSION > POP_LOCATIONPOSTSCREATION_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation Web Platform', 'pop-locationpostscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation', 'pop-locationpostscreation-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation', 'pop-locationpostscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSCREATIONWEBPLATFORM_POP_LOCATIONPOSTSCREATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation Web Platform', 'pop-locationpostscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-locationpostscreation-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-locationpostscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

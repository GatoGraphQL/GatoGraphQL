...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERROLESWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Roles for WordPress', 'pop-userroles-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-userroles-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-userroles-wp'),
            'https://github.com/leoloso/PoP',
            POP_USERROLESWP_POP_ENGINEWP_MIN_VERSION
        );
    }

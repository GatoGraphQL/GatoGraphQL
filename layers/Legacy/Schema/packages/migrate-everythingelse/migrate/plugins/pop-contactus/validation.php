...
define('POP_CONTACTUS_POP_APPLICATION_MIN_VERSION', 0.1);
define('POP_CONTACTUS_POP_FORMS_MIN_VERSION', 0.1);

class PoP_ContactUs_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTACTUS_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
        ...
        if (!defined('POP_FORMS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTACTUS_POP_FORMS_MIN_VERSION > POP_FORMS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Contact Us', 'pop-contactus'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-contactus')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-contactus'),
            'https://github.com/leoloso/PoP',
            POP_CONTACTUS_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Contact Us', 'pop-contactus'),
            TranslationAPIFacade::getInstance()->__('PoP Forms', 'pop-contactus')
        );
    }

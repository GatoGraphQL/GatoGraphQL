...
define('POP_VOLUNTEERINGPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_VOLUNTEERINGPROCESSORS_POP_VOLUNTEERING_MIN_VERSION', 0.1);

class PoP_VolunteeringProcessors_Validation
{
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Volunteering Processors', 'pop-volunteering-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-volunteering-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-volunteering-processors'),
            'https://github.com/leoloso/PoP',
            POP_VOLUNTEERINGPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Volunteering Processors', 'pop-volunteering-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Volunteering', 'pop-volunteering-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Volunteering', 'pop-volunteering-processors'),
            'https://github.com/leoloso/PoP',
            POP_VOLUNTEERINGPROCESSORS_POP_VOLUNTEERING_MIN_VERSION
        );
    }

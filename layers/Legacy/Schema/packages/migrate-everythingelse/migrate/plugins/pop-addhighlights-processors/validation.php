...
define('POP_ADDHIGHLIGHTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_ADDHIGHLIGHTSPROCESSORS_POP_ADDHIGHLIGHTS_MIN_VERSION', 0.1);

class PoP_AddHighlightsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDHIGHLIGHTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_ADDHIGHLIGHTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDHIGHLIGHTSPROCESSORS_POP_ADDHIGHLIGHTS_MIN_VERSION > POP_ADDHIGHLIGHTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights Processors', 'pop-addhighlights-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addhighlights-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addhighlights-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDHIGHLIGHTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights Processors', 'pop-addhighlights-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights', 'pop-addhighlights-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights', 'pop-addhighlights-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDHIGHLIGHTSPROCESSORS_POP_ADDHIGHLIGHTS_MIN_VERSION
        );
    }

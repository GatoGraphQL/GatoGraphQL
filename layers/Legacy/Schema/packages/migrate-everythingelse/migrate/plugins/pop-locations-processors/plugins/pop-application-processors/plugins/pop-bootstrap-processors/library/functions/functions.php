...
function gdEmSectiontabpanelSubmodules($submodules, array $componentVariation)
{
...
function gdEmSinglesectiontabpanelSubmodules($submodules, array $componentVariation)
{

 ...
 * navigation.php
 */
\PoP\Root\App::addFilter('route:icon', 'popEventlinkscreationRouteIcon', 10, 3);
...
\PoP\Root\App::addFilter('route:title', 'popEventlinkscreationNavigationRouteTitle', 10, 2);

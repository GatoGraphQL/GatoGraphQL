...
define('POP_ADDPOSTLINKSWEBPLATFORM_POP_ADDPOSTLINKS_MIN_VERSION', 0.1);
define('POP_ADDPOSTLINKSWEBPLATFORM_POP_AVATARWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_AddPostLinksWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_ADDPOSTLINKS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_ADDPOSTLINKS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_ADDPOSTLINKSWEBPLATFORM_POP_ADDPOSTLINKS_MIN_VERSION > POP_ADDPOSTLINKS_VERSION) {
        ...
        if (!defined('POP_AVATARWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_AVATARWEBPLATFORM_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_ADDPOSTLINKSWEBPLATFORM_POP_AVATARWEBPLATFORM_MIN_VERSION > POP_AVATARWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Post Links Web Platform', 'pop-addpostlinks-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Add Post Links', 'pop-addpostlinks-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Post Links', 'pop-addpostlinks-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_ADDPOSTLINKSWEBPLATFORM_POP_ADDPOSTLINKS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Post Links Web Platform', 'pop-addpostlinks-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Avatar Web Platform', 'pop-addpostlinks-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Avatar Web Platform', 'pop-addpostlinks-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_ADDPOSTLINKSWEBPLATFORM_POP_AVATARWEBPLATFORM_MIN_VERSION
        );
    }

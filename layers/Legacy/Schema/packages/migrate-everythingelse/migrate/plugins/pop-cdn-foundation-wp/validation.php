...
define('POP_CDNFOUNDATIONWP_POP_CDNFOUNDATION_MIN_VERSION', 0.1);

class PoP_CDNFoundationWP_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_CDNFOUNDATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CDNFOUNDATIONWP_POP_CDNFOUNDATION_MIN_VERSION > POP_CDNFOUNDATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP CDN Foundation', 'pop-cdn-foundation-wp'),
            TranslationAPIFacade::getInstance()->__('PoP CDN Foundation WordPress', 'pop-cdn-foundation-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP CDN Foundation WordPress', 'pop-cdn-foundation-wp'),
            'https://github.com/leoloso/PoP',
            POP_CDNFOUNDATIONWP_POP_CDNFOUNDATION_MIN_VERSION
        );
    }

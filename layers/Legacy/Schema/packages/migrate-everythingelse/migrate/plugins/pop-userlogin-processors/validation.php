...
define('POP_USERLOGINPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_USERLOGINPROCESSORS_POP_USERLOGIN_MIN_VERSION', 0.1);

class PoP_UserLoginProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERLOGINPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_USERLOGIN_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERLOGINPROCESSORS_POP_USERLOGIN_MIN_VERSION > POP_USERLOGIN_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Login Processors', 'pop-userlogin-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-userlogin-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-userlogin-processors'),
            'https://github.com/leoloso/PoP',
            POP_USERLOGINPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Login Processors', 'pop-userlogin-processors'),
            TranslationAPIFacade::getInstance()->__('PoP User Login', 'pop-userlogin-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Login', 'pop-userlogin-processors'),
            'https://github.com/leoloso/PoP',
            POP_USERLOGINPROCESSORS_POP_USERLOGIN_MIN_VERSION
        );
    }

...
{
    public final const COMPONENT_LAYOUT_CHECKPOINTMESSAGEALERT_NOTLOGGEDIN = 'layout-checkpointmessagealert-notloggedin';
    public final const COMPONENT_LAYOUT_CHECKPOINTMESSAGEALERT_LOGGEDIN = 'layout-checkpointmessagealert-loggedin';
    ...
    {
        return array(
            self::COMPONENT_LAYOUT_CHECKPOINTMESSAGEALERT_NOTLOGGEDIN,
            self::COMPONENT_LAYOUT_CHECKPOINTMESSAGEALERT_LOGGEDIN,
            self::COMPONENT_LAYOUT_CHECKPOINTMESSAGEALERT_LOGGEDINCANEDIT,
            self::COMPONENT_LAYOUT_CHECKPOINTMESSAGEALERT_LOGGEDINISADMIN,
        );
    }

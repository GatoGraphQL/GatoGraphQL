...
{
    public const MODULE_BLOCK_LOGIN = 'block-login';
    public const MODULE_BLOCK_LOSTPWD = 'block-lostpwd';
    public const MODULE_BLOCK_LOSTPWDRESET = 'block-lostpwdreset';
    public const MODULE_BLOCK_LOGOUT = 'block-logout';

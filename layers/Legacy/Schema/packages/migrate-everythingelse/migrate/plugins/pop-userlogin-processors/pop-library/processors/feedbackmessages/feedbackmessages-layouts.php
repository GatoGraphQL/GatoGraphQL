...
{
    public const MODULE_LAYOUT_FEEDBACKMESSAGE_LOGIN = 'layout-feedbackmessage-login';
    public const MODULE_LAYOUT_FEEDBACKMESSAGE_LOSTPWD = 'layout-feedbackmessage-lostpwd';
    public const MODULE_LAYOUT_FEEDBACKMESSAGE_LOSTPWDRESET = 'layout-feedbackmessage-lostpwdreset';
    public const MODULE_LAYOUT_FEEDBACKMESSAGE_LOGOUT = 'layout-feedbackmessage-logout';
    public const MODULE_LAYOUT_FEEDBACKMESSAGE_USER_CHANGEPASSWORD = 'layout-feedbackmessage-user-changepassword';

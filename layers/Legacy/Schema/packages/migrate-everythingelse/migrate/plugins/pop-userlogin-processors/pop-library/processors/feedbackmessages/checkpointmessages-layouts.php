...
{
    public const MODULE_LAYOUT_CHECKPOINTMESSAGE_NOTLOGGEDIN = 'layout-checkpointmessage-notloggedin';
    public const MODULE_LAYOUT_CHECKPOINTMESSAGE_LOGGEDIN = 'layout-checkpointmessage-loggedin';
    public const MODULE_LAYOUT_CHECKPOINTMESSAGE_LOGGEDINCANEDIT = 'layout-checkpointmessage-loggedincanedit';
    public const MODULE_LAYOUT_CHECKPOINTMESSAGE_LOGGEDINISADMIN = 'layout-checkpointmessage-loggedinisadmin';
    ...
    public function getMessages(array $module, array &$props)
    {
        ...
        switch ($module[1]) {
            ...
            case self::MODULE_LAYOUT_CHECKPOINTMESSAGE_LOGGEDINISADMIN:
                ...
                $extra_checkpoint_msgs = HooksAPIFacade::getInstance()->applyFilters(

...
class PoP_ThemeWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_THEMEWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
        ...
        if (!defined('POP_THEME_VERSION')) {
            ...
            $success = false;
        } elseif (POP_THEMEWEBPLATFORM_POP_THEME_MIN_VERSION > POP_THEME_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Theme Web Platform', 'pop-theme-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-theme-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-theme-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_THEMEWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Theme Web Platform', 'pop-theme-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Theme', 'pop-theme-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Theme', 'pop-theme-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_THEMEWEBPLATFORM_POP_THEME_MIN_VERSION
        );
    }

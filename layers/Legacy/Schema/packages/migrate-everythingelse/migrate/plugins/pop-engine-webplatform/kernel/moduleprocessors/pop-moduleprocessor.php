...
abstract class PoP_WebPlatformQueryDataModuleProcessorBase extends PoP_HTMLCSSPlatformQueryDataModuleProcessorBase
{
    ...
    public function getJsdataFeedbackDatasetmoduletree(array $module, array &$props, array $data_properties, $dataaccess_checkpoint_validation, $actionexecution_checkpoint_validation, $executed, $dbobjectids): array
    {
    ...
    public function getJsdataFeedbackModuletree(array $module, array &$props, array $data_properties, $dataaccess_checkpoint_validation, $actionexecution_checkpoint_validation, $executed, $dbobjectids): array
    {
        $ret = array();

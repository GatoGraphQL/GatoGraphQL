...
define('POP_BLOG_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_Blog_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_BLOG_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Blog', 'pop-blog'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-blog')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-blog'),
            'https://github.com/leoloso/PoP',
            POP_BLOG_POP_APPLICATION_MIN_VERSION
        );
    }

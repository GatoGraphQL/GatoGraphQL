...
define('POP_ADDCOMMENTS_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_AddComments_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDCOMMENTS_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Comments', 'pop-addcomments'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-addcomments')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-addcomments'),
            'https://github.com/leoloso/PoP',
            POP_ADDCOMMENTS_POP_APPLICATION_MIN_VERSION
        );
    }

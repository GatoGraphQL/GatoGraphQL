...
define('POP_BOOTSTRAPWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_BootstrapWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_BOOTSTRAPWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Bootstrap Web Platform', 'pop-bootstrap-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-bootstrap-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-bootstrap-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_BOOTSTRAPWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

...
// define('POP_FORMSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_FORMSPROCESSORS_POP_FORMS_MIN_VERSION', 0.1);

class PoP_FormsProcessors_Validation
{
    public function validate()
    {
        ...
        //     $success = false;
        // }
        // elseif (POP_FORMSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_FORMS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_FORMSPROCESSORS_POP_FORMS_MIN_VERSION > POP_FORMS_VERSION) {
    ...
    //         TranslationAPIFacade::getInstance()->__('PoP Forms Processors', 'pop-forms-processors'),
    //         TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-forms-processors')
    //     );
    // }
    ...
    //         TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-forms-processors'),
    //         'https://github.com/leoloso/PoP',
    //         POP_FORMSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
    //     );
    // }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Forms Processors', 'pop-forms-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Forms', 'pop-forms-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Forms', 'pop-forms-processors'),
            'https://github.com/leoloso/PoP',
            POP_FORMSPROCESSORS_POP_FORMS_MIN_VERSION
        );
    }

...
define('POP_EVENTSCREATIONWEBPLATFORM_POP_EVENTSCREATION_MIN_VERSION', 0.1);
define('POP_EVENTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_EventsCreationWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_EVENTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_EVENTSCREATION_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_EVENTSCREATIONWEBPLATFORM_POP_EVENTSCREATION_MIN_VERSION > POP_EVENTSCREATION_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Creation Web Platform', 'pop-eventscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Events Creation', 'pop-eventscreation-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Events Creation', 'pop-eventscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSCREATIONWEBPLATFORM_POP_EVENTSCREATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Creation Web Platform', 'pop-eventscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-eventscreation-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-eventscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

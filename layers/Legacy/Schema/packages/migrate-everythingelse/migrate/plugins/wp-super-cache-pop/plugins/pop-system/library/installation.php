...
class WPSC_PoP_Installation
{
    public function __construct()
    {
         ...
         */
        \PoP\Root\App::getHookManager()->addAction('PoP:system-build', 'wp_cache_clear_cache');
        ...
        \PoP\Root\App::getHookManager()->addAction('PoP:system-generate', array($this, 'setRejectedUri'), 20);
    }
    ...
    public function setRejectedUri()
    {
        ...
        if ($rejected_uris = array_unique(\PoP\Root\App::getHookManager()->applyFilters('pop_wp_cache_set_rejected_uri', array()))) {

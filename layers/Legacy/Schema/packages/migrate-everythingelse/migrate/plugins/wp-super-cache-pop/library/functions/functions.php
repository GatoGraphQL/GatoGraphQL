...
HooksAPIFacade::getInstance()->addAction('init', 'popWpscRemoveCommentActions');
function popWpscRemoveCommentActions()
{
    HooksAPIFacade::getInstance()->removeAction('trackback_post', 'wp_cache_get_postid_from_comment', 99);
    HooksAPIFacade::getInstance()->removeAction('pingback_post', 'wp_cache_get_postid_from_comment', 99);
    HooksAPIFacade::getInstance()->removeAction('comment_post', 'wp_cache_get_postid_from_comment', 99);
    HooksAPIFacade::getInstance()->removeAction('edit_comment', 'wp_cache_get_postid_from_comment', 99);
    HooksAPIFacade::getInstance()->removeAction('wp_set_comment_status', 'wp_cache_get_postid_from_comment', 99, 2);
}
...
function popWpscIsStacktraceComingFromComments()
{
    ...
    //     ["function"]=>"HooksAPIFacade::getInstance()->doAction"
    //   }
    //   [3]=>array {
...
// Priority 9: execute before HooksAPIFacade::getInstance()->addAction( 'clean_post_cache', 'wp_cache_post_edit' );
HooksAPIFacade::getInstance()->addAction('clean_post_cache', 'popWpscRemoveforcomments', 9, 1);
function popWpscRemoveforcomments($post_id)
{
    if (popWpscIsStacktraceComingFromComments()) {
        ...
        HooksAPIFacade::getInstance()->removeAction('clean_post_cache', 'wp_cache_post_edit');
...
HooksAPIFacade::getInstance()->addAction('publish_to_draft', 'gdWpscPublishToDraft', 0);
...
HooksAPIFacade::getInstance()->addFilter('wp_cache_eof_tags', 'gdWpCacheEofTagsJsonResponse');

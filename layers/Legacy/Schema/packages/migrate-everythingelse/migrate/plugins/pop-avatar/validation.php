...
define('UAPOP_POP_AVATARFOUNDATION_MIN_VERSION', 0.1);

class PoP_Avatar_Validation
{
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Avatar', 'pop-events')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Avatar', 'pop-avatar'),
            TranslationAPIFacade::getInstance()->__('PoP Avatar Foundation', 'pop-avatar')
        );
    }

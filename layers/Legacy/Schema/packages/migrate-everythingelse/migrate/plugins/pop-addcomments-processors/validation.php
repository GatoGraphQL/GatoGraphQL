...
define('POP_ADDCOMMENTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_ADDCOMMENTSPROCESSORS_POP_ADDCOMMENTS_MIN_VERSION', 0.1);

class PoP_AddCommentsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDCOMMENTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_ADDCOMMENTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDCOMMENTSPROCESSORS_POP_ADDCOMMENTS_MIN_VERSION > POP_ADDCOMMENTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Comments Processors', 'pop-addcomments-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addcomments-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addcomments-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDCOMMENTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Comments Processors', 'pop-addcomments-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Add Comments', 'pop-addcomments-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Comments', 'pop-addcomments-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDCOMMENTSPROCESSORS_POP_ADDCOMMENTS_MIN_VERSION
        );
    }

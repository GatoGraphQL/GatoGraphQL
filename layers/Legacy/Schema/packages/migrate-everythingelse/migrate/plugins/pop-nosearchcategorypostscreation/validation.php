...
define('POP_NOSEARCHCATEGORYPOSTSCREATION_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION', 0.1);
define('POP_NOSEARCHCATEGORYPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION', 0.1);

class PoP_NoSearchCategoryPostsCreation_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_NOSEARCHCATEGORYPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSCREATION_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION > POP_NOSEARCHCATEGORYPOSTS_VERSION) {
        ...
        if (!defined('POP_POSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION > POP_POSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation', 'pop-nosearchcategorypostscreation'),
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts', 'pop-nosearchcategorypostscreation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts', 'pop-nosearchcategorypostscreation'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSCREATION_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation', 'pop-nosearchcategorypostscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-nosearchcategorypostscreation')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-nosearchcategorypostscreation'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION
        );
    }

...
define('POP_ADDCOAUTHORSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_ADDCOAUTHORSPROCESSORS_POP_ADDCOAUTHORS_MIN_VERSION', 0.1);

class PoP_AddCoauthorsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDCOAUTHORSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_ADDCOAUTHORS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_ADDCOAUTHORS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_ADDCOAUTHORSPROCESSORS_POP_ADDCOAUTHORS_MIN_VERSION > POP_ADDCOAUTHORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Coauthors Processors', 'pop-addcoauthors-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addcoauthors-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addcoauthors-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDCOAUTHORSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Coauthors Processors', 'pop-addcoauthors-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Coauthors', 'pop-addcoauthors-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Coauthors', 'pop-addcoauthors-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDCOAUTHORSPROCESSORS_POP_ADDCOAUTHORS_MIN_VERSION
        );
    }

...
define('POP_COAUTHORSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_COAUTHORSPROCESSORS_POP_COAUTHORS_MIN_VERSION', 0.1);

class PoP_CoauthorsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_COAUTHORSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_COAUTHORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_COAUTHORSPROCESSORS_POP_COAUTHORS_MIN_VERSION > POP_COAUTHORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Coauthors Processors', 'pop-coauthors-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-coauthors-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-coauthors-processors'),
            'https://github.com/leoloso/PoP',
            POP_COAUTHORSPROCESSORS_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Coauthors Processors', 'pop-coauthors-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Coauthors', 'pop-coauthors-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Coauthors', 'pop-coauthors-processors'),
            'https://github.com/leoloso/PoP',
            POP_COAUTHORSPROCESSORS_POP_COAUTHORS_MIN_VERSION
        );
    }

...
define('POP_NOSEARCHCATEGORYPOSTSWEBPLATFORM_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION', 0.1);
define('POP_NOSEARCHCATEGORYPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_NoSearchCategoryPostsWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_NOSEARCHCATEGORYPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_NOSEARCHCATEGORYPOSTS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSWEBPLATFORM_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION > POP_NOSEARCHCATEGORYPOSTS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Web Platform', 'pop-nosearchcategoryposts-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts', 'pop-nosearchcategoryposts-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts', 'pop-nosearchcategoryposts-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSWEBPLATFORM_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Web Platform', 'pop-nosearchcategoryposts-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-nosearchcategoryposts-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-nosearchcategoryposts-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

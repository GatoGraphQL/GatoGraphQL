...
define('POP_EVENTLINKSCREATIONWEBPLATFORM_POP_EVENTLINKSCREATION_MIN_VERSION', 0.1);
define('POP_EVENTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_EventLinksCreationWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_EVENTLINKSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTLINKSCREATIONWEBPLATFORM_POP_EVENTLINKSCREATION_MIN_VERSION > POP_EVENTLINKSCREATION_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Event Links Creation Web Platform', 'pop-eventlinkscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Event Links Creation', 'pop-eventlinkscreation-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Event Links Creation', 'pop-eventlinkscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_EVENTLINKSCREATIONWEBPLATFORM_POP_EVENTLINKSCREATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Event Links Creation Web Platform', 'pop-eventlinkscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-eventlinkscreation-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-eventlinkscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_EVENTLINKSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

...
define('POP_BASECOLLECTIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_BaseCollectionWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_BASECOLLECTIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Base Collection Web Platform', 'pop-basecollection-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-basecollection-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-basecollection-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_BASECOLLECTIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

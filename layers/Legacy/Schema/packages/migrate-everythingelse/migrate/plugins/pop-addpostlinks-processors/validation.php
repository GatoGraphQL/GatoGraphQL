...
define('POP_ADDPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_ADDPOSTLINKSPROCESSORS_POP_ADDPOSTLINKS_MIN_VERSION', 0.1);

class PoP_AddPostLinksProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_ADDPOSTLINKS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDPOSTLINKSPROCESSORS_POP_ADDPOSTLINKS_MIN_VERSION > POP_ADDPOSTLINKS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Post Links Processors', 'pop-addpostlinks-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addpostlinks-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addpostlinks-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Post Links Processors', 'pop-addpostlinks-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Coauthors', 'pop-addpostlinks-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Coauthors', 'pop-addpostlinks-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDPOSTLINKSPROCESSORS_POP_ADDPOSTLINKS_MIN_VERSION
        );
    }

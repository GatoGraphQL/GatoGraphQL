...
define('POP_SYSTEM_POP_ENGINE_MIN_VERSION', 0.1);
...
class PoP_System_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SYSTEM_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP System', 'pop-system'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-system')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-system'),
            'https://github.com/leoloso/PoP',
            POP_SYSTEM_POP_ENGINE_MIN_VERSION
        );
    }

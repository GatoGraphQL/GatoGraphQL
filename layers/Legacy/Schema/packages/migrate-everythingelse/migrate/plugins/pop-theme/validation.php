...
define('POP_THEME_POP_ENGINE_MIN_VERSION', 0.1);

class PoP_Theme_Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_THEME_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Theme', 'pop-theme')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Theme', 'pop-theme'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-theme')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-theme'),
            'https://github.com/leoloso/PoP',
            POP_THEME_POP_ENGINE_MIN_VERSION
        );
    }

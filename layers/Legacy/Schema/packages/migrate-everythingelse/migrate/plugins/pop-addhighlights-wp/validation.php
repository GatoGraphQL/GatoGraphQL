...
define('POP_ADDHIGHLIGHTSWP_POP_ADDHIGHLIGHTS_MIN_VERSION', 0.1);

class PoP_AddHighlightsWP_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ADDHIGHLIGHTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDHIGHLIGHTSWP_POP_ADDHIGHLIGHTS_MIN_VERSION > POP_ADDHIGHLIGHTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights WordPress', 'pop-addhighlights-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights', 'pop-addhighlights-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights', 'pop-addhighlights-wp'),
            'https://github.com/leoloso/PoP',
            POP_ADDHIGHLIGHTSWP_POP_ADDHIGHLIGHTS_MIN_VERSION
        );
    }

 ...
 * navigation.php
 */
\PoP\Root\App::addFilter('route:icon', 'popLocationpostscreationRouteIcon', 10, 3);
...
\PoP\Root\App::addFilter('route:title', 'popLocationpostscreationNavigationRouteTitle', 10, 2);

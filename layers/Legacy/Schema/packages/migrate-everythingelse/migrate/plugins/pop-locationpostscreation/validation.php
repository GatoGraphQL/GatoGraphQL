...
define('POP_LOCATIONPOSTSCREATION_POP_LOCATIONPOSTS_MIN_VERSION', 0.1);
define('POP_LOCATIONPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION', 0.1);

class PoP_LocationPostsCreation_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_LOCATIONPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSCREATION_POP_LOCATIONPOSTS_MIN_VERSION > POP_LOCATIONPOSTS_VERSION) {
        ...
        if (!defined('POP_POSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION > POP_POSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation', 'pop-locationpostscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Location Posts', 'pop-locationpostscreation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Location Posts', 'pop-locationpostscreation'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSCREATION_POP_LOCATIONPOSTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Location Posts Creation', 'pop-locationpostscreation'),
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-locationpostscreation')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Creation', 'pop-locationpostscreation'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONPOSTSCREATION_POP_POSTSCREATION_MIN_VERSION
        );
    }

...
class PoP_NoSearchCategoryPosts_Module_Processor_Scrolls extends PoP_Module_Processor_ScrollsBase
{
    ...
    {
        return array(
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS00_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS01_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS02_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS03_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS04_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS05_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS06_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS07_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS08_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS09_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS10_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS11_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS12_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS13_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS14_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS15_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS16_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS17_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS18_SIMPLEVIEW,
            self::COMPONENT_SCROLL_NOSEARCHCATEGORYPOSTS19_SIMPLEVIEW,
        );
    }

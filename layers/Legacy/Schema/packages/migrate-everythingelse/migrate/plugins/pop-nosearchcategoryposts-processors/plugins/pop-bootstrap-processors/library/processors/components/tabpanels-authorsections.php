...
class NSCPP_Module_Processor_AuthorSectionTabPanelComponents extends PoP_Module_Processor_AuthorSectionTabPanelComponentsBase
{
    ...
    {
        return array(
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS00,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS01,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS02,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS03,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS04,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS05,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS06,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS07,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS08,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS09,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS10,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS11,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS12,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS13,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS14,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS15,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS16,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS17,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS18,
            self::COMPONENT_TABPANEL_AUTHORNOSEARCHCATEGORYPOSTS19,
        );
    }

...
define('POP_NOSEARCHCATEGORYPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_NOSEARCHCATEGORYPOSTSPROCESSORS_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION', 0.1);

class PoP_NoSearchCategoryPostsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_NOSEARCHCATEGORYPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSPROCESSORS_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION > POP_NOSEARCHCATEGORYPOSTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Processors', 'pop-nosearchcategoryposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-nosearchcategoryposts-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-nosearchcategoryposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Processors', 'pop-nosearchcategoryposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts', 'pop-nosearchcategoryposts-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts', 'pop-nosearchcategoryposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSPROCESSORS_POP_NOSEARCHCATEGORYPOSTS_MIN_VERSION
        );
    }

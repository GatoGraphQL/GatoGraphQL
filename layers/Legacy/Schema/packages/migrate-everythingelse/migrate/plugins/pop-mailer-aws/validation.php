...
define('POPMAILERAWS_POP_AWS_MIN_VERSION', 0.1);
...
class PoP_Mailer_AWS_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_AWS_VERSION')) {
            ...
            $success = false;
        } elseif (POPMAILERAWS_POP_AWS_MIN_VERSION > POP_AWS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Mailer AWS', 'pop-mailer-aws'),
            TranslationAPIFacade::getInstance()->__('PoP AWS', 'pop-mailer-aws')
        );
    }

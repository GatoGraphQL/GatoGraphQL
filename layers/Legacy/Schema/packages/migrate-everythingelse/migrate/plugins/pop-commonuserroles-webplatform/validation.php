...
define('POP_COMMONUSERROLESWEBPLATFORM_POP_COMMONUSERROLES_MIN_VERSION', 0.1);
define('POP_COMMONUSERROLESWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_CommonUserRolesWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_COMMONUSERROLES_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_COMMONUSERROLES_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_COMMONUSERROLESWEBPLATFORM_POP_COMMONUSERROLES_MIN_VERSION > POP_COMMONUSERROLES_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_COMMONUSERROLESWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Common User Roles Web Platform', 'pop-commonuserroles-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Common User Roles', 'pop-commonuserroles-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Common User Roles', 'pop-commonuserroles-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_COMMONUSERROLESWEBPLATFORM_POP_COMMONUSERROLES_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Common User Roles Web Platform', 'pop-commonuserroles-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-commonuserroles-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-commonuserroles-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_COMMONUSERROLESWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

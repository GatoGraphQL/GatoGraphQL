...
define('POP_MULTIDOMAINSPARESOURCELOADER_POP_MULTIDOMAIN_MIN_VERSION', 0.1);
define('POP_MULTIDOMAINSPARESOURCELOADER_POP_SPARESOURCELOADER_MIN_VERSION', 0.1);

class PoP_MultiDomainSPAResourceLoader_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_MULTIDOMAIN_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_MULTIDOMAIN_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_MULTIDOMAINSPARESOURCELOADER_POP_MULTIDOMAIN_MIN_VERSION > POP_MULTIDOMAIN_VERSION) {
        ...
        if (!defined('POP_SPARESOURCELOADER_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_SPARESOURCELOADER_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_MULTIDOMAINSPARESOURCELOADER_POP_SPARESOURCELOADER_MIN_VERSION > POP_SPARESOURCELOADER_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Multidomain for SPA Resource Loader', 'pop-multidomain-sparesourceloader'),
            TranslationAPIFacade::getInstance()->__('PoP Multidomain', 'pop-multidomain-sparesourceloader')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Multidomain', 'pop-multidomain-sparesourceloader'),
            'https://github.com/leoloso/PoP',
            POP_MULTIDOMAINSPARESOURCELOADER_POP_MULTIDOMAIN_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Multidomain for SPA Resource Loader', 'pop-multidomain-sparesourceloader'),
            TranslationAPIFacade::getInstance()->__('PoP SPA Resource Loader', 'pop-multidomain-sparesourceloader')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP SPA Resource Loader', 'pop-multidomain-sparesourceloader'),
            'https://github.com/leoloso/PoP',
            POP_MULTIDOMAINSPARESOURCELOADER_POP_SPARESOURCELOADER_MIN_VERSION
        );
    }

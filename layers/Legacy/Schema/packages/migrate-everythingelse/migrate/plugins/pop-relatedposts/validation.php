...
define('POP_RELATEDPOSTS_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_RelatedPosts_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_RELATEDPOSTS_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Related Posts', 'pop-relatedposts'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-relatedposts')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-relatedposts'),
            'https://github.com/leoloso/PoP',
            POP_RELATEDPOSTS_POP_APPLICATION_MIN_VERSION
        );
    }

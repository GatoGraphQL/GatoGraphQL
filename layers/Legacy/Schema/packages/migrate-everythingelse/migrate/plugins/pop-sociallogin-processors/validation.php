...
define('POP_SOCIALLOGINPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_SOCIALLOGINPROCESSORS_POP_SOCIALLOGIN_MIN_VERSION', 0.1);

class PoP_SocialLoginProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SOCIALLOGINPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_SOCIALLOGIN_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SOCIALLOGINPROCESSORS_POP_SOCIALLOGIN_MIN_VERSION > POP_SOCIALLOGIN_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Social Login Processors', 'wsl-popprocessors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'wsl-popprocessors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'wsl-popprocessors'),
            'https://github.com/leoloso/PoP',
            POP_SOCIALLOGINPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Social Login Processors', 'wsl-popprocessors'),
            TranslationAPIFacade::getInstance()->__('PoP Social Login', 'wsl-popprocessors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Social Login', 'wsl-popprocessors'),
            'https://github.com/leoloso/PoP',
            POP_SOCIALLOGINPROCESSORS_POP_SOCIALLOGIN_MIN_VERSION
        );
    }

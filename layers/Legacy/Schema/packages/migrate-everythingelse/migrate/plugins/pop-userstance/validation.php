...
define('POP_USERSTANCE_POP_ADDRELATEDPOSTS_MIN_VERSION', 0.1);

class PoP_UserStance_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ADDRELATEDPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERSTANCE_POP_ADDRELATEDPOSTS_MIN_VERSION > POP_ADDRELATEDPOSTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Stance', 'pop-userstance'),
            TranslationAPIFacade::getInstance()->__('PoP Add Related Posts', 'pop-userstance')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Related Posts', 'pop-userstance'),
            'https://github.com/leoloso/PoP',
            POP_USERSTANCE_POP_ADDRELATEDPOSTS_MIN_VERSION
        );
    }

...
define('POP_MASTERCOLLECTIONPROCESSORS_POP_BASECOLLECTIONPROCESSORS_MIN_VERSION', 0.1);

class PoP_MasterCollectionProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_BASECOLLECTIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_MASTERCOLLECTIONPROCESSORS_POP_BASECOLLECTIONPROCESSORS_MIN_VERSION > POP_BASECOLLECTIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Master Collection Processors', 'pop-mastercollection-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Base Collection Processors', 'pop-mastercollection-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Base Collection Processors', 'pop-mastercollection-processors'),
            'https://github.com/leoloso/PoP',
            POP_MASTERCOLLECTIONPROCESSORS_POP_BASE_MIN_VERSION
        );
    }

...
class PoP_HTMLCSSPlatform_ConfigurationUtils
{
    ...
    {
        return \PoP\Root\App::getHookManager()->applyFilters('pop_modulemanager:multilayout_labels', array());
    }
    ...
    public static function getStatusSettings()
    {
        ...
        return \PoP\Root\App::getHookManager()->applyFilters('pop_modulemanager:status_settings', $status);
    }
    ...
    public static function getLabelizeClasses()
    {
        ...
        return \PoP\Root\App::getHookManager()->applyFilters('pop_modulemanager:labelize_classes', $labelize_classes);
    }

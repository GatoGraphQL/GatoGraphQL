...
class PoPHTMLCSSPlatform_Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_CONFIGURATIONCOMPONENTMODEL_VERSION')) {
            HooksAPIFacade::getInstance()->addAction('admin_notices', array($this, 'installWarning_2'));
            HooksAPIFacade::getInstance()->addAction('network_admin_notices', array($this, 'installWarning_2'));
            $success = false;
        } elseif (!defined('POP_CONFIGURATIONCOMPONENTMODEL_INITIALIZED')) {
            HooksAPIFacade::getInstance()->addAction('admin_notices', array($this, 'initializeWarning_2'));
            HooksAPIFacade::getInstance()->addAction('network_admin_notices', array($this, 'initializeWarning_2'));
            $success = false;
        } elseif (POP_ENGINEHTMLCSSPLATFORM_POP_CONFIGURATIONCOMPONENTMODEL_MIN_VERSION > POP_CONFIGURATIONCOMPONENTMODEL_VERSION) {
            HooksAPIFacade::getInstance()->addAction('admin_notices', array($this, 'versionWarning_2'));
            HooksAPIFacade::getInstance()->addAction('network_admin_notices', array($this, 'versionWarning_2'));
        }

        if (!defined('POP_PLATFORM_VERSION')) {
            HooksAPIFacade::getInstance()->addAction('admin_notices', array($this, 'installWarning_3'));
            HooksAPIFacade::getInstance()->addAction('network_admin_notices', array($this, 'installWarning_3'));
            $success = false;
        } elseif (!defined('POP_PLATFORM_INITIALIZED')) {
            HooksAPIFacade::getInstance()->addAction('admin_notices', array($this, 'initializeWarning_3'));
            HooksAPIFacade::getInstance()->addAction('network_admin_notices', array($this, 'initializeWarning_3'));
            $success = false;
        } elseif (POP_ENGINEHTMLCSSPLATFORM_POP_PLATFORM_MIN_VERSION > POP_PLATFORM_VERSION) {
            HooksAPIFacade::getInstance()->addAction('admin_notices', array($this, 'versionWarning_3'));
            HooksAPIFacade::getInstance()->addAction('network_admin_notices', array($this, 'versionWarning_3'));
        }

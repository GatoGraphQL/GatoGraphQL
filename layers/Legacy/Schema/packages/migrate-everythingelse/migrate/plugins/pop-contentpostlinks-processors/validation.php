...
define('POP_CONTENTPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_CONTENTPOSTLINKSPROCESSORS_POP_CONTENTPOSTLINKS_MIN_VERSION', 0.1);

class PoP_ContentPostLinksProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_CONTENTPOSTLINKS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTPOSTLINKSPROCESSORS_POP_CONTENTPOSTLINKS_MIN_VERSION > POP_CONTENTPOSTLINKS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Processors', 'pop-contentpostlinks-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-contentpostlinks-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-contentpostlinks-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTPOSTLINKSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Processors', 'pop-contentpostlinks-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-contentpostlinks-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-contentpostlinks-processors'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTPOSTLINKSPROCESSORS_POP_CONTENTPOSTLINKS_MIN_VERSION
        );
    }

...
define('POP_ADDRELATEDPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_ADDRELATEDPOSTSPROCESSORS_POP_ADDRELATEDPOSTS_MIN_VERSION', 0.1);

class PoP_AddRelatedPostsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDRELATEDPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_ADDRELATEDPOSTS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_ADDRELATEDPOSTS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_ADDRELATEDPOSTSPROCESSORS_POP_ADDRELATEDPOSTS_MIN_VERSION > POP_ADDRELATEDPOSTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Related Posts Processors', 'pop-addrelatedposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addrelatedposts-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-addrelatedposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDRELATEDPOSTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Related Posts Processors', 'pop-addrelatedposts-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Related Posts', 'pop-addrelatedposts-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Related Posts', 'pop-addrelatedposts-processors'),
            'https://github.com/leoloso/PoP',
            POP_ADDRELATEDPOSTSPROCESSORS_POP_ADDRELATEDPOSTS_MIN_VERSION
        );
    }

...
define('POP_ADDCOMMENTSWEBPLATFORM_POP_ADDCOMMENTS_MIN_VERSION', 0.1);
define('POP_ADDCOMMENTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_AddCommentsWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ADDCOMMENTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDCOMMENTSWEBPLATFORM_POP_ADDCOMMENTS_MIN_VERSION > POP_ADDCOMMENTS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDCOMMENTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Comments Web Platform', 'pop-addcomments-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Add Comments', 'pop-addcomments-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Comments', 'pop-addcomments-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_ADDCOMMENTSWEBPLATFORM_POP_ADDCOMMENTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Comments Web Platform', 'pop-addcomments-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-addcomments-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-addcomments-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_ADDCOMMENTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

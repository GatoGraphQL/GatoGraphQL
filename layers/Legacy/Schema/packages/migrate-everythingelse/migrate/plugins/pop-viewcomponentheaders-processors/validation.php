...
define('POP_VIEWCOMPONENTHEADERSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);

class PoP_ViewcomponentHeadersProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_VIEWCOMPONENTHEADERSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Viewcomponent Headers for PoP Processors', 'pop-viewcomponentheaders-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-viewcomponentheaders-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-viewcomponentheaders-processors'),
            'https://github.com/leoloso/PoP',
            POP_VIEWCOMPONENTHEADERSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }

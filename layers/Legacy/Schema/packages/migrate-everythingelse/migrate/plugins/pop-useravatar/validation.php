...
define('UAPOP_POP_USERPLATFORM_MIN_VERSION', 0.1);
define('UAPOP_POP_AVATAR_MIN_VERSION', 0.1);
...
class PoP_UserAvatar_Validation
{
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Avatar', 'pop-useravatar'),
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-useravatar')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-useravatar'),
            'https://github.com/leoloso/PoP',
            UAPOP_POP_USERPLATFORM_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Avatar', 'pop-useravatar'),
            TranslationAPIFacade::getInstance()->__('PoP Avatar', 'pop-useravatar')
        );
    }

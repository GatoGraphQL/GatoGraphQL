...
define('POP_CDNWP_POP_CDN_MIN_VERSION', 0.1);

class PoP_CDNWP_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_CDN_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CDNWP_POP_CDN_MIN_VERSION > POP_CDN_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP CDN WordPress', 'pop-cdn-wp'),
            TranslationAPIFacade::getInstance()->__('PoP CDN', 'pop-cdn-wp')
        );
    }

...
\PoP\Root\App::addFilter('pop_componentVariationmanager:pathstartpos', 'gdQtransPathstartpos');
...
\PoP\Root\App::addFilter('pop_componentVariationmanager:locale', 'popQtransLocale');
...
\PoP\Root\App::addFilter('pop_componentVariationmanager:homelocale_url', 'popQtransHomelocaleUrl');

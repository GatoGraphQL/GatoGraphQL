...
define('POP_ADDLOCATIONS_POP_LOCATIONS_MIN_VERSION', 0.1);
define('POP_ADDLOCATIONS_POP_USERPLATFORM_MIN_VERSION', 0.1);

class PoP_AddLocations_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_LOCATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDLOCATIONS_POP_LOCATIONS_MIN_VERSION > POP_LOCATIONS_VERSION) {
        ...
        if (!defined('POP_USERPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDLOCATIONS_POP_USERPLATFORM_MIN_VERSION > POP_USERPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Locations', 'pop-addlocations'),
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-addlocations')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-addlocations'),
            'https://github.com/leoloso/PoP',
            POP_ADDLOCATIONS_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Locations', 'pop-socialnetwork'),
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-socialnetwork'),
            'https://github.com/leoloso/PoP',
            POP_ADDLOCATIONS_POP_USERPLATFORM_MIN_VERSION
        );
    }

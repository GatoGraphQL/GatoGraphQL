 ...
 * navigation.php
 */
\PoP\Root\App::getHookManager()->addFilter('route:icon', 'popAddlocationsRouteIcon', 10, 3);
...
\PoP\Root\App::getHookManager()->addFilter('route:title', 'popAddlocationsNavigationRouteTitle', 10, 2);

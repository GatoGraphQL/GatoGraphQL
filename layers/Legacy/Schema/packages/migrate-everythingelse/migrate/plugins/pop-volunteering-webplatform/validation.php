...
define('POP_VOLUNTEERINGWEBPLATFORM_POP_VOLUNTEERING_MIN_VERSION', 0.1);
define('POP_VOLUNTEERINGWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_VolunteeringWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_VOLUNTEERING_VERSION')) {
            ...
            $success = false;
        } elseif (POP_VOLUNTEERINGWEBPLATFORM_POP_VOLUNTEERING_MIN_VERSION > POP_VOLUNTEERING_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_VOLUNTEERINGWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Volunteering Web Platform', 'pop-volunteering-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Volunteering', 'pop-volunteering-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Volunteering', 'pop-volunteering-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_VOLUNTEERINGWEBPLATFORM_POP_VOLUNTEERING_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Volunteering Web Platform', 'pop-volunteering-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-volunteering-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-volunteering-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_VOLUNTEERINGWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

...
define('POP_ADDHIGHLIGHTSWEBPLATFORM_POP_ADDHIGHLIGHTS_MIN_VERSION', 0.1);
define('POP_ADDHIGHLIGHTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_AddHighlightsWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_ADDHIGHLIGHTS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_ADDHIGHLIGHTS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_ADDHIGHLIGHTSWEBPLATFORM_POP_ADDHIGHLIGHTS_MIN_VERSION > POP_ADDHIGHLIGHTS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDHIGHLIGHTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights Web Platform', 'pop-addhighlights-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights', 'pop-addhighlights-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights', 'pop-addhighlights-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_ADDHIGHLIGHTSWEBPLATFORM_POP_ADDHIGHLIGHTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Highlights Web Platform', 'pop-addhighlights-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-addhighlights-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-addhighlights-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_ADDHIGHLIGHTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

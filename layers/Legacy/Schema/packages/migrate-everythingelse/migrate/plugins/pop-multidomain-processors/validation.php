...
define('POP_MULTIDOMAINPROCESSORS_POP_MASTERCOLLECTIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_MULTIDOMAINPROCESSORS_POP_MULTIDOMAIN_MIN_VERSION', 0.1);

class PoP_MultidomainProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_MASTERCOLLECTIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_MULTIDOMAINPROCESSORS_POP_MASTERCOLLECTIONPROCESSORS_MIN_VERSION > POP_MASTERCOLLECTIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_MULTIDOMAIN_VERSION')) {
            ...
            $success = false;
        } elseif (POP_MULTIDOMAINPROCESSORS_POP_MULTIDOMAIN_MIN_VERSION > POP_MULTIDOMAIN_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Multidomain Processors', 'pop-multidomain-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Master Collection Processors', 'pop-multidomain-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Master Collection Processors', 'pop-multidomain-processors'),
            'https://github.com/leoloso/PoP',
            POP_MULTIDOMAINPROCESSORS_POP_MASTERCOLLECTIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Multidomain Processors', 'pop-multidomain-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Multidomain', 'pop-multidomain-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Multidomain', 'pop-multidomain-processors'),
            'https://github.com/leoloso/PoP',
            POP_MULTIDOMAINPROCESSORS_POP_MULTIDOMAIN_MIN_VERSION
        );
    }

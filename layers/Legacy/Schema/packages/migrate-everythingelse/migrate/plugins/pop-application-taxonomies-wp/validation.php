...
define('POP_APPLICATIONTAXONOMIESWP_POP_ENGINEWP_MIN_VERSION', 0.1);
...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_APPLICATIONTAXONOMIESWP_POP_ENGINEWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP ApplicationTaxonomies for WordPress', 'pop-application-taxonomies-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-application-taxonomies-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-application-taxonomies-wp'),
            'https://github.com/leoloso/PoP',
            POP_APPLICATIONTAXONOMIESWP_POP_ENGINEWP_MIN_VERSION
        );
    }

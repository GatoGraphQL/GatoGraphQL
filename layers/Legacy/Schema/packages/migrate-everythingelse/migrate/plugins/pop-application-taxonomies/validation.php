...
class Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_APPLICATIONTAXONOMIES_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP ApplicationTaxonomies', 'pop-application-taxonomies')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP ApplicationTaxonomies', 'pop-application-taxonomies'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-application-taxonomies')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-application-taxonomies'),
            'https://github.com/leoloso/PoP',
            POP_APPLICATIONTAXONOMIES_POP_ENGINE_MIN_VERSION
        );
    }

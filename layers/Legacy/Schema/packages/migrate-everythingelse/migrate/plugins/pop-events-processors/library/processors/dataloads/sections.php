...
class PoP_Events_Module_Processor_CustomSectionDataloads extends PoP_Module_Processor_SectionDataloadsBase
{
    ...
    public final const COMPONENT_DATALOAD_EVENTS_TYPEAHEAD = 'dataload-events-typeahead';
    public final const COMPONENT_DATALOAD_PASTEVENTS_TYPEAHEAD = 'dataload-pastevents-typeahead';
    public final const COMPONENT_DATALOAD_PASTEVENTS_SCROLL_NAVIGATOR = 'dataload-pastevents-scroll-navigator';
    public final const COMPONENT_DATALOAD_EVENTS_SCROLL_NAVIGATOR = 'dataload-events-scroll-navigator';
    public final const COMPONENT_DATALOAD_EVENTSCALENDAR_CALENDAR_NAVIGATOR = 'dataload-eventscalendar-calendar-navigator';
    public final const COMPONENT_DATALOAD_PASTEVENTS_SCROLL_ADDONS = 'dataload-pastevents-scroll-addons';
    public final const COMPONENT_DATALOAD_EVENTS_SCROLL_ADDONS = 'dataload-events-scroll-addons';
    public final const COMPONENT_DATALOAD_EVENTSCALENDAR_CALENDAR_ADDONS = 'dataload-eventscalendar-calendar-addons';
    public final const COMPONENT_DATALOAD_EVENTS_SCROLL_DETAILS = 'dataload-events-scroll-details';
    public final const COMPONENT_DATALOAD_PASTEVENTS_SCROLL_DETAILS = 'dataload-pastevents-scroll-details';
    public final const COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_DETAILS = 'dataload-authorevents-scroll-details';
    public final const COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_DETAILS = 'dataload-authorpastevents-scroll-details';
    public final const COMPONENT_DATALOAD_TAGEVENTS_SCROLL_DETAILS = 'dataload-tagevents-scroll-details';
    public final const COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_DETAILS = 'dataload-tagpastevents-scroll-details';
    public final const COMPONENT_DATALOAD_EVENTS_SCROLL_SIMPLEVIEW = 'dataload-events-scroll-simpleview';
    public final const COMPONENT_DATALOAD_PASTEVENTS_SCROLL_SIMPLEVIEW = 'dataload-pastevents-scroll-simpleview';
    public final const COMPONENT_DATALOAD_EVENTS_SCROLL_FULLVIEW = 'dataload-events-scroll-fullview';
    public final const COMPONENT_DATALOAD_PASTEVENTS_SCROLL_FULLVIEW = 'dataload-pastevents-scroll-fullview';
    public final const COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_SIMPLEVIEW = 'dataload-authorevents-scroll-simpleview';
    public final const COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_SIMPLEVIEW = 'dataload-authorpastevents-scroll-simpleview';
    public final const COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_FULLVIEW = 'dataload-authorevents-scroll-fullview';
    public final const COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_FULLVIEW = 'dataload-authorpastevents-scroll-fullview';
    public final const COMPONENT_DATALOAD_TAGEVENTS_SCROLL_SIMPLEVIEW = 'dataload-tagevents-scroll-simpleview';
    public final const COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_SIMPLEVIEW = 'dataload-tagpastevents-scroll-simpleview';
    public final const COMPONENT_DATALOAD_TAGEVENTS_SCROLL_FULLVIEW = 'dataload-tagevents-scroll-fullview';
    public final const COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_FULLVIEW = 'dataload-tagpastevents-scroll-fullview';
    public final const COMPONENT_DATALOAD_EVENTS_SCROLL_THUMBNAIL = 'dataload-events-scroll-thumbnail';
    public final const COMPONENT_DATALOAD_PASTEVENTS_SCROLL_THUMBNAIL = 'dataload-pastevents-scroll-thumbnail';
    public final const COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_THUMBNAIL = 'dataload-authorevents-scroll-thumbnail';
    public final const COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_THUMBNAIL = 'dataload-authorpastevents-scroll-thumbnail';
    public final const COMPONENT_DATALOAD_TAGEVENTS_SCROLL_THUMBNAIL = 'dataload-tagevents-scroll-thumbnail';
    public final const COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_THUMBNAIL = 'dataload-tagpastevents-scroll-thumbnail';
    public final const COMPONENT_DATALOAD_EVENTS_SCROLL_LIST = 'dataload-events-scroll-list';
    public final const COMPONENT_DATALOAD_PASTEVENTS_SCROLL_LIST = 'dataload-pastevents-scroll-list';
    public final const COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_LIST = 'dataload-authorevents-scroll-list';
    public final const COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_LIST = 'dataload-authorpastevents-scroll-list';
    public final const COMPONENT_DATALOAD_TAGEVENTS_SCROLL_LIST = 'dataload-tagevents-scroll-list';
    public final const COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_LIST = 'dataload-tagpastevents-scroll-list';
    public final const COMPONENT_DATALOAD_EVENTSCALENDAR_CALENDARMAP = 'dataload-eventscalendar-calendarmap';
    public final const COMPONENT_DATALOAD_AUTHOREVENTSCALENDAR_CALENDARMAP = 'dataload-authoreventscalendar-calendarmap';
    public final const COMPONENT_DATALOAD_TAGEVENTSCALENDAR_CALENDARMAP = 'dataload-tageventscalendar-calendarmap';
    public final const COMPONENT_DATALOAD_EVENTSCALENDAR_CALENDAR = 'dataload-eventscalendar-calendar';
    public final const COMPONENT_DATALOAD_AUTHOREVENTSCALENDAR_CALENDAR = 'dataload-authoreventscalendar-calendar';
    public final const COMPONENT_DATALOAD_TAGEVENTSCALENDAR_CALENDAR = 'dataload-tageventscalendar-calendar';
    public final const COMPONENT_DATALOAD_EVENTS_CAROUSEL = 'dataload-events-carousel';
    ...
    {
        return array(
            self::COMPONENT_DATALOAD_EVENTS_TYPEAHEAD,
            self::COMPONENT_DATALOAD_PASTEVENTS_TYPEAHEAD,
            self::COMPONENT_DATALOAD_PASTEVENTS_SCROLL_NAVIGATOR,
            self::COMPONENT_DATALOAD_EVENTS_SCROLL_NAVIGATOR,
            self::COMPONENT_DATALOAD_EVENTSCALENDAR_CALENDAR_NAVIGATOR,
            self::COMPONENT_DATALOAD_PASTEVENTS_SCROLL_ADDONS,
            self::COMPONENT_DATALOAD_EVENTS_SCROLL_ADDONS,
            self::COMPONENT_DATALOAD_EVENTSCALENDAR_CALENDAR_ADDONS,
            self::COMPONENT_DATALOAD_EVENTS_SCROLL_DETAILS,
            self::COMPONENT_DATALOAD_PASTEVENTS_SCROLL_DETAILS,
            self::COMPONENT_DATALOAD_EVENTS_SCROLL_SIMPLEVIEW,
            self::COMPONENT_DATALOAD_PASTEVENTS_SCROLL_SIMPLEVIEW,
            self::COMPONENT_DATALOAD_EVENTS_SCROLL_FULLVIEW,
            self::COMPONENT_DATALOAD_PASTEVENTS_SCROLL_FULLVIEW,
            self::COMPONENT_DATALOAD_EVENTS_SCROLL_THUMBNAIL,
            self::COMPONENT_DATALOAD_PASTEVENTS_SCROLL_THUMBNAIL,
            self::COMPONENT_DATALOAD_EVENTS_SCROLL_LIST,
            self::COMPONENT_DATALOAD_PASTEVENTS_SCROLL_LIST,
            self::COMPONENT_DATALOAD_EVENTSCALENDAR_CALENDARMAP,
            self::COMPONENT_DATALOAD_EVENTSCALENDAR_CALENDAR,

            self::COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_DETAILS,
            self::COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_DETAILS,
            self::COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_SIMPLEVIEW,
            self::COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_SIMPLEVIEW,
            self::COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_FULLVIEW,
            self::COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_FULLVIEW,
            self::COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_THUMBNAIL,
            self::COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_THUMBNAIL,
            self::COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_LIST,
            self::COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_LIST,
            self::COMPONENT_DATALOAD_AUTHOREVENTSCALENDAR_CALENDARMAP,
            self::COMPONENT_DATALOAD_AUTHOREVENTSCALENDAR_CALENDAR,

            self::COMPONENT_DATALOAD_TAGEVENTS_SCROLL_DETAILS,
            self::COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_DETAILS,
            self::COMPONENT_DATALOAD_TAGEVENTS_SCROLL_SIMPLEVIEW,
            self::COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_SIMPLEVIEW,
            self::COMPONENT_DATALOAD_TAGEVENTS_SCROLL_FULLVIEW,
            self::COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_FULLVIEW,
            self::COMPONENT_DATALOAD_TAGEVENTS_SCROLL_THUMBNAIL,
            self::COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_THUMBNAIL,
            self::COMPONENT_DATALOAD_TAGEVENTS_SCROLL_LIST,
            self::COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_LIST,
            self::COMPONENT_DATALOAD_TAGEVENTSCALENDAR_CALENDARMAP,
            self::COMPONENT_DATALOAD_TAGEVENTSCALENDAR_CALENDAR,

            self::COMPONENT_DATALOAD_EVENTS_CAROUSEL,
            self::COMPONENT_DATALOAD_AUTHOREVENTS_CAROUSEL,
            self::COMPONENT_DATALOAD_TAGEVENTS_CAROUSEL,
        );
    }
    ...
    protected function getPostmapInnerComponent(\PoP\ComponentModel\Component\Component $component)
    {
    ...
    public function getInnerSubcomponent(\PoP\ComponentModel\Component\Component $component)
    {
        ...
        *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
            ...
            self::COMPONENT_DATALOAD_AUTHOREVENTS_SCROLL_SIMPLEVIEW => [PoP_Events_Module_Processor_CustomScrolls::class, PoP_Events_Module_Processor_CustomScrolls::COMPONENT_SCROLL_EVENTS_SIMPLEVIEW],//self::COMPONENT_SCROLL_AUTHOREVENTS_SIMPLEVIEW,
            self::COMPONENT_DATALOAD_AUTHORPASTEVENTS_SCROLL_SIMPLEVIEW => [PoP_Events_Module_Processor_CustomScrolls::class, PoP_Events_Module_Processor_CustomScrolls::COMPONENT_SCROLL_PASTEVENTS_SIMPLEVIEW],//self::COMPONENT_SCROLL_AUTHORPASTEVENTS_SIMPLEVIEW,
        ...
        *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
            ...
            self::COMPONENT_DATALOAD_TAGEVENTS_SCROLL_SIMPLEVIEW => [PoP_Events_Module_Processor_CustomScrolls::class, PoP_Events_Module_Processor_CustomScrolls::COMPONENT_SCROLL_EVENTS_SIMPLEVIEW],//self::COMPONENT_SCROLL_AUTHOREVENTS_SIMPLEVIEW,
            self::COMPONENT_DATALOAD_TAGPASTEVENTS_SCROLL_SIMPLEVIEW => [PoP_Events_Module_Processor_CustomScrolls::class, PoP_Events_Module_Processor_CustomScrolls::COMPONENT_SCROLL_PASTEVENTS_SIMPLEVIEW],//self::COMPONENT_SCROLL_AUTHORPASTEVENTS_SIMPLEVIEW,

...
define('POP_EVENTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_EVENTSPROCESSORS_POP_EVENTS_MIN_VERSION', 0.1);

class PoP_EventsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_EVENTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSPROCESSORS_POP_EVENTS_MIN_VERSION > POP_EVENTS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Processors', 'pop-events-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-events-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-events-processors'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Processors', 'pop-events-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events-processors'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSPROCESSORS_POP_EVENTS_MIN_VERSION
        );
    }

...
define('PTWAE_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);
define('PTWAE_POP_COMMONAUTOMATEDEMAILS_MIN_VERSION', 0.1);

class PoP_CommonAutomatedEmailsWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (PTWAE_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
        ...
        if (!defined('POP_COMMONAUTOMATEDEMAILS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_COMMONAUTOMATEDEMAILS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (PTWAE_POP_COMMONAUTOMATEDEMAILS_MIN_VERSION > POP_COMMONAUTOMATEDEMAILS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Common Automated Emails for PoP', 'pop-commonautomatedemails-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-commonautomatedemails-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-commonautomatedemails-webplatform'),
            'https://github.com/leoloso/PoP',
            PTWAE_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Common Automated Emails for PoP', 'pop-commonautomatedemails-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Common Automated Emails', 'pop-commonautomatedemails-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Common Automated Emails', 'pop-commonautomatedemails-webplatform'),
            'https://github.com/leoloso/PoP',
            PTWAE_POP_COMMONAUTOMATEDEMAILS_MIN_VERSION
        );
    }

...
define('POPPP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);
...
class PoP_PrettyPrint_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POPPP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Pretty Print', 'pop-prettyprint'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-prettyprint')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-prettyprint'),
            'https://github.com/leoloso/PoP',
            POPPP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

...
define('POP_CDNFOUNDATION_POP_ENGINE_MIN_VERSION', 0.1);

class PoP_CDNFoundation_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CDNFOUNDATION_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP CDN', 'pop-cdn-foundation'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-cdn-foundation')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-cdn-foundation'),
            'https://github.com/leoloso/PoP',
            POP_CDNFOUNDATION_POP_ENGINE_MIN_VERSION
        );
    }

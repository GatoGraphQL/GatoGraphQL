...
define('POP_APPLICATIONWP_POP_APPLICATION_MIN_VERSION', 0.1);
define('POP_APPLICATIONWP_POP_CMSWP_MIN_VERSION', 0.1);

class PoP_ApplicationWP_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_APPLICATIONWP_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
        ...
        if (!defined('POP_ENGINEWP_VERSION')) {
            ...
            $success = false;
        } elseif (POP_APPLICATIONWP_POP_CMSWP_MIN_VERSION > POP_ENGINEWP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP WordPress Application', 'pop-application-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-application-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-application-wp'),
            'https://github.com/leoloso/PoP',
            POP_APPLICATIONWP_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP WordPress Application', 'pop-application-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'pop-application-wp')
        );
    }

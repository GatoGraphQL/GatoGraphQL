...
define('POP_ADDPOSTLINKS_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_AddPostLinks_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDPOSTLINKS_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Post Links', 'pop-addpostlinks'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-addpostlinks')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-addpostlinks'),
            'https://github.com/leoloso/PoP',
            POP_ADDPOSTLINKS_POP_APPLICATION_MIN_VERSION
        );
    }

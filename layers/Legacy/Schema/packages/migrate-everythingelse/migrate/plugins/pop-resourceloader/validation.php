...
define('POP_RESOURCELOADER_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_ResourceLoader_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_RESOURCELOADER_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Resource Loader', 'pop-resourceloader'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-resourceloader')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-resourceloader'),
            'https://github.com/leoloso/PoP',
            POP_RESOURCELOADER_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

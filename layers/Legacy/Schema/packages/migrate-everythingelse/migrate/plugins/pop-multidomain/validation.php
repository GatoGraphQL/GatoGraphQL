...
define('POP_MULTIDOMAIN_POP_DOMAIN_MIN_VERSION', 0.1);

class PoP_MultiDomain_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_DOMAIN_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_DOMAIN_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_MULTIDOMAIN_POP_DOMAIN_MIN_VERSION > POP_DOMAIN_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Multidomain', 'pop-multidomain'),
            TranslationAPIFacade::getInstance()->__('PoP Domain', 'pop-multidomain')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Domain', 'pop-multidomain'),
            'https://github.com/leoloso/PoP',
            POP_MULTIDOMAIN_POP_DOMAIN_MIN_VERSION
        );
    }

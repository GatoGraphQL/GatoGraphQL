...
define('POP_TRENDINGTAGSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_TRENDINGTAGSPROCESSORS_POP_TRENDINGTAGS_MIN_VERSION', 0.1);

class PoP_TrendingTagsProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TRENDINGTAGSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_TRENDINGTAGS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_TRENDINGTAGSPROCESSORS_POP_TRENDINGTAGS_MIN_VERSION > POP_TRENDINGTAGS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Trending Tags Processors', 'pop-trendingtags-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-trendingtags-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-trendingtags-processors'),
            'https://github.com/leoloso/PoP',
            POP_TRENDINGTAGSPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Trending Tags Processors', 'pop-trendingtags-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Trending Tags', 'pop-trendingtags-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Trending Tags', 'pop-trendingtags-processors'),
            'https://github.com/leoloso/PoP',
            POP_TRENDINGTAGSPROCESSORS_POP_TRENDINGTAGS_MIN_VERSION
        );
    }

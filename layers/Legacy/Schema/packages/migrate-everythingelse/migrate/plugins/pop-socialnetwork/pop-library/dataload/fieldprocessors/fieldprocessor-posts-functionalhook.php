    ...
    public function resolveValue(
        ...
        switch ($field->getName()) {
            ...
            case 'recommendPostCountPlus1':
                if ($count = $objectTypeResolver->resolveValue($object, 'recommendPostCount', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    return $count+1;
                }
                return 1;
            ...
            case 'upvotePostCountPlus1':
                if ($count = $objectTypeResolver->resolveValue($object, 'upvotePostCount', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    return $count+1;
                }
                return 1;
            ...
            case 'downvotePostCountPlus1':
                if ($count = $objectTypeResolver->resolveValue($object, 'downvotePostCount', $objectTypeFieldResolutionFeedbackStore, $options)) {
                    return $count+1;
                }
                return 1;
        }

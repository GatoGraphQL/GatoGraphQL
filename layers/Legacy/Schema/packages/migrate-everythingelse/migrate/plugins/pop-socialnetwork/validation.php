...
define('POP_SOCIALNETWORK_POP_USERPLATFORM_MIN_VERSION', 0.1);

class PoP_SocialNetwork_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SOCIALNETWORK_POP_USERPLATFORM_MIN_VERSION > POP_USERPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Social Network', 'pop-socialnetwork'),
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-socialnetwork'),
            'https://github.com/leoloso/PoP',
            POP_SOCIALNETWORK_POP_USERPLATFORM_MIN_VERSION
        );
    }

...
class PoP_SocialNetwork_EmailSender_ContentCreation_Hooks
{
    public function __construct()
    {
        ...
        //----------------------------------------------------------------------
        // User tagged
        \PoP\Root\App::addAction('PoP_Mentions:post_tags:tagged_users', $this->sendemailToUsersTaggedInPost(...), 10, 3);
        \PoP\Root\App::addAction('PoP_Mentions:comment_tags:tagged_users', $this->sendemailToUsersTaggedInComment(...), 10, 2);

        //----------------------------------------------------------------------
        // Email Notifications
        //----------------------------------------------------------------------
        // EMAILNOTIFICATIONS_SUBSCRIBEDTOPIC_CREATEDCONTENT:
        \PoP\Root\App::addAction(AbstractCreateUpdateCustomPostMutationResolver::HOOK_EXECUTE_CREATE, $this->emailnotificationsSubscribedtopicCreatedpostCreate(...), 10, 1);
        \PoP\Root\App::addAction(AbstractCreateUpdateCustomPostMutationResolver::HOOK_EXECUTE_UPDATE, $this->emailnotificationsSubscribedtopicCreatedpostUpdate(...), 10, 2);
        // EMAILNOTIFICATIONS_NETWORK_CREATEDCONTENT:
        \PoP\Root\App::addAction(AbstractCreateUpdateCustomPostMutationResolver::HOOK_EXECUTE_CREATE, $this->emailnotificationsNetworkCreatedpostCreate(...), 10, 1);
        \PoP\Root\App::addAction(AbstractCreateUpdateCustomPostMutationResolver::HOOK_EXECUTE_UPDATE, $this->emailnotificationsNetworkCreatedpostUpdate(...), 10, 2);
        ...
        \PoP\Root\App::addAction(
            ...
            $this->emailnotificationsSubscribedtopicAddedcomment(...),
            10,
            2
        );
        ...
        \PoP\Root\App::addAction(
            'wp_insert_comment',// Must add a loose contract instead: 'popcms:insertComment'
            $this->emailnotificationsNetworkAddedcomment(...),
            10,
            2
        );
        // EMAILNOTIFICATIONS_NETWORK_SUBSCRIBEDTOTOPIC:
        \PoP\Root\App::addAction('gd_subscribetotag', $this->emailnotificationsNetworkSubscribedtotopic(...), 10, 1);
    }

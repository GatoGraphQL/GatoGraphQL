...
define('POP_APPLICATIONWEBPLATFORM_POP_APPLICATION_MIN_VERSION', 0.1);
define('POP_APPLICATIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_ApplicationWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_APPLICATIONWEBPLATFORM_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_APPLICATIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-application-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-application-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-application-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_APPLICATIONWEBPLATFORM_POP_APPLICATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-application-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-application-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-application-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_APPLICATIONWEBPLATFORM_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

...
define('GADWPPOP_POP_CMSWP_MIN_VERSION', 0.1);
define('GADWPPOP_CAP_MIN_VERSION', '3.2.1');
...
class GADWP_PoP_Validation
{
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Google Analytics Dashboard for WP for PoP', 'gadwp-pop'),
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'gadwp-pop')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine for WordPress', 'gadwp-pop'),
            'https://github.com/leoloso/PoP',
            GADWPPOP_POP_CMSWP_MIN_VERSION
        );
    }
    public function pluginWarning()
    {
        $this->dependencyInstallationWarning(
            TranslationAPIFacade::getInstance()->__('Google Analytics Dashboard for WP for PoP', 'gadwp-pop'),
            TranslationAPIFacade::getInstance()->__('Google Analytics Dashboard for WP', 'gadwp-pop'),

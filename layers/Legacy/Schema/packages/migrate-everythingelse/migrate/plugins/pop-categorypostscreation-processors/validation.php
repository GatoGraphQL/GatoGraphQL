...
define('POP_CATEGORYPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_CATEGORYPOSTSCREATIONPROCESSORS_POP_CATEGORYPOSTSCREATION_MIN_VERSION', 0.1);

class PoP_CategoryPostsCreationProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_CATEGORYPOSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSCREATIONPROCESSORS_POP_CATEGORYPOSTSCREATION_MIN_VERSION > POP_CATEGORYPOSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation Processors', 'pop-categorypostscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-categorypostscreation-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-categorypostscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation Processors', 'pop-categorypostscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation', 'pop-categorypostscreation-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation', 'pop-categorypostscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSCREATIONPROCESSORS_POP_CATEGORYPOSTSCREATION_MIN_VERSION
        );
    }

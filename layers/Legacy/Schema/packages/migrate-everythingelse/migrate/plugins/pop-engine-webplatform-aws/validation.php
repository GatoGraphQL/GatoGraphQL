...
define('POP_FEEAWS_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);
define('POP_FEEAWS_POP_AWS_MIN_VERSION', 0.1);

class PoP_WebPlatformEngine_AWS_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_FEEAWS_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
        ...
        if (!defined('POP_AWS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_FEEAWS_POP_AWS_MIN_VERSION > POP_AWS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform AWS', 'pop-aws'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-aws')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-aws'),
            'https://github.com/leoloso/PoP',
            POP_FEEAWS_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform AWS', 'pop-aws'),
            TranslationAPIFacade::getInstance()->__('PoP AWS', 'pop-aws')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP AWS', 'pop-aws'),
            'https://github.com/leoloso/PoP',
            POP_FEEAWS_POP_AWS_MIN_VERSION
        );
    }

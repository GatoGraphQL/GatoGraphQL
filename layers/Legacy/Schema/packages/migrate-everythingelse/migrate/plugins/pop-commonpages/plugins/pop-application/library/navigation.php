 ...
 * navigation.php
 */
\PoP\Root\App::addFilter('page:icon', 'popwassupPageIcon', 10, 3);
...
\PoP\Root\App::addFilter('route:icon', 'popwassupRouteIcon', 10, 3);
...
\PoP\Root\App::addFilter('route:title', 'popwassupWassupNavigationRouteTitle', 10, 2);

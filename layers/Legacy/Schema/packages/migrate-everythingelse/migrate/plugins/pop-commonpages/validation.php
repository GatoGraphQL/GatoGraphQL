...
define('PTWSP_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_CommonPages_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (PTWSP_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Common Pages', 'pop-commonpages'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-commonpages')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-commonpages'),
            'https://github.com/leoloso/PoP',
            PTWSP_POP_APPLICATION_MIN_VERSION
        );
    }

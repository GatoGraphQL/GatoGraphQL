...
define('POP_SHAREWEBPLATFORM_POP_SHARE_MIN_VERSION', 0.1);
define('POP_SHAREWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_ShareWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_SHARE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SHAREWEBPLATFORM_POP_SHARE_MIN_VERSION > POP_SHARE_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SHAREWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Share Web Platform', 'pop-share-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Share', 'pop-share-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Share', 'pop-share-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_SHAREWEBPLATFORM_POP_SHARE_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Share Web Platform', 'pop-share-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-share-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-share-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_SHAREWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

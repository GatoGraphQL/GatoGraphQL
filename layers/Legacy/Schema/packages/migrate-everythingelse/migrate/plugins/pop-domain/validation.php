...
define('POP_DOMAIN_POP_ENGINEWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_Domain_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINEWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_DOMAIN_POP_ENGINEWEBPLATFORM_MIN_VERSION > POP_ENGINEWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Domain', 'pop-domain'),
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-domain')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine Web Platform', 'pop-domain'),
            'https://github.com/leoloso/PoP',
            POP_DOMAIN_POP_ENGINEWEBPLATFORM_MIN_VERSION
        );
    }

...
define('POP_FORMS_POP_ENGINE_MIN_VERSION', 0.1);

class PoP_Forms_Validation
{
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Forms', 'pop-forms'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-forms')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-forms'),
            'https://github.com/leoloso/PoP',
            POP_FORMS_POP_ENGINE_MIN_VERSION
        );
    }

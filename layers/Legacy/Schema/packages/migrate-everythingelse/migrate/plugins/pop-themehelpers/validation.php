...
// define('POP_THEMEHELPERS_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_ThemeHelpers_Validation
{
    public function validate()
    {
        ...
        //     $success = false;
        // }
        // elseif (POP_THEMEHELPERS_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    //         TranslationAPIFacade::getInstance()->__('PoP Theme Helpers', 'pop-themehelpers'),
    //         TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-themehelpers')
    //     );
    // }
    ...
    //         TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-themehelpers'),
    //         'https://github.com/leoloso/PoP',
    //         POP_THEMEHELPERS_POP_APPLICATION_MIN_VERSION
    //     );
    // }

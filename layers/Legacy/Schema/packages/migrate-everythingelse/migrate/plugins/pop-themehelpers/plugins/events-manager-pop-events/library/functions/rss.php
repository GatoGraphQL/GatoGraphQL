 ...
 */
\PoP\Root\App::addAction('em:rss2_ns', 'gdRssNamespace');
\PoP\Root\App::addAction('em:rss2_item', 'gdEmRssFeaturedImage', 10, 1);
 ...
 */
\PoP\Root\App::addFilter('gdEmRss:author', 'gdEmRssAuthor', 10, 2);

...
define('POP_EVENTSWEBPLATFORM_POP_EVENTS_MIN_VERSION', 0.1);
define('POP_EVENTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_EventsWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_EVENTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSWEBPLATFORM_POP_EVENTS_MIN_VERSION > POP_EVENTS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Web Platform', 'pop-events-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSWEBPLATFORM_POP_EVENTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Web Platform', 'pop-events-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-events-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-events-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

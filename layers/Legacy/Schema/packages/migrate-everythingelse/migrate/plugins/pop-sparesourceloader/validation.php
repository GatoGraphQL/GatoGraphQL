...
define('POP_SPARESOURCELOADER_POP_RESOURCELOADER_MIN_VERSION', 0.1);
define('POP_SPARESOURCELOADER_POP_SPAWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_SPAResourceLoader_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_RESOURCELOADER_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_RESOURCELOADER_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_SPARESOURCELOADER_POP_RESOURCELOADER_MIN_VERSION > POP_RESOURCELOADER_VERSION) {
        ...
        if (!defined('POP_SPAWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_SPAWEBPLATFORM_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_SPARESOURCELOADER_POP_SPAWEBPLATFORM_MIN_VERSION > POP_SPAWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP SPA Resource Loader', 'pop-sparesourceloader'),
            TranslationAPIFacade::getInstance()->__('PoP Resource Loader', 'pop-sparesourceloader')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Resource Loader', 'pop-sparesourceloader'),
            'https://github.com/leoloso/PoP',
            POP_SPARESOURCELOADER_POP_RESOURCELOADER_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP SPA Resource Loader', 'pop-sparesourceloader'),
            TranslationAPIFacade::getInstance()->__('PoP Single-Page Application Web Platform', 'pop-sparesourceloader')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Single-Page Application Web Platform', 'pop-sparesourceloader'),
            'https://github.com/leoloso/PoP',
            POP_SPARESOURCELOADER_POP_SPAWEBPLATFORM_MIN_VERSION
        );
    }

...
define('POP_LOCATIONSWEBPLATFORM_POP_LOCATIONS_MIN_VERSION', 0.1);
define('POP_LOCATIONSWEBPLATFORM_POP_FORMSWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_LocationsWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_LOCATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONSWEBPLATFORM_POP_LOCATIONS_MIN_VERSION > POP_LOCATIONS_VERSION) {
        ...
        if (!defined('POP_FORMSWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_LOCATIONSWEBPLATFORM_POP_FORMSWEBPLATFORM_MIN_VERSION > POP_FORMSWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Locations Web Platform', 'pop-locations-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-locations-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Locations', 'pop-locations-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONSWEBPLATFORM_POP_LOCATIONS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Locations Web Platform', 'pop-locations-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Forms Web Platform', 'pop-locations-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Forms Web Platform', 'pop-locations-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_LOCATIONSWEBPLATFORM_POP_FORMSWEBPLATFORM_MIN_VERSION
        );
    }

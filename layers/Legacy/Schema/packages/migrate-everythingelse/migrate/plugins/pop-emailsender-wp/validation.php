...
class Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_EMAILSENDER_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EMAILSENDERWP_POP_EMAILSENDER_MIN_VERSION > POP_EMAILSENDER_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP WordPress Email Sender', 'pop-emailsender-wp'),
            TranslationAPIFacade::getInstance()->__('PoP Email Sender', 'pop-emailsender-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Email Sender', 'pop-emailsender-wp'),
            'https://github.com/leoloso/PoP',
            POP_EMAILSENDERWP_POP_EMAILSENDER_MIN_VERSION
        );
    }

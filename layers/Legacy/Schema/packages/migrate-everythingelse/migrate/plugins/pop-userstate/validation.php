...
define('POP_USERSTATE_POP_ENGINE_MIN_VERSION', 0.1);

class PoP_UserState_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERSTATE_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User State', 'pop-userstate'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-userstate')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-userstate'),
            'https://github.com/leoloso/PoP',
            POP_USERSTATE_POP_ENGINE_MIN_VERSION
        );
    }

...
define('POP_EMAILSENDER_POP_APPLICATION_MIN_VERSION', 0.1);
...
class PoP_EmailSender_Validation
{
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Email Sender', 'pop-emailsender'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-emailsender')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-emailsender'),
            'https://github.com/leoloso/PoP',
            POP_EMAILSENDER_POP_APPLICATION_MIN_VERSION
        );
    }

...
define('POP_SPAPROCESSORS_POP_ENGINE_MIN_VERSION', 0.1);
define('POP_SPAPROCESSORS_POP_SPA_MIN_VERSION', 0.1);

class PoP_SPAProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SPAPROCESSORS_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
        ...
        if (!defined('POP_SPA_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_SPA_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_SPAPROCESSORS_POP_SPA_MIN_VERSION > POP_SPA_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('SPA for PoP Processors', 'pop-spa-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-spa-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-spa-processors'),
            'https://github.com/leoloso/PoP',
            POP_SPAPROCESSORS_POP_ENGINE_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('SPA for PoP Processors', 'pop-spa-processors'),
            TranslationAPIFacade::getInstance()->__('SPA for PoP', 'pop-spa-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('SPA for PoP', 'pop-spa-processors'),
            'https://github.com/leoloso/PoP',
            POP_SPAPROCESSORS_POP_SPA_MIN_VERSION
        );
    }

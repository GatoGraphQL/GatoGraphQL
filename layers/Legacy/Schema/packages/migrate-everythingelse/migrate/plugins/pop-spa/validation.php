...
define('POP_SPA_POP_ENGINE_MIN_VERSION', 0.1);

class PoP_SPA_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SPA_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Single-Page Application', 'pop-spa'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-spa')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-spa'),
            'https://github.com/leoloso/PoP',
            POP_SPA_POP_ENGINE_MIN_VERSION
        );
    }

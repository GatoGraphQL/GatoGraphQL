...
class PoP_UserLoginWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_USERLOGIN_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERLOGINWEBPLATFORM_POP_USERLOGIN_MIN_VERSION > POP_USERLOGIN_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_USERLOGINWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Login Web Platform', 'pop-userlogin-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP User Login', 'pop-userlogin-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Login', 'pop-userlogin-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERLOGINWEBPLATFORM_POP_USERLOGIN_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Login Web Platform', 'pop-userlogin-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-userlogin-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-userlogin-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_USERLOGINWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

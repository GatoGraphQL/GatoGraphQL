...
define('POP_APPLICATION_POP_ENGINE_MIN_VERSION', 0.1);

class PoP_Application_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_APPLICATION_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-application'),
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-application')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-application'),
            'https://github.com/leoloso/PoP',
            POP_APPLICATION_POP_ENGINE_MIN_VERSION
        );
    }

...
class PoP_Migrate_Events_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_EVENTS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTS_POP_EVENTS_MIN_VERSION > POP_EVENTS_VERSION) {
        ...
        if (!defined('POP_CONTENTPOSTLINKS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTS_POP_CONTENTPOSTLINKS_MIN_VERSION > POP_CONTENTPOSTLINKS_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events'),
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events'),
            'https://github.com/leoloso/PoP',
            POP_EVENTS_POP_EVENTS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events', 'pop-events'),
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-events')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-events'),
            'https://github.com/leoloso/PoP',
            POP_EVENTS_POP_CONTENTPOSTLINKS_MIN_VERSION
        );
    }

...
define('POP_CATEGORYPOSTSCREATIONWEBPLATFORM_POP_CATEGORYPOSTSCREATION_MIN_VERSION', 0.1);
define('POP_CATEGORYPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_CategoryPostsCreationWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_CATEGORYPOSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_CATEGORYPOSTSCREATION_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSCREATIONWEBPLATFORM_POP_CATEGORYPOSTSCREATION_MIN_VERSION > POP_CATEGORYPOSTSCREATION_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CATEGORYPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation Web Platform', 'pop-categorypostscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation', 'pop-categorypostscreation-webplatform')
        );
    }
    ...
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Category Posts Creation Web Platform', 'pop-categorypostscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-categorypostscreation-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-categorypostscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

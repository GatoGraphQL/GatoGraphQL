...
define('POP_NOSEARCHCATEGORYPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_NOSEARCHCATEGORYPOSTSCREATIONPROCESSORS_POP_NOSEARCHCATEGORYPOSTSCREATION_MIN_VERSION', 0.1);

class PoP_NoSearchCategoryPostsCreationProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_NOSEARCHCATEGORYPOSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_NOSEARCHCATEGORYPOSTSCREATION_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSCREATIONPROCESSORS_POP_NOSEARCHCATEGORYPOSTSCREATION_MIN_VERSION > POP_NOSEARCHCATEGORYPOSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation Processors', 'pop-nosearchcategorypostscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-nosearchcategorypostscreation-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-nosearchcategorypostscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation Processors', 'pop-nosearchcategorypostscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation', 'pop-nosearchcategorypostscreation-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation', 'pop-nosearchcategorypostscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSCREATIONPROCESSORS_POP_NOSEARCHCATEGORYPOSTSCREATION_MIN_VERSION
        );
    }

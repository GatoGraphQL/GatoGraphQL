...
define('POP_ADDLOCATIONSWEBPLATFORM_POP_ADDLOCATIONS_MIN_VERSION', 0.1);
define('POP_ADDLOCATIONSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_AddLocationsWebPlatform_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_ADDLOCATIONS_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_ADDLOCATIONS_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_ADDLOCATIONSWEBPLATFORM_POP_ADDLOCATIONS_MIN_VERSION > POP_ADDLOCATIONS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_ADDLOCATIONSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Locations Web Platform', 'pop-addlocations-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Add Locations', 'pop-addlocations-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Add Locations', 'pop-addlocations-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_ADDLOCATIONSWEBPLATFORM_POP_ADDLOCATIONS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Add Locations Web Platform', 'pop-addlocations-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-addlocations-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-addlocations-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_ADDLOCATIONSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

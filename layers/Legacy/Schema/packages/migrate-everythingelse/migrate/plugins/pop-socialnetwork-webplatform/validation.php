...
define('POP_SOCIALNETWORKWEBPLATFORM_POP_SOCIALNETWORK_MIN_VERSION', 0.1);
define('POP_SOCIALNETWORKWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_SocialNetworkWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_SOCIALNETWORK_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SOCIALNETWORKWEBPLATFORM_POP_SOCIALNETWORK_MIN_VERSION > POP_SOCIALNETWORK_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SOCIALNETWORKWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Social Network Web Platform', 'pop-socialnetwork-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Social Network', 'pop-socialnetwork-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Social Network', 'pop-socialnetwork-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_SOCIALNETWORKWEBPLATFORM_POP_SOCIALNETWORK_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Social Network Web Platform', 'pop-socialnetwork-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-socialnetwork-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-socialnetwork-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_SOCIALNETWORKWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

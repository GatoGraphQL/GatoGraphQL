...
define('POP_CONTENTPOSTLINKSWEBPLATFORM_POP_CONTENTPOSTLINKS_MIN_VERSION', 0.1);
define('POP_CONTENTPOSTLINKSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_ContentPostLinksWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_CONTENTPOSTLINKS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTPOSTLINKSWEBPLATFORM_POP_CONTENTPOSTLINKS_MIN_VERSION > POP_CONTENTPOSTLINKS_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CONTENTPOSTLINKSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Web Platform', 'pop-contentpostlinks-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-contentpostlinks-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links', 'pop-contentpostlinks-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTPOSTLINKSWEBPLATFORM_POP_CONTENTPOSTLINKS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Content Post Links Web Platform', 'pop-contentpostlinks-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-contentpostlinks-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-contentpostlinks-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CONTENTPOSTLINKSWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

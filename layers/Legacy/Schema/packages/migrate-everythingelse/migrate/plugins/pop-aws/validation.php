...
define('POP_AWS_POP_ENGINE_MIN_VERSION', 0.1);
...
class PoP_AWS_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_ENGINE_VERSION')) {
            ...
            $success = false;
        } elseif (POP_AWS_POP_ENGINE_MIN_VERSION > POP_ENGINE_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-aws')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-aws'),
            'https://github.com/leoloso/PoP',
            POP_AWS_POP_ENGINE_MIN_VERSION
        );
    }

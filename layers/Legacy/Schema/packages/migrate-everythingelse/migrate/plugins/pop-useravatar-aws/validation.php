...
define('POP_USERAVATAR_AWS_POP_USERAVATAR_MIN_VERSION', 0.1);
define('POP_USERAVATAR_AWS_POP_AVATAR_AWS_MIN_VERSION', 0.1);
...
class PoP_UserAvatar_AWS_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_AVATAR_AWS_VERSION')) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('User Avatar for PoP and AWS', 'pop-useravatar-aws'),
            TranslationAPIFacade::getInstance()->__('User Avatar for PoP', 'pop-useravatar-aws')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('User Avatar for PoP', 'pop-useravatar-aws'),
            'https://github.com/leoloso/PoP',
            POP_USERAVATAR_AWS_POP_USERAVATAR_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('User Avatar for PoP and AWS', 'pop-useravatar-aws'),
            TranslationAPIFacade::getInstance()->__('PoP Avatar AWS', 'pop-useravatar-aws')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Avatar AWS', 'pop-useravatar-aws'),
            'https://github.com/leoloso/PoP',
            POP_USERAVATAR_AWS_POP_AVATAR_AWS_MIN_VERSION
        );
    }

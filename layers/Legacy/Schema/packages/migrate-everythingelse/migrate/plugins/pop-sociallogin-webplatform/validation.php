...
define('POP_SOCIALLOGINWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);
define('POP_SOCIALLOGINWEBPLATFORM_POP_SOCIALLOGIN_MIN_VERSION', 0.1);

class PoP_SocialLoginWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_SOCIALLOGINWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
        ...
        if (!defined('POP_SOCIALLOGIN_VERSION')) {
            ...
            $success = false;
        } elseif (!defined('POP_SOCIALLOGIN_INITIALIZED')) {
            ...
            $success = false;
        } elseif (POP_SOCIALLOGINWEBPLATFORM_POP_SOCIALLOGIN_MIN_VERSION > POP_SOCIALLOGIN_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Social Login Web Platform', 'pop-sociallogin-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-sociallogin-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-sociallogin-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_SOCIALLOGINWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Social Login Web Platform', 'pop-sociallogin-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Social Login', 'pop-sociallogin-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Social Login', 'pop-sociallogin-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_SOCIALLOGINWEBPLATFORM_POP_SOCIALLOGIN_MIN_VERSION
        );
    }

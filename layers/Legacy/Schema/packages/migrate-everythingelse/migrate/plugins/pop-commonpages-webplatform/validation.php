...
define('PTWSP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);
define('PTWSP_POP_COMMONPAGES_MIN_VERSION', 0.1);

class PoP_CommonPagesWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (PTWSP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Common Pages Web Platform', 'pop-commonpages-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-commonpages-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-commonpages-webplatform'),
            'https://github.com/leoloso/PoP',
            PTWSP_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Common Pages Web Platform', 'pop-commonpages-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Common Pages', 'pop-commonpages-webplatform')
        );
    }

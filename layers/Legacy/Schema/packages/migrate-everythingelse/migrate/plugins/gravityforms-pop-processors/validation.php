...
define('GFPOPPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('GFPOPPROCESSORS_GFPOP_MIN_VERSION', 0.1);

class GFPoPProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (GFPOPPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('GFPOP_VERSION')) {
            ...
            $success = false;
        } elseif (GFPOPPROCESSORS_GFPOP_MIN_VERSION > GFPOP_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Gravity Forms for PoP Processors', 'gravityforms-pop'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'gravityforms-pop')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'gravityforms-pop'),
            'https://github.com/leoloso/PoP',
            GFPOPPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('Gravity Forms for PoP', 'gravityforms-pop'),
            'https://github.com/leoloso/PoP',
            GFPOPPROCESSORS_GFPOP_MIN_VERSION
        );
    }

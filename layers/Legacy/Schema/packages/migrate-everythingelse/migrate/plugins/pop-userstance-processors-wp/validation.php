...
define('POP_USERSTANCEPROCESSORSWP_POP_USERSTANCEPROCESSORS_MIN_VERSION', 0.1);

class PoP_UserStanceProcessorsWP_Validation
{
    public function validate()
    {
        $success = true;
        if (!defined('POP_USERSTANCEPROCESSORS_VERSION')) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP User Stance Processors WordPress', 'pop-userstance-processors-wp'),
            TranslationAPIFacade::getInstance()->__('PoP User Stance Processors', 'pop-userstance-processors-wp')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Stance Processors', 'pop-userstance-processors-wp'),
            'https://github.com/leoloso/PoP',
            POP_USERSTANCEPROCESSORSWP_POP_USERSTANCEPROCESSORS_MIN_VERSION
        );
    }

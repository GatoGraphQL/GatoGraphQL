...
define('POP_AVATARWEBPLATFORM_POP_AVATAR_MIN_VERSION', 0.1);
define('POP_AVATARWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_AvatarWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_AVATAR_VERSION')) {
            ...
            $success = false;
        } elseif (POP_AVATARWEBPLATFORM_POP_AVATAR_MIN_VERSION > POP_AVATAR_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_AVATARWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Avatar Web Platform', 'pop-avatar-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Avatar', 'pop-avatar-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Avatar', 'pop-avatar-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_AVATARWEBPLATFORM_POP_AVATAR_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Avatar Web Platform', 'pop-avatar-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-avatar-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-avatar-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_AVATARWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

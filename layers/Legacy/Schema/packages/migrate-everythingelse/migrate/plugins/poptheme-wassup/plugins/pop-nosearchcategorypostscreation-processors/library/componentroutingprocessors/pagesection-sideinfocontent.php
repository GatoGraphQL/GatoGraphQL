...
class PoPTheme_Wassup_NoSearchCategoryPostsCreation_Module_SideInfoContentPageSectionComponentRoutingProcessor extends PoP_Module_SideInfoContentPageSectionComponentRoutingProcessorBase
{
    /**
...
add_action('init', function() {
	\PoP\ComponentRouting\Facades\ComponentRoutingProcessorManagerFacade::getInstance()->addComponentRoutingProcessor(
		new PoPTheme_Wassup_NoSearchCategoryPostsCreation_Module_SideInfoContentPageSectionComponentRoutingProcessor()
	);
}, 200);

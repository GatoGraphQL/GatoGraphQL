            ...
            switch ($component[1]) {
                case self::MODULE_ENTRY_DEFAULT:
                    ...
                    if ($content_pagesection_component = $pop_component_componentroutingprocessor_manager->getRoutingComponentByMostAllMatchingStateProperties(POP_PAGEMODULEGROUP_TOPLEVEL_CONTENTPAGESECTION)) {
                        ...
                        if ($content_pagesection_component == [PoP_Module_Processor_Offcanvas::class, PoP_Module_Processor_Offcanvas::MODULE_OFFCANVAS_BODY]/* ||
                         $content_pagesection_component == [PoP_Module_Processor_TabPanes::class, PoP_Module_Processor_TabPanes::MODULE_PAGESECTION_ADDONS]*/
                        ) {
                        ...
                        if ($content_pagesection_component == [PoP_Module_Processor_Offcanvas::class, PoP_Module_Processor_Offcanvas::MODULE_OFFCANVAS_BODY]/* ||
                        $content_pagesection_component == [PoP_Module_Processor_PageSections::class, PoP_Module_Processor_PageSections::MODULE_PAGESECTION_QUICKVIEW]*/
                        ) {

...
class PoP_Events_Module_MainContentComponentRoutingProcessor extends \PoP\Application\AbstractMainContentComponentRoutingProcessor
{
    ...
    public function getStatePropertiesToSelectComponentByNatureAndRoute(): array
    {
        ...
        foreach ($routemodules_calendar as $route => $componentVariation) {
            $ret[RequestNature::GENERIC][$route][] = [
                'component-variation' => $componentVariation,
                'conditions' => [
        ...
        foreach ($routemodules_calendar_map as $route => $componentVariation) {
            $ret[RequestNature::GENERIC][$route][] = [
                'component-variation' => $componentVariation,
                'conditions' => [
        ...
        foreach ($routemodules_calendarmap as $route => $componentVariation) {
            $ret[UserRequestNature::USER][$route][] = [
                'component-variation' => $componentVariation,
                'conditions' => [
                    'format' => POP_FORMAT_CALENDARMAP,

...
function gdCommonuserrolesAuthorsidebarsComponents($components, $section)
{
    if (PoP_ApplicationProcessors_Utils::addAuthorWidgetDetails()) {
        ...
        if ($section == GD_SIDEBARSECTION_ORGANIZATION) {
            $extra_components[] = [GD_URE_Custom_Module_Processor_Widgets::class, GD_URE_Custom_Module_Processor_Widgets::COMPONENT_URE_WIDGET_PROFILEORGANIZATION_DETAILS];
        } elseif ($section == GD_SIDEBARSECTION_INDIVIDUAL) {
            $extra_components[] = [GD_URE_Custom_Module_Processor_Widgets::class, GD_URE_Custom_Module_Processor_Widgets::COMPONENT_URE_WIDGET_PROFILEINDIVIDUAL_DETAILS];
        }

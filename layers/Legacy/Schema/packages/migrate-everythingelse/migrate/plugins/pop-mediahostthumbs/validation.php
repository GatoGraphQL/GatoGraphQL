...
define('POP_CPHT_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_MediaHostThumbs_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_CPHT_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('Media Host Thumbs for PoP', 'pop-mediahostthumbs'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-mediahostthumbs')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-mediahostthumbs'),
            'https://github.com/leoloso/PoP',
            POP_CPHT_POP_APPLICATION_MIN_VERSION
        );
    }

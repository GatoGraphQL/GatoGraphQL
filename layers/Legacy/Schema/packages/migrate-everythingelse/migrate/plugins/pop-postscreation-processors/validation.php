...
define('POP_POSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_POSTSCREATIONPROCESSORS_POP_POSTSCREATION_MIN_VERSION', 0.1);

class PoP_PostsCreationProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_POSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_POSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_POSTSCREATIONPROCESSORS_POP_POSTSCREATION_MIN_VERSION > POP_POSTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation Processors', 'pop-postscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-postscreation-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-postscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_POSTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation Processors', 'pop-postscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation', 'pop-postscreation-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Posts Creation', 'pop-postscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_POSTSCREATIONPROCESSORS_POP_POSTSCREATION_MIN_VERSION
        );
    }

...
define('POP_EVENTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION', 0.1);
define('POP_EVENTSCREATIONPROCESSORS_POP_EVENTSCREATION_MIN_VERSION', 0.1);

class PoP_EventsCreationProcessors_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATIONPROCESSORS_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION > POP_APPLICATIONPROCESSORS_VERSION) {
        ...
        if (!defined('POP_EVENTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_EVENTSCREATIONPROCESSORS_POP_EVENTSCREATION_MIN_VERSION > POP_EVENTSCREATION_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Creation Processors', 'pop-eventscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-eventscreation-processors')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Processors', 'pop-eventscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSCREATIONPROCESSORS_POP_APPLICATIONPROCESSORS_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Events Creation Processors', 'pop-eventscreation-processors'),
            TranslationAPIFacade::getInstance()->__('PoP Events Creation', 'pop-eventscreation-processors')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Events Creation', 'pop-eventscreation-processors'),
            'https://github.com/leoloso/PoP',
            POP_EVENTSCREATIONPROCESSORS_POP_EVENTSCREATION_MIN_VERSION
        );
    }

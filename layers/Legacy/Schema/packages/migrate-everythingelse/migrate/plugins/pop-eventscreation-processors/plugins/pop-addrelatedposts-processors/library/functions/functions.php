...
function gdEmAddrelatedpostButtons($buttons)
{
    ...
    if (defined('POP_EVENTSCREATION_ROUTE_ADDEVENT') && POP_EVENTSCREATION_ROUTE_ADDEVENT) {
        $buttons[] = [GD_Custom_EM_Module_Processor_Buttons::class, GD_Custom_EM_Module_Processor_Buttons::COMPONENT_BUTTON_EVENT_CREATE];

        if (defined('POP_EVENTLINKSCREATIONPROCESSORS_INITIALIZED')) {
            $buttons[] = [PoP_EventLinksCreation_Module_Processor_Buttons::class, PoP_EventLinksCreation_Module_Processor_Buttons::COMPONENT_BUTTON_EVENTLINK_CREATE];
        }
    }

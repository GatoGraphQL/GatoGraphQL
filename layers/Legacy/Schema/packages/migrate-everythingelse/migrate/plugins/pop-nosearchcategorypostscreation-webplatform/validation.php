...
define('POP_NOSEARCHCATEGORYPOSTSCREATIONWEBPLATFORM_POP_NOSEARCHCATEGORYPOSTSCREATION_MIN_VERSION', 0.1);
define('POP_NOSEARCHCATEGORYPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION', 0.1);

class PoP_NoSearchCategoryPostsCreationWebPlatform_Validation
{
    public function validate()
    {
        ...
        if (!defined('POP_NOSEARCHCATEGORYPOSTSCREATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSCREATIONWEBPLATFORM_POP_NOSEARCHCATEGORYPOSTSCREATION_MIN_VERSION > POP_CATEGORYPOSTSCREATION_VERSION) {
        ...
        if (!defined('POP_APPLICATIONWEBPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOSEARCHCATEGORYPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION > POP_APPLICATIONWEBPLATFORM_VERSION) {
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation Web Platform', 'pop-nosearchcategorypostscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation', 'pop-nosearchcategorypostscreation-webplatform')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation', 'pop-nosearchcategorypostscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_CATEGORYPOSTSCREATIONWEBPLATFORM_POP_CATEGORYPOSTSCREATION_MIN_VERSION
        );
    }
    public function initialize_warning_2()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP No Search Category Posts Creation Web Platform', 'pop-nosearchcategorypostscreation-webplatform'),
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-nosearchcategorypostscreation-webplatform')
        );
    }
    ...
    public function version_warning_2()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application Web Platform', 'pop-nosearchcategorypostscreation-webplatform'),
            'https://github.com/leoloso/PoP',
            POP_NOSEARCHCATEGORYPOSTSCREATIONWEBPLATFORM_POP_APPLICATIONWEBPLATFORM_MIN_VERSION
        );
    }

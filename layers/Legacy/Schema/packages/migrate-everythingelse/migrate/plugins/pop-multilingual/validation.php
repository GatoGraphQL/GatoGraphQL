...
define('POP_MULTILINGUAL_POP_APPLICATION_MIN_VERSION', 0.1);

class PoP_Multilingual_Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_APPLICATION_VERSION')) {
            ...
            $success = false;
        } elseif (POP_MULTILINGUAL_POP_APPLICATION_MIN_VERSION > POP_APPLICATION_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Multilingual', 'pop-multilingual')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Multilingual', 'pop-multilingual'),
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-multilingual')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP Application', 'pop-multilingual'),
            'https://github.com/leoloso/PoP',
            POP_MULTILINGUAL_POP_APPLICATION_MIN_VERSION
        );
    }

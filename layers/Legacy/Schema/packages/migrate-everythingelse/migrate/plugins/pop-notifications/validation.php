...
define('POP_NOTIFICATIONS_POP_USERPLATFORM_MIN_VERSION', 0.1);

class PoP_Notifications_Validation
{
    ...
    public function validate()
    {
        ...
        if (!defined('POP_USERPLATFORM_VERSION')) {
            ...
            $success = false;
        } elseif (POP_NOTIFICATIONS_POP_USERPLATFORM_MIN_VERSION > POP_USERPLATFORM_VERSION) {
    ...
    public function providerinstall_warning()
    {
        $this->providerinstall_warning_notice(
            TranslationAPIFacade::getInstance()->__('PoP Notifications', 'pop-events')
        );
    }
    ...
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(
            TranslationAPIFacade::getInstance()->__('PoP Notifications', 'pop-notifications'),
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-notifications')
        );
    }
    ...
    public function versionWarning()
    {
        $this->dependencyVersionWarning(
            ...
            TranslationAPIFacade::getInstance()->__('PoP User Platform', 'pop-notifications'),
            'https://github.com/leoloso/PoP',
            POP_NOTIFICATIONS_POP_USERPLATFORM_MIN_VERSION
        );
    }

...
class CreateUpdateWithCommunityProfileMutationResolver extends CreateUpdateProfileMutationResolver
{
    ...
    protected function usercommunitiesAdditionalsCreate($user_id, FieldDataProviderInterface $fieldDataProvider): void
    {
    ...
    protected function usercommunitiesCreateuser($user_id, FieldDataProviderInterface $fieldDataProvider): void
    {

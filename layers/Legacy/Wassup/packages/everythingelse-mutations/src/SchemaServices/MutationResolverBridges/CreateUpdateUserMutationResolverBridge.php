...
class CreateUpdateUserMutationResolverBridge extends AbstractComponentMutationResolverBridge
{
    ...
    public function getSuccessString(string | int $result_id): ?string
    {
        ...
        if (App::getState('is-user-logged-in')) {
            ...
            return sprintf(
                ...
                \PoP\Root\App::getHookManager()->applyFilters('GD_DataLoad_ActionExecuter_CreateUpdate_UserBase:success_msg:linkattrs', '')
            );
        }
    }
    ...
    public function getFormData(): array
    {
        ...
        $form_data = \PoP\Root\App::getHookManager()->applyFilters('gd_createupdate_user:form_data', $form_data);
    ...
    {
        // Allow to add extra inputs
        $form_data = \PoP\Root\App::getHookManager()->applyFilters('gd_createupdate_user:form_data:create', $form_data);
    ...
    {
        // Allow to add extra inputs
        $form_data = \PoP\Root\App::getHookManager()->applyFilters('gd_createupdate_user:form_data:update', $form_data);

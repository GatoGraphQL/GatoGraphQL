...
{
    public const MODULE_LAYOUT_AUTOMATEDEMAILS_PREVIEWNOTIFICATION_DETAILS = 'layout-automatedemails-previewnotification-details';
    public const MODULE_LAYOUT_AUTOMATEDEMAILS_PREVIEWNOTIFICATION_LIST = 'layout-automatedemails-previewnotification-list';

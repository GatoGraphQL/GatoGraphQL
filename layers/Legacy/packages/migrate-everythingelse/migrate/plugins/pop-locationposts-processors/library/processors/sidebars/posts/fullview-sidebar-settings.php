    ...
    public static function getSidebarSubmodules($section)
    {
        ...
        switch ($section) {
            ...
            case GD_COMPACTSIDEBARSECTION_LOCATIONPOST:
                ...
                $ret[] = [GD_SP_Custom_EM_Module_Processor_PostMultipleSidebarComponents::class, GD_SP_Custom_EM_Module_Processor_PostMultipleSidebarComponents::MODULE_SIDEBARMULTICOMPONENT_LOCATIONPOST];
                break;
        }

 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigSchemaSettings?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigSchemaSettings?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigSchemaSettings?.defaultLang

 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigResponseHeaders?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigResponseHeaders?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigResponseHeaders?.defaultLang

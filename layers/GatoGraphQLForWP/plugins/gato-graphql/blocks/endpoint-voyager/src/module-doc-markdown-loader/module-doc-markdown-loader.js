 ...
 */
__webpack_public_path__ = window.gatoGraphqlEndpointVoyager?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlEndpointVoyager?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlEndpointVoyager?.defaultLang

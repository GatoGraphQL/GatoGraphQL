 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigExposeSensitiveData?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigExposeSensitiveData?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigExposeSensitiveData?.defaultLang

 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigExposeSensitiveData?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigExposeSensitiveData?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigExposeSensitiveData?.defaultLang

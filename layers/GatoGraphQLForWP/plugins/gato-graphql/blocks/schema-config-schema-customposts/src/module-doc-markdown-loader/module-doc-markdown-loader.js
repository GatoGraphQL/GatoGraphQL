 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigSchemaCustomposts?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigSchemaCustomposts?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigSchemaCustomposts?.defaultLang

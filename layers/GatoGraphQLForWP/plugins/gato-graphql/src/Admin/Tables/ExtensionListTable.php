...
use GatoGraphQL\GatoGraphQL\ConditionalOnContext\Admin\SystemServices\TableActions\ExtensionListTableAction;
...
class ExtensionListTable extends WP_Plugin_Install_List_Table/*AbstractItemListTable*/ implements ItemListTableInterface
{
    ...
    {
        return \__('Extension', 'gato-graphql');
    }
    ...
    protected function column_default($item, $column_name)
    {
        ...
        //          */
        //         $modulesMenuPage = $instanceManager->getInstance(ExtensionsMenuPage::class);
        //         if ($item['has-docs']) {
        //             $url = \admin_url(sprintf(
    ...
    protected function column_cb($item)
    {
        ...
        //     ExtensionListTableAction::INPUT_BULK_ACTION_IDS,
        //     $item['id']
        // );
    }
    ...
    protected function getColumnActions(array $item): array
    {
        ...
        //             $linkPlaceholder,
        //             $page,
        //             ExtensionListTableAction::ACTION_DISABLE,
        //             $item['id'],
        //             $nonce,
        ...
        //         $linkPlaceholder,
        //         $page,
        //         ExtensionListTableAction::ACTION_ENABLE,
        //         $item['id'],
        //         $nonce,
    ...
    public function get_columns()
    {
        return array_merge(
            [
                ...
                'name' => \__('Extension', 'gato-graphql'),
            ],
    ...
    {
        return [
            // ExtensionListTableAction::ACTION_ENABLE => \__('Enable', 'gato-graphql'),
            // ExtensionListTableAction::ACTION_DISABLE => \__('Disable', 'gato-graphql'),
        ];
    }
    ...
    */
    ...
    public function prepare_items()
    {
        ...
        // /**
        //  * @var ExtensionListTableAction
        //  */
        // $tableAction = $systemInstanceManager->getInstance(ExtensionListTableAction::class);

...
class ExtensionModuleResolver extends AbstractExtensionModuleResolver
{
    ...
    public function getDescription(string $module): string
    {
        return match ($module) {
            ...
            self::AUTOMATION => \__('Automate tasks by chaining GraphQL queries via hooks and triggering them via WP-Cron (Internal GraphQL Server extension is required).', 'gato-graphql'),
            ...
            self::INTERNAL_GRAPHQL_SERVER => \__('Execute GraphQL queries directly within your application, using PHP code.', 'gato-graphql'),

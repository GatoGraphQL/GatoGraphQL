 ...
 */
__webpack_public_path__ = window.gatoGraphqlProSchemaConfigFieldToInput?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlProSchemaConfigFieldToInput?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlProSchemaConfigFieldToInput?.defaultLang

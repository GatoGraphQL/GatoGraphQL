 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigFieldToInput?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigFieldToInput?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigFieldToInput?.defaultLang

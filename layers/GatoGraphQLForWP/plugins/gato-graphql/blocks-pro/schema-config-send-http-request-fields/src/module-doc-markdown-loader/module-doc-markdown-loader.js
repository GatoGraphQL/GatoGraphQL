 ...
 */
__webpack_public_path__ = window.gatoGraphqlProSchemaConfigSendHttpRequestFields?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlProSchemaConfigSendHttpRequestFields?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlProSchemaConfigSendHttpRequestFields?.defaultLang

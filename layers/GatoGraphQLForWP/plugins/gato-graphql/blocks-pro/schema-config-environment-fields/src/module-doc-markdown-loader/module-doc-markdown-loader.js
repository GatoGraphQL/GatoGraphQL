 ...
 */
__webpack_public_path__ = window.gatoGraphqlProSchemaConfigEnvironmentFields?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlProSchemaConfigEnvironmentFields?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlProSchemaConfigEnvironmentFields?.defaultLang

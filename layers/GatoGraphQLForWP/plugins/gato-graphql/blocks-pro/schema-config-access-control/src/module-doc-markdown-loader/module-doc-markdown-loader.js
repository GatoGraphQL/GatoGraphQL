 ...
 */
__webpack_public_path__ = window.gatoGraphqlProSchemaConfigAccessControl?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlProSchemaConfigAccessControl?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlProSchemaConfigAccessControl?.defaultLang

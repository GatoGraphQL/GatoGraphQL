 ...
 */
__webpack_public_path__ = window.gatoGraphqlProSchemaConfigMultifieldDirectives?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlProSchemaConfigMultifieldDirectives?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlProSchemaConfigMultifieldDirectives?.defaultLang

 ...
 */
__webpack_public_path__ = window.gatoGraphqlProSchemaConfigMultipleQueryExecution?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlProSchemaConfigMultipleQueryExecution?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlProSchemaConfigMultipleQueryExecution?.defaultLang

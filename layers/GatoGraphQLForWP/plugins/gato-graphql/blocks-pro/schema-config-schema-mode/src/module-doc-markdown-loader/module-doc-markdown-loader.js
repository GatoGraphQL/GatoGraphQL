 ...
 */
__webpack_public_path__ = window.gatoGraphqlProSchemaConfigSchemaMode?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlProSchemaConfigSchemaMode?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlProSchemaConfigSchemaMode?.defaultLang

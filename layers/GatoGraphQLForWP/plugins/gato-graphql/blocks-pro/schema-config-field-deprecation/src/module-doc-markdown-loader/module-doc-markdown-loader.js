 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigFieldDeprecation?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigFieldDeprecation?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigFieldDeprecation?.defaultLang

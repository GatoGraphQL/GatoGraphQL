...
= 1.0 =
* Plugin is released! Refer to the [changelog in the plugin's repo](https://github.com/leoloso/PoP/blob/master/layers/GatoGraphQLForWP/plugins/gatographql/CHANGELOG.md) for a thorough description of all changes

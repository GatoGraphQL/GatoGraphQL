...
* Added documentation for new "Schema Functions extension" fields `_listEncodeAsJSONString` and `_objectEncodeAsJSONString`
* [Extensions][Schema Functions] Added fields `_listEncodeAsJSONString` and `_objectEncodeAsJSONString`

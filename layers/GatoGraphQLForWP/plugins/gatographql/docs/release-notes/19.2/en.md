...
- Updated the WooCommerce docs with the store configuration, webhooks and customer downloads, and brought the bundle teaser in line with what the extension reaches ([#3374](https://github.com/GatoGraphQL/GatoGraphQL/pull/3374))

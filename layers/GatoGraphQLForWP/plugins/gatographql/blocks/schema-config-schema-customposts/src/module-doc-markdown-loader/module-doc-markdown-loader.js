 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigSchemaCustomposts?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigSchemaCustomposts?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigSchemaCustomposts?.defaultLang

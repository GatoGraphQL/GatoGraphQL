 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigPayloadTypesForMutations?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigPayloadTypesForMutations?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigPayloadTypesForMutations?.defaultLang

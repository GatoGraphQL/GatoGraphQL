...
export const blockTypeSettings = {
	...
	attributes: {
		 ...
		 * GatoGraphQL\GatoGraphQL\Services\Blocks\AbstractGraphiQLBlock::ATTRIBUTE_NAME_QUERY
		 */
		query: {
			type: 'string',
		...
		/**
		 * Same attribute name as defined in
		 * GatoGraphQL\GatoGraphQL\Services\Blocks\AbstractGraphiQLBlock::ATTRIBUTE_NAME_VARIABLES
		 */
		variables: {
			type: 'string',
			default: '',

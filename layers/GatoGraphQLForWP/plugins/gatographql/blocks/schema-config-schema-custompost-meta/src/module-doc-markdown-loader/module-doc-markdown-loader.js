 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigSchemaCustompostMeta?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigSchemaCustompostMeta?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigSchemaCustompostMeta?.defaultLang

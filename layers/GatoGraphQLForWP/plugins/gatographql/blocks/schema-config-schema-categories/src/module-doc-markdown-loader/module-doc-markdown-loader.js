 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigSchemaCategories?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigSchemaCategories?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigSchemaCategories?.defaultLang

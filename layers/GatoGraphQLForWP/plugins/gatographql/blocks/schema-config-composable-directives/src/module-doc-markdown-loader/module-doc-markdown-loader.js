 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigComposableDirectives?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigComposableDirectives?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigComposableDirectives?.defaultLang

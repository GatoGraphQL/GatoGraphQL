 ...
 */
__webpack_public_path__ = window.gatoGraphqlSchemaConfigSelfFields?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatoGraphqlSchemaConfigSelfFields?.localeLang
	defaultLang = defaultLang || window.gatoGraphqlSchemaConfigSelfFields?.defaultLang

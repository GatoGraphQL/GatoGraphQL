 ...
 */
__webpack_public_path__ = window.gatographqlSchemaConfigMultifieldDirectives?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatographqlSchemaConfigMultifieldDirectives?.localeLang
	defaultLang = defaultLang || window.gatographqlSchemaConfigMultifieldDirectives?.defaultLang

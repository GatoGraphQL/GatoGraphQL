 ...
 * Define constants
 */
const MODULE = 'multifield-directives';
...
const GITHUB_BASE_URL = `https://raw.githubusercontent.com/leoloso/PoP/${ PACKAGE_TAG }/layers/GatoGraphQLForWP/plugins/gatographql`
 ...
 */
// ------------------------------------------------------
config.output.jsonpFunction = 'webpackJsonpGatoGraphQLSchemaConfigMultiFieldDirectives';
// ------------------------------------------------------

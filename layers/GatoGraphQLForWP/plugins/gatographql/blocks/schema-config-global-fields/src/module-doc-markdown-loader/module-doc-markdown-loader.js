 ...
 */
__webpack_public_path__ = window.gatographqlSchemaConfigGlobalFields?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.gatographqlSchemaConfigGlobalFields?.localeLang
	defaultLang = defaultLang || window.gatographqlSchemaConfigGlobalFields?.defaultLang

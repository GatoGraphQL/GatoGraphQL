...
query {
  ...
  caseInsensitiveExistingCookie: _httpRequestCookie(name: "Wordpress_Test_Cookie")
  nonExistingCookie: _httpRequestCookie(name: "not_existing")
  existingHasCookie: _httpRequestHasCookie(name: "wordpress_test_cookie")
  caseInsensitiveExistingHasCookie: _httpRequestHasCookie(name: "Wordpress_Test_Cookie")
...
```json
{
  "data": {
    ...
    "caseInsensitiveExistingCookie": null,
    "nonExistingCookie": null,
    "existingHasCookie": true,
    "caseInsensitiveExistingHasCookie": false,

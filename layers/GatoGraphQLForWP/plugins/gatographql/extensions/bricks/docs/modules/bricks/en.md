...
Field `CustomPost.bricksFlattenedDataItems: [JSONObject!]` flattens the output from the `bricksData` field, hence all elements (even the nested ones) appear in the first level of the array.

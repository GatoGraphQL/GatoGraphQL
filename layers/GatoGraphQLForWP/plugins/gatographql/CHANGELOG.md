...
- The activated licenses are stored without the raw response from the marketplace, cutting the option loaded on every request to a third of its size (#3397)

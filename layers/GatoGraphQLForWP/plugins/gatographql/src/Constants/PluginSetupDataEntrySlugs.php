...
class PluginSetupDataEntrySlugs
{
    ...
    public final const PERSISTED_QUERY_IMPORT_POST_FROM_WORDPRESS_RSS_FEED_AND_REWRITE_ITS_CONTENT_WITH_CHATGPT = 'import-post-from-wordpress-rss-feed-and-rewrite-its-content-with-chatgpt';

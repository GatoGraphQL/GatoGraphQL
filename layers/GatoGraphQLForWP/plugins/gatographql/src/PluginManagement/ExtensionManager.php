    ...
    public function assertIsValid(
        ...
        if (
            ...
            $this->printAdminNoticeErrorMessage(
                sprintf(
                    __('Extension or bundle <strong>%1$s</strong> requires plugin <strong>%2$s</strong> to satisfy version constraint <code>%3$s</code>, but the current version <code>%4$s</code> does not. The extension or bundle has not been loaded. (If you have just updated <strong>%2$s</strong>, notice that a new, corresponding version for the extension should be available; please download it and install it.)', 'gatographql'),

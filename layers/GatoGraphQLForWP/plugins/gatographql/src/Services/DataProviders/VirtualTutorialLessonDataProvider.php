...
class VirtualTutorialLessonDataProvider
{
    ...
    public function getTutorialLessonSlugDataItems(): array
    {
        return [
            ...
            VirtualTutorialLessons::TRANSLATING_MEDIA_FOR_POLYLANG => [
                \__('Translating a media item to a different language, with integration for Polylang', 'gatographql'),
                [
                    ExtensionModuleResolver::FIELD_VALUE_ITERATION_AND_MANIPULATION,
                    ExtensionModuleResolver::GOOGLE_TRANSLATE,
                    ExtensionModuleResolver::MULTIPLE_QUERY_EXECUTION,
            ...
            VirtualTutorialLessons::CREATING_MISSING_TRANSLATION_MEDIA_FOR_POLYLANG => [
                \__('Creating missing translation media items for Polylang', 'gatographql'),
                [
                    ExtensionModuleResolver::FIELD_ON_FIELD,
                    ExtensionModuleResolver::FIELD_RESPONSE_REMOVAL,
                    ExtensionModuleResolver::FIELD_TO_INPUT,
            ...
            VirtualTutorialLessons::IMPORTING_A_POST_FROM_WORDPRESS_RSS_FEED_AND_REWRITING_ITS_CONTENT_WITH_CHATGPT => [
                \__('Import a post from some WordPress RSS feed, and rewriting its content with ChatGPT', 'gatographql'),
                [
                    ExtensionModuleResolver::FIELD_TO_INPUT,
                    ExtensionModuleResolver::HELPER_FUNCTION_COLLECTION,
                    ExtensionModuleResolver::HTTP_CLIENT,

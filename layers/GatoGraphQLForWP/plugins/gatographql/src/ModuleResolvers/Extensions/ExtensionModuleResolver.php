...
class ExtensionModuleResolver extends AbstractExtensionModuleResolver
{
    ...
    public function getName(string $module): string
    {
        return match ($module) {
            ...
            self::MULTILINGUALPRESS => \__('Multilingual Press', 'gatographql'),
    ...
    public function getDescription(string $module): string
    {
        return match ($module) {
            ...
            self::MULTILINGUALPRESS => \__('Integration with plugin "Multilingual Press", adding fields to the schema to fetch multilingual data.', 'gatographql'),

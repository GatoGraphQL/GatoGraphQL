...
class PremiumBundleExtensionModuleResolver extends AbstractBundleExtensionModuleResolver
{
    ...
    public function getDescription(string $module): string
    {
        return match ($module) {
            ...
            self::TRANSLATION => \__('Translate content to multiple languages using the service provider of your choice, among ChatGPT, Claude, Mistral AI, DeepL, and Google Translate.', 'gatographql'),

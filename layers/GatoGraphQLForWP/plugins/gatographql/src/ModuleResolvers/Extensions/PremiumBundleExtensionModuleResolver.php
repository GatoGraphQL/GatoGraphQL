...
class PremiumBundleExtensionModuleResolver extends AbstractBundleExtensionModuleResolver
{
    ...
    public function getDescription(string $module): string
    {
        return match ($module) {
            ...
            self::TRANSLATION => \__('Translate content to multiple languages using the selected API service provider, among ChatGPT, DeepL, and Google Translate.', 'gatographql'),

...
class BundleExtensionModuleResolver extends AbstractBundleExtensionModuleResolver
{
    ...
    public function getName(string $module): string
    {
        ...
        return match ($module) {
            ...
            self::ACCESS_CONTROL => sprintf($extensionPlaceholder, \__('Security', 'gatographql')),
    ...
    public function getDescription(string $module): string
    {
        return match ($module) {
            ...
            self::ACCESS_CONTROL => \__('Grant permission to users to modify the GraphQL schema, and define Access Control Lists to manage granular access to the API based', 'gatographql'),

...
abstract class AbstractMainPlugin extends AbstractPlugin implements MainPluginInterface
{
    ...
    protected function useMarketplacePluginUpdaterForActiveCommercialExtensions(): void
    {
        ...
        /** @var DelegatingCommercialPluginUpdaterServiceInterface */
        $delegatingCommercialPluginUpdaterService = $instanceManager->getInstance(DelegatingCommercialPluginUpdaterServiceInterface::class);

        $delegatingCommercialPluginUpdaterService->setupMarketplacePluginUpdaterForExtensions(
     ...
     * on every request. It is not stored anymore, and this blanks
     * it in the entries written before.
     *
     ...
     *
     * The key is kept, with an empty array, so that a site rolled
     * back to a version that still reads it keeps working.
     */

 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigSchemaMode?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigSchemaMode?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigSchemaMode?.defaultLang

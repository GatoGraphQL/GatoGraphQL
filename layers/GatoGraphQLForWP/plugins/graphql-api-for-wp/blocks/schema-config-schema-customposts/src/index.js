...
const defaultCustomPostTypes = window.graphqlApiSchemaConfigSchemaCustomposts.defaultCustomPostTypes;
...
registerBlockType( 'graphql-api/schema-config-schema-customposts', {
	 ...
	 */
	title: __( 'Custom Posts', 'graphql-api' ),
	...
	attributes: {
		...
		/**
		 * Same attribute name as defined in
		 * GatoGraphQL\GatoGraphQL\Services\Blocks\SchemaConfigSchemaCustomPostsBlock::ATTRIBUTE_NAME_INCLUDED_CUSTOM_POST_TYPES
		 */
	 ...
	 */
	edit(props) {
		const possibleCustomPostTypes = window.graphqlApiSchemaConfigSchemaCustomposts.possibleCustomPostTypes;
		return <EditBlock

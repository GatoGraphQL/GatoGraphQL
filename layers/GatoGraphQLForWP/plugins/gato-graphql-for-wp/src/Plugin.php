    ...
    protected function showReleaseNotesInAdminNotice(): void
    {
        ...
        \add_action('admin_notices', function (): void {
            ...
            _e(sprintf(
                ...
                '</div>',
                sprintf(
                    __('Plugin <strong>Gato GraphQL for WordPress</strong> has been updated to version <code>%s</code>. <strong><a href="%s" class="%s">Check out what\'s new</a></strong> | <a href="%s">Disable this admin notice in the Settings</a>', 'gato-graphql'),
                    $this->pluginVersion,
                    $releaseNotesURL,

 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigSchemaSettings?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigSchemaSettings?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigSchemaSettings?.defaultLang

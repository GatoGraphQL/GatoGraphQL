...
abstract class AbstractServerSideRegisteredOrNotSchemaTestingBlock extends AbstractBlock
{
    ...
    public function renderBlock(array $attributes, string $content): string
    {
        ...
        $blockContent = sprintf(
            ...
            \__('This is a block for testing the schema', 'gatographql'),
            \__('In particular, to test field <code>CustomPost.blocks</code>, to see that blocks not registered on the server-side display a warning when parsed.', 'gatographql'),
        );
        ...
        return sprintf(
            ...
            $className . '__title',
            \__('Gato GraphQL: Block for testing the schema', 'gatographql'),
            $blockContent
        );
    }

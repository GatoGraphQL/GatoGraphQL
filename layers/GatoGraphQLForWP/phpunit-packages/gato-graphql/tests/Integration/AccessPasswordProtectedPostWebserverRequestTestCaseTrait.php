...
trait AccessPasswordProtectedPostWebserverRequestTestCaseTrait
{
     ...
     *
     *   curl 'https://gatographql.lndo.site/wp-login.php?action=postpass' -i -X POST -H 'Content-Type: application/x-www-form-urlencoded' --data-raw 'post_password=password'
     */

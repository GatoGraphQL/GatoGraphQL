...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`GatoGraphQL/packages/external-dependency-wrappers`](https://github.com/GatoGraphQL/PoP/tree/master/layers/GatoGraphQL/packages/external-dependency-wrappers).

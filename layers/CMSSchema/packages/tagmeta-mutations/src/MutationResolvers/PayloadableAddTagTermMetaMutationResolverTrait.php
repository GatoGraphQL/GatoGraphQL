...
{
    use PayloadableMutationResolverTrait, AddTagTermMetaMutationResolverTrait {
        AddTagTermMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof AddTagTermMetaMutationResolverTrait;
    }

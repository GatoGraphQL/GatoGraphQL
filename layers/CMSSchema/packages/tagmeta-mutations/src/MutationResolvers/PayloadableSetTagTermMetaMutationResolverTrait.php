...
{
    use PayloadableMutationResolverTrait, SetTagTermMetaMutationResolverTrait {
        SetTagTermMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof SetTagTermMetaMutationResolverTrait;
    }

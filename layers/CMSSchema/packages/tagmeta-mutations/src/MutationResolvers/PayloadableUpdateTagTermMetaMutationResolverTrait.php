...
{
    use PayloadableMutationResolverTrait, UpdateTagTermMetaMutationResolverTrait {
        UpdateTagTermMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof UpdateTagTermMetaMutationResolverTrait;
    }

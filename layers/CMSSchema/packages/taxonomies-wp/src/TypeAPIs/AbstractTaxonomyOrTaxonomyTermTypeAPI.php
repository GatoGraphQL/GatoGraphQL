...
abstract class AbstractTaxonomyOrTaxonomyTermTypeAPI extends AbstractBasicService implements TaxonomyTypeAPIInterface
{
    ...
    protected function getTerm(string|int $termObjectID, ?string $taxonomy = null): ?WP_Term
    {

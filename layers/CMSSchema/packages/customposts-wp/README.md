...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Schema/packages/customposts-wp`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Schema/packages/customposts-wp).

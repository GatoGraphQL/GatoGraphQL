...
abstract class AbstractUpdateMediaItemInputObjectTypeResolver extends AbstractCreateOrUpdateMediaItemInputObjectTypeResolver implements UpdateMediaItemInputObjectTypeResolverInterface
{
    ...
    public function getInputFieldNameTypeResolvers(): array
    {
        return App::applyFilters(
            MediaCRUDHookNames::UPDATE_MEDIA_ITEM_INPUT_FIELD_NAME_TYPE_RESOLVERS,
    ...
    {
        return App::applyFilters(
            MediaCRUDHookNames::UPDATE_MEDIA_ITEM_INPUT_FIELD_DESCRIPTION,
    ...
    {
        return App::applyFilters(
            MediaCRUDHookNames::UPDATE_MEDIA_ITEM_INPUT_FIELD_TYPE_MODIFIERS,

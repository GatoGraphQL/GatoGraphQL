...
class MediaItemSourceIsMissingMutationErrorPayloadObjectTypeResolverPicker extends AbstractMediaItemSourceIsMissingErrorPayloadObjectTypeResolverPicker
{
    /**

...
class UpdateMediaItemMutationResolver extends AbstractMutationResolver
{
    ...
    protected function updateMediaItem(
        ...
        if (isset($from->{MutationInputProperties::URL})) {
            ...
            return $this->getMediaTypeMutationAPI()->updateMediaItemFromURL(
        ...
        if (isset($from->{MutationInputProperties::MEDIAITEM_BY})) {
            ...
            return $this->getMediaTypeMutationAPI()->updateMediaItemFromExistingMediaItem(
                $mediaItemID,
                $mediaItemData,
            );
        }
        ...
        return $this->getMediaTypeMutationAPI()->updateMediaItemFromContents(

...
class CommentObjectTypeFieldResolver extends AbstractQueryableObjectTypeFieldResolver
{
    ...
    public function resolveValue(
        ...
        switch ($field->getName()) {
            ...
            case 'date':
                return new DateTime($this->getCommentTypeAPI()->getCommentDate($comment, $field->getArgument('gmt')?->getTEMPPPValue()));

            case 'dateStr':
                return $this->getDateFormatter()->format(
                    $field->getArgument('format')?->getTEMPPPValue(),
                    $this->getCommentTypeAPI()->getCommentDate($comment, $field->getArgument('gmt')?->getTEMPPPValue())
                );
        }

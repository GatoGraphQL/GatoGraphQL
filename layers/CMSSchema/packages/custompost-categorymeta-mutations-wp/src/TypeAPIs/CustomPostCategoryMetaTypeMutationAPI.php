...
namespace PoPCMSSchema\CustomPostCategoryMetaMutationsWP\TypeAPIs;
 ...
 */
class CustomPostCategoryMetaTypeMutationAPI implements CustomPostCategoryMetaTypeMutationAPIInterface
{
    /**

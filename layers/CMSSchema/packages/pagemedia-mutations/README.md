...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Schema/packages/pagemedia-mutations`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Schema/packages/pagemedia-mutations).

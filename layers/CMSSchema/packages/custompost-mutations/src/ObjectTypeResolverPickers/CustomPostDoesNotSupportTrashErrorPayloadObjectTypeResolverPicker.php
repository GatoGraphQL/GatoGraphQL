...
class CustomPostDoesNotSupportTrashErrorPayloadObjectTypeResolverPicker extends AbstractCustomPostDoesNotSupportTrashErrorPayloadObjectTypeResolverPicker
{
    /**

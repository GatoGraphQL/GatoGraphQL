...
{
    use PayloadableMutationResolverTrait, UpdateCommentMetaMutationResolverTrait {
        UpdateCommentMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof UpdateCommentMetaMutationResolverTrait;
    }

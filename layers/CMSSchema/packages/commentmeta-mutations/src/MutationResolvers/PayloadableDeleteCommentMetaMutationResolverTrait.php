...
{
    use PayloadableMutationResolverTrait, DeleteCommentMetaMutationResolverTrait {
        DeleteCommentMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof DeleteCommentMetaMutationResolverTrait;
    }

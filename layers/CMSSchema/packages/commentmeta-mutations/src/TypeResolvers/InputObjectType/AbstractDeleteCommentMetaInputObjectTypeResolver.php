...
abstract class AbstractDeleteCommentMetaInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements DeleteCommentMetaInputObjectTypeResolverInterface
{
    ...
    {
        return $this->__('Input to delete a comment\'s meta entry', 'commentmeta-mutations');
    }

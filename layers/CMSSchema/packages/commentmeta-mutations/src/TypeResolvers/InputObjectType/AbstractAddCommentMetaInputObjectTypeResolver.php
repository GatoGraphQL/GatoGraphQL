...
abstract class AbstractAddCommentMetaInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements AddCommentMetaInputObjectTypeResolverInterface
{
    ...
    public function getInputFieldDescription(string $inputFieldName): ?string
    {
        return match ($inputFieldName) {
            ...
            MutationInputProperties::SINGLE => $this->__('Is the meta a single value?', 'commentmeta-mutations'),

...
abstract class AbstractUpdateCommentMetaInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements UpdateCommentMetaInputObjectTypeResolverInterface
{
    ...
    public function getInputFieldDescription(string $inputFieldName): ?string
    {
        return match ($inputFieldName) {
            ...
            MutationInputProperties::KEY => $this->__('The meta key', 'commentmeta-mutations'),
            MutationInputProperties::VALUE => $this->__('The meta value', 'commentmeta-mutations'),
            MutationInputProperties::PREV_VALUE => $this->__('Previous value to check before updating. If specified, only update existing metadata entries with this value. Otherwise, update all entries', 'commentmeta-mutations'),

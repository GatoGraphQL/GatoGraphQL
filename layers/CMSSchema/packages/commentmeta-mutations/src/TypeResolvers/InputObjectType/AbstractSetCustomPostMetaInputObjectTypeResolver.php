...
abstract class AbstractSetCommentMetaInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements SetCommentMetaInputObjectTypeResolverInterface
{
    ...
    public function getInputFieldDescription(string $inputFieldName): ?string
    {
        return match ($inputFieldName) {
            ...
            MutationInputProperties::ENTRIES => $this->__('The meta entries', 'commentmeta-mutations'),

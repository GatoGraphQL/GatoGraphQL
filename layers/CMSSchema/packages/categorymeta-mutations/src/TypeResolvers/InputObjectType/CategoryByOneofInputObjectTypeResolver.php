...
class CategoryByOneofInputObjectTypeResolver extends AbstractOneofInputObjectTypeResolver
{
    ...
    public function getInputFieldDescription(string $inputFieldName): ?string
    {
        return match ($inputFieldName) {
            MutationInputProperties::ID => $this->__('Input the parent category ID', 'categorymeta-mutations'),
            MutationInputProperties::SLUG => $this->__('Input the parent category slug', 'categorymeta-mutations'),

...
class CategoryMetaCRUDHookNames
{
    ...
    public final const VALIDATE_UPDATE_META_META = __CLASS__ . ':validate-update-meta';
    public final const VALIDATE_DELETE_META_META = __CLASS__ . ':validate-delete-meta';
    ...
    public final const EXECUTE_UPDATE_META_META = __CLASS__ . ':execute-update-meta';
    public final const EXECUTE_DELETE_META_META = __CLASS__ . ':execute-delete-meta';

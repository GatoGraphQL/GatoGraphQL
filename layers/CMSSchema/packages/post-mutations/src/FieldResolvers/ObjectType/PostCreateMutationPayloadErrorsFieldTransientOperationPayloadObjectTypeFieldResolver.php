...
class PostCreateMutationPayloadErrorsFieldTransientOperationPayloadObjectTypeFieldResolver extends AbstractErrorsFieldTransientOperationPayloadObjectTypeFieldResolver
{
    ...
    {
        return [
            PostCreateMutationPayloadObjectTypeResolver::class,
        ];
    }

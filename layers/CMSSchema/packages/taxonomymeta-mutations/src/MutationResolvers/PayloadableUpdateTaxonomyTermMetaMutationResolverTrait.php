...
trait PayloadableUpdateTaxonomyTermMetaMutationResolverTrait
{
    use PayloadableMutationResolverTrait, UpdateTaxonomyTermMetaMutationResolverTrait {
        UpdateTaxonomyTermMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof UpdateTaxonomyTermMetaMutationResolverTrait;
    }

...
trait PayloadableDeleteTaxonomyTermMetaMutationResolverTrait
{
    use PayloadableMutationResolverTrait, DeleteTaxonomyTermMetaMutationResolverTrait {
        DeleteTaxonomyTermMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof DeleteTaxonomyTermMetaMutationResolverTrait;
    }

...
use PoPCMSSchema\TaxonomyMetaMutations\RelationalTypeDataLoaders\ObjectType\LoggedInUserHasNoAssigningTermsToTaxonomyCapabilityErrorPayloadObjectTypeDataLoader;
...
class LoggedInUserHasNoAssigningTermsToTaxonomyCapabilityErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    {
        return $this->__('Error payload for: "The logged-in user has no permission to assign terms to a taxonomy"', 'taxonomymeta-mutations');
    }

...
abstract class AbstractCreateOrUpdateTaxonomyTermMetaInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements UpdateTaxonomyTermMetaInputObjectTypeResolverInterface, CreateTaxonomyTermMetaInputObjectTypeResolverInterface
{
    ...
    {
        return $this->__('Input to create or update a taxonomy term', 'taxonomymeta-mutations');
    }
    ...
    public function getInputFieldDescription(string $inputFieldName): ?string
    {
        return match ($inputFieldName) {
            MutationInputProperties::ID => $this->__('The ID of the taxonomy to update', 'taxonomymeta-mutations'),
            MutationInputProperties::NAME => $this->__('The name of the taxonomy', 'taxonomymeta-mutations'),
            MutationInputProperties::DESCRIPTION => $this->__('The description of the taxonomy', 'taxonomymeta-mutations'),
            MutationInputProperties::SLUG => $this->__('The slug of the taxonomy', 'taxonomymeta-mutations'),
            MutationInputProperties::TAXONOMY => $this->__('The taxonomy', 'taxonomymeta-mutations'),
            MutationInputProperties::PARENT_BY => $this->__('The taxonomy\'s parent, or `null` to remove it', 'taxonomymeta-mutations'),

...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Schema/packages/custompost-user-mutations`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Schema/packages/custompost-user-mutations).

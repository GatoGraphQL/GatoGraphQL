...
class MenuTypeMutationAPI extends AbstractBasicService implements MenuTypeMutationAPIInterface
{
    ...
    public function createMenuFromURL(
        ...
        /**
         * When creating a menu item from an URL, WordPress sets
         * "reject_unsafe_urls" to `true`, because `download_url`
         * calls `wp_safe_remote_get`.
         *
         * This way, by default we can't create menu items from unsafe URLs,
        ...
        $menuID = $this->createMenuFromLocalFile(
            $downloadedFile,
            $filename,
            $mimeType,
            $menuData,

...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Schema/packages/media-wp`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Schema/packages/media-wp).

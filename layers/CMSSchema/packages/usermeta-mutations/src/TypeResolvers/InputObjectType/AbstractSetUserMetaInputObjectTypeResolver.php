...
abstract class AbstractSetUserMetaInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements SetUserMetaInputObjectTypeResolverInterface
{
    ...
    public function getInputFieldDescription(string $inputFieldName): ?string
    {
        return match ($inputFieldName) {
            ...
            MutationInputProperties::ENTRIES => $this->__('The meta entries', 'usermeta-mutations'),

...
abstract class AbstractAddUserMetaInputObjectTypeResolver extends AbstractInputObjectTypeResolver implements AddUserMetaInputObjectTypeResolverInterface
{
    ...
    public function getInputFieldDescription(string $inputFieldName): ?string
    {
        return match ($inputFieldName) {
            ...
            MutationInputProperties::SINGLE => $this->__('Is the meta a single value?', 'usermeta-mutations'),

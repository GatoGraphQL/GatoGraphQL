...
{
    use PayloadableMutationResolverTrait, AddUserMetaMutationResolverTrait {
        AddUserMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof AddUserMetaMutationResolverTrait;
    }

...
{
    use PayloadableMutationResolverTrait, DeleteUserMetaMutationResolverTrait {
        DeleteUserMetaMutationResolverTrait::executeMutation as upstreamExecuteMutation;
        PayloadableMutationResolverTrait::validate insteadof DeleteUserMetaMutationResolverTrait;
    }

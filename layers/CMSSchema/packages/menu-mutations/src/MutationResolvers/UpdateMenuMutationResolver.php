...
class UpdateMenuMutationResolver extends AbstractCreateOrUpdateMenuMutationResolver
{
    ...
    public function validate(
        ...
        App::doAction(
            MenuCRUDHookNames::VALIDATE_UPDATE_MENU_ITEM,
            $fieldDataAccessor,
            $objectTypeFieldResolutionFeedbackStore,
        );
    }
    ...
    protected function getMenuData(FieldDataAccessorInterface $fieldDataAccessor): array
    {
        return App::applyFilters(
            MenuCRUDHookNames::GET_UPDATE_MENU_ITEM_DATA,
    ...
    protected function updateMenu(
        ...
        $this->getMenuTypeMutationAPI()->updateMenu(
            $menuID,
            $menuData,
        );

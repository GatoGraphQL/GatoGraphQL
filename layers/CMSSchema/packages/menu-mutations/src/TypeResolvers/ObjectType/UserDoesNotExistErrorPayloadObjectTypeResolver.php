...
use PoPCMSSchema\MenuMutations\RelationalTypeDataLoaders\ObjectType\UserDoesNotExistErrorPayloadObjectTypeDataLoader;
...
class UserDoesNotExistErrorPayloadObjectTypeResolver extends AbstractErrorPayloadObjectTypeResolver
{
    ...
    {
        return $this->__('Error payload for: "The user does not exist"', 'menu-mutations');
    }

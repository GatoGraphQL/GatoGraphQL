...
use PoPCMSSchema\CategoryMutations\TypeResolvers\UnionType\AbstractCategoryAddMutationErrorPayloadUnionTypeResolver;
...
class GenericCategoryAddMetaMutationErrorPayloadUnionTypeResolver extends AbstractCategoryAddMutationErrorPayloadUnionTypeResolver
{
    ...
    {
        return $this->__('Union of \'Error Payload\' types when adding a category term (using nested mutations)', 'post-mutations');
    }

...
class RootObjectTypeFieldResolver extends AbstractObjectTypeFieldResolver
{
    ...
    protected function doResolveSchemaValidationErrors(
        ...
        switch ($field->getName()) {
            ...
            case 'optionObjectValue':
                if (!$this->getSettingsTypeAPI()->validateIsOptionAllowed($field->getArgument('name')?->getValue()->getValue())) {
                    return [
    ...
    public function resolveValue(
        ...
        switch ($field->getName()) {
            ...
            case 'optionValues':
            case 'optionObjectValue':
                $value = $this->getSettingsTypeAPI()->getOption($field->getArgument('name')?->getValue()->getValue());

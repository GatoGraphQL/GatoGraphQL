...
class WordPressAuthenticatedUserEndpoints
{
    public const ENDPOINTS = [
        ...
        'editing-public-persisted-query-client' => 'wp-admin/edit.php?page=graphql_api&action=execute_query&endpoint_group=publicPersistedQuery&persisted_query_id=65',
    ];
}

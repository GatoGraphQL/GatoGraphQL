...
class UserInterfaceFunctionalityModuleResolver extends AbstractFunctionalityModuleResolver
{
    ...
    public final const CUSTOM_ENDPOINT_URLS_AND_CLIENTS = Plugin::NAMESPACE . '\custom-endpoint-urls-and-clients';
    ...
    public function getName(string $module): string
    {
        return match ($module) {
            ...
            self::CUSTOM_ENDPOINT_URLS_AND_CLIENTS => \__('Custom Endpoint URLs and Clients', 'graphql-api'),
            default => $module,
        };
    }
    ...
    public function getDescription(string $module): string
    {
        return match ($module) {
            ...
            self::CUSTOM_ENDPOINT_URLS_AND_CLIENTS => \__('Sidebar component displaying URLs and Clients for a Custom Endpoint', 'graphql-api'),

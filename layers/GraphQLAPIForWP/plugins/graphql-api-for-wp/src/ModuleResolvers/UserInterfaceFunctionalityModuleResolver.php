...
class UserInterfaceFunctionalityModuleResolver extends AbstractFunctionalityModuleResolver
{
    ...
    public final const ADDITIONAL_DOCUMENTATION = Plugin::NAMESPACE . '\additional-documentation';
    ...
    public function getDependedModuleLists(string $module): array
    {
        switch ($module) {
            ...
            case self::ADDITIONAL_DOCUMENTATION:
                return [
                    [
    ...
    public function getName(string $module): string
    {
        return match ($module) {
            ...
            self::ADDITIONAL_DOCUMENTATION => \__('Additional Documentation', 'graphql-api'),
            default => $module,
        };
    }
    ...
    public function getDescription(string $module): string
    {
        return match ($module) {
            ...
            self::ADDITIONAL_DOCUMENTATION => \__('Documentation on using the GraphQL API', 'graphql-api'),

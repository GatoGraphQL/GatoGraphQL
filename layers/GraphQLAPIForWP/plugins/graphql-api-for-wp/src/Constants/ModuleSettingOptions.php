...
class ModuleSettingOptions
{
    ...
    public final const CATEGORY_TAXONOMIES = 'category-taxonomies';
    public final const TAG_TAXONOMIES = 'tag-taxonomies';
    ...
    public final const SCHEMA_EXPOSURE = 'schema-exposure';
}

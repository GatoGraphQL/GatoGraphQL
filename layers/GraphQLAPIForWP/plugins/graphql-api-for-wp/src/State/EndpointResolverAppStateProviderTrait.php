...
trait EndpointResolverAppStateProviderTrait
{
    abstract protected function getGraphQLDataStructureFormatter(): GraphQLDataStructureFormatter;
    abstract protected function getGraphQLQueryConvertor(): GraphQLQueryConvertorInterface;
    abstract protected function getGraphQLEndpointResolver(): GraphQLEndpointResolverInterface;

    protected function initializeState(array &$state): void
    {
    ...
    protected function consolidateState(array &$state): void
    {
        /**

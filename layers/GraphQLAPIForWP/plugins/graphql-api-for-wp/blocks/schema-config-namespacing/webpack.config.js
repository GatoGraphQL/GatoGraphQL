...
config.resolve.alias['@moduleDocs'] = path.resolve(process.cwd(), '../../docs/modules/namespacing/')
 ...
 */
// ------------------------------------------------------
config.output.jsonpFunction = 'webpackJsonpGraphQLAPISchemaConfigNamespacing';
// ------------------------------------------------------

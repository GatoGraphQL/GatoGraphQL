...
registerBlockType( 'graphql-api/schema-config-schema-custompost-meta', {
	...
	attributes: {
		...
		/**
		 * Same attribute name as defined in
		 * GraphQLAPI\GraphQLAPI\Services\Blocks\AbstractSchemaConfigSchemaMetaBlock::ATTRIBUTE_NAME_ENTRIES
		 */
		entries: {
			type: 'array',
			default: [],
		...
		/**
		 * Same attribute name as defined in
		 * GraphQLAPI\GraphQLAPI\Services\Blocks\AbstractSchemaConfigSchemaMetaBlock::ATTRIBUTE_NAME_BEHAVIOR
		 */
		behavior: {
			type: 'string',

 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigExposeAdminData?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigExposeAdminData?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigExposeAdminData?.defaultLang

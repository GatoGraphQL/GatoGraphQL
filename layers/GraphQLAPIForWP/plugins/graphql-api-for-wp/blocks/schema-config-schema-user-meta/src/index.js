...
const defaultBehavior = window.graphqlApiSchemaConfigSchemaUserMeta ? window.graphqlApiSchemaConfigSchemaUserMeta.defaultBehavior : [];
 ...
 * @see https://developer.wordpress.org/block-editor/developers/block-api/#registering-a-block
 */
registerBlockType( 'graphql-api/schema-config-schema-user-meta', {
	/**
	 * This is the display title for your block, which can be translated with `i18n` functions.
	 * The block inserter will show this name.
	 */
	title: __( 'User Meta for the Schema Configuration', 'graphql-api' ),
	 ...
	 */
	description: __(
		'Configure user meta options in the Schema Configuration',
		'graphql-api'
	),

 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigPayloadTypesInMutations?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigPayloadTypesInMutations?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigPayloadTypesInMutations?.defaultLang

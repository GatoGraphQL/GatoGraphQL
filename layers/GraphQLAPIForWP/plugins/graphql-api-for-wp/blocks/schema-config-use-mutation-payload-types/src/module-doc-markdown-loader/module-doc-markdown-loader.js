 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigUseMutationPayloadTypes?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigUseMutationPayloadTypes?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigUseMutationPayloadTypes?.defaultLang

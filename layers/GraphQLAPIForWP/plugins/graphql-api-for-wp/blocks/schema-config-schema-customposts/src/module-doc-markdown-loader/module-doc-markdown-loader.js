 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigCustomposts?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigCustomposts?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigCustomposts?.defaultLang

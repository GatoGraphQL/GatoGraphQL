 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigPayloadTypesForMutations?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigPayloadTypesForMutations?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigPayloadTypesForMutations?.defaultLang

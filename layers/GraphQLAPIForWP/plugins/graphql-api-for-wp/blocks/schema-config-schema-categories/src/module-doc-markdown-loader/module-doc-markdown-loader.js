 ...
 */
__webpack_public_path__ = window.graphqlApiSchemaConfigSchemaCategories?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiSchemaConfigSchemaCategories?.localeLang
	defaultLang = defaultLang || window.graphqlApiSchemaConfigSchemaCategories?.defaultLang

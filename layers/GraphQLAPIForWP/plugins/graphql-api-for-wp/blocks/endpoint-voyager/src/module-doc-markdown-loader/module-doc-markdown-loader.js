 ...
 */
__webpack_public_path__ = window.graphqlApiEndpointVoyager?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiEndpointVoyager?.localeLang
	defaultLang = defaultLang || window.graphqlApiEndpointVoyager?.defaultLang

...
Several modules had their Settings value split into 2: "Default value for Schema Configuration" and "Value for the Admin".

Then, the settings for these modules must be set once again. The updated modules are:

...
<a href="../../images/releases/v09/settings-schema-configuration-for-single-endpoint.png" target="_blank">![Settings for the Schema Configuration for the Single Endpoint](../../images/releases/v09/settings-schema-configuration-for-single-endpoint.png)</a>
...
In addition, you must click on "Reset the template" on all Schema Configurations to show the corresponding block once again:

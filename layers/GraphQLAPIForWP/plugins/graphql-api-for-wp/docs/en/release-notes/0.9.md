...
- `Post.modified(format: String): String!`
- `Media.modified(format: String): String!`
- `User.registeredDate(format: String): String!`

These fields have been renamed as `...AsString`:

- `Post.dateAsString(format: String): String!`
- `Media.dateAsString(format: String): String!`
- `Comment.dateAsString(format: String): String!`
- `Post.modifiedAsString(format: String): String!`
- `Media.modifiedAsString(format: String): String!`
- `User.registeredDateAsString(format: String): String!`
...
For instance, mutation `loginUser` was used like this:

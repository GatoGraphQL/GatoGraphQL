...
(The documentation on how to create custom scalars is not ready yet... to explore the source code, check out the base class for all custom scalars [here](https://github.com/leoloso/PoP/blob/b66b5a2bef50d66b6e643b065a26158a88a5fed3/layers/Engine/packages/component-model/src/TypeResolvers/ScalarType/AbstractScalarTypeResolver.php)).

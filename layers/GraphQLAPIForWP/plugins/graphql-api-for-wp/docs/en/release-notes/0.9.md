...
## Expose the `__schema` introspection field in the ACLs
...
This way, we can disable introspection for the single endpoint or custom endpoints, following any of the already available rules:

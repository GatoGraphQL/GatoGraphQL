...
The [Convert Case Directives extension]() makes available the following directives to manipulate strings:

- `@upperCase`
- `@lowerCase`
- `@titleCase`

The [Events Manager extension]() provides the integration for plugin [Events Manager](https://wordpress.org/plugins/events-manager/), to retrieve event data.

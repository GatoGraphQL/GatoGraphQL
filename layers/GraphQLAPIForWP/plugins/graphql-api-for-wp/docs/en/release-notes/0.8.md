...
The cached files were previously stored under a system folder, out of view to the admin user.
...
## There are two GraphQL endpoints to power the WordPress editor

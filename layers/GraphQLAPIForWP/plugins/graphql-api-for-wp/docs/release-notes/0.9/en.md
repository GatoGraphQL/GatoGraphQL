...
This opens the doors to using the GraphQL API with other frameworks (eg: Laravel), and wherever WordPress is not available (such as when executing a Continous Integration task).

 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigAccessControl?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigAccessControl?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigAccessControl?.defaultLang

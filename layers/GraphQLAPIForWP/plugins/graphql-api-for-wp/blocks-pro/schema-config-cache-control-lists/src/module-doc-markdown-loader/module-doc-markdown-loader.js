 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigCacheControlLists?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigCacheControlLists?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigCacheControlLists?.defaultLang

 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigSendHttpRequestFields?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigSendHttpRequestFields?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigSendHttpRequestFields?.defaultLang

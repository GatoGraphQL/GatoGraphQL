 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigAccessControlLists?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigAccessControlLists?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigAccessControlLists?.defaultLang

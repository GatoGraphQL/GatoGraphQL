 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigMultifieldDirectives?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigMultifieldDirectives?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigMultifieldDirectives?.defaultLang

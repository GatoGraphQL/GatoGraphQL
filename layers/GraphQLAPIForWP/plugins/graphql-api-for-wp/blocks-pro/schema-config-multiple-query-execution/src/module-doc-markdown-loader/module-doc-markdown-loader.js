 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigMultipleQueryExecution?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigMultipleQueryExecution?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigMultipleQueryExecution?.defaultLang

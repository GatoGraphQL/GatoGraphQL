 ...
 */
__webpack_public_path__ = window.graphqlApiProSchemaConfigEnvironmentFields?.publicPath;
...
const getModuleDocMarkdownContentOrUseDefault = ( defaultLang, lang ) => {
	lang = lang || window.graphqlApiProSchemaConfigEnvironmentFields?.localeLang
	defaultLang = defaultLang || window.graphqlApiProSchemaConfigEnvironmentFields?.defaultLang

...
<tr><td><a href="docs/modules/schema-expose-admin-data/en.md">Schema Expose Admin Data</a></td><td>Expose "admin" elements in the GraphQL schema (such as field <code>Root.roles</code>, input field <code>Root.posts(status:)</code>, and others), which provide access to private data</td></tr>

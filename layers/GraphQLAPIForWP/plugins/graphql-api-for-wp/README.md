...
<tr><td><a href="docs/en/modules/schema-expose-admin-data.md">Schema Expose Admin Data</a></td><td>Expose "admin" elements in the GraphQL schema (such as field <code>Root.roles</code>, input field <code>Root.posts(status:)</code>, and others), which expose private data</td></tr>

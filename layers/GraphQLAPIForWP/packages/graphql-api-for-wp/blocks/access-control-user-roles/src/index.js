 ...
 * @see https://developer.wordpress.org/block-editor/developers/block-api/#registering-a-block
 */
registerBlockType( 'graphql-api/access-control-user-roles', {
	/**
	 * This is the display title for your block, which can be translated with `i18n` functions.
	 * The block inserter will show this name.
	 */
	title: __( 'User roles', 'graphql-api' ),
	 ...
	 */
	description: __(
		'Grant access to the selected fields and directives based on the user having any of the selected roles',
		'graphql-api'
	),

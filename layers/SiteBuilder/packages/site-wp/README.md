...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`SiteBuilder/packages/site-wp`](https://github.com/GatoGraphQL/PoP/tree/master/layers/SiteBuilder/packages/site-wp).

...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`SiteBuilder/packages/application-wp`](https://github.com/GatoGraphQL/PoP/tree/master/layers/SiteBuilder/packages/application-wp).

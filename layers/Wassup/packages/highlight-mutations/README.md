...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Wassup/packages/highlight-mutations`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Wassup/packages/highlight-mutations).

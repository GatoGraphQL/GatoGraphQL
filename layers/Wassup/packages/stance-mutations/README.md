...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Wassup/packages/stance-mutations`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Wassup/packages/stance-mutations).

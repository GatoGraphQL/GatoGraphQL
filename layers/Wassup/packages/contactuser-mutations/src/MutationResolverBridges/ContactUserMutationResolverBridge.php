...
{
    protected ?ContactUserMutationResolver $contactUserMutationResolver = null;
    ...
    {
        return $this->contactUserMutationResolver ??= $this->getInstanceManager()->getInstance(ContactUserMutationResolver::class);
    }

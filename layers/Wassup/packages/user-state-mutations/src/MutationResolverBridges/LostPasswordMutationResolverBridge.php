...
{
    protected ?LostPasswordMutationResolver $lostPasswordMutationResolver = null;
    ...
    {
        return $this->lostPasswordMutationResolver ??= $this->getInstanceManager()->getInstance(LostPasswordMutationResolver::class);
    }

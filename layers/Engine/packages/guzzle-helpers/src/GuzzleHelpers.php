...
class GuzzleHelpers
{
     ...
     *
     * @param string $url The Endpoint URL
     * @param array<string,mixed> $bodyJSONQueries The form params
     ...
     * @param array<string,mixed> $bodyJSONQueries the bodyJSONQuery to attach to each URL, on the same order provided in param $urls
     * @return array<string,mixed> The payload if successful
     * @throws GuzzleInvalidResponseException
     */

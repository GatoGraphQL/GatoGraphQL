...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Engine/packages/root`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Engine/packages/root).

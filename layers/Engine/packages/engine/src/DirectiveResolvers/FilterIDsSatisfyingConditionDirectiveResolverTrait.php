...
trait FilterIDsSatisfyingConditionDirectiveResolverTrait
{
    ...
    protected function getIdsSatisfyingCondition(ObjectTypeResolverInterface $objectTypeResolver, array &$resultIDItems, array &$idsDataFields, array &$variables, array &$messages, array &$dbErrors, array &$dbWarnings, array &$dbDeprecations)
    {
        ...
        foreach (array_keys($idsDataFields) as $id) {
            ...
            ) = $this->dissectAndValidateDirectiveForResultItem($objectTypeResolver, $resultItem, $variables, $expressions, $dbErrors, $dbWarnings, $dbDeprecations);

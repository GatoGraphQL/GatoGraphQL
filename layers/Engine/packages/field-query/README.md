...
A fragment can further contain `|` (to split fields), but it cannot contain `;` (to split operations) or `,` (to split queries). See issue [#255](https://github.com/leoloso/PoP/issues/255).

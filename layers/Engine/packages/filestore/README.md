...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Engine/packages/filestore`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Engine/packages/filestore).

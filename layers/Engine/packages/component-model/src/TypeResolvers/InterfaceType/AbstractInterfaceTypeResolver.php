    ...
    protected function calculateAllInterfaceTypeFieldResolversByField(): array
    {
        ...
        while (!empty($classStack)) {
            ...
            do {
                ...
                $attachedInterfaceTypeFieldResolvers = $this->attachableExtensionManager->getAttachedExtensions($class, AttachableExtensionGroups::INTERFACE_TYPE_FIELD_RESOLVERS);

...
abstract class AbstractValidateDirectiveResolver extends AbstractGlobalDirectiveResolver
{
    ...
    public function resolveDirective(
        ...
        $this->validateAndFilterFields($objectTypeResolver, $idsDataFields, $succeedingPipelineIDsDataFields, $dbItems, $variables, $schemaErrors, $schemaWarnings, $schemaDeprecations);
    }
    ...
    protected function validateAndFilterFields(
        ...
        $this->validateFields($objectTypeResolver, $dataFields, $schemaErrors, $schemaWarnings, $schemaDeprecations, $variables, $failedDataFields);
        ...
        //         $this->validateAndFilterConditionalFields($objectTypeResolver, $conditionField, $idsDataFields[$id]['conditional'], $dataFields, $schemaErrors, $schemaWarnings, $schemaDeprecations, $variables, $failedDataFields);
        //     }
        // }
    }

    abstract protected function validateFields(ObjectTypeResolverInterface $objectTypeResolver, array $dataFields, array &$schemaErrors, array &$schemaWarnings, array &$schemaDeprecations, array &$variables, array &$failedDataFields): void;
}

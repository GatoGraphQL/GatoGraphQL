...
abstract class AbstractValidateConditionDirectiveResolver extends AbstractValidateDirectiveResolver
{
    ...
    {
        if (!$this->validateCondition($objectTypeResolver)) {
            // All fields failed
            ...
            $schemaErrors[] = [
                ...
                Tokens::MESSAGE => $this->getValidationFailedMessage($objectTypeResolver, $dataFields),
            ];
        }
    }
     ...
     */
    abstract protected function validateCondition(ObjectTypeResolverInterface $objectTypeResolver): bool;

...
class Engine implements EngineInterface
{
    ...
    public function sendEtagHeader(): void
    {
        ...
        if (\PoP\Root\App::getHookManager()->applyFilters('\PoP\ComponentModel\Engine:outputData:addEtagHeader', true)) {
            ...
            $commoncode = \PoP\Root\App::getHookManager()->applyFilters('\PoP\ComponentModel\Engine:etag_header:commoncode', $commoncode);
    ...
    public function getExtraRoutes(): array
    {
        ...
        $this->extra_routes = \PoP\Root\App::getHookManager()->applyFilters(
    ...
    {
        \PoP\Root\App::getHookManager()->doAction('\PoP\ComponentModel\Engine:beginning');
    ...
    public function moveEntriesUnderDBName(
        ...
        if ($entries) {
            ...
            $dbname_datafields = \PoP\Root\App::getHookManager()->applyFilters(

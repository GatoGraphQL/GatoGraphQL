...
class CoreGlobalObjectTypeFieldResolver extends AbstractGlobalObjectTypeFieldResolver
{
    ...
    public function resolveValue(
        ...
        switch ($field->getName()) {
            ...
            case 'isObjectType':
                $typeName = $field->getArgument('type')?->getValue()->getValue();
            ...
            case 'implements':
                $interface = $field->getArgument('interface')?->getValue()->getValue();
            ...
            case 'isInUnionType':
                $unionTypeName = $field->getArgument('type')?->getValue()->getValue();
                    ...
                    new LeafField(
                        ...
                        [
                            new Argument(
                                'type',
                                new Literal(
                                    $field->getArgument('typeOrInterface')?->getValue()->getValue(),
                                    $field->getLocation()
                                ),
                                $field->getLocation()
                            ),
            ...
            case 'isTypeOrImplementsAll':
                foreach ($field->getArgument('typesOrInterfaces')?->getValue()->getValue() as $typeOrInterface) {

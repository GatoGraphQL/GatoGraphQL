...
interface FieldQueryInterpreterInterface extends \PoP\FieldQuery\FieldQueryInterpreterInterface
{
     ...
     */
    public function getUniqueFieldOutputKey(ObjectTypeResolverInterface $typeResolver, string $field): string;
    ...
    public function extractFieldArgumentsForSchema(ObjectTypeResolverInterface $typeResolver, string $field, ?array $variables = null): array;
    public function extractDirectiveArgumentsForSchema(DirectiveResolverInterface $directiveResolver, ObjectTypeResolverInterface $typeResolver, string $directive, ?array $variables = null, bool $disableDynamicFields = false): array;

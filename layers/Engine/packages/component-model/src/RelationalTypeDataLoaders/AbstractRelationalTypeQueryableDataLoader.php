...
abstract class AbstractRelationalTypeQueryableDataLoader extends AbstractRelationalTypeDataLoader implements TypeQueryableRelationalDataLoaderInterface
{
    /**
     * @return mixed[]
     */

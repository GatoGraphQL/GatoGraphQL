...
class Environment
{
    ...
    public const ENABLE_FIELD_OR_DIRECTIVE_ARGUMENT_DEPRECATIONS = 'ENABLE_FIELD_OR_DIRECTIVE_ARGUMENT_DEPRECATIONS';
    public const ENABLE_USING_DANGEROUSLY_DYNAMIC_SCALAR = 'ENABLE_USING_DANGEROUSLY_DYNAMIC_SCALAR';

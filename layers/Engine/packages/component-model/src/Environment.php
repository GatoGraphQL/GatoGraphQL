...
class Environment
{
    ...
    public final const SKIP_EXPOSING_DANGEROUSLY_DYNAMIC_SCALAR_TYPE_IN_SCHEMA = 'SKIP_EXPOSING_DANGEROUSLY_DYNAMIC_SCALAR_TYPE_IN_SCHEMA';
    ...
    public final const LOG_EXCEPTION_ERROR_MESSAGES = 'LOG_EXCEPTION_ERROR_MESSAGES';

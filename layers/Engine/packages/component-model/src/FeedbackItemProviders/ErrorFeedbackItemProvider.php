...
class ErrorFeedbackItemProvider extends AbstractFeedbackItemProvider
{
    ...
    public function getMessagePlaceholder(string $code): string
    {
        return match ($code) {
            ...
            self::E27 => $this->__('Field \'%1$s\' has no argument(s) with name(s) \'%2$s\'', 'component-model'),
            self::E28 => $this->__('Directive \'%1$s\' has no argument(s) with name(s) \'%2$s\'', 'component-model'),

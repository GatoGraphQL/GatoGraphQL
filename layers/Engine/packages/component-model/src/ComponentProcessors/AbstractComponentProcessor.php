                    ...
                    foreach ($conditionalSubcomponents as $subcomponent) {
                        ...
                        if ($subcomponentConditionalFieldSplObjectStorage !== null) {
                            foreach ($subcomponentConditionalFieldSplObjectStorage as $subcomponentComponentField) {
                                ...
                                /** @var SplObjectStorage */
                                $conditionalFieldSubcomponentSplObjectStorage = $conditionalFieldSplObjectStorage[$subcomponentComponentField];
                                foreach ($subcomponent_conditional_data_fields as $subcomponent_conditional_data_field) {
                                    ...
                                    $conditionalFieldSubcomponentSplObjectStorage[$subcomponent_conditional_data_field] ??= new SplObjectStorage();
                                    $conditionalFieldSubcomponentSplObjectStorage[$subcomponent_conditional_data_field]->addAll($subcomponent_conditional_data_fields_storage);
                                }
                                $conditionalFieldSplObjectStorage[$subcomponentComponentField] = $conditionalFieldSubcomponentSplObjectStorage;
                            }
                ...
                if ($subcomponent_component_data_properties['conditional-data-fields'] ?? null) {
                    ...
                    foreach ($subcomponentConditionalDataFields as $conditionComponentField) {
                        ...
                        foreach ($conditionalDataFields as $conditionalDataField) {
                            ...
                            $subcomponentConditionalDataFieldStorage = $subcomponent_components_data_properties['conditional-data-fields'][$conditionComponentField];
                            $subcomponentConditionalDataFieldStorage[$conditionalDataField] = $conditionalDataFieldStorage;
                            $subcomponent_components_data_properties['conditional-data-fields'][$conditionComponentField] = $subcomponentConditionalDataFieldStorage;
                        }
                    }
                }
            ...
            if ($subcomponentConditionalDataFields->count() > 0) {
                ...
                foreach ($subcomponentConditionalDataFields as $conditionComponentField) {
                    ...
                    foreach ($conditionalDataFields as $conditionalDataField) {
                        ...
                        $subcomponentsSubcomponentFieldSplObjectStorage = $subcomponentsSubcomponentField['conditional-data-fields'][$conditionComponentField];
                        $subcomponentsSubcomponentFieldSplObjectStorage[$conditionalDataField] = $conditionalDataFieldStorage;
                        $subcomponentsSubcomponentField['conditional-data-fields'][$conditionComponentField] = $subcomponentsSubcomponentFieldSplObjectStorage;
                    }
                }
            }
            /** @var SplObjectStorage */

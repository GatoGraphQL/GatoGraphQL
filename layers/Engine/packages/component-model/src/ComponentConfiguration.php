...
class ComponentConfiguration
{
    ...
    public static function init(): void
    {
        ...
        if (self::enableConfigByParams()) {
            self::$overrideConfiguration = isset($_REQUEST[\POP_URLPARAM_CONFIG]) ? explode(\PoP\ComponentModel\Tokens\Param::VALUE_SEPARATOR, $_REQUEST[\POP_URLPARAM_CONFIG]) : array();
        }
    }

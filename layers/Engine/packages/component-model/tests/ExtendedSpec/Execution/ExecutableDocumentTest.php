...
class ExecutableDocumentTest extends UpstreamExecutableDocumentTest
{
    ...
    public function testNonExistingTypeOrInterfaceFragmentSpread()
    {
        ...
        $this->expectExceptionMessage((new FeedbackItemResolution(GraphQLSpecErrorFeedbackItemProvider::class, GraphQLSpecErrorFeedbackItemProvider::E_5_5_1_2))->getMessage());
        $parser = $this->getParser();
        $document = $parser->parse(
            <<<GRAPHQL
            {

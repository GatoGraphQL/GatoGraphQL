...
class RequestValidatorTest extends AbstractTestCase
{
    ...
    public function invalidRequestProvider(): array
    {
        ...
        $variable1 = new Variable('test', 'Int', false, false, true, false, false, [], new Location(1, 1));
        $variable1->setContext($context);
        $variable2 = new Variable('test2', 'Int', false, false, true, false, false, [], new Location(1, 1));
        $variable2->setContext($context);
        $variable3 = new Variable('test3', 'Int', false, false, true, false, false, [], new Location(1, 1));
        $variable3->setContext($context);
        $requiredVariable = new Variable('test', 'Int', true, false, true, false, false, [], new Location(1, 1));

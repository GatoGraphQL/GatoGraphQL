...
class GraphQLSpecErrorFeedbackItemProvider extends AbstractFeedbackItemProvider
{
    ...
    public function getSpecifiedByURL(string $code): ?string
    {
        return match ($code) {
            ...
            self::E_5_6_2 => 'https://spec.graphql.org/draft/#sec-Input-Object-Field-Names', // 'TODO: satisfy',
            ...
            self::E_5_8_2 => 'https://spec.graphql.org/draft/#sec-Variables-Are-Input-Types', // 'TODO: satisfy',

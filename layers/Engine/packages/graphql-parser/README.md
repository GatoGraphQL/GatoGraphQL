...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Engine/packages/graphql-parser`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Engine/packages/graphql-parser).

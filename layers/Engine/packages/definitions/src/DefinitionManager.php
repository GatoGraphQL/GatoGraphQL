...
class DefinitionManager implements DefinitionManagerInterface
{
     ...
     * Instead of using the name of the $componentVariation, we use a unique number in base 36,
     * so the name will occupy much lower size
     * Comment Leo 27/09/2017: Changed from $componentVariation to only $id so that it can also

...
The source code is hosted on the [PoP monorepo](https://github.com/GatoGraphQL/PoP), under [`Engine/packages/access-control`](https://github.com/GatoGraphQL/PoP/tree/master/layers/Engine/packages/access-control).

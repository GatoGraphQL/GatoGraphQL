...
3. [Layer dependency graph](docs/layer-dependency-graph.md) <!-- 4. [Supported PHP features](docs/supported-php-features.md) -->
...
9. [Installing Gato GraphQL](docs/installing-gatographql-for-wordpress.md)

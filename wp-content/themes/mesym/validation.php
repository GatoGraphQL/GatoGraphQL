...
class MESYM_Validation {
	...
	function validate(){
		...
		if(!defined('MESYM_ENVIRONMENT_VERSION')){
	...
	function plugins_env_warning(){
		...
		$this->admin_notice(__('Error: <b>MESYM Environment Constants</b> is not installed/activated. Without it, <b>MESYM</b> will not work. Please install this plugin from your plugin installer or download it <a href="http://wordpress.org/extend/plugins/pop/">from here</a>.','ps-pop'));
	}
}

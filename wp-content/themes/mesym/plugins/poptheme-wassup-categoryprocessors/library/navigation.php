 ...
 * navigation.php
 * ---------------------------------------------------------------------------------------------------------------*/
add_filter('gd_navigation_menu_item_icon', 'mesym_cpp_navigation_menu_item_icon', 10, 3); 
function mesym_cpp_navigation_menu_item_icon($icon, $menu_item_object_id, $html = true) {

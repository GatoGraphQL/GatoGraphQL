...
;!function(e){popCreateLocation={createLocationModal:function(e){var a=this,t=e.pageSection,r=e.targets;a.execCreateLocationModal(t,r)},createLocationModalBlock:function(e){var a=this,t=e.pageSection,r=e.targets,n=e.relatedTarget;a.transferAttributes(r.closest(".modal"),n),a.execCreateLocationModal(t,r.closest(".modal"))},maybeCloseLocationModal:function(a){var t=a.pageSection,r=a.targets,n=popManager.getSettingsId(t);r.on("fetched",function(a,t){var r=e(this),o=popManager.getSettingsId(r),i=t.feedback.block[n][o];i.result===!0&&r.closest(".modal").modal("hide")})},transferAttributes:function(e,a){a=popManager.getOriginalLink(a),e.data("typeahead-target",a.data("typeahead-target"))},execCreateLocationModal:function(a,t){var r=this;t.addClass("pop-createlocation"),t.on("show.bs.modal",function(a){var t=e(this),n=e(a.relatedTarget);r.transferAttributes(t,n)})}}}(jQuery),popJSLibraryManager.register(popCreateLocation,["createLocationModal","createLocationModalBlock","maybeCloseLocationModal"]),function(e){popMap={initBlockRuntimeMemory:function(e){var a=this,t=e.pageSection,r=e.block,n=e.runtimeMempage;n.map={},a.resetBlockRuntimeMemory(t,r)},map:function(a){var t=this,r=a.pageSection,n=a.block,o=a.targets;n.one("rerender",function(e){t.destroy(r,n,o)}),o.each(function(){var a=e(this);t.triggerShowMap(r,n,a)})},mapModal:function(a){var t=this,r=a.pageSection,n=a.targets;n.on("shown.bs.modal",function(){var a=e(this);e.each(a.find(".pop-map"),function(){var a=e(this),n=popManager.getBlock(a);popManager.jsInitialized(n)&&t.triggerShowMap(r,n,a)})})},mapStandalone:function(a){var t=this,r=a.pageSection,n=a.block,o=a.targets;popPageSectionManager.getGroup(r).on("on.bs.pagesection:theater off.bs.pagesection:theater",function(a){o.each(function(){var a=e(this);popManager.isHidden(a)||t.refresh(r,n,a)})}),n.on("fetchCompleted",function(a,i){popJSRuntimeManager.setBlockURL(n.data("toplevel-url")),o.each(function(){var a=e(this);t.triggerAddMarkers(r,n,a,i)})}),o.each(function(){var a=e(this);t.hoverBlockElems(r,n,a)})},getRuntimeMemoryPage:function(e,a){return popManager.getRuntimeMemoryPage(e,a).map},resetBlockRuntimeMemory:function(a,t){var r=this,n=r.getRuntimeMemoryPage(a,t),o={markers:{},markersPos:{},markersOpen:{},maps:{}};e.extend(n,o)},destroy:function(a,t,r){var n=this,o=n.getRuntimeMemoryPage(a,t);r.each(function(){var a=e(this),t=a.attr("id");delete o.maps[t]})},triggerShowMap:function(e,a,t){var r=this;popManager.isHidden(t)?r.pendingTriggerMap("showmap",e,a,t):r.execTriggerShowMap(e,a,t)},triggerAddMarkers:function(e,a,t,r){var n=this;popManager.isHidden(t)?n.pendingTriggerMap("addmarkers",e,a,t,r):n.addMarkers(e,a,t,r.reload)},triggerFunction:function(e,a,t,r,n){var o=this;"showmap"==e?o.triggerShowMap(a,t,r):"addmarkers"==e&&o.triggerAddMarkers(a,t,r,n)},pendingTriggerMap:function(a,t,r,n,o){var i=this,s=popManager.getPageSectionPage(r);if(popPageSectionManager.execIsHidden(t))popPageSectionManager.getGroup(t).one("on.bs.pagesection-group:pagesection-"+t.attr("id")+":opened",function(){r=e("#"+r.attr("id")),r.length&&i.triggerFunction(a,t,r,n,o)});else if(n.parents(".collapse").not(".in").length){var p=n.parents(".collapse").not(".in");p.one("shown.bs.collapse",function(){i.triggerFunction(a,t,r,n,o)})}else s.hasClass("tab-pane")&&!popManager.isActive(s)&&s.one("shown.bs.tabpane",function(){i.triggerFunction(a,t,r,n,o)})},execTriggerShowMap:function(e,a,t){var r=this;r.addMarkers(e,a,t,t.data("markers-removecurrent")),windowResize()},refresh:function(e,a,t){var r=this,n=r.getGMap(e,a,t);n&&n.refresh()},hoverBlockElems:function(a,t,r){var n=this;t.on("mouseenter",".pop-openmapmarkers",function(){var o,i=e(this);if(i.hasClass("make-popover")){var s=i.attr("aria-describedby");s&&(o=e("#"+s).find("a.pop-modalmap-link"))}else o=i.find("a.pop-modalmap-link");n.openMapMarkers(a,t,r,o)})},openMapMarkers:function(e,a,t,r){var n=this;popManager.isHidden(t)||(n.closeMarkers(e,a,t),r.length&&n.openMarkers(e,a,t,r))},closeMarkers:function(a,t,r){var n=this,o=n.getGMap(a,t,r);if(o){var i=n.getMarkersInfo(a,t,r);o.hideInfoWindows(),e.each(i.markersOpen,function(e,a){markerPos=i.markersPos[a],o.markers[markerPos]&&o.markers[markerPos].setIcon("https://maps.google.com/mapfiles/ms/icons/red-dot.png")})}},getMarkerIdsFromLinkURLs:function(a){var t=[];return a.each(function(){var a=e(this);a=popManager.getOriginalLink(a);var r=a.attr("href"),n=getParam(M.LOCATIONSID_FIELDNAME,r);n&&e.each(n,function(e,a){t.push(a)})}),t},openMarkers:function(a,t,r,n){var o=this,i=o.getMarkerIdsFromLinkURLs(n);if(i.length){i=i.filter(function(e,a){return i.indexOf(e)==a});var s=o.getGMap(a,t,r);if(s){var p=o.getMarkersInfo(a,t,r);e.each(i,function(e,a){markerPos=p.markersPos[a],s.markers[markerPos]&&s.markers[markerPos].setIcon("https://maps.google.com/mapfiles/ms/icons/green-dot.png")}),1==i.length?(markerPos=p.markersPos[i[0]],s.markers[markerPos]&&google.maps.event.trigger(s.markers[markerPos],"click")):s.fitZoom(),o.setMarkersOpen(a,t,r,i,!0)}}},initMarker:function(e,a,t,r){var n=this,o=n.getRuntimeMemoryPage(e,a),i=o.markers[t];if(i){if(i.title.split(" | ").indexOf(r.title)>-1)return;r.title=i.title+" | "+r.title,r.infoWindow.content=r.infoWindow.content+"<hr/>"+i.infoWindow.content,r.icon="https://maps.google.com/mapfiles/ms/icons/red-dot.png"}o.markers[t]=r},hasMarker:function(e,a,t){var r=this,n=r.getRuntimeMemoryPage(e,a);return n.markers[t]},getGMap:function(e,a,t){var r=this;if("undefined"!=typeof GMaps){var n=r.getRuntimeMemoryPage(e,a),o=t.attr("id"),i=n.maps[o];return i||(i=n.maps[o]=new GMaps({div:"#"+o,lat:M.LOCATIONSMAP_LAT,lng:M.LOCATIONSMAP_LNG,zoom:parseInt(M.LOCATIONSMAP_ZOOM)})),i}},getMarkersInfo:function(e,a,t){var r=this,n=t.data("markers-pagesection")||e,o=t.data("markers-block")||a,i=r.getRuntimeMemoryPage(n,o),s=t.attr("id");return{markers:i.markers||{},markersPos:i.markersPos[s]||{},markersOpen:i.markersOpen[s]||[]}},setMarkersOpen:function(e,a,t,r,n){var o=this,i=o.getRuntimeMemoryPage(e,a),s=t.attr("id");!n&&i.markersOpen[s]||(i.markersOpen[s]=[]),r&&(i.markersOpen[s]=i.markersOpen[s].concat(r))},setMarkersPos:function(a,t,r,n,o){var i=this,s=i.getRuntimeMemoryPage(a,t),p=r.attr("id");!o&&s.markersPos[p]||(s.markersPos[p]={}),n&&e.extend(s.markersPos[p],n)},removeMarker:function(e,a,t,r){var n=this,o=n.getGMap(e,a,t);if(o){var i=n.getMarkersInfo(e,a,t);markerPos=i.markersPos[r],o.markers[markerPos]&&o.markers[markerPos].setMap(null),n.zoom(e,a,t)}},zoom:function(e,a,t){var r=this,n=r.getGMap(e,a,t);if(n)if(n.markers.length>1)n.fitZoom();else if(1==n.markers.length){var o=n.markers[0].getPosition();n.setCenter(o.lat(),o.lng()),n.setZoom(parseInt(M.LOCATIONSMAP_1MARKER_ZOOM))}},addMarkers:function(a,t,r,n){var o=this,i=o.getGMap(a,t,r);if(i){n&&(i.removeMarkers(),o.setMarkersOpen(a,t,r,null,!0),o.setMarkersPos(a,t,r,null,!0));var s=r.data("marker-ids");if(s&&s.length){r.data("marker-ids",null);var p,c,g,l=o.getMarkersInfo(a,t,r),d={};e.each(s,function(e,a){p=l.markers[a];var t={content:p.infoWindow.header+"<br/>"+p.infoWindow.content},r={lat:p.coordinates.lat,lng:p.coordinates.lng,title:p.title,infoWindow:t,icon:p.icon,animation:google.maps.Animation.DROP};c=i.addMarker(r),g=i.markers.length-1,d[a]=g}),o.setMarkersPos(a,t,r,d);var m=r.data("open-onemarker-infowindow");1==s.length&&m&&(i.hideInfoWindows(),google.maps.event.trigger(c,"click")),o.zoom(a,t,r)}}},geocode:function(e,a,t,r,n,o){var i=this,s=i.getGMap(e,a,t);s&&GMaps.geocode({address:r,callback:function(e,a){if("OK"==a){s.removeMarkers();var t=e[0].geometry.location;s.setCenter(t.lat(),t.lng()),s.addMarker({lat:t.lat(),lng:t.lng(),draggable:!0}),s.setZoom(parseInt(M.LOCATIONSMAP_1MARKER_ZOOM)),n.val(t.lat()),o.val(t.lng());var r=s.markers[0];google.maps.event.addListener(r,"dragend",function(){var e=r.getPosition();n.val(e.lat()),o.val(e.lng())})}}})}}}(jQuery),function(e){popMapRuntime={initBlockRuntimeMemory:function(e){var a=this,t=e.pageSection,r=e.block,n=e.runtimeMempage;n.mapRuntime={},a.resetBlockRuntimeMemory(t,r)},getRuntimeMemoryPage:function(e,a){return popManager.getRuntimeMemoryPage(e,a).mapRuntime},resetBlockRuntimeMemory:function(a,t){var r=this,n=r.getRuntimeMemoryPage(a,t),o={content:"",title:"",marker_ids:[]};e.extend(n,o)},drawMarkers:function(e,a,t){var r=this;popManager.jsInitialized(a)?r.execDrawMarkers(e,a,t):a.one("initialize",function(){r.execDrawMarkers(e,a,t)})},execDrawMarkers:function(e,a,t){var r=this,n=r.getRuntimeMemoryPage(e,a);t.data("marker-ids",n.marker_ids)},resetMarkerIds:function(e,a){var t=this;popManager.jsInitialized(a)?t.execResetMarkerIds(e,a):a.one("initialize",function(){t.execResetMarkerIds(e,a)})},execResetMarkerIds:function(e,a){var t=this,r=t.getRuntimeMemoryPage(e,a);r.marker_ids=[]},setMarkerData:function(e,a,t,r){var n=this;popManager.jsInitialized(a)?n.execSetMarkerData(e,a,t,r):a.one("initialize",function(){n.execSetMarkerData(e,a,t,r)})},execSetMarkerData:function(e,a,t,r){var n=this,o=n.getRuntimeMemoryPage(e,a);o.title||(o.title=t),o.content||(o.content=r)},initMarker:function(e,a,t,r,n,o,i){var s=this;popManager.jsInitialized(a)?s.execInitMarker(e,a,t,r,n,o,i):a.one("initialize",function(){s.execInitMarker(e,a,t,r,n,o,i)})},execInitMarker:function(e,a,t,r,n,o,i){var s=this,p=s.getRuntimeMemoryPage(e,a);s.setMarkerData(e,a,o,i);var c=p.title,g=p.content,l={coordinates:{lat:r,lng:n},title:c,infoWindow:{header:"<strong>"+c+"</strong>",content:g},icon:"https://maps.google.com/mapfiles/ms/icons/red-dot.png"};p.marker_ids.push(t),popMap.initMarker(e,a,t,l),p.content="",p.title=""}}}(jQuery),popJSLibraryManager.register(popMap,["initBlockRuntimeMemory","map","mapModal","mapStandalone"]),popJSLibraryManager.register(popMapRuntime,["initBlockRuntimeMemory"]),function(e){popTypeaheadMap={typeaheadMap:function(a){var t=a.pageSection,r=a.block,n=a.targets;n.each(function(){var a=e(this),n=a.find(".pop-typeahead"),o=a.find(".pop-map"),i=a.data("addmarker-template");n.on("selected",function(n,s){if(!popMap.hasMarker(t,r,s.id)){var p=popManager.getTargetConfiguration(t,r,i);e.extend(p,{itemObject:s}),popJSRuntimeManager.setBlockURL(r.data("toplevel-url"));var c=popManager.getTemplateHtml(t,r,i);popManager.mergeHtml(c,a),popManager.runJSMethods(t,r,i,"last"),popJSRuntimeManager.deleteBlockLastSessionIds(t,r,i)}o.data("marker-ids",[s.id]),popMap.addMarkers(t,r,o)}),n.on("close",function(e,a,n){popMap.removeMarker(t,r,o,n)})})}}}(jQuery),popJSLibraryManager.register(popTypeaheadMap,["typeaheadMap"]),function(e){popMapCollection={formMapLocationGeocode:function(a){var t=a.pageSection,r=a.block,n=a.targets;n.find("input.address-input").change(function(){var a=e(this),n=a.closest("div.pop-map-locationgeocode"),o=[];n.find("input.address-input").each(function(){var a=e(this);a.val()&&o.push(a.val())});var i=n.find("div.pop-map"),s=n.find("input.address-lat"),p=n.find("input.address-lng");popMap.geocode(t,r,i,o.join(", "),s,p)})},modalMap:function(a){var t=this,r=a.targets;r.on("show.bs.modal",function(a){var r=e(this),n=e(a.relatedTarget);t.execModalMap(r,n)})},modalMapBlock:function(e){var a=this,t=(e.pageSection,e.block,e.targets),r=e.relatedTarget,n=t.closest(".modal");a.execModalMap(n,r)},execModalMap:function(e,a){a=popManager.getOriginalLink(a);var t=popManager.getBlock(a),r=popManager.getPageSection(t),n=e.find(".pop-map");n.data("markers-pagesection",r),n.data("markers-block",t),n.data("markers-removecurrent",!0);var o=popMap.getMarkerIdsFromLinkURLs(a);n.data("marker-ids",o)}}}(jQuery),popJSLibraryManager.register(popMapCollection,["formMapLocationGeocode","modalMap","modalMapBlock"]),function(e){popFullCalendar={initBlockRuntimeMemory:function(e){var a=this,t=e.pageSection,r=e.block,n=e.runtimeMempage;n.fullCalendar={},a.resetBlockRuntimeMemory(t,r)},calendar:function(a){var t=this,r=a.pageSection,n=a.block,o=a.targets,i=popManager.getPageSectionPage(n);i.one("destroy",function(){o.fullCalendar("destroy")}),i.hasClass("tab-pane")&&!popManager.isActive(i)&&i.one("shown.bs.tabpane",function(){o.fullCalendar("render")}),n.on("beforeMerge",function(a,n){var o=e(this);n.operation==M.URLPARAM_OPERATION_REPLACE&&t.resetBlockRuntimeMemory(r,o)}),n.on("rendered",function(a){var r=e(this),n=popManager.getPageSection(r);t.execCalendar(n,r,o,"update"),windowResize()}),t.execCalendar(r,n,o,"new")},getRuntimeMemoryPage:function(e,a){return popManager.getRuntimeMemoryPage(e,a).fullCalendar},resetBlockRuntimeMemory:function(a,t){var r=this,n=r.getRuntimeMemoryPage(a,t),o={eventsHtml:{},runJS:!1,events:[],loadedEventIds:{},loadedDates:{}};e.extend(n,o)},addEvents:function(e,a,t){var r=this;t.length&&(popManager.jsInitialized(a)?r.execAddEvents(e,a,t):a.one("initialize",function(){r.execAddEvents(e,a,t)}))},execAddEvents:function(a,t,r){var n=this,o=n.getRuntimeMemoryPage(a,t),i=[];e.each(r,function(e,r){n.isEventLoaded(a,t,r.id)||(i.push(r),n.setEventLoaded(a,t,r.id))}),e.merge(o.events,i)},execCalendar:function(a,t,r,n){var o,i=this,s=i.getRuntimeMemoryPage(a,t),p=i.getDate(a,t);"new"==n&&(o={header:{left:"title",center:"",right:""},events:function(e,a,t,r){var n;n=s.events,r(n)},defaultDate:p,fixedWeekCount:!1,height:"auto",contentHeight:"auto",dayNamesShort:M.DATERANGE_DAYSOFWEEK}),r.each(function(){var r=e(this);if("new"==n){var s=popManager.getJsSettings(a,t,r),p=s.options||{},c=e.extend({},o,p),g=s.layouts;c.eventRender=function(e,r){i.renderEvent(a,t,g,e,r)},c.eventAfterAllRender=function(e){i.renderEventAfterAll(a,t,g)},r.fullCalendar(c)}else"update"==n&&r.fullCalendar("refetchEvents")}),i.setDateLoaded(a,t,p)},setDateLoaded:function(e,a,t){var r=this,n=r.getRuntimeMemoryPage(e,a);n.loadedDates[t.year()+"-"+(t.month()+1)]=!0},isDateLoaded:function(e,a,t){var r=this,n=r.getRuntimeMemoryPage(e,a);return n.loadedDates[t.year()+"-"+(t.month()+1)]===!0},setEventLoaded:function(e,a,t){var r=this,n=r.getRuntimeMemoryPage(e,a);n.loadedEventIds[t]=!0},isEventLoaded:function(e,a,t){var r=this,n=r.getRuntimeMemoryPage(e,a);return n.loadedEventIds[t]===!0},getDate:function(e,a){var t=popManager.getBlockParams(e,a),r=parseInt(t[M.DATALOAD_VISIBLEPARAMS][M.URLPARAM_YEAR]),n=parseInt(t[M.DATALOAD_VISIBLEPARAMS][M.URLPARAM_MONTH]);return moment(r+"-"+n+"-01","YYYY-M-DD")},renderEvent:function(a,t,r,n,o){var i=this,s=i.getRuntimeMemoryPage(a,t),p=n.id,c=s.eventsHtml[p];if(c)s.runJS=!0;else{var g={},l=popManager.getDatabaseKeys(a,t),d=l["db-key"];c="",popJSRuntimeManager.setBlockURL(t.data("toplevel-url")),e.each(r,function(e,r){c+=popManager.getTemplateHtml(a,t,r,g,d,p)}),s.eventsHtml[p]=c}o.html(c)},renderEventAfterAll:function(a,t,r){var n=this,o=n.getRuntimeMemoryPage(a,t);popManager.triggerHTMLMerged(),o.runJS&&(o.runJS=!1,e.each(r,function(e,r){popManager.runJSMethods(a,t,r,"full")}))},fetch:function(e,a,t){var r=this,n=r.getDate(e,a);t.fullCalendar("gotoDate",n),r.isDateLoaded(e,a,n)||popManager.fetchBlock(e,a,{operation:M.URLPARAM_OPERATION_APPEND})}}}(jQuery),function(e){popFullCalendarControls={controlCalendarPrev:function(a){var t=this,r=a.pageSection,n=a.block,o=a.targets;o.click(function(a){var o=e(this);t.execute(r,n,o,"prev")})},controlCalendarNext:function(a){var t=this,r=a.pageSection,n=a.block,o=a.targets;o.click(function(a){var o=e(this);t.execute(r,n,o,"next")})},setCalendarBlockParams:function(e,a,t){var r=popManager.getBlockParams(e,a);r[M.DATALOAD_VISIBLEPARAMS][M.URLPARAM_YEAR]=t.year(),r[M.DATALOAD_VISIBLEPARAMS][M.URLPARAM_MONTH]=t.month()+1},execute:function(a,t,r,n){var o=this,i=e(r.closest(".pop-calendar-controls").data("target")),s=i.fullCalendar("getDate");"next"==n?s.add(1,"months"):s=s.subtract(1,"months"),o.setCalendarBlockParams(a,t,s),popManager.closeMessageFeedback(t),popFullCalendar.fetch(a,t,i)}}}(jQuery),popJSLibraryManager.register(popFullCalendar,["initBlockRuntimeMemory","calendar"]),popJSLibraryManager.register(popFullCalendarControls,["controlCalendarPrev","controlCalendarNext"]);
;function wsl_wordpress_social_login_callback(){if(popUserAccount.isLoggedIn()&&popWSL.loginBlock){var o=popManager.getPageSection(popWSL.loginBlock),l=M.WSL_LOGINUSER_CLOSETIME||1500;popSystem.timeoutClosePageSection(o,l)}}!function(o){popWSL={loginBlock:null,wslNetworkLink:function(l){var a=this,i=l.targets;i.click(function(l){l.preventDefault();var i=o(this);popupurl=i.data("url");var n=popManager.getBlock(i);a.loginBlock=o(n.data("loginblock")),window.open(popupurl,"hybridauth_social_sing_on","location=1,status=0,scrollbars=0,width=600,height=400")})}}}(jQuery),popJSLibraryManager.register(popWSL,["wslNetworkLink"]),window.wsl_wordpress_social_login=function(o){var l={params:o};popWSL.loginBlock&&(l["disable-layer"]=popWSL.loginBlock,l["urlfetched-callbacks"]=[wsl_wordpress_social_login_callback]),popUserAccount.fetchLoggedInUserData(l)};
;!function(t){popPhotoSwipe={linksImage:function(e){var i=this,a=e.anchor,r=new PhotoSwipe(t("#pswp")[0],PhotoSwipeUI_Default,i.getItems(a),i.getOptions(a));r.init()},getOptions:function(t){var e=this;return{index:e.getIndex(t),bgOpacity:.8,showHideOpacity:!0,history:!1,loop:!1,shareButtons:[{id:"download",label:M.LABELS.DOWNLOAD,url:"{{raw_image_url}}?fileaction=download",download:!0}]}},getItem:function(t){var e=t.children("img"),i={src:t.attr("href"),msrc:e.attr("src"),w:640,h:480};if(e.attr("width")&&e.attr("height")&&(i.w=e.attr("width"),i.h=e.attr("height")),t.data("size")){var a=t.data("size").split("x");i.w=a[0],i.h=a[1]}return t.attr("title")?i.title=t.attr("title"):e.attr("alt")&&(i.title=e.attr("alt")),i},getItems:function(e){var i=this,a=[],r=e.closest(".gallery");return r.length?r.find(".gallery-item a").each(function(){a.push(i.getItem(t(this)))}):a.push(i.getItem(e)),a},getIndex:function(t){var e=t.closest(".gallery-item");return e.length?e.index():0}}}(jQuery),popJSLibraryManager.register(popPhotoSwipe,["linksImage"]);
;!function(e){popCustomFunctions={addPageSectionIds:function(e){var t=e.pageSection,a=e.template,i=popManager.getSettingsId(t),n=t.attr("id");n==M.PS_HOVER_ID?popJSRuntimeManager.addPageSectionId(i,a,n,"closehover"):n==M.PS_FRAME_NAVIGATOR_ID?popJSRuntimeManager.addPageSectionId(i,a,n,"closenavigator"):n==M.PS_ADDONS_ID&&(popJSRuntimeManager.addPageSectionId(i,a,n,"window-fullsize"),popJSRuntimeManager.addPageSectionId(i,a,n,"window-maximize"),popJSRuntimeManager.addPageSectionId(i,a,n,"window-minimize"))},pageSectionInitialized:function(e){var t=e.pageSection,a=t.attr("id");a==M.PS_PAGETABS_ID&&popManager.getPageSectionGroup(t).on("on.bs.pagesection-group:pagesection-"+M.PS_HOVER_ID+":closed",function(){t.find("a.pop-pagetab-btn.active").trigger("click")})},pageSectionNewDOMsBeforeInitialize:function(t){var a=this,i=t.pageSection,n=t.newDOMs,o=t.inactivePane,r=i.attr("id");o=o===!0&&n.siblings(".pop-pagesection-page").length>0;var p=popManager.isFirstLoad(i),s=n.filter(".tab-pane"),d=[M.PS_PAGETABS_ID,M.PS_ADDONTABS_ID],c=[M.PS_MAIN_ID,M.PS_ADDONS_ID];if(c.indexOf(r)>-1){if(o){if(r==M.PS_MAIN_ID){var S=e("#"+M.PS_PAGETABS_ID);popPageSectionManager.open(S),popPageSectionManager.open(S,"xs")}}else s.addClass("active");if(r==M.PS_ADDONS_ID)s.on("shown.bs.tabpane",function(){a.handleWindow(i,"minimized")}),o||p||a.handleWindow(i,"minimized");else{var g=e("#"+M.PS_ADDONS_ID);s.on("shown.bs.tabpane",function(){a.handleWindow(g,"fullsize")}),o||p||a.handleWindow(g,"fullsize")}}else d.indexOf(r)>-1&&o&&n.filter(".pop-pagesection-page").find(".pop-pagetab-btn").addClass("pop-highlight");var l=[M.PS_MAIN_ID,M.PS_HOVER_ID,M.PS_ADDONS_ID,M.PS_FRAME_NAVIGATOR_ID],u=[M.PS_QUICKVIEW_ID,M.PS_QUICKVIEWINFO_ID],_=[M.PS_SIDEINFO_ID],I=[M.PS_MODALS_ID];if(l.indexOf(r)>-1){var P=r==M.PS_MAIN_ID,_=e("#"+M.PS_SIDEINFO_ID+",#"+M.PS_FRAME_SIDE_ID+",#"+M.PS_FRAME_NAVIGATOR_ID);popCustomBootstrap.activateTabPanes(i,n,o,P,_)}else d.indexOf(r)>-1?popCustomBootstrap.activatePageTabs(i,n,o):_.indexOf(r)>-1?popCustomBootstrap.activateSideTabpanes(i,n,o):u.indexOf(r)>-1?popCustomBootstrap.activateQuickviewTabpanes(i,n,o):I.indexOf(r)>-1&&popCustomBootstrap.activateModals(i,n)},isUserIdSameAsLoggedInUser:function(e){if(popUserAccount.isLoggedIn()){var t=e.input;return popUserAccount.id==t}return!1},getEmbedUrl:function(e){var t=this,a=e.url;return t.addURLParams(add_query_arg(M.URLPARAM_THEMEMODE,M.THEMEMODE_WASSUP_EMBED,a))},getUnembedUrl:function(e){var t=e.url;return removeQueryFields(t,[M.URLPARAM_THEMEMODE])},getPrintUrl:function(e){var t=this,a=e.url;return t.addURLParams(add_query_arg(M.URLPARAM_ACTION,M.URLPARAM_ACTION_PRINT,add_query_arg(M.URLPARAM_THEMEMODE,M.THEMEMODE_WASSUP_PRINT,a)))},scrollToElem:function(e){var t=this,a=e.elem,i=e.position,n=e.animate,o=popManager.getPageSection(i),r=i.offset().top-o.offset().top;return t.execScrollTop(a,r,n)},scrollTop:function(e){var t=this,a=e.elem,i=e.top,n=e.animate;return t.execScrollTop(a,i,n)},getPosition:function(e){var t=e.elem;return t.attr("id")!=M.PS_MAIN_ID||t.hasClass("perfect-scrollbar")?0:body.scrollTop},execScrollTop:function(t,a,i){return t.attr("id")==M.PS_MAIN_ID&&!t.hasClass("perfect-scrollbar")&&(i?e(document.body).animate({scrollTop:a},"fast"):window.scrollTo(0,a),!0)},addURLParams:function(e){return M.THEMESTYLE&&(e=add_query_arg(M.URLPARAM_THEMESTYLE,M.THEMESTYLE,e)),e},handleWindow:function(e,t){var a=e.closest(".window");popWindow.getSize(a)==t&&popWindow.maximize(a)}}}(jQuery),popJSLibraryManager.register(popCustomFunctions,["addPageSectionIds","pageSectionNewDOMsBeforeInitialize"],!0),popJSLibraryManager.register(popCustomFunctions,["pageSectionInitialized","getEmbedUrl","getUnembedUrl","getPrintUrl","isUserIdSameAsLoggedInUser","getPosition","scrollToElem","scrollTop"]),function(e){popUserRole={filterByCommunity:function(t){var a=t.pageSection,i=t.block,n=t.targets;n.change(function(t){var n=e(this),o=n.val(),r=e(n.data("target"));if(n.is(":checked")){var p=n.data("user-datum");popTypeahead.triggerSelect(a,i,r,p)}else popTypeahead.removeSelected(r,o)})}}}(jQuery),popJSLibraryManager.register(popUserRole,["filterByCommunity"]),function(e){popUREAAL={isActionUpdatedUserMembership:function(e){var t=e.input;return t==M.ACTION_USER_UPDATEDUSERMEMBERSHIP},isActionJoinedCommunity:function(e){var t=e.input;return t==M.ACTION_USER_JOINEDCOMMUNITY},isObjectTypeUser:function(e){var t=e.input;return t==M.OBJECTTYPE_USER}}}(jQuery),popJSLibraryManager.register(popUREAAL,["isActionUpdatedUserMembership","isActionJoinedCommunity","isObjectTypeUser"]);
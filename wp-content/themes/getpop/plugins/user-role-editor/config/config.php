...
function gd_ure_header_page_description_impl($description, $page_id) {
	...
	switch ($page_id) {
		...
		case POP_URE_POPPROCESSORS_PAGE_COMMUNITIES:
			...
			$description = sprintf(GD_CONSTANT_PLACEHOLDER_DESCRIPTIONVIEWALL, __('Organizations', 'getpop'));
			break;

		case POP_URE_POPPROCESSORS_PAGE_INDIVIDUALS:

			$description = sprintf(GD_CONSTANT_PLACEHOLDER_DESCRIPTIONVIEWALL, __('People', 'getpop'));
			break;

		case POP_URE_POPPROCESSORS_PAGE_ADDPROFILEORGANIZATION:

			$description = sprintf(GD_CONSTANT_PLACEHOLDER_DESCRIPTIONADDYOUR, __('Organization user account', 'getpop'));
			break;

		case POP_URE_POPPROCESSORS_PAGE_ADDPROFILEINDIVIDUAL:

			$description = sprintf(GD_CONSTANT_PLACEHOLDER_DESCRIPTIONADDYOUR, __('Individual user account', 'getpop'));
			break;
	}

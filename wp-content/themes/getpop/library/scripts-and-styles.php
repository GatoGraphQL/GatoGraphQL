	...
	if (GetPoP_Utils::is_demo()) {
		...
		$styles .= '
			...
			body.sliding.pop-loadingframe.pop-loadingjs.getpop-demo .loading-screen {
			  background: #fcec8c url('.GETPOP_ASSETS_URI.'/img/getpop-demo-bg-1440x900.jpg?ver=1) no-repeat fixed center;
			}
		...
		$styles .= '
			...
			body.sliding.pop-loadingframe.pop-loadingjs.getpop .loading-screen {
			  background: #a2dfe4 url('.GETPOP_ASSETS_URI.'/img/getpop-bg-1440x900.jpg?ver=1) no-repeat fixed center;
			}
			@media (min-width: 1440px) {
			  body.sliding.getpop .background-screen,
			  body.sliding.getpop .loading-screen {
			    background-image: url('.GETPOP_ASSETS_URI.'/img/getpop-bg-1920x1080.jpg?ver=1);
			  }
			}
		';
	}

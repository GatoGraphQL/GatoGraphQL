...
wget -O $POP_APP_PATH/wp-content/plugins/poptheme-wassup-categoryprocessors/css/dist/bundles/poptheme-wassup-categoryprocessors.bundle.min.css "http://min.localhost/?b=$POP_APP_MIN_FOLDER/plugins/poptheme-wassup-categoryprocessors/css&f=style.min.css"

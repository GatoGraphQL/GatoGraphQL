...
class PoPTheme_Wassup_CategoryProcessors_Validation {
	...
	function install_warning(){
		...
		$this->admin_notice(__('Error: <b>PoP Theme: Wassup</b> is not installed/activated. Without it, <b>PoP Theme Category Processors</b> will not work. Please install this plugin from your plugin installer or download it <a href="https://github.com/leoloso/PoP/">from here</a>.','ps-pop'));
	}

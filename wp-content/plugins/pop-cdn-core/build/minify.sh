...
wget -O $POP_APP_PATH/wp-content/plugins/pop-cdn-core/js/dist/bundles/pop-cdn-core.bundle.min.js "http://min.localhost/?b=$POP_APP_MIN_FOLDER/plugins/pop-cdn-core/js/libraries&f=cdn.min.js,cdn-coreprocessors-hooks.min.js"

(function($){popCDN={localStorageKey:'PoP:cdn-thumbprints',thumbprintValues:{},documentInitialized:function(args){var t=this;var domain=args.domain;var tlValues=popManager.getTopLevelFeedback(domain)[M.CDN_THUMBPRINTVALUES];t.thumbprintValues=popManager.getStoredData(t.localStorageKey,false);if(t.thumbprintValues){t.updateThumbprintValues(tlValues);}

...
define ('GD_TEMPLATE_BLOCK_WHATISIT', PoP_ServerUtils::get_template_definition('block-whatisit'));
// define ('GD_TEMPLATE_BLOCK_DISCOVER', PoP_ServerUtils::get_template_definition('block-discover'));
define ('GD_TEMPLATE_BLOCK_FRAMEWORK', PoP_ServerUtils::get_template_definition('block-framework'));
...
define ('GD_TEMPLATE_BLOCK_WEBSITEFEATURES_SOCIALNETWORK', PoP_ServerUtils::get_template_definition('block-websitefeatures-socialnetwork'));
...
define ('GD_TEMPLATE_BLOCK_WEBSITEFEATURES_ADVANTAGES', PoP_ServerUtils::get_template_definition('block-websitefeatures-advantages'));
...
class GetPoP_Template_Processor_CustomSectionBlocks extends GD_Template_Processor_BlocksBase {
	...
	protected function get_block_inner_templates($template_id) {
		...
		$inners = array(			
			...
			GD_TEMPLATE_BLOCK_WHATISIT => GD_TEMPLATE_POSTCODE_WHATISIT,
			// GD_TEMPLATE_BLOCK_DISCOVER => GD_TEMPLATE_POSTCODE_DISCOVER, //GD_TEMPLATE_CONTENT_DEMODOWNLOADS,
			GD_TEMPLATE_BLOCK_FRAMEWORK => GD_TEMPLATE_POSTCODE_FRAMEWORK,
			...
			GD_TEMPLATE_BLOCK_WEBSITEFEATURES_SOCIALNETWORK => GD_TEMPLATE_CONTENT_WEBSITEFEATURES_SOCIALNETWORK,
			GD_TEMPLATE_BLOCK_WEBSITEFEATURES_UNDERTHEHOOD => GD_TEMPLATE_CONTENT_WEBSITEFEATURES_UNDERTHEHOOD,
			GD_TEMPLATE_BLOCK_WEBSITEFEATURES_ADVANTAGES => GD_TEMPLATE_CONTENT_WEBSITEFEATURES_ADVANTAGES,
	...
	function get_title($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCK_WEBSITEFEATURES_SOCIALNETWORK:
				...
				return __('Social network features', 'getpop-processors');

			case GD_TEMPLATE_BLOCK_WEBSITEFEATURES_UNDERTHEHOOD:

				return __('Under the hood', 'getpop-processors');

			case GD_TEMPLATE_BLOCK_WEBSITEFEATURES_ADVANTAGES:

				return __('Advantages of using PoP', 'getpop-processors');

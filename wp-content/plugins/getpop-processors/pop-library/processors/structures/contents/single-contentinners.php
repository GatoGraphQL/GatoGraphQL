...
define ('GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_SOCIALNETWORK', PoP_ServerUtils::get_template_definition('contentinner-websitefeatures-socialnetwork'));
...
define ('GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_ADVANTAGES', PoP_ServerUtils::get_template_definition('contentinner-websitefeatures-advantages'));
...
class GetPoP_Template_Processor_SingleContentInners extends GD_Template_Processor_ContentSingleInnersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_SOCIALNETWORK,
			GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_UNDERTHEHOOD,
			GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_ADVANTAGES,
	...
	function get_layouts($template_id) {
		...
		$layouts = array(
			...
			GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_SOCIALNETWORK => GD_TEMPLATE_CODE_WEBSITEFEATURES_SOCIALNETWORK,
			GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_UNDERTHEHOOD => GD_TEMPLATE_CODE_WEBSITEFEATURES_UNDERTHEHOOD,
			GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_ADVANTAGES => GD_TEMPLATE_CODE_WEBSITEFEATURES_ADVANTAGES,

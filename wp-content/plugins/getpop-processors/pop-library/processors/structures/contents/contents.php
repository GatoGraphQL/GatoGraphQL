...
define ('GD_TEMPLATE_CONTENT_WEBSITEFEATURES_SOCIALNETWORK', PoP_ServerUtils::get_template_definition('content-websitefeatures-socialnetwork'));
...
define ('GD_TEMPLATE_CONTENT_WEBSITEFEATURES_ADVANTAGES', PoP_ServerUtils::get_template_definition('content-websitefeatures-advantages'));
...
class GetPoP_Template_Processor_Contents extends GD_Template_Processor_ContentsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_CONTENT_WEBSITEFEATURES_SOCIALNETWORK,
			GD_TEMPLATE_CONTENT_WEBSITEFEATURES_UNDERTHEHOOD,
			GD_TEMPLATE_CONTENT_WEBSITEFEATURES_ADVANTAGES,
	...
	function get_inner_template($template_id) {
		...
		$inners = array(
			...
			GD_TEMPLATE_CONTENT_WEBSITEFEATURES_SOCIALNETWORK => GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_SOCIALNETWORK,
			GD_TEMPLATE_CONTENT_WEBSITEFEATURES_UNDERTHEHOOD => GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_UNDERTHEHOOD,
			GD_TEMPLATE_CONTENT_WEBSITEFEATURES_ADVANTAGES => GD_TEMPLATE_CONTENTINNER_WEBSITEFEATURES_ADVANTAGES,

...
class OrganikFundraising_Processors_PageSectionSettingsProcessor extends Wassup_PageSectionSettingsProcessorBase {
	...
	function add_sideinfo_page_blockunits(&$ret, $template_id) {
		...
		if ($add) {
			...
			switch ($page_id) {
				 ...
				 * About
				 *********************************************/
				case ORGANIKFUNDRAISING_PROCESSORS_PAGE_HOME:
				case ORGANIKFUNDRAISING_PROCESSORS_PAGE_ASKTHEEXPERTS:
				case ORGANIKFUNDRAISING_PROCESSORS_PAGE_HOWMUCHWENEED:
				case ORGANIKFUNDRAISING_PROCESSORS_PAGE_CONTACTABOUTUS:
 ...
 * Initialization
 * ---------------------------------------------------------------------------------------------------------------*/
new OrganikFundraising_Processors_PageSectionSettingsProcessor();

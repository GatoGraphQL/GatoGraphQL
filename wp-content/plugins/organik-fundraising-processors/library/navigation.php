 ...
 * navigation.php
 * ---------------------------------------------------------------------------------------------------------------*/
add_filter('gd_navigation_menu_item_icon', 'organikfundraising_processors_navigation_menu_item_icon', 10, 3); 
function organikfundraising_processors_navigation_menu_item_icon($icon, $menu_item_object_id, $html = true) {

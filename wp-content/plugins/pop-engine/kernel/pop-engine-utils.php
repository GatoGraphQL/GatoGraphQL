...
class GD_TemplateManager_Utils {
	...
	public static function get_current_url() {
		...
		$url = remove_query_arg(array(GD_URLPARAM_SETTINGSFORMAT, GD_URLPARAM_THEME, GD_URLPARAM_THEMEMODE, GD_URLPARAM_THEMESTYLE, GD_URLPARAM_TARGET, GD_URLPARAM_MODULE, GD_URLPARAM_OUTPUT, GD_URLPARAM_DATASTRUCTURE), full_url());

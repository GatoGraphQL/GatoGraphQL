...
class AgendaUrbana_Processors_Validation {
	...
	function install_warning(){
		...
		$this->admin_notice(__('Error: <b>PoP Theme: Wassup</b> is not installed/activated. Without it, <b>Agenda Urbana Processors</b> will not work. Please install this plugin from your plugin installer or download it <a href="http://wordpress.org/extend/plugins/pop/">from here</a>.','ps-pop'));
	}
	function version_warning(){
		
		$this->admin_notice(__('Warning: please make sure to have the <a href="http://wordpress.org/extend/plugins/pop/">latest version</a> of <b>PoP Theme: Wassup</b> installed, or otherwise <b>AgendaUrbana Processors</b> might not function properly.','ps-pop'));
	}
}

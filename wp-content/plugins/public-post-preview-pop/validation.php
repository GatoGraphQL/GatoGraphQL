...
define('PPPPOP_POP_COREPROCESSORS_MIN_VERSION', 0.1);
...
class PPP_PoP_Validation {
	...
	function validate() {
		...
		elseif(PPPPOP_POP_COREPROCESSORS_MIN_VERSION > POP_COREPROCESSORS_VERSION){
	...
	function plugin_install_warning(){
		...
		$this->admin_notice(__('Error: <b>Public Post Preview for PoP</b> is not installed/activated. Without it, <b>Public Post Preview PoP Processors</b> will not work. Please install this plugin from your plugin installer or download it <a href="https://github.com/leoloso/PoP/">from here</a>.','ps-pop'));
	}

...
class PoPTheme_Wassup_AutomatedEmails_AAL_Template_SettingsProcessor extends GD_Template_SettingsProcessorBase {
	...
	function get_checkpoints($hierarchy) {
		...
		if ($hierarchy == GD_SETTINGS_HIERARCHY_PAGE) {
			...
			return array(
				POPTHEME_WASSUP_AUTOMATEDEMAILS_PAGE_LATESTNOTIFICATIONS_DAILY => PoPTheme_Wassup_PoPSystem_SettingsProcessor_CheckpointUtils::get_checkpoint($hierarchy, WASSUP_CHECKPOINT_LOGGEDIN_SYSTEMACCESSVALID),
			);
		}

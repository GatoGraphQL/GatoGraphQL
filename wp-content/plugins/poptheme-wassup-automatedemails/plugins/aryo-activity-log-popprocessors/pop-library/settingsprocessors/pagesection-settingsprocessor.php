...
class PoPTheme_Wassup_AutomatedEmails_AAL_PageSectionSettingsProcessor extends Wassup_PageSectionSettingsProcessorBase {
	...
	function add_sideinfo_page_blockunits(&$ret, $template_id) {
		...
		if ($add) {
			...
			switch ($page_id) {
				...
				case POPTHEME_WASSUP_AUTOMATEDEMAILS_PAGE_LATESTNOTIFICATIONS_DAILY:
 ...
 * Initialization
 * ---------------------------------------------------------------------------------------------------------------*/
new PoPTheme_Wassup_AutomatedEmails_AAL_PageSectionSettingsProcessor();

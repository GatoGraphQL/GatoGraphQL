...
define ('GD_TEMPLATE_SCROLL_AUTOMATEDEMAILS_NOTIFICATIONS_DETAILS', PoP_TemplateIDUtils::get_template_definition('scroll-automatedemails-notifications-details'));
define ('GD_TEMPLATE_SCROLL_AUTOMATEDEMAILS_NOTIFICATIONS_LIST', PoP_TemplateIDUtils::get_template_definition('scroll-automatedemails-notifications-list'));

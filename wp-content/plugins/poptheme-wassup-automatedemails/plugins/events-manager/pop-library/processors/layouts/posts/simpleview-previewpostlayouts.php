...
define ('GD_TEMPLATE_LAYOUT_AUTOMATEDEMAILS_PREVIEWPOST_EVENT_SIMPLEVIEW', PoP_ServerUtils::get_template_definition('layout-automatedemails-previewpost-event-simpleview'));

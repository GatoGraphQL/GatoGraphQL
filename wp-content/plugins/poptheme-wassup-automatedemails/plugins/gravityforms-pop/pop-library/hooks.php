...
class PoP_ThemeWassup_AE_GF_NewsletterRecipientsHooks {

    function __construct() {

        add_filter(
            'PoP_ThemeWassup_AE_NewsletterRecipientsBase:recipients',
            array($this, 'get_recipients')
        );
    }

    function get_recipients($recipients) {

        if ($form_id = PoP_GFPoPGenericForms_GFHelpers::get_newsletter_form_id()) {
 ...
 * Initialization
 * ---------------------------------------------------------------------------------------------------------------*/
new PoP_ThemeWassup_AE_GF_NewsletterRecipientsHooks();

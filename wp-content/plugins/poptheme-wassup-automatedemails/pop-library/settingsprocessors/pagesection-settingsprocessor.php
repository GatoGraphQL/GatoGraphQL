...
class PoPTheme_Wassup_AutomatedEmails_PageSectionSettingsProcessor extends Wassup_PageSectionSettingsProcessorBase {
 ...
 * Initialization
 * ---------------------------------------------------------------------------------------------------------------*/
new PoPTheme_Wassup_AutomatedEmails_PageSectionSettingsProcessor();

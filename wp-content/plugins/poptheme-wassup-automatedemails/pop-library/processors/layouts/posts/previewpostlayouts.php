...
define ('GD_TEMPLATE_LAYOUT_AUTOMATEDEMAILS_PREVIEWPOST_POST_DETAILS', PoP_ServerUtils::get_template_definition('layout-automatedemails-previewpost-post-details'));
define ('GD_TEMPLATE_LAYOUT_AUTOMATEDEMAILS_PREVIEWPOST_POST_THUMBNAIL', PoP_ServerUtils::get_template_definition('layout-automatedemails-previewpost-post-thumbnail'));
define ('GD_TEMPLATE_LAYOUT_AUTOMATEDEMAILS_PREVIEWPOST_POST_LIST', PoP_ServerUtils::get_template_definition('layout-automatedemails-previewpost-post-list'));

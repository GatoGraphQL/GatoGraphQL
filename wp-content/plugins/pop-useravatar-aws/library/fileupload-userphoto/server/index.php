...
require_once dirname(__FILE__).'/../../../../pop-useravatar/library/fileupload-userphoto/server/config.php';

// Override with AWS version
require_once dirname(__FILE__).'/uploadHandlerS3.php';

// Load the upload class from UserAvatar PoP
require_once dirname(__FILE__).'/../../../../pop-useravatar/library/fileupload-userphoto/server/upload.php';

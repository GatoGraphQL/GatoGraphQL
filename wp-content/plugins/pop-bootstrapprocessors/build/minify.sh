...
cd $POP_APP_PATH/wp-content/plugins/pop-bootstrapprocessors/js/
uglifyjs libraries/bootstrap.js -o dist/libraries/bootstrap.min.js -c warnings=false -m
uglifyjs libraries/custombootstrap.js -o dist/libraries/custombootstrap.min.js -c warnings=false -m

# All files together: generate it EXACTLY in this order, as it was taken from scripts_and_styles.php
rm $POP_APP_MIN_PATH/$POP_APP_MIN_FOLDER/plugins/pop-bootstrapprocessors/js/libraries/*.js
cp $POP_APP_PATH/wp-content/plugins/pop-bootstrapprocessors/js/dist/libraries/*.min.js $POP_APP_MIN_PATH/$POP_APP_MIN_FOLDER/plugins/pop-bootstrapprocessors/js/libraries/
wget -O $POP_APP_PATH/wp-content/plugins/pop-bootstrapprocessors/js/dist/bundles/pop-bootstrapprocessors.bundle.min.js "http://min.localhost/?b=$POP_APP_MIN_FOLDER/plugins/pop-bootstrapprocessors/js/libraries&f=custombootstrap.min.js,bootstrap.min.js"

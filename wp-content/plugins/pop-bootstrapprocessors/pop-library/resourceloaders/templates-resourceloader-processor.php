...
define ('POP_RESOURCELOADER_TEMPLATE_BLOCKGROUP_CAROUSEL', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_BLOCKGROUP_CAROUSEL));
define ('POP_RESOURCELOADER_TEMPLATE_BLOCKGROUP_COLLAPSEPANELGROUP', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_BLOCKGROUP_COLLAPSEPANELGROUP));
define ('POP_RESOURCELOADER_TEMPLATE_BLOCKGROUP_TABPANEL', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_BLOCKGROUP_TABPANEL));
define ('POP_RESOURCELOADER_TEMPLATE_BLOCKGROUP_VIEWCOMPONENT', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_BLOCKGROUP_VIEWCOMPONENT));
define ('POP_RESOURCELOADER_TEMPLATE_PAGESECTION_MODAL', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_PAGESECTION_MODAL));
define ('POP_RESOURCELOADER_TEMPLATE_PAGESECTION_PAGETAB', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_PAGESECTION_PAGETAB));
define ('POP_RESOURCELOADER_TEMPLATE_PAGESECTION_TABPANE', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_PAGESECTION_TABPANE));

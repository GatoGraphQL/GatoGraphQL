...
popBootstrap.closeModals();var theater;if(tabPane){if(tabPane.data('lastposition')){popManager.scrollTop(pageSection,tabPane.data('lastposition'));tabPane.data('lastposition',null);}

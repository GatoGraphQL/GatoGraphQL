...
var options={'force-init':true};var url=component.data('intercept-url')||component.data('original-url');if(url){options.url=url;}
...
return false;},};})(jQuery);popJSLibraryManager.register(popBootstrap,['modal','closeModals','popover','contentPopover','tooltip','openParentCollapse','alertCloseOnTimeout','scrollTop']);
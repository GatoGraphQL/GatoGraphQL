...
class GD_URE_Template_Processor_MemberPrivilegesLayoutsBase extends GD_Template_ProcessorBase {

	function get_template_source($template_id, $atts) {
	
		return GD_TEMPLATESOURCE_LAYOUTUSER_MEMBERPRIVILEGES;
	}

	function get_data_fields($template_id, $atts) {
	
		return array('memberprivileges-strings');
	}	

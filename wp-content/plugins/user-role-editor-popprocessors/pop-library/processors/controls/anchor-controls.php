	...
	function get_href($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_URE_TEMPLATE_ANCHORCONTROL_CONTENTSOURCEORGANIZATION:
				...
				$sources = array(
					GD_URE_TEMPLATE_ANCHORCONTROL_CONTENTSOURCECOMMUNITY => GD_URLPARAM_URECONTENTSOURCE_COMMUNITY,
					GD_URE_TEMPLATE_ANCHORCONTROL_CONTENTSOURCEORGANIZATION => GD_URLPARAM_URECONTENTSOURCE_ORGANIZATION,
				);
				...
				$url = remove_query_arg(GD_URLPARAM_URECONTENTSOURCE, $url);

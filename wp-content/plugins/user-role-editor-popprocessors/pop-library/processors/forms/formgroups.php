...
define ('GD_URE_TEMPLATE_FORMCOMPONENTGROUP_SELECTABLETYPEAHEAD_COMMUNITIES', PoP_TemplateIDUtils::get_template_definition('ure-formcomponentgroup-selectabletypeahead-ure-communities'));

define ('GD_URE_TEMPLATE_FILTERFORMCOMPONENTGROUP_TYPEAHEAD_PROFILES', PoP_TemplateIDUtils::get_template_definition('filterformcomponentgroup-users'));
define ('GD_URE_TEMPLATE_FILTERFORMCOMPONENTGROUP_TYPEAHEAD_COMMUNITYUSERS', PoP_TemplateIDUtils::get_template_definition('filterformcomponentgroup-community-users'));
define ('GD_URE_TEMPLATE_FILTERFORMCOMPONENTGROUP_TYPEAHEAD_COMMUNITIES_POST', PoP_TemplateIDUtils::get_template_definition('filterformcomponentgroup-communities-post'));
define ('GD_URE_TEMPLATE_FILTERFORMCOMPONENTGROUP_TYPEAHEAD_COMMUNITIES_USER', PoP_TemplateIDUtils::get_template_definition('filterformcomponentgroup-communities-user'));

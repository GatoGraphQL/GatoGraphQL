...
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUTUSER_MEMBERPRIVILEGES', PoP_TemplateIDUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUTUSER_MEMBERPRIVILEGES));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUTUSER_MEMBERSTATUS', PoP_TemplateIDUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUTUSER_MEMBERSTATUS));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUTUSER_MEMBERTAGS', PoP_TemplateIDUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUTUSER_MEMBERTAGS));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUTUSER_TYPEAHEAD_SELECTED_FILTERBYCOMMUNITY', PoP_TemplateIDUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUTUSER_TYPEAHEAD_SELECTED_FILTERBYCOMMUNITY));
...
class URE_PoPProcessors_TemplateResourceLoaderProcessor extends PoP_TemplateResourceLoaderProcessor {
	...
	function get_dir($resource) {
		...
		return URE_POPPROCESSORS_DIR.'/js/dist/templates';
	}
}

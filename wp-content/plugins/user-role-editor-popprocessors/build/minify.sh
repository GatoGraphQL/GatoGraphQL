...
wget -O $POP_APP_PATH/wp-content/plugins/user-role-editor-popprocessors/js/dist/bundles/user-role-editor-popprocessors.templates.bundle.min.js "http://min.localhost/?b=$POP_APP_MIN_FOLDER/plugins/user-role-editor-popprocessors/js/templates&f=ure-layoutuser-typeahead-selected-filterbycommunity.tmpl.js,ure-layoutuser-memberprivileges.tmpl.js,ure-layoutuser-memberstatus.tmpl.js,ure-layoutuser-membertags.tmpl.js"

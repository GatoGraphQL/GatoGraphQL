...
// 	// Simply render the renderer
// 	global $popcore_userloggedinstyles_filerenderer;
// 	$styles .= $popcore_userloggedinstyles_filerenderer->render();
// 	return $styles;
// }
// add_filter('pop_header_inlinestyles:styles', 'wassup_loggedin_styles');
// function wassup_loggedin_styles($styles) {
...
function get_loggedin_domain_styles($domain) {
	...
	global $popcore_userloggedinstyles_filerenderer;
	foreach ($popcore_userloggedinstyles_filerenderer->get() as $filereproduction) {
		
		$filereproduction->setDomain($domain);
	}
	return $popcore_userloggedinstyles_filerenderer->render();
}

...
# cp libraries/fileupload.js $POP_APP_MIN_PATH/$POP_APP_MIN_FOLDER/plugins/pop-coreprocessors/js/libraries/
...
wget -O $POP_APP_PATH/wp-content/plugins/pop-coreprocessors/js/dist/pop-coreprocessors.bundle.min.js "http://min.localhost/?b=$POP_APP_MIN_FOLDER/plugins/pop-coreprocessors/js/libraries&f=helpers.handlebars.js,custombootstrap.js,system.js,addeditpost.js,editor.js,mentions.js,featuredimage.js,user-account.js,bootstrap.js,bootstrap-carousel.js,waypoints.js,window.js,multiselect.js,dynamicmaxheight.js,daterange.js,typeahead.js,modals.js,analytics.js,perfectscrollbar.js,functions.js,block-functions.js,controls.js,jquery.fullscreen-min.js,bootstrap-multiselect.0.9.13.js,jquery.dynamicmaxheight.min.js"

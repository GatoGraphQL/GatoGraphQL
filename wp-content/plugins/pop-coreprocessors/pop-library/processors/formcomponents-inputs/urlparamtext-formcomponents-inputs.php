...
define ('GD_TEMPLATE_FORMCOMPONENT_POSTID', PoP_TemplateIDUtils::get_template_definition('pid', true));
define ('GD_TEMPLATE_FORMCOMPONENT_USERID', PoP_TemplateIDUtils::get_template_definition('uid', true));
define ('GD_TEMPLATE_FORMCOMPONENT_COMMENTID', PoP_TemplateIDUtils::get_template_definition('cid', true));

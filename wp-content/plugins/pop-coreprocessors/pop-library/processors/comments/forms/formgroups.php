...
define ('GD_TEMPLATE_FORMCOMPONENTGROUP_COMMENTEDITOR', PoP_ServerUtils::get_template_definition('formcomponentgroupcommenteditor')); // Lowercase letters, no _ or - (http://codex.wordpress.org/Function_Reference/wp_editor)

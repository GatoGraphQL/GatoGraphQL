...
// require_once 'pagesections/load.php';
...
require_once 'sidebars/load.php';
require_once 'sidebar-layouts/load.php';
...
require_once 'media/load.php';
require_once 'createupdateuser/load.php';
require_once 'createupdateprofile/load.php';
require_once 'comments/load.php';
require_once 'functions/load.php';
require_once 'viewcomponents/load.php';
require_once 'login/load.php';
require_once 'quicklinks/load.php';
require_once 'submenus/load.php';

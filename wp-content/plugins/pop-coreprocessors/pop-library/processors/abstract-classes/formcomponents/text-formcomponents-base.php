...
class GD_Template_Processor_TextFormComponentsBase extends GD_Template_Processor_FormComponentsBase {

	function get_template_source($template_id, $atts) {

		return GD_TEMPLATESOURCE_FORMCOMPONENT_TEXT;
	}
	...
	function get_template_configuration($template_id, $atts) {
		...
		$ret['type'] = $this->get_type($template_id, $atts);

...
class GD_Template_Processor_FunctionLayouts extends GD_Template_Processor_StylesLayoutsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_LAYOUT_SUBSCRIBETOTAG_SHOW_STYLES,
			GD_TEMPLATE_LAYOUT_SUBSCRIBETOTAG_HIDE_STYLES,
			GD_TEMPLATE_LAYOUT_UNSUBSCRIBEFROMTAG_SHOW_STYLES,
			GD_TEMPLATE_LAYOUT_UNSUBSCRIBEFROMTAG_HIDE_STYLES,
	...
	function get_elem_target($template_id, $atts) {
		...
		$targets = array(
			...
			GD_TEMPLATE_LAYOUT_SUBSCRIBETOTAG_SHOW_STYLES => GD_CLASS_SUBSCRIBETOTAG,
			GD_TEMPLATE_LAYOUT_UNSUBSCRIBEFROMTAG_SHOW_STYLES => GD_CLASS_UNSUBSCRIBEFROMTAG,
			...
			GD_TEMPLATE_LAYOUT_SUBSCRIBETOTAG_HIDE_STYLES => GD_CLASS_SUBSCRIBETOTAG,
			GD_TEMPLATE_LAYOUT_UNSUBSCRIBEFROMTAG_HIDE_STYLES => GD_CLASS_UNSUBSCRIBEFROMTAG,
	...
	function get_elem_styles($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_LAYOUT_SUBSCRIBETOTAG_SHOW_STYLES:
			case GD_TEMPLATE_LAYOUT_UNSUBSCRIBEFROMTAG_SHOW_STYLES:
			...
			case GD_TEMPLATE_LAYOUT_SUBSCRIBETOTAG_HIDE_STYLES:
			case GD_TEMPLATE_LAYOUT_UNSUBSCRIBEFROMTAG_HIDE_STYLES:

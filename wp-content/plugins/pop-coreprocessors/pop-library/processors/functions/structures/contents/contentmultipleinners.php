...
class GD_Template_Processor_FunctionsContentMultipleInners extends GD_Template_Processor_ContentMultipleInnersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_CONTENTINNER_SUBSCRIBESTOTAGS,
			GD_TEMPLATE_CONTENTINNER_UNSUBSCRIBESFROMTAGS,
		...
		switch ($template_id) {
			...
			default:
				...
				$layouts = array(
					...
					GD_TEMPLATE_CONTENTINNER_SUBSCRIBESTOTAGS => GD_TEMPLATE_LAYOUT_SUBSCRIBETOTAG_STYLES,
					GD_TEMPLATE_CONTENTINNER_UNSUBSCRIBESFROMTAGS => GD_TEMPLATE_LAYOUT_UNSUBSCRIBEFROMTAG_STYLES,

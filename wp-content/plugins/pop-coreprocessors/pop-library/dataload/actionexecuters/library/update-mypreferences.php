	...
	protected function get_inputs_metakeys() {
		...
		return apply_filters(
			...
			array(
				...
				GD_TEMPLATE_FORMCOMPONENT_EMAILDIGESTS_WEEKLYLATESTPOSTS => GD_METAKEY_PROFILE_EMAILDIGESTS_WEEKLYLATESTPOSTS,
				GD_TEMPLATE_FORMCOMPONENT_EMAILDIGESTS_WEEKLYUPCOMINGEVENTS => GD_METAKEY_PROFILE_EMAILDIGESTS_WEEKLYUPCOMINGEVENTS,
				GD_TEMPLATE_FORMCOMPONENT_EMAILDIGESTS_DAILYNOTIFICATIONS => GD_METAKEY_PROFILE_EMAILDIGESTS_DAILYNOTIFICATIONS,
				GD_TEMPLATE_FORMCOMPONENT_EMAILDIGESTS_SPECIALPOSTS => GD_METAKEY_PROFILE_EMAILDIGESTS_SPECIALPOSTS,

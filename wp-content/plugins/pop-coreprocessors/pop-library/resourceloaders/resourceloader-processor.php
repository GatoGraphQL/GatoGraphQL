...
// define ('POP_RESOURCELOADER_ANALYTICS', PoP_ServerUtils::get_template_definition('analytics'));
define ('POP_RESOURCELOADER_DATERANGE', PoP_ServerUtils::get_template_definition('daterange'));
define ('POP_RESOURCELOADER_DYNAMICMAXHEIGHT', PoP_ServerUtils::get_template_definition('dynamicmaxheight'));
define ('POP_RESOURCELOADER_MULTISELECT', PoP_ServerUtils::get_template_definition('multiselect'));
define ('POP_RESOURCELOADER_PERFECTSCROLLBAR', PoP_ServerUtils::get_template_definition('perfectscrollbar'));
define ('POP_RESOURCELOADER_TYPEAHEAD', PoP_ServerUtils::get_template_definition('typeahead'));
define ('POP_RESOURCELOADER_WAYPOINTS', PoP_ServerUtils::get_template_definition('waypoints'));
define ('POP_RESOURCELOADER_ADDEDITPOST', PoP_ServerUtils::get_template_definition('addeditpost'));
// define ('POP_RESOURCELOADER_BLOCKFUNCTIONS', PoP_ServerUtils::get_template_definition('block-functions'));
define ('POP_RESOURCELOADER_BOOTSTRAPCAROUSEL', PoP_ServerUtils::get_template_definition('bootstrap-carousel'));
define ('POP_RESOURCELOADER_CONTROLS', PoP_ServerUtils::get_template_definition('controls'));
define ('POP_RESOURCELOADER_EDITOR', PoP_ServerUtils::get_template_definition('editor'));
define ('POP_RESOURCELOADER_FEATUREDIMAGE', PoP_ServerUtils::get_template_definition('featuredimage'));
define ('POP_RESOURCELOADER_COOKIES', PoP_ServerUtils::get_template_definition('cookies'));
define ('POP_RESOURCELOADER_FUNCTIONS', PoP_ServerUtils::get_template_definition('functions'));
define ('POP_RESOURCELOADER_INPUTFUNCTIONS', PoP_ServerUtils::get_template_definition('input-functions'));
define ('POP_RESOURCELOADER_EMBEDFUNCTIONS', PoP_ServerUtils::get_template_definition('embed-functions'));
define ('POP_RESOURCELOADER_PRINTFUNCTIONS', PoP_ServerUtils::get_template_definition('print-functions'));
define ('POP_RESOURCELOADER_CONTENTFUNCTIONS', PoP_ServerUtils::get_template_definition('content-functions'));
define ('POP_RESOURCELOADER_TARGETFUNCTIONS', PoP_ServerUtils::get_template_definition('target-functions'));
define ('POP_RESOURCELOADER_SOCIALMEDIA', PoP_ServerUtils::get_template_definition('socialmedia'));
define ('POP_RESOURCELOADER_EMBEDDABLE', PoP_ServerUtils::get_template_definition('embeddable'));
define ('POP_RESOURCELOADER_BLOCKDATAQUERY', PoP_ServerUtils::get_template_definition('block-dataquery'));
define ('POP_RESOURCELOADER_BLOCKGROUPDATAQUERY', PoP_ServerUtils::get_template_definition('blockgroup-dataquery'));
define ('POP_RESOURCELOADER_MENUS', PoP_ServerUtils::get_template_definition('menus'));
define ('POP_RESOURCELOADER_DATASETCOUNT', PoP_ServerUtils::get_template_definition('dataset-count'));
define ('POP_RESOURCELOADER_REPLICATE', PoP_ServerUtils::get_template_definition('replicate'));
define ('POP_RESOURCELOADER_FORMS', PoP_ServerUtils::get_template_definition('forms'));
define ('POP_RESOURCELOADER_LINKS', PoP_ServerUtils::get_template_definition('links'));
define ('POP_RESOURCELOADER_CLASSES', PoP_ServerUtils::get_template_definition('classes'));
define ('POP_RESOURCELOADER_SCROLLS', PoP_ServerUtils::get_template_definition('scrolls'));
define ('POP_RESOURCELOADER_ONLINEOFFLINE', PoP_ServerUtils::get_template_definition('onlineoffline'));
define ('POP_RESOURCELOADER_EVENTREACTIONS', PoP_ServerUtils::get_template_definition('event-reactions'));
define ('POP_RESOURCELOADER_FEEDBACKMESSAGE', PoP_ServerUtils::get_template_definition('feedback-message'));
define ('POP_RESOURCELOADER_COREHANDLEBARSHELPERS', PoP_ServerUtils::get_template_definition('core-helpers-handlebars'));
define ('POP_RESOURCELOADER_MEDIAMANAGERCORS', PoP_ServerUtils::get_template_definition('mediamanager-cors'));
define ('POP_RESOURCELOADER_MEDIAMANAGER', PoP_ServerUtils::get_template_definition('mediamanager'));
define ('POP_RESOURCELOADER_MENTIONS', PoP_ServerUtils::get_template_definition('mentions'));
define ('POP_RESOURCELOADER_MODALS', PoP_ServerUtils::get_template_definition('modals'));
define ('POP_RESOURCELOADER_SYSTEM', PoP_ServerUtils::get_template_definition('system'));
define ('POP_RESOURCELOADER_TABS', PoP_ServerUtils::get_template_definition('tabs'));
define ('POP_RESOURCELOADER_USERACCOUNT', PoP_ServerUtils::get_template_definition('user-account'));
define ('POP_RESOURCELOADER_WINDOW', PoP_ServerUtils::get_template_definition('window'));

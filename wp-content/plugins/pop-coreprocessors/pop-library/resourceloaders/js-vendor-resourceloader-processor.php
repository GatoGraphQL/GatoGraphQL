	...
	function get_path($resource) {
		...
		switch ($resource) {
			...
			case POP_RESOURCELOADER_EXTERNAL_DYNAMICMAXHEIGHT:
				...
				return POP_COREPROCESSORS_URL.'/js/includes';
		}

		return POP_COREPROCESSORS_URL.'/js/includes/cdn';
	}
	...
	function get_dependencies($resource) {
		...
		switch ($resource) {
			...
			case POP_RESOURCELOADER_EXTERNAL_DYNAMICMAXHEIGHT:
				...
				$dependencies[] = POP_RESOURCELOADER_EXTERNAL_CSS_DYNAMICMAXHEIGHT;
				break;

			case POP_RESOURCELOADER_EXTERNAL_PERFECTSCROLLBAR:
			
				$dependencies[] = POP_RESOURCELOADER_EXTERNAL_CSS_PERFECTSCROLLBAR;
				break;
		}
		...
		switch ($resource) {
			...
			case POP_RESOURCELOADER_EXTERNAL_BOOTSTRAPMULTISELECT:
				...
				$dependencies[] = POP_RESOURCELOADER_EXTERNAL_CSS_BOOTSTRAPMULTISELECT;
				break;
		}
 ...
 * Initialization
 * ---------------------------------------------------------------------------------------------------------------*/
new PoP_CoreProcessors_VendorJSResourceLoaderProcessor();

...
targets.push(target);});return new Handlebars.SafeString(targets.join(','));});Handlebars.registerHelper('formatFeedbackMessage',function(message,options){var isMultiDomain=options.hash['is-multidomain'];var domain=options.hash.domain;if(isMultiDomain&&domain){var name=M.MULTIDOMAIN_WEBSITES[domain]?M.MULTIDOMAIN_WEBSITES[domain].name:domain;message=M.FEEDBACKMSG_MULTIDOMAIN.format(name,message);}

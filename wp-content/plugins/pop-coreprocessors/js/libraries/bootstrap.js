...
popBootstrap = {
	...
	tooltip : function(args) {
		...
		jQuery(document).ready( function($) {
			...
			targets.each(function() {
				...
				var tooltip = $(this);
				var container = popManager.getDOMContainer(pageSection, tooltip);
	...
	execPopover : function(pageSection, block, targets) {
		...
		jQuery(document).ready( function($) {
			...
			var container = popManager.getDOMContainer(pageSection, block);
			var containerTarget = '#'+container.attr('id');
			// Default Options
			var options = {
				animation : false,
			...
			targets.each(function() {
				...
				if (popoverTarget.length) {
					...
					// Instead, set the block id to the popover, and add another way to find the block when the object is not inside the block (in function popManager.getBlock)
					var blockTarget = '#'+popManager.getBlock(popover).attr('id');

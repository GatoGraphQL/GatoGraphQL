"use strict";
(function($){
window.popBootstrapCarouselAutomatic = {
	...
	carouselAutomatic : function(args) {
		...
		if (carousel.find('.item.active').length) {
			...
			if (popBootstrapCarousel.numberSlides(carousel) >= 2) {
...
// Initialize
//-------------------------------------------------
popJSLibraryManager.register(popBootstrapCarouselAutomatic, ['carouselAutomatic']);

    ...
    function __construct($vars, $options = null, $initialize = true, $error_messages = null) {
		...
		$this->options = array(
            ...
            'image_versions' => array(
                'photo' => array(
                    ...
                    'upload_url' => $this->get_full_url().$this->vars['user_upload_photo_path'],
                ...
                'thumb' => array(
                    ...
                    'upload_url' => $this->get_full_url().$this->vars['user_upload_thumb_path'],
        ...
        foreach ($thumb_sizes as $thumb_size) {
            $this->options['image_versions']['thumb-'.$thumb_size] = array(
                ...
                'upload_url'=> $this->get_full_url().$this->vars['user_upload_avatars_path'].$thumb_size.'/',

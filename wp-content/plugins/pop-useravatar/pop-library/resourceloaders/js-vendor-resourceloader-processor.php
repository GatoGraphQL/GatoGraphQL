...
class PoP_UserAvatar_VendorJSResourceLoaderProcessor extends PoP_VendorJSResourceLoaderProcessor {
	...
	function get_path($resource) {
		...
		return POP_USERAVATAR_URL.'/js/includes/cdn';
	}
	...
	function get_dependencies($resource) {
		...
		switch ($resource) {
			...
			case POP_RESOURCELOADER_EXTERNAL_FILEUPLOAD:
				...
				$dependencies[] = POP_RESOURCELOADER_EXTERNAL_CSS_FILEUPLOAD;
 ...
 * Initialization
 * ---------------------------------------------------------------------------------------------------------------*/
new PoP_UserAvatar_VendorJSResourceLoaderProcessor();

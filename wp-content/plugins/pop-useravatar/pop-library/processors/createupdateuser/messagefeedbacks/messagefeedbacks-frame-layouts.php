...
define ('GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_USERAVATAR_UPDATE', PoP_TemplateIDUtils::get_template_definition('layout-messagefeedbackframe-useravatar-update'));

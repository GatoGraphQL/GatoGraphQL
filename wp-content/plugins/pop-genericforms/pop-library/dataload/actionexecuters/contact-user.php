...
define ('GD_DATALOAD_ACTIONEXECUTER_CONTACTUSER', 'contact-user');

class GD_DataLoad_ActionExecuter_ContactUser extends GD_DataLoad_FormActionExecuterBase {

    function get_name() {
    
		return GD_DATALOAD_ACTIONEXECUTER_CONTACTUSER;
	}
    ...
    function execute_form(&$block_data_settings, $block_atts, &$block_execution_bag) {
		...
		$instance->contactuser($errors, $block_atts);
 ...
 * Initialize
 * ---------------------------------------------------------------------------------------------------------------*/
new GD_DataLoad_ActionExecuter_ContactUser();
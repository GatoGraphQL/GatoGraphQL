...
define ('GD_DATALOAD_ACTIONEXECUTER_CONTACTUS', 'contact-us');

class GD_DataLoad_ActionExecuter_ContactUs extends GD_DataLoad_FormActionExecuterBase {

    function get_name() {
    
		return GD_DATALOAD_ACTIONEXECUTER_CONTACTUS;
	}
    ...
    function execute_form(&$block_data_settings, $block_atts, &$block_execution_bag) {
		...
		$instance->contactus($errors, $block_atts);
 ...
 * Initialize
 * ---------------------------------------------------------------------------------------------------------------*/
new GD_DataLoad_ActionExecuter_ContactUs();
...
define ('GD_DATALOAD_ACTIONEXECUTER_NEWSLETTERSUBSCRIPTION', 'newsletter-subscription');

class GD_DataLoad_ActionExecuter_NewsletterSubscription extends GD_DataLoad_FormActionExecuterBase {

    function get_name() {
    
		return GD_DATALOAD_ACTIONEXECUTER_NEWSLETTERSUBSCRIPTION;
	}
    ...
    function execute_form(&$block_data_settings, $block_atts, &$block_execution_bag) {
		...
		$instance->subscribe($errors, $block_atts);
 ...
 * Initialize
 * ---------------------------------------------------------------------------------------------------------------*/
new GD_DataLoad_ActionExecuter_NewsletterSubscription();

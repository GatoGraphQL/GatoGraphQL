...
define ('GD_DATALOAD_ACTIONEXECUTER_SHAREBYEMAIL', 'share-by-email');

class GD_DataLoad_ActionExecuter_ShareByEmail extends GD_DataLoad_FormActionExecuterBase {

    function get_name() {
    
		return GD_DATALOAD_ACTIONEXECUTER_SHAREBYEMAIL;
	}
    ...
    function execute_form(&$block_data_settings, $block_atts, &$block_execution_bag) {
		...
		$instance->share($errors, $block_atts);
 ...
 * Initialize
 * ---------------------------------------------------------------------------------------------------------------*/
new GD_DataLoad_ActionExecuter_ShareByEmail();

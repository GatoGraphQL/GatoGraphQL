...
wget -O $POP_APP_PATH/wp-content/plugins/pop-serviceworkers/js/dist/bundles/pop-serviceworkers.bundle.min.js "http://min.localhost/?b=$POP_APP_MIN_FOLDER/plugins/pop-serviceworkers/js/libraries&f=sw.min.js"

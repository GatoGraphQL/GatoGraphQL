...
//-------------------------------------------------------------------------------------
define ('POP_BASEPROCESSORS_VERSION', 0.210);
...
class PoP_BaseProcessors {
	...
	function init(){
		...
		define ('POP_BASEPROCESSORS_URL', plugins_url('', __FILE__));
		define ('POP_BASEPROCESSORS_URL_LIB', POP_BASEPROCESSORS_URL.'/library' );

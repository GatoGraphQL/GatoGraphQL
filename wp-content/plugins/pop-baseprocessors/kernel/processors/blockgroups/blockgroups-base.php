...
class GD_Template_Processor_BlockGroupsBase extends GD_Template_Processor_BlocksBase {
	...
	function init_atts_blockgroup_block($blockgroup, $blockgroup_block, &$blockgroup_block_atts, $blockgroup_atts) {
		...
		// The contained block is not main, since it's wrapped by another one
		$this->add_att($blockgroup_block, $blockgroup_block_atts, 'is-mainblock', false);
	...
	function init_atts_blockgroup_blockgroup($blockgroup, $blockgroup_blockgroup, &$blockgroup_blockgroup_atts, $blockgroup_atts) {
		...
		// The contained block is not main, since it's wrapped by another one
		$this->add_att($blockgroup_blockgroup, $blockgroup_blockgroup_atts, 'is-mainblock', false);
	...
	function get_extra_blocks($template_id) {
		...
		// $ret = parent::get_extra_blocks($template_id, $atts);

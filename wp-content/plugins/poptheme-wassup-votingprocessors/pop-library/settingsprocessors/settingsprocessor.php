...
class VotingProcessors_Template_SettingsProcessor extends GD_Template_SettingsProcessorBase {
	...
	function get_page_blockgroups($hierarchy, $include_common = true) {
		...
		elseif ($hierarchy == GD_SETTINGS_HIERARCHY_TAG) {
			...
			$pageblockgroups = array(
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES => GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGOPINIONATEDVOTES,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_PRO => GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGOPINIONATEDVOTES_PRO,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_NEUTRAL => GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGOPINIONATEDVOTES_NEUTRAL,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_AGAINST => GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGOPINIONATEDVOTES_AGAINST,
			);
			foreach ($pageblockgroups as $page => $blockgroup) {
	...
	function get_page_blocks($hierarchy, $include_common = true) {
		...
		elseif ($hierarchy == GD_SETTINGS_HIERARCHY_TAG) {
			...
			$default_format_votes = PoPTheme_Wassup_Utils::get_defaultformat_by_screen(POP_VOTINGPROCESSORS_SCREEN_TAGOPINIONATEDVOTES);
			
			$pageblocks_fullview = array(
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_SCROLL_FULLVIEW,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_PRO  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_PRO_SCROLL_FULLVIEW,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_NEUTRAL  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_NEUTRAL_SCROLL_FULLVIEW,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_AGAINST  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_AGAINST_SCROLL_FULLVIEW,
			);
			foreach ($pageblocks_fullview as $page => $block) {
				$ret[$page]['blocks'][GD_TEMPLATEFORMAT_FULLVIEW] = $block;
			...
			$pageblocks_thumbnail = array(
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_SCROLL_THUMBNAIL,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_PRO  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_PRO_SCROLL_THUMBNAIL,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_NEUTRAL  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_NEUTRAL_SCROLL_THUMBNAIL,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_AGAINST  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_AGAINST_SCROLL_THUMBNAIL,
			);
			foreach ($pageblocks_thumbnail as $page => $block) {
				$ret[$page]['blocks'][GD_TEMPLATEFORMAT_THUMBNAIL] = $block;
			...
			$pageblocks_list = array(
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_SCROLL_LIST,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_PRO  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_PRO_SCROLL_LIST,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_NEUTRAL  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_NEUTRAL_SCROLL_LIST,
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES_AGAINST  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_AGAINST_SCROLL_LIST,
			);
			foreach ($pageblocks_list as $page => $block) {
				$ret[$page]['blocks'][GD_TEMPLATEFORMAT_LIST] = $block;
			...
			$pageblocks_carousels = array(
				POPTHEME_WASSUP_VOTINGPROCESSORS_PAGE_OPINIONATEDVOTES  => GD_TEMPLATE_BLOCK_TAGOPINIONATEDVOTES_CAROUSEL,
			);
			foreach ($pageblocks_carousels as $page => $block) {
				$ret[$page]['blocks'][GD_TEMPLATEFORMAT_CAROUSEL] = $block;

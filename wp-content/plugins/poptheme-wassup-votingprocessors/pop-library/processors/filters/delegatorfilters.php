...
define ('GD_TEMPLATE_DELEGATORFILTER_TAGOPINIONATEDVOTES', PoP_ServerUtils::get_template_definition('delegatorfilter-tagopinionatedvotes'));
define ('GD_TEMPLATE_DELEGATORFILTER_TAGOPINIONATEDVOTES_STANCE', PoP_ServerUtils::get_template_definition('delegatorfilter-tagopinionatedvotes-stance'));
...
class PoPVP_Template_Processor_CustomDelegatorFilters extends GD_Template_Processor_CustomDelegatorFiltersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_DELEGATORFILTER_TAGOPINIONATEDVOTES,
			GD_TEMPLATE_DELEGATORFILTER_TAGOPINIONATEDVOTES_STANCE,
		);
	}
	...
	function get_inner_template($template_id) {
		...
		$inners = array(
			...
			GD_TEMPLATE_DELEGATORFILTER_TAGOPINIONATEDVOTES => GD_TEMPLATE_SIMPLEFILTERINNER_TAGOPINIONATEDVOTES,
			GD_TEMPLATE_DELEGATORFILTER_TAGOPINIONATEDVOTES_STANCE => GD_TEMPLATE_SIMPLEFILTERINNER_TAGOPINIONATEDVOTES_STANCE,
		);

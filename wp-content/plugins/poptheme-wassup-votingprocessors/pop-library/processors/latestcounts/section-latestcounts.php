...
define ('GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES', PoP_ServerUtils::get_template_definition('latestcount-tag-opinionatedvotes'));
...
define ('GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_PRO', PoP_ServerUtils::get_template_definition('latestcount-tag-opinionatedvotes-pro'));
...
define ('GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_AGAINST', PoP_ServerUtils::get_template_definition('latestcount-tag-opinionatedvotes-against'));
...
define ('GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_NEUTRAL', PoP_ServerUtils::get_template_definition('latestcount-tag-opinionatedvotes-neutral'));
...
class PoPThemeWassup_VotingProcessors_Template_Processor_SectionLatestCounts extends GD_Template_Processor_SectionLatestCountsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES,
			...
			GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_PRO,
			...
			GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_AGAINST,
			...
			GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_NEUTRAL,
	...
	function get_object_name($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES:
			...
			case GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_PRO:
			...
			case GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_AGAINST:
			...
			case GD_TEMPLATE_LATESTCOUNT_TAG_OPINIONATEDVOTES_NEUTRAL:

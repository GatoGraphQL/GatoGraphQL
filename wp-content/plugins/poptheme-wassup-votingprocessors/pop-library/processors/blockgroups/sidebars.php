...
define ('GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_SIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-tag-opinionatedvotes-sidebar'));
define ('GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_STANCE_SIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-tag-opinionatedvotes-stance-sidebar'));
...
class PoPVP_Template_Processor_SidebarBlockGroups extends GD_Template_Processor_SidebarBlockGroupsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_SIDEBAR,
			GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_STANCE_SIDEBAR,
	...
	function get_inner_blocks($template_id) {
		...
		$blocks = array(
			...
			GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_SIDEBAR => GD_TEMPLATE_BLOCK_TAGSECTION_OPINIONATEDVOTES_SIDEBAR,
			GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_STANCE_SIDEBAR => GD_TEMPLATE_BLOCK_TAGSECTION_OPINIONATEDVOTES_STANCE_SIDEBAR,
	...
	function get_screen($template_id) {
		...
		$screens = array(
			...
			GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_SIDEBAR => POP_SCREEN_TAGSECTION,
			GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_STANCE_SIDEBAR => POP_SCREEN_TAGSECTION,
	...
	function get_screengroup($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_SIDEBAR:
			case GD_TEMPLATE_BLOCKGROUP_TAG_OPINIONATEDVOTES_STANCE_SIDEBAR:

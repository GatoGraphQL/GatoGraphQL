...
define ('GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGFARMS', PoP_ServerUtils::get_template_definition('blockgroup-tabpanel-tagfarms'));

class OP_Template_Processor_TagSectionTabPanelBlockGroups extends GD_Template_Processor_TagSectionTabPanelBlockGroupsBase {

	function get_templates_to_process() {
	
		return array(
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGFARMS,
		);
	}
	...
	function get_panel_headers($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGFARMS:
				...
				$ret = array(
					GD_TEMPLATE_BLOCK_TAGFARMS_SCROLL_SIMPLEVIEW => array(
						GD_TEMPLATE_BLOCK_TAGFARMS_SCROLL_SIMPLEVIEW,
						GD_TEMPLATE_BLOCK_TAGFARMS_SCROLL_FULLVIEW,
					),
					GD_TEMPLATE_BLOCK_TAGFARMS_SCROLL_LIST => array(
						GD_TEMPLATE_BLOCK_TAGFARMS_SCROLL_DETAILS,
						GD_TEMPLATE_BLOCK_TAGFARMS_SCROLL_THUMBNAIL,
						GD_TEMPLATE_BLOCK_TAGFARMS_SCROLL_LIST,
					),
					GD_TEMPLATE_BLOCK_TAGFARMS_SCROLLMAP => array(),
				);
				break;
		}

		if ($ret) {
			return apply_filters('OP_Template_Processor_TagSectionTabPanelBlockGroups:panel_headers', $ret, $template_id);
		}
	...
	function get_default_active_blockunit($template_id) {
		...
		$pages_id = array(
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGFARMS => POPTHEME_WASSUP_ORGANIKPROCESSORS_PAGE_FARMS,
		);
 ...
 * Initialization
 * ---------------------------------------------------------------------------------------------------------------*/
new OP_Template_Processor_TagSectionTabPanelBlockGroups();

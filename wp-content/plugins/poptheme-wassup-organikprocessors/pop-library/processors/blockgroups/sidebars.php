...
define ('GD_TEMPLATE_BLOCKGROUP_AUTHOR_FARMS_SIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-author-farms-sidebar'));
...
class PoPOP_Template_Processor_SidebarBlockGroups extends GD_Template_Processor_SidebarBlockGroupsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_BLOCKGROUP_AUTHOR_FARMS_SIDEBAR,
		...
		switch ($template_id) {
			...
			default:
				...
				$blocks = array(
					...
					GD_TEMPLATE_BLOCKGROUP_AUTHOR_FARMS_SIDEBAR => GD_TEMPLATE_BLOCK_AUTHOR_FARMS_SIDEBAR,
	...
	function get_screen($template_id) {
		...
		$screens = array(
			...
			GD_TEMPLATE_BLOCKGROUP_AUTHOR_FARMS_SIDEBAR => POP_SCREEN_AUTHORSECTION,
	...
	function get_screengroup($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_AUTHOR_FARMS_SIDEBAR:

<div id="<?php echo GD_TEMPLATEID_PAGESECTIONGROUP_ID ?>" class="pop-pagesection-group pagesection-group <?php echo implode(' ', PoPTheme_Wassup_Utils::get_pagesectiongroup_active_pagesection_classes()) ?>">

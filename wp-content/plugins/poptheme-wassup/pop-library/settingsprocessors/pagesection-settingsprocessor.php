...
class PoPTheme_Wassup_PageSectionSettingsProcessor extends Wassup_PageSectionSettingsProcessorBase {
	...
	function add_page_blockunits(&$ret, $template_id) {
		...
		switch ($page_id) {
			...
			case POP_WPAPI_PAGE_LOADERS_POSTS_DATA:
			case POP_WPAPI_PAGE_LOADERS_USERS_DATA:
			case POP_WPAPI_PAGE_LOADERS_COMMENTS_DATA:
			case POP_WPAPI_PAGE_LOADERS_TAGS_DATA:
			...
			case POP_WPAPI_PAGE_LOGIN:
				...
				if ($add) {
					...
					if ($submitted_data) {
						...
						// $blocks[] = GD_TEMPLATE_BLOCKDATA_FOLLOWSUSERS;
						// $blocks[] = GD_TEMPLATE_BLOCKDATA_RECOMMENDSPOSTS;
						// $blocks[] = GD_TEMPLATE_BLOCKDATA_UPVOTESPOSTS;
						// $blocks[] = GD_TEMPLATE_BLOCKDATA_DOWNVOTESPOSTS;

...
define ('GD_FILTER_MYWEBPOSTS', 'mywebposts');

class GD_Filter_MyWebPosts extends GD_FilterMyPosts {
	...
	function get_filtercomponents() {
		...
		$ret = array($status, $gd_filtercomponent_search, $gd_filtercomponent_webpostsections, $gd_filtercomponent_hashtags, /*$gd_filtercomponent_categories, */$gd_filtercomponent_daterangepicker, $gd_filtercomponent_orderpost);
		...
		// }
		$ret = apply_filters('gd_template:filter-mywebposts:filtercomponents', $ret);

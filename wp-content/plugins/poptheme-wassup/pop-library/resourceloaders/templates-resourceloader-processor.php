...
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUT_LINK_ACCESS', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUT_LINK_ACCESS));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUT_VOLUNTEERTAG', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUT_VOLUNTEERTAG));
define ('POP_RESOURCELOADER_TEMPLATE_PAGESECTION_BACKGROUND', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_PAGESECTION_BACKGROUND));
define ('POP_RESOURCELOADER_TEMPLATE_PAGESECTION_TOPSIMPLE', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_PAGESECTION_TOPSIMPLE));
define ('POP_RESOURCELOADER_TEMPLATE_PAGESECTION_SIDE', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_PAGESECTION_SIDE));
define ('POP_RESOURCELOADER_TEMPLATE_PAGESECTION_TOP', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_PAGESECTION_TOP));
define ('POP_RESOURCELOADER_TEMPLATE_SPEECHBUBBLE', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_SPEECHBUBBLE));

...
class GD_Template_Processor_CustomFilterInners extends GD_Template_Processor_FilterInnersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_FILTERINNER_AUTHORPOSTS,
			GD_TEMPLATE_FILTERINNER_TAGWEBPOSTS,
			GD_TEMPLATE_FILTERINNER_TAGPOSTS,
	...
	function get_filter($template_id) {
		...
		$filters = array(
			...
			GD_TEMPLATE_FILTERINNER_AUTHORPOSTS => GD_FILTER_AUTHORPOSTS,
			GD_TEMPLATE_FILTERINNER_TAGWEBPOSTS => GD_FILTER_TAGWEBPOSTS,
			GD_TEMPLATE_FILTERINNER_TAGPOSTS => GD_FILTER_TAGPOSTS,

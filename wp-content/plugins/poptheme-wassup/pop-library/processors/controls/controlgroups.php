...
define ('GD_TEMPLATE_CONTROLGROUP_FILTER', PoP_TemplateIDUtils::get_template_definition('controlgroup-filter'));
define ('GD_TEMPLATE_CONTROLGROUP_SHOWHIDESIDEBAR', PoP_TemplateIDUtils::get_template_definition('controlgroup-showsidehidebar'));
define ('GD_TEMPLATE_CONTROLGROUP_CALENDAR_WIDGET', PoP_TemplateIDUtils::get_template_definition('controlgroup-calendar-widget'));
// define ('GD_TEMPLATE_CONTROLGROUP_NAVIGATORCALENDAR', PoP_TemplateIDUtils::get_template_definition('controlgroup-navigatorcalendar'));
define ('GD_TEMPLATE_CONTROLGROUP_COMMENTS', PoP_TemplateIDUtils::get_template_definition('controlgroup-comments'));
define ('GD_TEMPLATE_CONTROLGROUP_TAGLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-taglist'));
define ('GD_TEMPLATE_CONTROLGROUP_TRENDINGTAGLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-trendingtaglist'));
define ('GD_TEMPLATE_CONTROLGROUP_POSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-postlist'));
define ('GD_TEMPLATE_CONTROLGROUP_BLOCKAUTHORPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-blockauthorpostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_BLOCKPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-blockpostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_BLOCKRELOAD', PoP_TemplateIDUtils::get_template_definition('controlgroup-blockreload'));
define ('GD_TEMPLATE_CONTROLGROUP_BLOCKLOADLATEST', PoP_TemplateIDUtils::get_template_definition('controlgroup-blockloadlatest'));
define ('GD_TEMPLATE_CONTROLGROUP_QUICKVIEWBLOCKPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-quickviewblockpostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_SUBMENUPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-submenupostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_SUBMENUPOSTLISTMAIN', PoP_TemplateIDUtils::get_template_definition('controlgroup-submenupostlistmain'));
define ('GD_TEMPLATE_CONTROLGROUP_USERLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-userlist'));
define ('GD_TEMPLATE_CONTROLGROUP_BLOCKUSERLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-blockuserlist'));
define ('GD_TEMPLATE_CONTROLGROUP_SUBMENUUSERLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-submenuuserlist'));
define ('GD_TEMPLATE_CONTROLGROUP_SUBMENUUSERLISTMAIN', PoP_TemplateIDUtils::get_template_definition('controlgroup-submenuuserlistmain'));
define ('GD_TEMPLATE_CONTROLGROUP_SUBMENUSHARE', PoP_TemplateIDUtils::get_template_definition('controlgroup-submenushare'));
define ('GD_TEMPLATE_CONTROLGROUP_SHARE', PoP_TemplateIDUtils::get_template_definition('controlgroup-share'));
define ('GD_TEMPLATE_CONTROLGROUP_FIXEDSHARE', PoP_TemplateIDUtils::get_template_definition('controlgroup-fixedshare'));
// define ('GD_TEMPLATE_CONTROLGROUP_NAVIGATORPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-navigatorpostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_MYPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-mypostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_MYBLOCKPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-myblockpostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_MYWEBPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-mywebpostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_MYBLOCKWEBPOSTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-myblockwebpostlist'));
define ('GD_TEMPLATE_CONTROLGROUP_MYHIGHLIGHTLIST', PoP_TemplateIDUtils::get_template_definition('controlgroup-myhighlightlist'));
define ('GD_TEMPLATE_CONTROLGROUP_ACCOUNT', PoP_TemplateIDUtils::get_template_definition('controlgroup-account'));
define ('GD_TEMPLATE_CONTROLGROUP_CREATEACCOUNT', PoP_TemplateIDUtils::get_template_definition('controlgroup-createaccount'));
define ('GD_TEMPLATE_CONTROLGROUP_CREATEPOST', PoP_TemplateIDUtils::get_template_definition('controlgroup-createpost'));
define ('GD_TEMPLATE_CONTROLGROUP_CREATERESETPOST', PoP_TemplateIDUtils::get_template_definition('controlgroup-createresetpost'));
define ('GD_TEMPLATE_CONTROLGROUP_EDITPOST', PoP_TemplateIDUtils::get_template_definition('controlgroup-editpost'));
define ('GD_TEMPLATE_CONTROLGROUP_TOGGLESIDEINFO_BACK', PoP_TemplateIDUtils::get_template_definition('controlgroup-togglesideinfo-back'));
define ('GD_TEMPLATE_CONTROLGROUP_USERPOSTINTERACTION', PoP_TemplateIDUtils::get_template_definition('controlgroup-userpostinteraction'));
define ('GD_TEMPLATE_CONTROLGROUP_PAGEOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-pageoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_PAGEWITHSIDEOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-pagewithsideoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_QUICKVIEWPAGEOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-quickviewpageoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_QUICKVIEWPAGEWITHSIDEOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-quickviewpagewithsideoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_SINGLEOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-singleoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_SINGLEOPTIONSBOTTOM', PoP_TemplateIDUtils::get_template_definition('controlgroup-singleoptionsbottom'));
define ('GD_TEMPLATE_CONTROLGROUP_QUICKVIEWSINGLEOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-quickviewsingleoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_HOMEOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-homeoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_QUICKVIEWHOMEOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-quickviewhomeoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_AUTHOROPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-authoroptions'));
define ('GD_TEMPLATE_CONTROLGROUP_QUICKVIEWAUTHOROPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-quickviewauthoroptions'));
define ('GD_TEMPLATE_CONTROLGROUP_TAGOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-tagoptions'));
define ('GD_TEMPLATE_CONTROLGROUP_QUICKVIEWTAGOPTIONS', PoP_TemplateIDUtils::get_template_definition('controlgroup-quickviewtagoptions'));
...
class GD_Template_Processor_CustomControlGroups extends GD_Template_Processor_ControlGroupsBase {
	...
	function get_modules($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_CONTROLGROUP_FIXEDSHARE:

				$ret[] = GD_TEMPLATE_CONTROLBUTTONGROUP_FIXEDSHARE;
				break;

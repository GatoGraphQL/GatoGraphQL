...
class GD_Template_Processor_CustomSectionBlocks extends GD_Template_Processor_SectionBlocksBase {
	...
	protected function get_dataload_query_args($template_id, $atts) {
		...
		switch ($template_id) {
			...
			// 	$ret['taxonomy'] = POPTHEME_WASSUP_MLA_CAT_RESOURCES;
			// 	break;
			...
			case GD_TEMPLATE_BLOCK_MYLINKS_SCROLL_FULLVIEWPREVIEW:
				...
				$ret = array_merge(
					$ret,
					$this->get_dataload_query_args(GD_TEMPLATE_BLOCK_LINKS_SCROLL_NAVIGATOR, $atts),
					$myposts_query_args
				);
				break;
			...
			case GD_TEMPLATE_BLOCK_MYHIGHLIGHTS_SCROLL_FULLVIEWPREVIEW:
				...
				$ret = array_merge(
					$ret,
					$this->get_dataload_query_args(GD_TEMPLATE_BLOCK_HIGHLIGHTS_SCROLL_NAVIGATOR, $atts),
					$myposts_query_args
				);
				break;
			...
			case GD_TEMPLATE_BLOCK_MYWEBPOSTS_SCROLL_FULLVIEWPREVIEW:
				...
				$ret = array_merge(
					$ret,
					$this->get_dataload_query_args(GD_TEMPLATE_BLOCK_WEBPOSTS_SCROLL_NAVIGATOR, $atts),
					$myposts_query_args
				);
				break;
			...
			// 	$ret = array_merge(
			// 		$ret,
			// 		$this->get_dataload_query_args(GD_TEMPLATE_BLOCK_RESOURCES_SCROLL_NAVIGATOR, $atts),
			// 		array(
			// 			'author' => get_current_user_id() // Current author
			// 		)
			// 	);
			// 	break;
		}

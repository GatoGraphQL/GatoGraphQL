		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCK_PAGETABS_WEBPOST_CREATE:
				...
				$pages = array(
					...
					GD_TEMPLATE_BLOCK_ADDONTABS_CONTACTUSER => POPTHEME_WASSUP_GF_PAGE_CONTACTUSER,
					GD_TEMPLATE_BLOCK_ADDONTABS_VOLUNTEER => POPTHEME_WASSUP_GF_PAGE_VOLUNTEER,
					GD_TEMPLATE_BLOCK_ADDONTABS_FLAG => POPTHEME_WASSUP_GF_PAGE_FLAG,

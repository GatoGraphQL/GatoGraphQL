...
class GD_Template_Processor_ControlBlocks extends GD_Template_Processor_ControlBlocksBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_BLOCK_PAGECONTROL_TAGSIDEBAR,
	...
	protected function get_controlgroup_top($template_id) {
		...
		$controlgroups = array(
			...
			GD_TEMPLATE_BLOCK_PAGECONTROL_TAGSIDEBAR => GD_TEMPLATE_CONTROLGROUP_TOGGLESIDEINFO_BACK,
	...
	function init_atts($template_id, &$atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCK_PAGECONTROL_TAGSIDEBAR:

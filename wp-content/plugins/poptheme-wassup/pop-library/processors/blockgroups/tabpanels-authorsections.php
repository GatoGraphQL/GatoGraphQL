...
class GD_Template_Processor_AuthorSectionTabPanelBlockGroups extends GD_Template_Processor_AuthorSectionTabPanelBlockGroupsBase {
	...
	function get_blockgroup_blocks($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_AUTHORSUBSCRIBEDTOTAGS:
	...
	function get_panel_headers($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_AUTHORSUBSCRIBEDTOTAGS:
				...
				$ret = array(
					GD_TEMPLATE_BLOCK_AUTHORSUBSCRIBEDTOTAGS_SCROLL_DETAILS => array(),
					GD_TEMPLATE_BLOCK_AUTHORSUBSCRIBEDTOTAGS_SCROLL_LIST => array(),
				);
				break;
	...
	function get_default_active_blockunit($template_id) {
		...
		$pages_id = array(
			...
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_AUTHORSUBSCRIBEDTOTAGS => POP_COREPROCESSORS_PAGE_SUBSCRIBEDTO,

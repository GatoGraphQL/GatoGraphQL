...
define ('GD_TEMPLATE_LAYOUT_CONTENT_POST', PoP_TemplateIDUtils::get_template_definition('layout-content-post'));
define ('GD_TEMPLATE_LAYOUT_CONTENT_POSTCOMPACT', PoP_TemplateIDUtils::get_template_definition('layout-content-postcompact'));
define ('GD_TEMPLATE_LAYOUT_CONTENT_COMMENT', PoP_TemplateIDUtils::get_template_definition('layout-content-comment'));
define ('GD_TEMPLATE_LAYOUT_CONTENT_PAGE', PoP_TemplateIDUtils::get_template_definition('layout-content-page'));

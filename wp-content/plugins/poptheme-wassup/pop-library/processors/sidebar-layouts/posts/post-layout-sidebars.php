...
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBAR_VERTICAL', PoP_ServerUtils::get_template_definition('layout-postsidebar-vertical'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBAR_VERTICAL_LINK', PoP_ServerUtils::get_template_definition('layout-postsidebar-vertical-link'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBAR_VERTICAL_HIGHLIGHT', PoP_ServerUtils::get_template_definition('layout-postsidebar-vertical-highlight'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBAR_VERTICAL_WEBPOST', PoP_ServerUtils::get_template_definition('layout-postsidebar-vertical-webpost'));

define ('GD_TEMPLATE_LAYOUT_POSTSIDEBAR_HORIZONTAL', PoP_ServerUtils::get_template_definition('layout-postsidebar-horizontal'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBAR_HORIZONTAL_LINK', PoP_ServerUtils::get_template_definition('layout-postsidebar-horizontal-link'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBAR_HORIZONTAL_HIGHLIGHT', PoP_ServerUtils::get_template_definition('layout-postsidebar-horizontal-highlight'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBAR_HORIZONTAL_WEBPOST', PoP_ServerUtils::get_template_definition('layout-postsidebar-horizontal-webpost'));

define ('GD_TEMPLATE_LAYOUT_POSTSIDEBARCOMPACT_HORIZONTAL', PoP_ServerUtils::get_template_definition('layout-postsidebarcompact-horizontal'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBARCOMPACT_HORIZONTAL_LINK', PoP_ServerUtils::get_template_definition('layout-postsidebarcompact-horizontal-link'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBARCOMPACT_HORIZONTAL_HIGHLIGHT', PoP_ServerUtils::get_template_definition('layout-postsidebarcompact-horizontal-highlight'));
define ('GD_TEMPLATE_LAYOUT_POSTSIDEBARCOMPACT_HORIZONTAL_WEBPOST', PoP_ServerUtils::get_template_definition('layout-postsidebarcompact-horizontal-webpost'));

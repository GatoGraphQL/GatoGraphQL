...
define ('GD_TEMPLATE_SIDEBAR_SECTION_POSTS', PoP_ServerUtils::get_template_definition('sidebar-section-posts'));
...
define ('GD_TEMPLATE_SIDEBAR_SECTION_MYPOSTS', PoP_ServerUtils::get_template_definition('sidebar-section-myposts'));
...
define ('GD_TEMPLATE_SIDEBAR_TAGSECTION_POSTS', PoP_ServerUtils::get_template_definition('sidebar-tagsection-posts'));
...
define ('GD_TEMPLATE_SIDEBAR_AUTHORSECTION_POSTS', PoP_ServerUtils::get_template_definition('sidebar-authorsection-posts'));

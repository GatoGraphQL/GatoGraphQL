	...
	function get_page_blocks($hierarchy, $include_common = true) {
		...
		if ($include_common) {
			...
			$pageblocks_allothers = array(
				...
				POPTHEME_WASSUP_GF_PAGE_NEWSLETTERUNSUBSCRIPTION => GD_TEMPLATE_BLOCK_NEWSLETTERUNSUBSCRIPTION,
			...
			$pageactions = array(
				...
				POPTHEME_WASSUP_GF_PAGE_NEWSLETTERUNSUBSCRIPTION => GD_TEMPLATE_ACTION_NEWSLETTERUNSUBSCRIPTION,
			);

...
class GD_GF_Template_Processor_FormGroups extends GD_Template_Processor_FormComponentGroupsBase {
	...
	function use_component_configuration($template_id) {
		...
		switch ($template_id) {
			...
			case GD_GF_TEMPLATE_FORMCOMPONENTGROUP_NEWSLETTEREMAILVERIFICATIONCODE:
	...
	function get_component($template_id) {
		...
		$components = array(
			...
			GD_GF_TEMPLATE_FORMCOMPONENTGROUP_NEWSLETTEREMAILVERIFICATIONCODE => GD_GF_TEMPLATE_FORMCOMPONENT_NEWSLETTEREMAILVERIFICATIONCODE,

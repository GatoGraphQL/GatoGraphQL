...
function gd_em_layouttemplates_simpleview_customlayouts($layouts) {
	...
	return array_merge(
		$layouts,
		array(
			EM_POST_TYPE_EVENT.'-'.POPTHEME_WASSUP_EM_CAT_FUTURE => GD_TEMPLATE_MULTICOMPONENT_EVENT_DATELOCATIONDOWNLOADLINKS,
			EM_POST_TYPE_EVENT.'-'.POPTHEME_WASSUP_EM_CAT_CURRENT => GD_TEMPLATE_MULTICOMPONENT_EVENT_DATELOCATIONDOWNLOADLINKS,
			EM_POST_TYPE_EVENT.'-'.POPTHEME_WASSUP_EM_CAT_PAST => GD_TEMPLATE_MULTICOMPONENT_EVENT_DATELOCATIONDOWNLOADLINKS,
		)
	);
}

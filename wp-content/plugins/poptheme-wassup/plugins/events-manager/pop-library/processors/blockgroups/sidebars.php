...
class GD_EM_Template_Processor_SidebarBlockGroups extends GD_Template_Processor_SidebarBlockGroupsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_BLOCKGROUP_TAG_EVENTS_CALENDAR_SIDEBAR,
			GD_TEMPLATE_BLOCKGROUP_TAG_EVENTS_SIDEBAR,
			GD_TEMPLATE_BLOCKGROUP_TAG_PASTEVENTS_SIDEBAR,
		...
		switch ($template_id) {
			...
			default:
				...
				$blocks = array(
					...
					GD_TEMPLATE_BLOCKGROUP_TAG_EVENTS_CALENDAR_SIDEBAR => GD_TEMPLATE_BLOCK_TAG_EVENTS_CALENDAR_SIDEBAR,
					GD_TEMPLATE_BLOCKGROUP_TAG_EVENTS_SIDEBAR => GD_TEMPLATE_BLOCK_TAG_EVENTS_SIDEBAR,
					GD_TEMPLATE_BLOCKGROUP_TAG_PASTEVENTS_SIDEBAR => GD_TEMPLATE_BLOCK_TAG_PASTEVENTS_SIDEBAR,
	...
	function get_screen($template_id) {
		...
		$screens = array(
			...
			GD_TEMPLATE_BLOCKGROUP_TAG_EVENTS_CALENDAR_SIDEBAR => POP_SCREEN_TAGSECTIONCALENDAR,
			GD_TEMPLATE_BLOCKGROUP_TAG_EVENTS_SIDEBAR => POP_SCREEN_TAGSECTION,
			GD_TEMPLATE_BLOCKGROUP_TAG_PASTEVENTS_SIDEBAR => POP_SCREEN_TAGSECTION,
	...
	function get_screengroup($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TAG_EVENTS_CALENDAR_SIDEBAR:
			case GD_TEMPLATE_BLOCKGROUP_TAG_EVENTS_SIDEBAR:
			case GD_TEMPLATE_BLOCKGROUP_TAG_PASTEVENTS_SIDEBAR:

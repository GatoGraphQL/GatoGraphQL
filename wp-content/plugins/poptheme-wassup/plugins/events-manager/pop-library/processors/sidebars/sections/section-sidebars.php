...
class GD_EM_Template_Processor_CustomSectionSidebars extends GD_Template_Processor_SidebarsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_SIDEBAR_TAG_EVENTS,
			GD_TEMPLATE_SIDEBAR_TAG_PASTEVENTS,
			GD_TEMPLATE_SIDEBAR_TAG_EVENTS_CALENDAR,
	...
	function get_inner_template($template_id) {
		...
		$sidebarinners = array(
			...
			GD_TEMPLATE_SIDEBAR_TAG_EVENTS => GD_TEMPLATE_SIDEBARINNER_TAG_EVENTS,
			GD_TEMPLATE_SIDEBAR_TAG_PASTEVENTS => GD_TEMPLATE_SIDEBARINNER_TAG_PASTEVENTS,
			GD_TEMPLATE_SIDEBAR_TAG_EVENTS_CALENDAR => GD_TEMPLATE_SIDEBARINNER_TAG_EVENTS_CALENDAR,

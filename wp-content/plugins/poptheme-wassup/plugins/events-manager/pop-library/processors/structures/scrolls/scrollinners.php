...
class GD_EM_Template_Processor_CustomScrollInners extends GD_Template_Processor_ScrollInnersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_SCROLLINNER_ALLUSERS_HORIZONTALMAP,
	...
	function get_layout_grid($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_SCROLLINNER_ALLUSERS_HORIZONTALMAP:
	...
	function get_layouts($template_id) {
		...
		$layouts = array(
			...
			GD_TEMPLATE_SCROLLINNER_ALLUSERS_HORIZONTALMAP => GD_TEMPLATE_LAYOUT_PREVIEWUSER_PROFILE_HORIZONTALMAPDETAILS,//GD_TEMPLATE_LAYOUT_MULTIPLEUSER_HORIZONTALMAPDETAILS,

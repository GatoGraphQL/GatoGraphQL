...
define ('GD_TEMPLATE_MESSAGEFEEDBACK_EVENTS', PoP_TemplateIDUtils::get_template_definition('messagefeedback-events'));
define ('GD_TEMPLATE_MESSAGEFEEDBACK_PASTEVENTS', PoP_TemplateIDUtils::get_template_definition('messagefeedback-pastevents'));
define ('GD_TEMPLATE_MESSAGEFEEDBACK_MYEVENTS', PoP_TemplateIDUtils::get_template_definition('messagefeedback-myevents'));
define ('GD_TEMPLATE_MESSAGEFEEDBACK_MYPASTEVENTS', PoP_TemplateIDUtils::get_template_definition('messagefeedback-mypastevents'));

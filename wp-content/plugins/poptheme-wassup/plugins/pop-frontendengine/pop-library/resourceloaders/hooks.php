...
class PoPThemeWassup_ResourceLoader_Hooks {
    ...
    function get_home_resources($resources, $fetching_json, $options) {
        ...
        if ($scheme == POP_RESOURCELOADERCONFIGURATION_HOME_FEED) {
            ...
            PoP_ResourceLoaderProcessorUtils::add_resources_from_settingsprocessors($fetching_json, $resources, $template_id, $hierarchy, array(), false, $options);
        }
        elseif ($scheme == POP_RESOURCELOADERCONFIGURATION_HOME_STATIC) {

            // Add a single item
            PoP_ResourceLoaderProcessorUtils::add_resources_from_current_vars($fetching_json, $resources, $template_id, array(), false, array(), $options);
        }

        return $resources;
    }

    function get_404_resources($resources, $fetching_json, $options) {
    ...
    function get_tag_resources($resources, $fetching_json, $options) {
        ...
        if ($ids = get_tags($query)) {
            ...
            PoP_ResourceLoaderProcessorUtils::add_resources_from_settingsprocessors($fetching_json, $resources, $template_id, $hierarchy, $ids, false, $options);
        }

        return $resources;
    }

    function get_author_resources($resources, $fetching_json, $options) {
    ...
    function get_single_resources($resources, $fetching_json, $options) {
    ...
    function get_page_resources($resources, $fetching_json, $options) {
    ...
    function get_backgroundurls_page_resources($resources, $fetching_json, $options) {
        ...
        foreach (PoP_Frontend_ConfigurationUtils::get_backgroundload_pages() as $page_id => $targets) {
            ...
            foreach ($targets as $target) {
                ...
                PoP_ResourceLoaderProcessorUtils::add_resources_from_current_vars($fetching_json, $resources, $template_id, $ids, $merge, $components, $options);
            }
        }

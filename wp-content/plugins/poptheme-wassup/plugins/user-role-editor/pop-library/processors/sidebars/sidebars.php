...
define ('GD_TEMPLATE_SIDEBAR_SECTION_ORGANIZATIONS', PoP_TemplateIDUtils::get_template_definition('sidebar-section-organizations'));
define ('GD_TEMPLATE_SIDEBAR_SECTION_INDIVIDUALS', PoP_TemplateIDUtils::get_template_definition('sidebar-section-individuals'));
define ('GD_TEMPLATE_SIDEBAR_SECTION_MYMEMBERS', PoP_TemplateIDUtils::get_template_definition('sidebar-section-mymembers'));

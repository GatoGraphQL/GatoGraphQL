...
define ('GD_TEMPLATE_HORIZONTALSIDEBAR_AUTHOR_ORGANIZATION', PoP_ServerUtils::get_template_definition('horizontal-sidebar-author-organization'));
define ('GD_TEMPLATE_HORIZONTALSIDEBAR_AUTHOR_INDIVIDUAL', PoP_ServerUtils::get_template_definition('horizontal-sidebar-author-individual'));

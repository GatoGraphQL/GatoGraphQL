...
define ('GD_TEMPLATE_HORIZONTALSIDEBARINNER_AUTHOR_ORGANIZATION', PoP_TemplateIDUtils::get_template_definition('horizontal-sidebarinner-author-organization'));
define ('GD_TEMPLATE_HORIZONTALSIDEBARINNER_AUTHOR_INDIVIDUAL', PoP_TemplateIDUtils::get_template_definition('horizontal-sidebarinner-author-individual'));

...
define ('GD_URE_AAL_TEMPLATE_MULTICOMPONENTWRAPPER_LAYOUTUSER_MEMBERSHIP', PoP_TemplateIDUtils::get_template_definition('ure-aal-multicomponentwrapper-layoutuser-membership'));
define ('GD_URE_AAL_TEMPLATE_MULTICOMPONENTACTIONWRAPPER_LAYOUTUSER_MEMBERSHIP', PoP_TemplateIDUtils::get_template_definition('ure-aal-multicomponentactionwrapper-layoutuser-membership'));

define ('GD_URE_AAL_TEMPLATE_QUICKLINKGROUPWRAPPER_USER_JOINEDCOMMUNITY', PoP_TemplateIDUtils::get_template_definition('ure-aal-quicklinkgroupwrapper-user-joinedcommunity'));
define ('GD_URE_AAL_TEMPLATE_QUICKLINKGROUPACTIONWRAPPER_USER_JOINEDCOMMUNITY', PoP_TemplateIDUtils::get_template_definition('ure-aal-quicklinkgroupactionwrapper-user-joinedcommunity'));

    ...
    function get_precache_list($precache, $resourceType) {
        ...
        if ($resourceType == 'static') {
            ...
            if (PoP_Frontend_ServerUtils::use_minified_files()) {
                ...
                $precache[] = POP_COREPROCESSORS_URI.'/css/includes/fonts/glyphicons-halflings-regular.eot';
                $precache[] = POP_COREPROCESSORS_URI.'/css/includes/fonts/glyphicons-halflings-regular.svg';
                $precache[] = POP_COREPROCESSORS_URI.'/css/includes/fonts/glyphicons-halflings-regular.ttf';
                $precache[] = POP_COREPROCESSORS_URI.'/css/includes/fonts/glyphicons-halflings-regular.woff';
                $precache[] = POP_COREPROCESSORS_URI.'/css/includes/fonts/glyphicons-halflings-regular.woff2';
            }
        }

...
wsl_login_url='';var url=popBrowserHistory.getApplicationURL(window.location.href);var domain=getDomain(url);$.each(M.USERLOGGEDIN_DATA_PAGEURLS,function(index,url){if(url.startsWith(domain)){wsl_login_url=url;return-1;}});if(wsl_login_url){popUserAccount.fetchLoggedInUserData(wsl_login_url,options);}}
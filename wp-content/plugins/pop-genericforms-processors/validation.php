...
class PoP_GenericFormsProcessors_Validation {
	...
	function install_warning(){
		...
		$this->admin_notice(__('Error: <b>PoP Core Processors</b> is not installed/activated. Without it, <b>PoP Generic Forms Processors</b> will not work. Please install this plugin from your plugin installer or download it <a href="https://github.com/leoloso/PoP/">from here</a>.','ps-pop'));
	}
	function version_warning(){
		
		$this->admin_notice(
			sprintf(
				__('Error: this version of <b>PoP Generic Forms Processors</b> requires version %s or bigger of <b>PoP Core Processors</b>. Please update this plugin from your plugin installer or download it <a href="https://github.com/leoloso/PoP/">from here</a>.','ps-pop'),
	...
	function forms_install_warning(){
		...
		$this->admin_notice(__('Error: <b>PoP Generic Forms</b> is not installed/activated. Without it, <b>PoP Generic Forms Processors</b> will not work. Please install this plugin from your plugin installer or download it <a href="https://github.com/leoloso/PoP/">from here</a>.','ps-pop'));
	}
	function forms_version_warning(){
		
		$this->admin_notice(
			sprintf(
				__('Error: this version of <b>PoP Generic Forms Processors</b> requires version %s or bigger of <b>PoP Generic Forms</b>. Please update this plugin from your plugin installer or download it <a href="https://github.com/leoloso/PoP/">from here</a>.','ps-pop'),

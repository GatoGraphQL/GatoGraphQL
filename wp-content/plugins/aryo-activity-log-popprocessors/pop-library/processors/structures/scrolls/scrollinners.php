...
define ('GD_TEMPLATE_SCROLLINNER_NOTIFICATIONS_DETAILS', PoP_TemplateIDUtils::get_template_definition('scrollinner-notifications-details'));
define ('GD_TEMPLATE_SCROLLINNER_NOTIFICATIONS_LIST', PoP_TemplateIDUtils::get_template_definition('scrollinner-notifications-list'));

...
wget -O $POP_APP_PATH/wp-content/plugins/pop-frontendengine/js/dist/popfrontend.bundle.min.js "http://min.localhost/?b=$POP_APP_MIN_FOLDER/plugins/pop-frontendengine/js/libraries&f=helpers.handlebars.js,utils.js,jslibrary-manager.js,jsruntime-manager.js,pagesection-manager.js,history.js,interceptors.js,pop-manager.js"

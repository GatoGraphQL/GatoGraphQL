...
popManager = {
	...
	// 				pageSection: pageSection
	// 			};
	// 			popJSLibraryManager.execute('linkClicked', args);
	...
	// 	// Allow other components to do their own things. Eg: open social media links in system.js
	// 	popJSLibraryManager.execute('links', {});
	// },

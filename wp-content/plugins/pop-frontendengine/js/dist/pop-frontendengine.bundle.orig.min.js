...
popJSLibraryManager.execute('initDocument',args);$(document).triggerHandler('initialize.pop.document',[domain]);},initDomain:function(domain,fetchData){var t=this;t.domains[domain]={initialized:true};t.initDomainVars(domain);if(fetchData){var url=M.PLACEHOLDER_DOMAINURL.format(encodeURIComponent(domain));var entries={};entries[url]=[M.URLPARAM_TARGET_MAIN];t.backgroundLoad(entries);}

...
return ret;}};})(jQuery);;(function($){popJSRuntimeManager={'full-session-ids':{},'last-session-ids':{},blockURL:null,pageSectionURL:'general',setBlockURL:function(url){var t=this;t.blockURL=url;},initPageSectionVarPaths:function(vars,pssId,template,group){var t=this;if(!vars[pssId]){vars[pssId]={};}
if(!vars[pssId][template]){vars[pssId][template]={};}
if(!vars[pssId][template][group]){vars[pssId][template][group]=[];}},initBlockVarPaths:function(vars,url,pssId,targetId,template,group){var t=this;group=group||M.JSMETHOD_GROUP_MAIN;if(!vars[url]){vars[url]={};}

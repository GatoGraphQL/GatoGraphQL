...
options=options||{};var target=t.getTarget(pageSection);var fetchUrl=url;if(fetchUrl.indexOf('#')>-1){fetchUrl=fetchUrl.substr(0,fetchUrl.indexOf('#'));}
...
popJSLibraryManager.execute('modifyFetchBlockOptions',{options:options,url:fetchUrl});var params=t.getBlockParams(pageSection,block);if(options['post-data']){params['post-data']=options['post-data'];}

...
class PoP_ResourceLoader_FileReproduction_ResourcesConfigBase extends PoP_Engine_FileReproductionBase {
    ...
    public function get_configuration() {
        ...
        $configuration['$bundles'] = 
            $resource_mapping['bundles'][POP_RESOURCELOADER_RESOURCETYPE_JS] +
            $resource_mapping['bundles'][POP_RESOURCELOADER_RESOURCETYPE_CSS];
        $configuration['$bundleGroups'] = 
            $resource_mapping['bundle-groups'][POP_RESOURCELOADER_RESOURCETYPE_JS] +
            $resource_mapping['bundle-groups'][POP_RESOURCELOADER_RESOURCETYPE_CSS];

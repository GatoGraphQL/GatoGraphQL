<?php
// class PoP_ResourceLoader_ConfigAddResourcesFileGeneratorBase extends PoP_ResourceLoader_ResourcesFileGeneratorBase {
class PoP_ResourceLoader_ConfigAddResourcesFileGeneratorBase extends PoP_ResourceLoader_ConfigFileGeneratorBase {

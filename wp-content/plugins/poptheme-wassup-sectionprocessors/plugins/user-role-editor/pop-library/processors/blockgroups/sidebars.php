...
define ('GD_TEMPLATE_BLOCKGROUP_AUTHORPROJECTS_SIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-authorprojects-sidebar'));
...
class PoPSP_URE_Template_Processor_SidebarBlockGroups extends GD_Template_Processor_SidebarBlockGroupsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_BLOCKGROUP_AUTHORPROJECTS_SIDEBAR,
	...
	function get_inner_blocks($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_AUTHORPROJECTS_SIDEBAR:
			case GD_TEMPLATE_BLOCKGROUP_AUTHORSTORIES_SIDEBAR:
				...
				$filters = array(
					...
					GD_TEMPLATE_BLOCKGROUP_AUTHORPROJECTS_SIDEBAR => GD_TEMPLATE_BLOCK_AUTHORPROJECTS_SIDEBAR,

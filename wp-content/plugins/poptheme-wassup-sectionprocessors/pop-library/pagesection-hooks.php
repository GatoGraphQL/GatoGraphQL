...
class PoPTheme_Wassup_SectionProcessors_PageSectionHooks {
	...
	function replicate_blocksettingsids($block_frames) {
		...
		return array_merge(
			$block_frames,
			array(
				GD_TEMPLATE_BLOCK_LOCATIONPOST_CREATE => GD_TEMPLATE_BLOCK_PAGECONTROL_LOCATIONPOST_CREATE,
				GD_TEMPLATE_BLOCK_LOCATIONPOSTLINK_CREATE => GD_TEMPLATE_BLOCK_PAGECONTROL_LOCATIONPOSTLINK_CREATE,
	...
	function blockunit_intercept_url_sideinfo_sourceblocks($block_sources) {
		...
		if (PoPTheme_Wassup_Utils::get_addcontent_target() == GD_URLPARAM_TARGET_MAIN) {
			...
			return array_merge(
				$block_sources,
				array(
					GD_TEMPLATE_BLOCK_EMPTYSIDEINFO_LOCATIONPOST_CREATE => GD_TEMPLATE_BLOCK_LOCATIONPOST_CREATE,
					GD_TEMPLATE_BLOCK_EMPTYSIDEINFO_LOCATIONPOSTLINK_CREATE => GD_TEMPLATE_BLOCK_LOCATIONPOSTLINK_CREATE,
	...
	function intercepturl_sourceblocks_main($source_blocks) {
		...
		if (PoPTheme_Wassup_Utils::get_addcontent_target() == GD_URLPARAM_TARGET_MAIN) {
			...
			return array_merge(
				$source_blocks,
				array(
					GD_TEMPLATE_BLOCK_PAGETABS_LOCATIONPOST_CREATE => GD_TEMPLATE_BLOCK_LOCATIONPOST_CREATE,
					GD_TEMPLATE_BLOCK_PAGETABS_LOCATIONPOSTLINK_CREATE => GD_TEMPLATE_BLOCK_LOCATIONPOSTLINK_CREATE,

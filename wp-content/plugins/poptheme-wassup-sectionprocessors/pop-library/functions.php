...
function gd_custom_navigatorblocks($blocks) {
	...
	return array_merge(
		$blocks,
		array(
			GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_NAVIGATOR,
...
function gd_custom_addrelatedpost_buttons($buttons) {
	...
	if (POPTHEME_WASSUP_SECTIONPROCESSORS_PAGE_ADDLOCATIONPOST) {
		$buttons[] = GD_CUSTOM_TEMPLATE_BUTTON_LOCATIONPOST_CREATE;
		$buttons[] = GD_CUSTOM_TEMPLATE_BUTTON_LOCATIONPOSTLINK_CREATE;
	}
...
function gd_custom_layouttemplates_navigator($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_PREVIEWPOST_LOCATIONPOST_NAVIGATOR,
...
function gd_custom_layouttemplates_addons($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_PREVIEWPOST_LOCATIONPOST_ADDONS,
...
function gd_custom_layouttemplates_details($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_PREVIEWPOST_LOCATIONPOST_DETAILS,
...
function gd_custom_layouttemplates_thumbnail($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_PREVIEWPOST_LOCATIONPOST_THUMBNAIL,
...
function gd_custom_layouttemplates_list($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_PREVIEWPOST_LOCATIONPOST_LIST,
...
function gd_custom_layouttemplates_related($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_PREVIEWPOST_LOCATIONPOST_RELATED,
...
function gd_custom_layouttemplates_edit($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_PREVIEWPOST_LOCATIONPOST_EDIT,
...
function gd_custom_layouttemplates_simpleview($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_PREVIEWPOST_LOCATIONPOST_SIMPLEVIEW,
...
function gd_custom_layouttemplates_fullview($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_FULLVIEW_LOCATIONPOST,
...
function gd_custom_layouttemplates_authorfullview($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_AUTHORLAYOUT_FULLVIEW_LOCATIONPOST,
...
function gd_custom_layouttemplates_singlefullview($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_SINGLELAYOUT_FULLVIEW_LOCATIONPOST,
...
function gd_custom_layouttemplates_simpleview_customlayouts($layouts) {
	...
	$cat_layouts = array(
		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_MULTICOMPONENT_LOCATIONVOLUNTEER,
	);
	foreach ($cat_layouts as $cat => $layout) {
		if ($cat) {
			$layouts['post-'.$cat] = $layout;

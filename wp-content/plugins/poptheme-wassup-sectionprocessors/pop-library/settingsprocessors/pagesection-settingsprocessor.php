...
class PoPTheme_Wassup_SectionProcessors_PageSectionSettingsProcessor extends Wassup_PageSectionSettingsProcessorBase {
	...
	function add_sideinfo_author_blockunits(&$ret, $template_id) {
		...
		if ($add) {
			...
			$page_sidebars = array(
				POPTHEME_WASSUP_SECTIONPROCESSORS_PAGE_PROJECTS => GD_TEMPLATE_BLOCKGROUP_AUTHORPROJECTS_SIDEBAR,
			...
			if ($post_type == 'post') {
				...
				if ($page_id = GD_TemplateManager_Utils::get_hierarchy_page_id()) {
					switch ($page_id) {
						...
						case POPTHEME_WASSUP_PAGE_HIGHLIGHTS:
							...
							$sidebars = array(
								POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_PROJECTS => GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_HIGHLIGHTSSIDEBAR,
						...
						case POP_COREPROCESSORS_PAGE_RELATEDCONTENT:
							...
							$sidebars = array(
								POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_PROJECTS => GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RELATEDCONTENTSIDEBAR,
						...
						// 	$sidebars = array(
						// 		POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_PROJECTS => GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_POSTAUTHORSSIDEBAR,
						...
						case POP_COREPROCESSORS_PAGE_RECOMMENDEDBY:
							...
							$sidebars = array(
								POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_PROJECTS => GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RECOMMENDEDBYSIDEBAR,
				...
				if (!$sidebar) {
					...
					$cats_blockgroup = array(
						POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_PROJECTS => GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_SIDEBAR,
		...
		if ($add) {
			...
			switch ($page_id) {
				...
				case POPTHEME_WASSUP_SECTIONPROCESSORS_PAGE_PROJECTS:
					...
					$blockgroups[] = GD_TEMPLATE_BLOCKGROUP_SECTION_PROJECTS_SIDEBAR;
					break;
				...
				case POPTHEME_WASSUP_SECTIONPROCESSORS_PAGE_MYPROJECTS:
					...
					$blockgroups[] = GD_TEMPLATE_BLOCKGROUP_SECTION_MYPROJECTS_SIDEBAR;
					break;
				...
				case POP_COREPROCESSORS_PAGE_LOADERS_INITIALFRAMES:
					...
					if ($template_id == GD_TEMPLATE_PAGESECTION_SIDEINFO_PAGE) {
						...
						$replicable[] = GD_TEMPLATE_BLOCK_EMPTYSIDEINFO_PROJECT_CREATE;
						$replicable[] = GD_TEMPLATE_BLOCK_EMPTYSIDEINFO_PROJECTLINK_CREATE;
			...
			case POP_COREPROCESSORS_PAGE_LOADERS_INITIALFRAMES:
				...
				if ($template_id == GD_TEMPLATE_PAGESECTION_PAGE) {
					...
					if (PoPTheme_Wassup_Utils::get_addcontent_target() == GD_URLPARAM_TARGET_MAIN) {
						...
						$replicable[] = GD_TEMPLATE_BLOCK_PROJECT_CREATE;
						$replicable[] = GD_TEMPLATE_BLOCK_PROJECTLINK_CREATE;
		...
		switch ($page_id) {
			...
			case POP_COREPROCESSORS_PAGE_LOADERS_INITIALFRAMES:
				...
				if ($template_id == GD_TEMPLATE_PAGESECTION_PAGE) {
					...
					$frames[] = GD_TEMPLATE_BLOCK_PAGECONTROL_PROJECT_CREATE;
					$frames[] = GD_TEMPLATE_BLOCK_PAGECONTROL_PROJECTLINK_CREATE;
			...
			case POP_COREPROCESSORS_PAGE_LOADERS_INITIALFRAMES:
				...
				if ($template_id == GD_TEMPLATE_PAGESECTION_PAGETABS_PAGE) {
					...
					if (PoPTheme_Wassup_Utils::get_addcontent_target() == GD_URLPARAM_TARGET_MAIN) {
						...
						$replicable[] = GD_TEMPLATE_BLOCK_PAGETABS_PROJECT_CREATE;
						$replicable[] = GD_TEMPLATE_BLOCK_PAGETABS_PROJECTLINK_CREATE;

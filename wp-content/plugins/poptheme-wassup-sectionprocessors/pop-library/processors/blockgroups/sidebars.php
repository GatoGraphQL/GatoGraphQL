...
define ('GD_TEMPLATE_BLOCKGROUP_SECTION_PROJECTS_SIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-section-projects-sidebar'));
...
define ('GD_TEMPLATE_BLOCKGROUP_SECTION_MYPROJECTS_SIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-section-myprojects-sidebar'));
...
define ('GD_TEMPLATE_BLOCKGROUP_TAG_PROJECTS_SIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-tag-projects-sidebar'));
...
define ('GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_SIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-single-project-sidebar'));
define ('GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RELATEDCONTENTSIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-single-project-relatedcontentsidebar'));
define ('GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_HIGHLIGHTSSIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-single-project-highlightssidebar'));
define ('GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_POSTAUTHORSSIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-single-project-postauthorssidebar'));
define ('GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RECOMMENDEDBYSIDEBAR', PoP_ServerUtils::get_template_definition('blockgroup-single-project-recommendedbysidebar'));
...
class PoPSP_Template_Processor_SidebarBlockGroups extends GD_Template_Processor_SidebarBlockGroupsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_BLOCKGROUP_SECTION_PROJECTS_SIDEBAR,
			...
			GD_TEMPLATE_BLOCKGROUP_SECTION_MYPROJECTS_SIDEBAR,
			...
			GD_TEMPLATE_BLOCKGROUP_TAG_PROJECTS_SIDEBAR,
			...
			GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_SIDEBAR,
			GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RELATEDCONTENTSIDEBAR,
			GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_HIGHLIGHTSSIDEBAR,
			GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_POSTAUTHORSSIDEBAR,
			GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RECOMMENDEDBYSIDEBAR,
	...
	function get_inner_blocks($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RELATEDCONTENTSIDEBAR:
			case GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_HIGHLIGHTSSIDEBAR:
			case GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_POSTAUTHORSSIDEBAR:
			case GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RECOMMENDEDBYSIDEBAR:

				$filters = array(
					GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RELATEDCONTENTSIDEBAR => GD_TEMPLATE_BLOCK_SECTION_ALLCONTENT_SIDEBAR,
					GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_HIGHLIGHTSSIDEBAR => GD_TEMPLATE_BLOCK_SECTION_HIGHLIGHTS_SIDEBAR,
					GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_POSTAUTHORSSIDEBAR => GD_TEMPLATE_BLOCK_SECTION_ALLUSERS_NOFILTERSIDEBAR,
					GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_RECOMMENDEDBYSIDEBAR => GD_TEMPLATE_BLOCK_SECTION_ALLUSERS_SIDEBAR,
				);
				$ret[] = $filters[$template_id];
				$ret[] = GD_TEMPLATE_BLOCK_SINGLE_PROJECT_SIDEBAR;
				break;
			...
			default:
				...
				$blocks = array(
					...
					GD_TEMPLATE_BLOCKGROUP_SECTION_PROJECTS_SIDEBAR => GD_TEMPLATE_BLOCK_SECTION_PROJECTS_SIDEBAR,
					...
					GD_TEMPLATE_BLOCKGROUP_SECTION_MYPROJECTS_SIDEBAR => GD_TEMPLATE_BLOCK_SECTION_MYPROJECTS_SIDEBAR,
					...
					GD_TEMPLATE_BLOCKGROUP_TAG_PROJECTS_SIDEBAR => GD_TEMPLATE_BLOCK_TAGSECTION_PROJECTS_SIDEBAR,
					...
					GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_SIDEBAR => GD_TEMPLATE_BLOCK_SINGLE_PROJECT_SIDEBAR,
	...
	function get_screen($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_SECTION_PROJECTS_SIDEBAR:
			...
			case GD_TEMPLATE_BLOCKGROUP_TAG_PROJECTS_SIDEBAR:
			...
			case GD_TEMPLATE_BLOCKGROUP_SECTION_MYPROJECTS_SIDEBAR:
			...
			case GD_TEMPLATE_BLOCKGROUP_SINGLE_PROJECT_SIDEBAR:

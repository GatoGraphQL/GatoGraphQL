...
class GD_Custom_Template_Processor_AuthorSectionTabPanelBlockGroups extends GD_Template_Processor_AuthorSectionTabPanelBlockGroupsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_AUTHORLOCATIONPOSTS,
	...
	protected function get_block_inner_templates($template_id) {
		...
		if (gd_ure_is_community($author)) {
			...
			switch ($template_id) {
				...
				case GD_TEMPLATE_BLOCKGROUP_TABPANEL_AUTHORLOCATIONPOSTS:
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_AUTHORLOCATIONPOSTS:
				...
				$ret = array_merge(
					$ret,
					array(
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_SIMPLEVIEW,
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_FULLVIEW,
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_DETAILS,
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_THUMBNAIL,
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_LIST,
	...
	function get_panel_headers($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_AUTHORLOCATIONPOSTS:
				...
				$ret = array(
					GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_SIMPLEVIEW => array(
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_SIMPLEVIEW,
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_FULLVIEW,
					),
					GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_LIST => array(
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_DETAILS,
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_THUMBNAIL,
						GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLL_LIST,
					),
					GD_TEMPLATE_BLOCK_AUTHORLOCATIONPOSTS_SCROLLMAP => array(),
				);
				break;
	...
	function get_default_active_blockunit($template_id) {
		...
		$pages_id = array(
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_AUTHORLOCATIONPOSTS => POPTHEME_WASSUP_SECTIONPROCESSORS_PAGE_LOCATIONPOSTS,

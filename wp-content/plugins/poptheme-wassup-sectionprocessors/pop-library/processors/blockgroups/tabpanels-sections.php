...
class GD_Custom_Template_Processor_SectionTabPanelBlockGroups extends GD_Template_Processor_SectionTabPanelBlockGroupsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_LOCATIONPOSTS,
			...
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_MYLOCATIONPOSTS,
	...
	function get_block_jsmethod($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_MYLOCATIONPOSTS:
	...
	function get_blockgroup_blocks($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_LOCATIONPOSTS:

				$ret = array_merge(
					$ret,
					array(
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_SIMPLEVIEW,
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_FULLVIEW,
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_DETAILS,
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_THUMBNAIL,
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_LIST,
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_MYLOCATIONPOSTS:
				...
				$ret = array_merge(
					$ret,
					array(
						GD_TEMPLATE_BLOCK_MYLOCATIONPOSTS_TABLE_EDIT,
						GD_TEMPLATE_BLOCK_MYLOCATIONPOSTS_SCROLL_SIMPLEVIEWPREVIEW,
						GD_TEMPLATE_BLOCK_MYLOCATIONPOSTS_SCROLL_FULLVIEWPREVIEW,
					)
				);
				break;
	...
	function get_panel_headers($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_LOCATIONPOSTS:
				...
				return array(
					GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_SIMPLEVIEW => array(
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_SIMPLEVIEW,
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_FULLVIEW,
					),
					GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_LIST => array(
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_DETAILS,
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_THUMBNAIL,
						GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLL_LIST,
					),
					GD_TEMPLATE_BLOCK_LOCATIONPOSTS_SCROLLMAP => array(),
				);
		...
		if (!$vars['fetching-json-quickview']) {
			...
			switch ($template_id) {
				...
				case GD_TEMPLATE_BLOCKGROUP_TABPANEL_MYLOCATIONPOSTS:
					...
					return GD_TEMPLATE_CONTROLGROUP_MYLOCATIONPOSTLIST;

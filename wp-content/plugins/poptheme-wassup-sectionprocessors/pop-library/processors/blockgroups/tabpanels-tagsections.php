...
class GD_Custom_Template_Processor_TagSectionTabPanelBlockGroups extends GD_Template_Processor_TagSectionTabPanelBlockGroupsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGLOCATIONPOSTS,
	...
	function get_blockgroup_blocks($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGLOCATIONPOSTS:

				$ret = array_merge(
					$ret,
					array(
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_SIMPLEVIEW,
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_FULLVIEW,
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_DETAILS,
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_THUMBNAIL,
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_LIST,
	...
	function get_panel_headers($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGLOCATIONPOSTS:
				...
				$ret = array(
					GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_SIMPLEVIEW => array(
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_SIMPLEVIEW,
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_FULLVIEW,
					),
					GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_LIST => array(
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_DETAILS,
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_THUMBNAIL,
						GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLL_LIST,
					),
					GD_TEMPLATE_BLOCK_TAGLOCATIONPOSTS_SCROLLMAP => array(),
				);
				break;
	...
	function get_default_active_blockunit($template_id) {
		...
		$pages_id = array(
			GD_TEMPLATE_BLOCKGROUP_TABPANEL_TAGLOCATIONPOSTS => POPTHEME_WASSUP_SECTIONPROCESSORS_PAGE_LOCATIONPOSTS,

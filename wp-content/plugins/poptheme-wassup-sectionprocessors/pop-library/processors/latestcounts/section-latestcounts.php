...
define ('GD_TEMPLATE_LATESTCOUNT_TAG_PROJECTS', PoP_ServerUtils::get_template_definition('latestcount-tag-projects'));
...
class PoPThemeWassup_SectionProcessors_Template_Processor_SectionLatestCounts extends GD_Template_Processor_SectionLatestCountsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_LATESTCOUNT_TAG_PROJECTS,
	...
	function get_object_name($template_id, $atts) {
		...
		$cats = array(
			...
			GD_TEMPLATE_LATESTCOUNT_TAG_PROJECTS => POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_PROJECTS,
	...
	function get_section_classes($template_id, $atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_LATESTCOUNT_TAG_PROJECTS:

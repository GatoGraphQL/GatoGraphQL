...
class GD_Custom_Template_Processor_CreateUpdatePostFormMessageFeedbackFrameLayouts extends GD_Template_Processor_MessageFeedbackFrameLayoutsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_LOCATIONPOST_CREATE,
			GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_LOCATIONPOST_UPDATE,
	...
	function get_layout($template_id) {
		...
		$layouts = array(
			GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_LOCATIONPOST_CREATE => GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACK_LOCATIONPOST_CREATE,
			GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_LOCATIONPOST_UPDATE => GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACK_LOCATIONPOST_UPDATE,

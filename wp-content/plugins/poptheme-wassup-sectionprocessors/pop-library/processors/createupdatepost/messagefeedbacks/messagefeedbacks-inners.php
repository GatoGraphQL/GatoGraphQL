...
class GD_Custom_Template_Processor_CreateUpdatePostFormMessageFeedbackInners extends GD_Template_Processor_MessageFeedbackInnersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			GD_TEMPLATE_MESSAGEFEEDBACKINNER_LOCATIONPOST_CREATE,
			GD_TEMPLATE_MESSAGEFEEDBACKINNER_LOCATIONPOST_UPDATE,
	...
	function get_layouts($template_id) {
		...
		$layouts = array(
			GD_TEMPLATE_MESSAGEFEEDBACKINNER_LOCATIONPOST_CREATE => GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_LOCATIONPOST_CREATE,
			GD_TEMPLATE_MESSAGEFEEDBACKINNER_LOCATIONPOST_UPDATE => GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_LOCATIONPOST_UPDATE,

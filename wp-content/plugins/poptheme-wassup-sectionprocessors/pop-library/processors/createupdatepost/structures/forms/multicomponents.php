...
define ('GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECT_RIGHTSIDE', PoP_ServerUtils::get_template_definition('multicomponent-form-project-rightside'));
define ('GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECTLINK_RIGHTSIDE', PoP_ServerUtils::get_template_definition('multicomponent-form-projectlink-rightside'));
...
class GD_Custom_Template_Processor_FormMultipleComponents extends GD_Template_Processor_MultiplesBase {
	...
	function get_modules($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECT_RIGHTSIDE:
			case GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECTLINK_RIGHTSIDE:
			...
			case GD_TEMPLATE_MULTICOMPONENT_FORM_FEATURED_RIGHTSIDE:
				...
				$details = array(
					GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECT_RIGHTSIDE => GD_TEMPLATE_WIDGET_FORM_PROJECTDETAILS,
					GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECTLINK_RIGHTSIDE => GD_TEMPLATE_WIDGET_FORM_PROJECTLINKDETAILS,

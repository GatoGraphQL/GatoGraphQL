...
define ('GD_TEMPLATE_FORMINNER_PROJECT_UPDATE', PoP_ServerUtils::get_template_definition('forminner-project-update'));
define ('GD_TEMPLATE_FORMINNER_PROJECTLINK_UPDATE', PoP_ServerUtils::get_template_definition('forminner-projectlink-update'));
define ('GD_TEMPLATE_FORMINNER_PROJECT_CREATE', PoP_ServerUtils::get_template_definition('forminner-project-create'));
define ('GD_TEMPLATE_FORMINNER_PROJECTLINK_CREATE', PoP_ServerUtils::get_template_definition('forminner-projectlink-create'));
...
class GD_Custom_Template_Processor_CreateUpdatePostFormInners extends Wassup_Template_Processor_CreateUpdatePostFormInnersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			GD_TEMPLATE_FORMINNER_PROJECT_UPDATE,
			GD_TEMPLATE_FORMINNER_PROJECTLINK_UPDATE,
			GD_TEMPLATE_FORMINNER_PROJECT_CREATE,
			GD_TEMPLATE_FORMINNER_PROJECTLINK_CREATE,
	...
	protected function is_link($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_FORMINNER_PROJECTLINK_UPDATE:			
			case GD_TEMPLATE_FORMINNER_PROJECTLINK_CREATE:			
	...
	protected function volunteering($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_FORMINNER_PROJECT_CREATE:
			case GD_TEMPLATE_FORMINNER_PROJECTLINK_CREATE:
			case GD_TEMPLATE_FORMINNER_PROJECT_UPDATE:
			case GD_TEMPLATE_FORMINNER_PROJECTLINK_UPDATE:
			...
			case GD_TEMPLATE_FORMINNER_PROJECT_CREATE:
				...
				return array_merge(
					...
					array(
						...
						GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECT_RIGHTSIDE,
					)
				);
			...
			case GD_TEMPLATE_FORMINNER_PROJECTLINK_CREATE:
				...
				return array_merge(
					...
					array(
						...
						GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECTLINK_RIGHTSIDE,
					)
				);
	...
	function init_atts($template_id, &$atts) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_FORMINNER_FEATURED_UPDATE:
				...
				$rightsides = array(
					GD_TEMPLATE_FORMINNER_PROJECT_CREATE => GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECT_RIGHTSIDE,
					GD_TEMPLATE_FORMINNER_PROJECTLINK_CREATE => GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECTLINK_RIGHTSIDE,
					GD_TEMPLATE_FORMINNER_PROJECT_UPDATE => GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECT_RIGHTSIDE,
					GD_TEMPLATE_FORMINNER_PROJECTLINK_UPDATE => GD_TEMPLATE_MULTICOMPONENT_FORM_PROJECTLINK_RIGHTSIDE,

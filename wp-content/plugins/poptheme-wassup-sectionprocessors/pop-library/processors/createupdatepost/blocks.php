...
define ('GD_TEMPLATE_BLOCK_PROJECT_UPDATE', PoP_ServerUtils::get_template_definition('block-project-update'));
define ('GD_TEMPLATE_BLOCK_PROJECTLINK_UPDATE', PoP_ServerUtils::get_template_definition('block-projectlink-update'));
define ('GD_TEMPLATE_BLOCK_PROJECT_CREATE', PoP_ServerUtils::get_template_definition('block-project-create'));
define ('GD_TEMPLATE_BLOCK_PROJECTLINK_CREATE', PoP_ServerUtils::get_template_definition('block-projectlink-create'));
...
class GD_Custom_Template_Processor_CreateUpdatePostBlocks extends GD_Template_Processor_BlocksBase {
	...
	protected function get_controlgroup_top($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_BLOCK_PROJECT_CREATE:
			case GD_TEMPLATE_BLOCK_PROJECTLINK_CREATE:
			...
			case GD_TEMPLATE_BLOCK_PROJECT_UPDATE:
			case GD_TEMPLATE_BLOCK_PROJECTLINK_UPDATE:
	...
	protected function get_messagefeedback($template_id) {
		...
		$feedbacks = array(
			GD_TEMPLATE_BLOCK_PROJECT_CREATE => GD_TEMPLATE_MESSAGEFEEDBACK_PROJECT_CREATE,
			GD_TEMPLATE_BLOCK_PROJECTLINK_CREATE => GD_TEMPLATE_MESSAGEFEEDBACK_PROJECT_CREATE,
			GD_TEMPLATE_BLOCK_PROJECT_UPDATE => GD_TEMPLATE_MESSAGEFEEDBACK_PROJECT_UPDATE,
			GD_TEMPLATE_BLOCK_PROJECTLINK_UPDATE => GD_TEMPLATE_MESSAGEFEEDBACK_PROJECT_UPDATE,
	...
	protected function get_block_inner_templates($template_id) {
		...
		$block_inners = array(
			GD_TEMPLATE_BLOCK_PROJECT_UPDATE => GD_TEMPLATE_FORM_PROJECT_UPDATE,
			GD_TEMPLATE_BLOCK_PROJECTLINK_UPDATE => GD_TEMPLATE_FORM_PROJECTLINK_UPDATE,
			GD_TEMPLATE_BLOCK_PROJECT_CREATE => GD_TEMPLATE_FORM_PROJECT_CREATE,
			GD_TEMPLATE_BLOCK_PROJECTLINK_CREATE => GD_TEMPLATE_FORM_PROJECTLINK_CREATE,

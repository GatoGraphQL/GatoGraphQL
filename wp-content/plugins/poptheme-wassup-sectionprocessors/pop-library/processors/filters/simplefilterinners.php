...
define ('GD_TEMPLATE_SIMPLEFILTERINNER_AUTHORFEATURED', PoP_TemplateIDUtils::get_template_definition('simplefilterinner-authorfeatured'));
...
class PoPSP_Template_Processor_CustomSimpleFilterInners extends GD_Template_Processor_SimpleFilterInnersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_SIMPLEFILTERINNER_AUTHORFEATURED,
	...
	function get_filter($template_id) {
		...
		$filters = array(
			...
			GD_TEMPLATE_SIMPLEFILTERINNER_AUTHORFEATURED => GD_FILTER_AUTHORFEATURED,

...
define ('GD_TEMPLATE_DELEGATORFILTER_TAGPROJECTS', PoP_ServerUtils::get_template_definition('delegatorfilter-tagprojects'));
...
class PoPSP_Template_Processor_CustomDelegatorFilters extends GD_Template_Processor_CustomDelegatorFiltersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_DELEGATORFILTER_TAGPROJECTS,
	...
	function get_inner_template($template_id) {
		...
		$inners = array(
			...
			GD_TEMPLATE_DELEGATORFILTER_TAGPROJECTS => GD_TEMPLATE_SIMPLEFILTERINNER_TAGPROJECTS,

...
define ('GD_TEMPLATE_DELEGATORFILTER_AUTHORFEATURED', PoP_TemplateIDUtils::get_template_definition('delegatorfilter-authorfeatured'));
...
class PoPSP_Template_Processor_CustomDelegatorFilters extends GD_Template_Processor_CustomDelegatorFiltersBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_DELEGATORFILTER_AUTHORFEATURED,
	...
	function get_inner_template($template_id) {
		...
		$inners = array(
			...
			GD_TEMPLATE_DELEGATORFILTER_AUTHORFEATURED => GD_TEMPLATE_SIMPLEFILTERINNER_AUTHORFEATURED,

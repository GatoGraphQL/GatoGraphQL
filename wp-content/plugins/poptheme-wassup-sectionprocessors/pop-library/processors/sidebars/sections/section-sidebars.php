...
define ('GD_TEMPLATE_SIDEBAR_SECTION_TAGPROJECTS', PoP_ServerUtils::get_template_definition('sidebar-section-tagprojects'));
...
class GD_Custom_Template_Processor_CustomSectionSidebars extends GD_Template_Processor_SidebarsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_SIDEBAR_SECTION_TAGPROJECTS, 
	...
	function get_inner_template($template_id) {
		...
		$sidebarinners = array(
			...
			GD_TEMPLATE_SIDEBAR_SECTION_TAGPROJECTS => GD_TEMPLATE_SIDEBARINNER_SECTION_TAGPROJECTS, 

...
define ('GD_TEMPLATE_MESSAGEFEEDBACK_PROJECTS', PoP_ServerUtils::get_template_definition('messagefeedback-projects'));
...
define ('GD_TEMPLATE_MESSAGEFEEDBACK_MYPROJECTS', PoP_ServerUtils::get_template_definition('messagefeedback-myprojects'));
...
class GD_Custom_Template_Processor_CustomListMessageFeedbacks extends GD_Template_Processor_MessageFeedbacksBase {
	...
	function get_templates_to_process() {
		...
		return array(
			GD_TEMPLATE_MESSAGEFEEDBACK_PROJECTS,
			...
			GD_TEMPLATE_MESSAGEFEEDBACK_MYPROJECTS,
	...
	function get_inner_template($template_id) {
		...
		$inners = array(
			GD_TEMPLATE_MESSAGEFEEDBACK_PROJECTS => GD_TEMPLATE_MESSAGEFEEDBACKINNER_PROJECTS,
			...
			GD_TEMPLATE_MESSAGEFEEDBACK_MYPROJECTS => GD_TEMPLATE_MESSAGEFEEDBACKINNER_MYPROJECTS,

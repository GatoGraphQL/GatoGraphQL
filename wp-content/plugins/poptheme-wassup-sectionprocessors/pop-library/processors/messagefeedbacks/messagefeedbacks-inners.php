...
define ('GD_TEMPLATE_MESSAGEFEEDBACKINNER_LOCATIONPOSTS', PoP_ServerUtils::get_template_definition('messagefeedbackinner-locationposts'));
...
define ('GD_TEMPLATE_MESSAGEFEEDBACKINNER_MYLOCATIONPOSTS', PoP_ServerUtils::get_template_definition('messagefeedbackinner-mylocationposts'));

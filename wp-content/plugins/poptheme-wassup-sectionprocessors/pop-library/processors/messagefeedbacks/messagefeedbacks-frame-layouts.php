...
class GD_Custom_Template_Processor_CustomListMessageFeedbackFrameLayouts extends GD_Template_Processor_MessageFeedbackFrameLayoutsBase {
	...
	function get_templates_to_process() {
		...
		return array(
			GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_LOCATIONPOSTS,
			...
			GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_MYLOCATIONPOSTS,
	...
	function get_layout($template_id) {
		...
		$layouts = array(
			GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACK_LOCATIONPOSTS,
			...
			GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACKFRAME_MYLOCATIONPOSTS => GD_TEMPLATE_LAYOUT_MESSAGEFEEDBACK_MYLOCATIONPOSTS,

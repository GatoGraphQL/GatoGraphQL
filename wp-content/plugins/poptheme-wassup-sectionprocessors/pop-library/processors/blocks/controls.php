...
define ('GD_TEMPLATE_BLOCK_PAGECONTROL_ANNOUNCEMENTLINK_CREATE', PoP_ServerUtils::get_template_definition('block-pagecontrol-announcementlink-create'));
define ('GD_TEMPLATE_BLOCK_PAGECONTROL_DISCUSSION_CREATE', PoP_ServerUtils::get_template_definition('block-pagecontrol-discussion-create'));
define ('GD_TEMPLATE_BLOCK_PAGECONTROL_DISCUSSIONLINK_CREATE', PoP_ServerUtils::get_template_definition('block-pagecontrol-discussionlink-create'));

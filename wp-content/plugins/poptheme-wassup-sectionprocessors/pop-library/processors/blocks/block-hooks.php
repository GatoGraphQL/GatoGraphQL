...
class PoPTheme_Wassup_SectionProcessors_BlockHooks {
	...
	function sidebars($sidebars) {
		...
		$cat_sidebars = array(
			POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_LAYOUT_POSTSIDEBARCOMPACT_HORIZONTAL_LOCATIONPOST,
	...
	function bottomsidebars($sidebars) {
		...
		// If a category was kept in false then it is not fed to allcontent. Eg: Projects not needed for TPP Debate
		$cat_sidebars = array(
			POPTHEME_WASSUP_SECTIONPROCESSORS_CAT_LOCATIONPOSTS => GD_TEMPLATE_CONTENT_POSTCONCLUSIONSIDEBAR_HORIZONTAL,

...
define ('GD_FILTER_TAGPROJECTS', 'tagprojects');

class GD_Filter_TagProjects extends GD_FilterTagPosts {

	function get_filtercomponents() {
	
		global $gd_filtercomponent_search, /*$gd_filtercomponent_projectcategories, *//*$gd_filtercomponent_categories, */$gd_filtercomponent_profiles, $gd_filtercomponent_volunteersneeded, $gd_filtercomponent_orderpost;
		...
		// }
		$ret = apply_filters('gd_template:filter-tagprojects:filtercomponents', $ret);

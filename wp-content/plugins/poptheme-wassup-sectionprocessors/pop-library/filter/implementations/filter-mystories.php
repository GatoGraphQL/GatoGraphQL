...
class GD_Filter_MyStories extends GD_FilterMyPosts {
	...
	function get_filtercomponents() {
		...
		global /*$gd_filtercomponent_moderatedstatus, */$gd_filtercomponent_search, $gd_filtercomponent_hashtags, /*$gd_filtercomponent_references, *//*$gd_filtercomponent_categories, */$gd_filtercomponent_orderpost /*,$gd_filtercomponent_locationposts, $gd_filtercomponent_events*/;		
		$status = $this->get_status_filtercomponent();
		$ret = array($status, $gd_filtercomponent_search, $gd_filtercomponent_hashtags, /*$gd_filtercomponent_references, *//*$gd_filtercomponent_categories, */$gd_filtercomponent_orderpost /*, $gd_filtercomponent_locationposts, $gd_filtercomponent_events*/);

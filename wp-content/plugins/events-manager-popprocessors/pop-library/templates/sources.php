...
define ('GD_TEMPLATESOURCE_MAP_STATICIMAGE', 'em-map-staticimage');
define ('GD_TEMPLATESOURCE_MAP_STATICIMAGE_URLPARAM', 'em-map-staticimage-urlparam');
define ('GD_TEMPLATESOURCE_MAP_STATICIMAGE_LOCATIONS', 'em-map-staticimage-locations');
...
$pop_serverside_rendering->add_templatesource_path(GD_TEMPLATESOURCE_MAP_STATICIMAGE, EM_POPPROCESSORS_PHPTEMPLATES_DIR);
$pop_serverside_rendering->add_templatesource_path(GD_TEMPLATESOURCE_MAP_STATICIMAGE_URLPARAM, EM_POPPROCESSORS_PHPTEMPLATES_DIR);
$pop_serverside_rendering->add_templatesource_path(GD_TEMPLATESOURCE_MAP_STATICIMAGE_LOCATIONS, EM_POPPROCESSORS_PHPTEMPLATES_DIR);

...
class GD_Template_Processor_MapIndividualsBase extends GD_Template_ProcessorBase {
	...
	function get_drawmarkers_template($template_id, $atts) {
	...
	function get_modules($template_id) {
		...
		$ret[] = $this->get_drawmarkers_template($template_id, $atts);
	...
	function get_template_configuration($template_id, $atts) {
		...
		$map_div = $this->get_mapdiv_template($template_id, $atts);
		$drawmarkers = $this->get_drawmarkers_template($template_id, $atts);

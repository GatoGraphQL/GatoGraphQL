...
define ('GD_TEMPLATE_VIEWCOMPONENT_BUTTONWRAPPER_POSTLOCATIONS_NOINITMARKERS', PoP_TemplateIDUtils::get_template_definition('viewcomponent-buttonwrapper-postlocations-noinitmarkers'));
...
define ('GD_TEMPLATE_VIEWCOMPONENT_BUTTONWRAPPER_USERLOCATIONS_NOINITMARKERS', PoP_TemplateIDUtils::get_template_definition('viewcomponent-buttonwrapper-userlocations-noinitmarkers'));
...
class GD_Template_Processor_LocationViewComponentButtonWrapperss extends GD_Template_Processor_ConditionWrapperBase {
	...
	function get_templates_to_process() {
		...
		return array(
			...
			GD_TEMPLATE_VIEWCOMPONENT_BUTTONWRAPPER_POSTLOCATIONS_NOINITMARKERS,
			GD_TEMPLATE_VIEWCOMPONENT_BUTTONWRAPPER_USERLOCATIONS,
			GD_TEMPLATE_VIEWCOMPONENT_BUTTONWRAPPER_USERLOCATIONS_NOINITMARKERS,
	...
	function get_layouts($template_id) {
		...
		switch ($template_id) {
			...
			case GD_TEMPLATE_VIEWCOMPONENT_BUTTONWRAPPER_POSTLOCATIONS_NOINITMARKERS:

				$ret[] = GD_TEMPLATE_VIEWCOMPONENT_BUTTON_POSTLOCATIONS_NOINITMARKERS;
				break;
			...
			case GD_TEMPLATE_VIEWCOMPONENT_BUTTONWRAPPER_USERLOCATIONS_NOINITMARKERS:

				$ret[] = GD_TEMPLATE_VIEWCOMPONENT_BUTTON_USERLOCATIONS_NOINITMARKERS;
				break;

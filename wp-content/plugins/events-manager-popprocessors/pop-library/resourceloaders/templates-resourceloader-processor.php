...
define ('POP_RESOURCELOADER_TEMPLATE_CALENDAR', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_CALENDAR));
define ('POP_RESOURCELOADER_TEMPLATE_CALENDAR_INNER', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_CALENDAR_INNER));
define ('POP_RESOURCELOADER_TEMPLATE_FORMCOMPONENT_TYPEAHEADMAP', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_FORMCOMPONENT_TYPEAHEADMAP));
define ('POP_RESOURCELOADER_TEMPLATE_FRAME_CREATELOCATIONMAP', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_FRAME_CREATELOCATIONMAP));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUT_CAROUSEL_INDICATORS_EVENTDATE', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUT_CAROUSEL_INDICATORS_EVENTDATE));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUT_DATETIME', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUT_DATETIME));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUT_LOCATIONADDRESS', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUT_LOCATIONADDRESS));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUT_LOCATIONNAME', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUT_LOCATIONNAME));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUT_LOCATIONS', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUT_LOCATIONS));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUTCALENDAR_CONTENT_POPOVER', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUTCALENDAR_CONTENT_POPOVER));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUTEVENT_TABLECOL', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUTEVENT_TABLECOL));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUTLOCATION_TYPEAHEAD_COMPONENT', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUTLOCATION_TYPEAHEAD_COMPONENT));
define ('POP_RESOURCELOADER_TEMPLATE_LAYOUTLOCATION_TYPEAHEAD_SELECTED', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_LAYOUTLOCATION_TYPEAHEAD_SELECTED));
define ('POP_RESOURCELOADER_TEMPLATE_MAP', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_ADDMARKER', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_ADDMARKER));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_DIV', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_DIV));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_INDIVIDUAL', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_INDIVIDUAL));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_INNER', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_INNER));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_SCRIPT', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_SCRIPT));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_SCRIPT_DRAWMARKERS', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_SCRIPT_DRAWMARKERS));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_SCRIPT_MARKERS', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_SCRIPT_MARKERS));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_SCRIPT_RESETMARKERS', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_SCRIPT_RESETMARKERS));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_SCRIPTCUSTOMIZATION_POST', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_SCRIPTCUSTOMIZATION_POST));
define ('POP_RESOURCELOADER_TEMPLATE_MAP_SCRIPTCUSTOMIZATION_USER', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_MAP_SCRIPTCUSTOMIZATION_USER));
define ('POP_RESOURCELOADER_TEMPLATE_SCRIPT_TRIGGERTYPEAHEADSELECT_LOCATION', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_SCRIPT_TRIGGERTYPEAHEADSELECT_LOCATION));
define ('POP_RESOURCELOADER_TEMPLATE_VIEWCOMPONENT_LOCATIONBUTTON', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_VIEWCOMPONENT_LOCATIONBUTTON));
define ('POP_RESOURCELOADER_TEMPLATE_VIEWCOMPONENT_LOCATIONBUTTONINNER', PoP_ServerUtils::get_template_definition(GD_TEMPLATESOURCE_VIEWCOMPONENT_LOCATIONBUTTONINNER));
